; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\CAMPAIGN\CAMPLIB\Name.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?NameIndex@@3PAFA				; NameIndex
PUBLIC	?NameEntries@@3FA				; NameEntries
PUBLIC	?NameFile@@3PADA				; NameFile
PUBLIC	?NameStream@@3PADA				; NameStream
...
_BSS	SEGMENT
?NameIndex@@3PAFA DD 01H DUP (?)			; NameIndex
?NameEntries@@3FA DW 01H DUP (?)			; NameEntries
	ALIGN	4

?NameFile@@3PADA DB 028H DUP (?)			; NameFile
?NameStream@@3PADA DD 01H DUP (?)			; NameStream
_BSS	ENDS
...
PUBLIC	?LoadNames@@YAXPAD@Z				; LoadNames
PUBLIC	?LoadNameStream@@YAXXZ				; LoadNameStream
PUBLIC	?SaveNames@@YAHPAD@Z				; SaveNames
PUBLIC	?FreeNames@@YAXXZ				; FreeNames
PUBLIC	?ReadNameString@@YAPADHPADI@Z			; ReadNameString
PUBLIC	?AddName@@YAHPAD@Z				; AddName
PUBLIC	?SetName@@YAHHPAD@Z				; SetName
PUBLIC	?FindName@@YAHPAD@Z				; FindName
PUBLIC	?RemoveName@@YAXH@Z				; RemoveName
PUBLIC	?RemoveName@@YAXPAD@Z				; RemoveName
...
PUBLIC	??_C@_06JGAGDFHN@?$CFd?5?$CFs?6?$AA@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_06JGAGDFHN@?$CFd?5?$CFs?6?$AA@
CONST	SEGMENT
??_C@_06JGAGDFHN@?$CFd?5?$CFs?6?$AA@ DB '%d %s', 0aH, 00H ; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
_nid$ = -4						; size = 4
_name$ = 8						; size = 4
?RemoveName@@YAXPAD@Z PROC				; RemoveName
...
; 268  : 	int		nid;
; 269  : 
; 270  : 	nid = FindName(name);

	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	call	?FindName@@YAHPAD@Z			; FindName
	add	esp, 4
...
; 271  : 	RemoveName(nid);
	...
	push	ecx
	call	?RemoveName@@YAXH@Z			; RemoveName
	add	esp, 4
...
; 272  : 	}
	...
	pop	ebp
	ret	0
?RemoveName@@YAXPAD@Z ENDP				; RemoveName
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
...
_i$ = -4						; size = 4
_nid$ = 8						; size = 4
?RemoveName@@YAXH@Z PROC				; RemoveName
...
; 245  : 	int		movesize,i,len;
; 246  : 	_TCHAR	*tmp;
; 247  : 
; 248  : 	if (nid < 2)

	cmp	DWORD PTR _nid$[ebp], 2
	jge	SHORT $LN5@RemoveName
...
; 250  : 
; 251  : 	// Load our wch file if we don't already have it in memory
; 252  : 	if (!NameStream)

	cmp	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
	jne	SHORT $LN4@RemoveName

; 253  : 		LoadNameStream();

	call	?LoadNameStream@@YAXXZ			; LoadNameStream
$LN4@RemoveName:

; 254  : 
; 255  : 	movesize = NameIndex[NameEntries-1] - NameIndex[nid+1];

	movsx	eax, WORD PTR ?NameEntries@@3FA		; NameEntries
	mov	ecx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	edx, WORD PTR [ecx+eax*2-2]
	mov	eax, DWORD PTR _nid$[ebp]
	mov	ecx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	eax, WORD PTR [ecx+eax*2+2]
	sub	edx, eax
	mov	DWORD PTR _movesize$[ebp], edx

; 256  : 	tmp = new _TCHAR[movesize];

	mov	ecx, DWORD PTR _movesize$[ebp]
	push	ecx
...
; 257  : 	memcpy (tmp,&NameStream[NameIndex[nid+1]],movesize);

	mov	eax, DWORD PTR _movesize$[ebp]
	push	eax
	mov	ecx, DWORD PTR _nid$[ebp]
	mov	edx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	eax, WORD PTR [edx+ecx*2+2]
	add	eax, DWORD PTR ?NameStream@@3PADA	; NameStream
	push	eax
...
; 258  : 	memcpy (&NameStream[NameIndex[nid]],tmp,movesize);

	mov	edx, DWORD PTR _movesize$[ebp]
	push	edx
...
; 260  : 
; 261  : 	len = NameIndex[nid+1] - NameIndex[nid];
...
; 262  : 	for (i=nid+1; i<NameEntries; i++)

	mov	ecx, DWORD PTR _nid$[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
	jmp	SHORT $LN3@RemoveName
$LN2@RemoveName:
...
; 264  : 	}
	...
	pop	ebp
	ret	0
?RemoveName@@YAXH@Z ENDP				; RemoveName
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
...
_name$ = 8						; size = 4
?FindName@@YAHPAD@Z PROC				; FindName
...
; 231  : 	int		i;
; 232  : 	_TCHAR	entry[128];
; 233  : 
; 234  : 	for (i=0; i<NameEntries; i++)

	mov	DWORD PTR _i$[ebp], 0
	jmp	SHORT $LN4@FindName
$LN3@FindName:
	mov	eax, DWORD PTR _i$[ebp]
	add	eax, 1
	mov	DWORD PTR _i$[ebp], eax
$LN4@FindName:
	movsx	ecx, WORD PTR ?NameEntries@@3FA		; NameEntries
	cmp	DWORD PTR _i$[ebp], ecx
	jge	SHORT $LN2@FindName

; 235  : 		{
; 236  : 		ReadNameString(i,entry,127);
...
; 237  : 		if (strcmp(name,entry) == 0)
	...
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@FindName

; 238  : 			return i;

	mov	eax, DWORD PTR _i$[ebp]
	jmp	SHORT $LN5@FindName
$LN1@FindName:
...
; 241  : 	}
	...
	pop	ebp
	ret	0
?FindName@@YAHPAD@Z ENDP				; FindName
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
_nameid$ = 8						; size = 4
_name$ = 12						; size = 4
?SetName@@YAHHPAD@Z PROC				; SetName
...
; 223  : 	// It's actually easier to remove our name and add a new one
; 224  : 	if (nameid)

	cmp	DWORD PTR _nameid$[ebp], 0
	je	SHORT $LN1@SetName

; 225  : 		RemoveName(nameid);
...
; 227  : 	}
	...
	pop	ebp
	ret	0
?SetName@@YAHHPAD@Z ENDP				; SetName
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
...
$T4 = -36						; size = 4
_offset$ = -32						; size = 4
_lastoffset$ = -28					; size = 4
_len$ = -24						; size = 4
_movesize$ = -20					; size = 4
_newstream$ = -16					; size = 4
_TmpIdx$5 = -12						; size = 4
_i$ = -8						; size = 4
_nid$ = -4						; size = 4
_name$ = 8						; size = 4
?AddName@@YAHPAD@Z PROC					; AddName
...
; 166  : 	int		i,nid=0,len,lastoffset=0,offset=0,movesize;

	mov	DWORD PTR _nid$[ebp], 0
	mov	DWORD PTR _lastoffset$[ebp], 0
	mov	DWORD PTR _offset$[ebp], 0

; 167  : 	_TCHAR	*newstream;
; 168  : 
; 169  : 	len = _tcslen(name);
...
; 170  : 	// Load our wch file if we don't already have it in memory
; 171  : 	if (!NameStream)

	cmp	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
	jne	SHORT $LN13@AddName
...
; 173  : 
; 174  : 	// Find a free spot
; 175  : 	for (i=2; i<NameEntries && !nid; i++)

	mov	DWORD PTR _i$[ebp], 2
	jmp	SHORT $LN12@AddName
$LN11@AddName:
	mov	ecx, DWORD PTR _i$[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
$LN12@AddName:
	movsx	edx, WORD PTR ?NameEntries@@3FA		; NameEntries
	cmp	DWORD PTR _i$[ebp], edx
	jge	SHORT $LN10@AddName
	cmp	DWORD PTR _nid$[ebp], 0
	jne	SHORT $LN10@AddName

; 176  : 		{
; 177  : 		// And entry is free if it has a zero (or negative) length
; 178  : 		if (NameIndex[i+1] - NameIndex[i] <= 0)
	...
	sub	edx, eax
	test	edx, edx
	jg	SHORT $LN9@AddName

; 179  : 			{
; 180  : 			offset = lastoffset;

	mov	ecx, DWORD PTR _lastoffset$[ebp]
...
; 183  : 		if (NameIndex[i])
	...
	test	edx, edx
	je	SHORT $LN8@AddName

; 184  : 			lastoffset = NameIndex[i];

	mov	eax, DWORD PTR _i$[ebp]
	mov	ecx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	edx, WORD PTR [ecx+eax*2]
	mov	DWORD PTR _lastoffset$[ebp], edx
$LN8@AddName:

; 185  : 		}

	jmp	SHORT $LN11@AddName
$LN10@AddName:
...
; 187  : 		{
; 188  : 		// Found a free spot, insert this string
; 189  : 		if (!NameIndex[nid])

	mov	eax, DWORD PTR _nid$[ebp]
	mov	ecx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	edx, WORD PTR [ecx+eax*2]
	test	edx, edx
	jne	SHORT $LN6@AddName

; 190  : 			NameIndex[nid] = (short)offset;

	mov	eax, DWORD PTR _nid$[ebp]
	mov	ecx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	mov	dx, WORD PTR _offset$[ebp]
	mov	WORD PTR [ecx+eax*2], dx
$LN6@AddName:

; 191  : 		for (i=nid+1; i<NameEntries; i++)

	mov	eax, DWORD PTR _nid$[ebp]
	add	eax, 1
	mov	DWORD PTR _i$[ebp], eax
	jmp	SHORT $LN5@AddName
$LN4@AddName:
	mov	ecx, DWORD PTR _i$[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
...
; 192  : 			NameIndex[i] += len;
	...
	mov	ecx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	mov	WORD PTR [ecx+eax*2], dx
	jmp	SHORT $LN4@AddName
$LN3@AddName:

; 193  : 		movesize = NameIndex[NameEntries-1] - NameIndex[nid+1];

	movsx	edx, WORD PTR ?NameEntries@@3FA		; NameEntries
	mov	eax, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	ecx, WORD PTR [eax+edx*2-2]
	mov	edx, DWORD PTR _nid$[ebp]
	mov	eax, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	edx, WORD PTR [eax+edx*2+2]
	sub	ecx, edx
	mov	DWORD PTR _movesize$[ebp], ecx

; 194  : 		}
; 195  : 	// Otherwise tack on a new entry
; 196  : 	else
...
; 200  : 		// Reallocate our memory
; 201  : 		TmpIdx = new short[NameEntries+1];
	...
	mov	DWORD PTR _TmpIdx$5[ebp], eax

; 202  : 		memcpy(TmpIdx,NameIndex,sizeof(short)*NameEntries);
	...
	mov	edx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	push	edx
	mov	eax, DWORD PTR _TmpIdx$5[ebp]
	push	eax
	call	_memcpy
	add	esp, 12					; 0000000cH

; 203  : 		TmpIdx[nid+1] = (short)(TmpIdx[nid] + len);

	mov	ecx, DWORD PTR _nid$[ebp]
	mov	edx, DWORD PTR _TmpIdx$5[ebp]
	movsx	eax, WORD PTR [edx+ecx*2]
...
; 205  : 		NameIndex = TmpIdx;

	mov	edx, DWORD PTR _TmpIdx$5[ebp]
	mov	DWORD PTR ?NameIndex@@3PAFA, edx	; NameIndex

; 206  : 		NameEntries++;

	mov	ax, WORD PTR ?NameEntries@@3FA		; NameEntries
	add	ax, 1
	mov	WORD PTR ?NameEntries@@3FA, ax		; NameEntries

; 207  : 		movesize = 0;

	mov	DWORD PTR _movesize$[ebp], 0
$LN2@AddName:

; 208  : 		}
; 209  : 	
; 210  : 	// Update our name stream
; 211  : 	newstream = new _TCHAR [NameIndex[NameEntries-1]];
	...
	mov	DWORD PTR _newstream$[ebp], ecx

; 212  : 	memcpy(newstream,NameStream,sizeof(_TCHAR)*NameIndex[nid]);

	mov	edx, DWORD PTR _nid$[ebp]
	mov	eax, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	ecx, WORD PTR [eax+edx*2]
	push	ecx
	mov	edx, DWORD PTR ?NameStream@@3PADA	; NameStream
	push	edx
	mov	eax, DWORD PTR _newstream$[ebp]
	push	eax
	call	_memcpy
	add	esp, 12					; 0000000cH
...
; 213  : 	if (movesize)
	...
	cmp	DWORD PTR _movesize$[ebp], 0
	je	SHORT $LN1@AddName

; 214  : 		memcpy(&newstream[NameIndex[nid+1]],&NameStream[NameIndex[nid]],movesize);
	...
	mov	eax, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	ecx, WORD PTR [eax+edx*2]
	add	ecx, DWORD PTR ?NameStream@@3PADA	; NameStream
	push	ecx
	mov	edx, DWORD PTR _nid$[ebp]
	mov	eax, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	ecx, WORD PTR [eax+edx*2+2]
	add	ecx, DWORD PTR _newstream$[ebp]
	push	ecx
	call	_memcpy
	add	esp, 12					; 0000000cH
$LN1@AddName:

; 215  : 	memcpy(&newstream[NameIndex[nid]],name,len);
	...
	mov	edx, DWORD PTR ?NameIndex@@3PAFA	; NameIndex
	movsx	eax, WORD PTR [edx+ecx*2]
	add	eax, DWORD PTR _newstream$[ebp]
	push	eax
	call	_memcpy
	add	esp, 12					; 0000000cH

; 216  : 	delete [] NameStream;

	mov	ecx, DWORD PTR ?NameStream@@3PADA	; NameStream
	mov	DWORD PTR $T1[ebp], ecx
	mov	edx, DWORD PTR $T1[ebp]
	push	edx
	call	??_V@YAXPAX@Z				; operator delete[]
...
; 217  : 	NameStream = newstream;

	mov	eax, DWORD PTR _newstream$[ebp]
	mov	DWORD PTR ?NameStream@@3PADA, eax	; NameStream
...
_wstr$ = 12						; size = 4
_len$ = 16						; size = 4
?ReadNameString@@YAPADHPADI@Z PROC			; ReadNameString
...
; 133  : 	FILE	*fp;
; 134  : 	unsigned int	size,rlen;
; 135  : 
; 136  : 	if (!NameIndex) // JB 010731 CTD

	cmp	DWORD PTR ?NameIndex@@3PAFA, 0		; NameIndex
	jne	SHORT $LN5@ReadNameSt

; 137  : 		return wstr;

	mov	eax, DWORD PTR _wstr$[ebp]
	jmp	$LN6@ReadNameSt
$LN5@ReadNameSt:

; 138  : 
; 139  : 	ShiAssert(FALSE == F4IsBadReadPtr(NameIndex, sizeof *NameIndex * NameEntries)); // JPO CTD
; 140  : 	size = NameIndex[sid+1]-NameIndex[sid];
...
; 145  : 	if (NameStream)
	...
	cmp	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
	je	SHORT $LN3@ReadNameSt

; 146  : 		{
; 147  : 		// The file's loaded. Should only happen when our tool is running
; 148  : 		_sntprintf(wstr,rlen,&NameStream[NameIndex[sid]]);
...
; 151  : 	else
	...
	jmp	SHORT $LN2@ReadNameSt
$LN3@ReadNameSt:

; 152  : 		{
; 153  : 		if ((fp = OpenCampFile(NameFile,"wch","rb")) == NULL)

	push	OFFSET ??_C@_02JDPG@rb?$AA@
	push	OFFSET ??_C@_03MPOGCMBA@wch?$AA@
	push	OFFSET ?NameFile@@3PADA			; NameFile
	call	?OpenCampFile@@YAPAU_iobuf@@PAD00@Z	; OpenCampFile
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _fp$[ebp], eax
	cmp	DWORD PTR _fp$[ebp], 0
	jne	SHORT $LN1@ReadNameSt

; 154  : 			return NULL;

	xor	eax, eax
	jmp	SHORT $LN6@ReadNameSt
$LN1@ReadNameSt:

; 155  : 		fseek(fp,NameIndex[sid],0);
...
; 156  : 		fread(wstr,sizeof(_TCHAR),rlen,fp);
...
; 161  : 	}
	...
	pop	ebp
	ret	0
?ReadNameString@@YAPADHPADI@Z ENDP			; ReadNameString
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
$T1 = -8						; size = 4
$T2 = -4						; size = 4
?FreeNames@@YAXXZ PROC					; FreeNames
...
; 119  : 	if (NameIndex)
	...
	cmp	DWORD PTR ?NameIndex@@3PAFA, 0		; NameIndex
	je	SHORT $LN2@FreeNames

; 120  : 		{
; 121  : 		delete [] NameIndex;
...
; 122  : 		NameIndex = NULL;
	...
	mov	DWORD PTR ?NameIndex@@3PAFA, 0		; NameIndex
$LN2@FreeNames:
...
; 124  : 	if (NameStream)
	...
	cmp	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
	je	SHORT $LN3@FreeNames

; 125  : 		{
; 126  : 		delete [] NameStream;
...
; 127  : 		NameStream = NULL;
	...
	mov	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
$LN3@FreeNames:
...
; 129  : 	}
	...
	pop	ebp
	ret	0
?FreeNames@@YAXXZ ENDP					; FreeNames
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
...
__$ArrayPad$ = -4					; size = 4
_filename$ = 8						; size = 4
?SaveNames@@YAHPAD@Z PROC				; SaveNames
...
; 86   : 	FILE*			fp;
; 87   : 	int				i;
; 88   : 	_TCHAR			buffer[128];
; 89   : 
; 90   : 	if ((fp = OpenCampFile (filename, "idx", "wb")) == NULL)
...
; 92   : 	fwrite(&NameEntries,sizeof(short),1,fp);

	mov	ecx, DWORD PTR _fp$[ebp]
	push	ecx
	push	1
	push	2
	push	OFFSET ?NameEntries@@3FA		; NameEntries
	call	_fwrite
	add	esp, 16					; 00000010H

; 93   : 	fwrite(NameIndex,sizeof(short),NameEntries,fp);
...
; 96   : 	if (NameStream)
	...
	cmp	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
	je	SHORT $LN6@SaveNames

; 97   : 		{
; 98   : 		if ((fp = OpenCampFile (filename, "wch", "wb")) == NULL)
...
; 100  : 		fwrite(NameStream,sizeof(_TCHAR),NameIndex[NameEntries-1],fp);
...
; 102  : 		}
; 103  : 
; 104  : 	if ((fp = OpenCampFile (filename, "txt", "wt")) == NULL)
...
; 106  : 	for (i=0; i<NameEntries-1; i++)

	mov	DWORD PTR _i$[ebp], 0
	jmp	SHORT $LN3@SaveNames
$LN2@SaveNames:
	mov	edx, DWORD PTR _i$[ebp]
	add	edx, 1
	mov	DWORD PTR _i$[ebp], edx
$LN3@SaveNames:
	...
	sub	eax, 1
	cmp	DWORD PTR _i$[ebp], eax
	jge	SHORT $LN1@SaveNames

; 107  : 		{
; 108  : 		ReadNameString(i,buffer,127);
...
; 109  : 		fprintf(fp, "%d %s\n", i, buffer);
	...
	mov	ecx, DWORD PTR _i$[ebp]
	push	ecx
	push	OFFSET ??_C@_06JGAGDFHN@?$CFd?5?$CFs?6?$AA@
	mov	edx, DWORD PTR _fp$[ebp]
	push	edx
	call	_fprintf
	add	esp, 16					; 00000010H
...
; 115  : 	}
	...
	pop	ebp
	ret	0
?SaveNames@@YAHPAD@Z ENDP				; SaveNames
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
...
$T2 = -8						; size = 4
_fp$ = -4						; size = 4
?LoadNameStream@@YAXXZ PROC				; LoadNameStream
...
; 69   : 	if (NameStream){
	...
	cmp	DWORD PTR ?NameStream@@3PADA, 0		; NameStream
	je	SHORT $LN2@LoadNameSt

; 70   : 		delete [] NameStream;

	mov	eax, DWORD PTR ?NameStream@@3PADA	; NameStream
	mov	DWORD PTR $T2[ebp], eax
	mov	ecx, DWORD PTR $T2[ebp]
	push	ecx
	call	??_V@YAXPAX@Z				; operator delete[]
...
; 71   : 	}
; 72   : 
; 73   : 	CampEnterCriticalSection();

	call	?CampEnterCriticalSection@@YAXXZ	; CampEnterCriticalSection

; 74   : 	NameStream = new _TCHAR [NameIndex[NameEntries-1]];
	...
	mov	edx, DWORD PTR $T1[ebp]
	mov	DWORD PTR ?NameStream@@3PADA, edx	; NameStream

; 75   : 	fp = OpenCampFile (NameFile, "wch", "rb");
...
; 76   : 	if (fp){
	...
	cmp	DWORD PTR _fp$[ebp], 0
	je	SHORT $LN1@LoadNameSt

; 77   : 		fread(NameStream,sizeof(_TCHAR),NameIndex[NameEntries-1],fp);
...
; 81   : }
	...
	pop	ebp
	ret	0
?LoadNameStream@@YAXXZ ENDP				; LoadNameStream
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\name.cpp
_TEXT	SEGMENT
...
_rem$ = -4						; size = 4
_filename$ = 8						; size = 4
?LoadNames@@YAXPAD@Z PROC				; LoadNames
...
; 42   : 	//char *data, *data_ptr;
; 43   : 	
; 44   : 	CampaignData cd = ReadCampFile(filename,"idx");
...
; 53   : 
; 54   : 	memcpychk(&NameEntries, &data_ptr, sizeof(short), &rem);
...
; 55   : 	
; 56   : 	if (NameIndex != NULL){

	cmp	DWORD PTR ?NameIndex@@3PAFA, 0		; NameIndex
	je	SHORT $LN1@LoadNames
...
; 58   : 	}
; 59   : 	NameIndex = new short[NameEntries];
	...
	mov	DWORD PTR $T3[ebp], eax
	mov	eax, DWORD PTR $T3[ebp]
	mov	DWORD PTR ?NameIndex@@3PAFA, eax	; NameIndex

; 60   : 	memcpychk(NameIndex, &data_ptr, sizeof(short) * NameEntries, &rem);
...
; 63   : }
	...
	pop	ebp
	ret	0
?LoadNames@@YAXPAD@Z ENDP				; LoadNames
_TEXT	ENDS
; Function compile flags: /Odtp
