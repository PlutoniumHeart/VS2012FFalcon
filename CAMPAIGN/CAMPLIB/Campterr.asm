; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\CAMPAIGN\CAMPLIB\Campterr.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?TheaterCells@@3PAEA				; TheaterCells
PUBLIC	?EastLongitude@@3EA				; EastLongitude
PUBLIC	?SouthLatitude@@3EA				; SouthLatitude
PUBLIC	?Latitude@@3MA					; Latitude
PUBLIC	?Longitude@@3MA					; Longitude
PUBLIC	?CellSizeInKilometers@@3MA			; CellSizeInKilometers
...
PUBLIC	?Map_Max_X@@3FA					; Map_Max_X
PUBLIC	?Map_Max_Y@@3FA					; Map_Max_Y
PUBLIC	?value@?$_Sizeof@U_Nil@std@@U12@U12@U12@U12@U12@U12@U12@@std@@2IB ; std::_Sizeof<std::_Nil,std::_Nil,std::_Nil,std::_Nil,std::_Nil,std::_Nil,std::_Nil,std::_Nil>::value
_BSS	SEGMENT
?TheaterCells@@3PAEA DD 01H DUP (?)			; TheaterCells
?EastLongitude@@3EA DB 01H DUP (?)			; EastLongitude
	ALIGN	4

?SouthLatitude@@3EA DB 01H DUP (?)			; SouthLatitude
	ALIGN	4

?Latitude@@3MA DD 01H DUP (?)				; Latitude
?Longitude@@3MA DD 01H DUP (?)				; Longitude
?CellSizeInKilometers@@3MA DD 01H DUP (?)		; CellSizeInKilometers
?Map_Max_X@@3FA DW 01H DUP (?)				; Map_Max_X
	ALIGN	4

?Map_Max_Y@@3FA DW 01H DUP (?)				; Map_Max_Y
_BSS	ENDS
...
PUBLIC	?InitTheaterTerrain@@YAXXZ			; InitTheaterTerrain
PUBLIC	?FreeTheaterTerrain@@YAXXZ			; FreeTheaterTerrain
PUBLIC	?LoadTheaterTerrain@@YAHPAD@Z			; LoadTheaterTerrain
PUBLIC	?LoadTheaterTerrainLight@@YAHPAD@Z		; LoadTheaterTerrainLight
PUBLIC	?SaveTheaterTerrain@@YAHPAD@Z			; SaveTheaterTerrain
PUBLIC	?GetCell@@YAPAEFF@Z				; GetCell
PUBLIC	?GetRelief@@YA?AW4ReliefType@@FF@Z		; GetRelief
PUBLIC	?GetCover@@YA?AW4CoverType@@FF@Z		; GetCover
PUBLIC	?GetRoad@@YADFF@Z				; GetRoad
PUBLIC	?GetRail@@YADFF@Z				; GetRail
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
_x$ = 8							; size = 2
_y$ = 12						; size = 2
?GetRail@@YADFF@Z PROC					; GetRail
...
; 148  :     ShiAssert(x >= 0 && x < Map_Max_X && y >= 0 && y < Map_Max_Y);
; 149  : 	return (char)((TheaterCells[x*Map_Max_Y + y] & RailMask) >> RailShift);

	movsx	eax, WORD PTR _x$[ebp]
	movsx	ecx, WORD PTR ?Map_Max_Y@@3FA		; Map_Max_Y
	imul	eax, ecx
	movsx	edx, WORD PTR _y$[ebp]
	add	edx, DWORD PTR ?TheaterCells@@3PAEA	; TheaterCells
...
; 142  :     ShiAssert(x >= 0 && x < Map_Max_X && y >= 0 && y < Map_Max_Y);
; 143  : 	return (char)((TheaterCells[x*Map_Max_Y + y] & RoadMask) >> RoadShift);
...
_x$ = 8							; size = 2
_y$ = 12						; size = 2
?GetCover@@YA?AW4CoverType@@FF@Z PROC			; GetCover
...
; 134  : 	if ((x< 0) || (x >= Map_Max_X) || (y < 0) || (y >= Map_Max_Y))

	movsx	eax, WORD PTR _x$[ebp]
	test	eax, eax
	jl	SHORT $LN2@GetCover
	movsx	ecx, WORD PTR _x$[ebp]
	movsx	edx, WORD PTR ?Map_Max_X@@3FA		; Map_Max_X
	cmp	ecx, edx
	jge	SHORT $LN2@GetCover
	...
	cmp	ecx, edx
	jl	SHORT $LN3@GetCover
$LN2@GetCover:

; 135  : 		return (CoverType) Water;

	xor	eax, eax
	jmp	SHORT $LN4@GetCover
...
; 137  : 		return (CoverType)((TheaterCells[x*Map_Max_Y + y] & GroundCoverMask) >> GroundCoverShift);
...
; 138  : 	}
	...
	pop	ebp
	ret	0
?GetCover@@YA?AW4CoverType@@FF@Z ENDP			; GetCover
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
_x$ = 8							; size = 2
_y$ = 12						; size = 2
?GetRelief@@YA?AW4ReliefType@@FF@Z PROC			; GetRelief
...
; 128  :     ShiAssert(x >= 0 && x < Map_Max_X && y >= 0 && y < Map_Max_Y);
; 129  : 	return (ReliefType)((TheaterCells[x*Map_Max_Y + y] & ReliefMask) >> ReliefShift);
...
; 130  : 	}
	...
	pop	ebp
	ret	0
?GetRelief@@YA?AW4ReliefType@@FF@Z ENDP			; GetRelief
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
_x$ = 8							; size = 2
_y$ = 12						; size = 2
?GetCell@@YAPAEFF@Z PROC				; GetCell
...
; 122  :     ShiAssert(x >= 0 && x < Map_Max_X && y >= 0 && y < Map_Max_Y);
; 123  : 	return &TheaterCells[x*Map_Max_Y + y];
...
; 124  : 	}
	...
	pop	ebp
	ret	0
?GetCell@@YAPAEFF@Z ENDP				; GetCell
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
_fp$ = -4						; size = 4
_name$ = 8						; size = 4
?SaveTheaterTerrain@@YAHPAD@Z PROC			; SaveTheaterTerrain
...
; 109  : 	if (!TheaterCells)
	...
	cmp	DWORD PTR ?TheaterCells@@3PAEA, 0	; TheaterCells
	jne	SHORT $LN2@SaveTheate
...
; 111  : 	if ((fp = OpenCampFile (name, "thr", "wb")) == NULL)

	push	OFFSET ??_C@_02GMLFBBN@wb?$AA@
	push	OFFSET ??_C@_03GBCLJGME@thr?$AA@
...
; 112  : 		return 0;
	...
	xor	eax, eax
	jmp	SHORT $LN3@SaveTheate
$LN1@SaveTheate:

; 113  : 	fwrite(&Map_Max_X,sizeof(short),1,fp);

	mov	ecx, DWORD PTR _fp$[ebp]
	push	ecx
	push	1
	push	2
	push	OFFSET ?Map_Max_X@@3FA			; Map_Max_X
	call	_fwrite
	add	esp, 16					; 00000010H

; 114  : 	fwrite(&Map_Max_Y,sizeof(short),1,fp);

	mov	edx, DWORD PTR _fp$[ebp]
	push	edx
	push	1
	push	2
	push	OFFSET ?Map_Max_Y@@3FA			; Map_Max_Y
	call	_fwrite
	add	esp, 16					; 00000010H

; 115  : 	fwrite(TheaterCells,sizeof(CellDataType),Map_Max_X*Map_Max_Y,fp);
	...
	push	ecx
	push	1
	mov	eax, DWORD PTR ?TheaterCells@@3PAEA	; TheaterCells
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H

; 116  : 	CloseCampFile(fp);
...
; 118  : 	}
	...
	pop	ebp
	ret	0
?SaveTheaterTerrain@@YAHPAD@Z ENDP			; SaveTheaterTerrain
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
_fp$ = -4						; size = 4
_name$ = 8						; size = 4
?LoadTheaterTerrainLight@@YAHPAD@Z PROC			; LoadTheaterTerrainLight
...
; 94   : 	FILE	*fp;
; 95   : 
; 96   : 	FreeTheaterTerrain();

	call	?FreeTheaterTerrain@@YAXXZ		; FreeTheaterTerrain

; 97   : 	if ((fp = OpenCampFile (name, "thr", "rb")) == NULL)
...
; 99   : 	fread(&Map_Max_X,sizeof(short),1,fp);
...
; 100  : 	fread(&Map_Max_Y,sizeof(short),1,fp);
...
; 103  : }
	...
	pop	ebp
	ret	0
?LoadTheaterTerrainLight@@YAHPAD@Z ENDP			; LoadTheaterTerrainLight
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
...
_rem$ = -4						; size = 4
_name$ = 8						; size = 4
?LoadTheaterTerrain@@YAHPAD@Z PROC			; LoadTheaterTerrain

; 62   : int LoadTheaterTerrain (char* name){

	push	ebp
	mov	ebp, esp
	sub	esp, 28					; 0000001cH

; 63   : 	//char *data, *data_ptr;
; 64   : 	
; 65   : 	FreeTheaterTerrain();

	call	?FreeTheaterTerrain@@YAXXZ		; FreeTheaterTerrain

; 66   : 
; 67   : 	CampaignData cd = ReadCampFile (name, "thr");
...
; 76   : 	memcpychk(&Map_Max_Y, &data_ptr, sizeof(short), &rem);
...
; 77   : 	
; 78   : #ifdef DEBUG
; 79   : 	ShiAssert(Map_Max_X == TheCampaign.TheaterSizeX);
; 80   : 	ShiAssert(Map_Max_Y == TheCampaign.TheaterSizeY);
; 81   : #endif
; 82   : 
; 83   : 	InitTheaterTerrain();

	call	?InitTheaterTerrain@@YAXXZ		; InitTheaterTerrain

; 84   : 	
; 85   : 	memcpychk(TheaterCells, &data_ptr, sizeof (CellDataType) * Map_Max_X * Map_Max_Y, &rem);
	...
	lea	eax, DWORD PTR _data_ptr$[ebp]
	push	eax
	mov	ecx, DWORD PTR ?TheaterCells@@3PAEA	; TheaterCells
	push	ecx
	call	?memcpychk@@YAXPAXPAPAEIPAJ@Z		; memcpychk
	add	esp, 16					; 00000010H
...
; 90   : }
	...
	pop	ebp
	ret	0
?LoadTheaterTerrain@@YAHPAD@Z ENDP			; LoadTheaterTerrain
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
$T1 = -4						; size = 4
?FreeTheaterTerrain@@YAXXZ PROC				; FreeTheaterTerrain
...
; 57   : 	if (TheaterCells)
	...
	cmp	DWORD PTR ?TheaterCells@@3PAEA, 0	; TheaterCells
	je	SHORT $LN1@FreeTheate

; 58   : 		delete [] TheaterCells;
...
; 59   : 	TheaterCells = NULL;

	mov	DWORD PTR ?TheaterCells@@3PAEA, 0	; TheaterCells
...
; 60   : 	}
	...
	pop	ebp
	ret	0
?FreeTheaterTerrain@@YAXXZ ENDP				; FreeTheaterTerrain
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\campaign\camplib\campterr.cpp
_TEXT	SEGMENT
$T1 = -4						; size = 4
?InitTheaterTerrain@@YAXXZ PROC				; InitTheaterTerrain
...
; 49   : 	if (TheaterCells)
	...
	cmp	DWORD PTR ?TheaterCells@@3PAEA, 0	; TheaterCells
	je	SHORT $LN1@InitTheate

; 50   : 		FreeTheaterTerrain();

	call	?FreeTheaterTerrain@@YAXXZ		; FreeTheaterTerrain
$LN1@InitTheate:

; 51   : 	TheaterCells = new CellDataType[Map_Max_X*Map_Max_Y];
	...
	mov	DWORD PTR ?TheaterCells@@3PAEA, edx	; TheaterCells

; 52   : 	memset(TheaterCells,0,sizeof(CellDataType)*Map_Max_X*Map_Max_Y);
	...
	push	eax
	push	0
	mov	edx, DWORD PTR ?TheaterCells@@3PAEA	; TheaterCells
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 53   : 	}
	...
	pop	ebp
	ret	0
?InitTheaterTerrain@@YAXXZ ENDP				; InitTheaterTerrain
_TEXT	ENDS
; Function compile flags: /Odtp
