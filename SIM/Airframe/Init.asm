; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\Airframe\Init.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Initialize@AirframeClass@@AAEXXZ		; AirframeClass::Initialize
PUBLIC	?InitializeEOM@AirframeClass@@AAEXXZ		; AirframeClass::InitializeEOM
PUBLIC	?ReInitialize@AirframeClass@@AAEXXZ		; AirframeClass::ReInitialize
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\airframe\init.cpp
_TEXT	SEGMENT
tv341 = -36						; size = 4
tv348 = -32						; size = 4
_groundZ$1 = -28					; size = 4
_qptchc$ = -24						; size = 4
_this$ = -20						; size = 4
_normal$2 = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
?ReInitialize@AirframeClass@@AAEXXZ PROC		; AirframeClass::ReInitialize
; _this$ = ecx
...
; 288  : 	// float e10, e20, e30, e40;
; 289  : 	float qptchc;
; 290  : 	//mlTrig trigMu, trigSig, trigGam;
; 291  : 
; 292  : 	/*--------------------------------------------------*/
; 293  : 	/* initial angles for 1-g straight and level flight */
; 294  : 	/*--------------------------------------------------*/
; 295  : 	beta  = 0.0f;
...
; 298  : 
; 299  : 	xdot  =  vt*platform->platformAngles.cosgam *
; 300  : 		platform->platformAngles.cossig;
...
; 301  : 	ydot  =  vt*platform->platformAngles.cosgam *
; 302  : 		platform->platformAngles.sinsig;
...
; 303  : 	zdot  = -vt*platform->platformAngles.singam ;
...
; 304  : 
; 305  : 	ShiAssert(!_isnan(xdot));
; 306  : 	ShiAssert(!_isnan(ydot));
; 307  : 	ShiAssert(!_isnan(zdot));
; 308  : 	   
; 309  : 	/*------------------------------------*/
; 310  : 	/* initial earth coordinate positions */
; 311  : 	/*------------------------------------*/
; 312  : 	if(!IsSet(InAir))
...
; 313  : 	{
; 314  : 		Tpoint normal;
; 315  : 		float groundZ = OTWDriver.GetGroundLevel(x, y, &normal);

	lea	edx, DWORD PTR _normal$2[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	push	ecx
...
; 316  : 		if (z > groundZ - CheckHeight() + 0.01F)
	...
	comiss	xmm1, xmm0
	jbe	SHORT $LN3@ReInitiali

; 317  : 			z = groundZ - CheckHeight();
...
; 323  : 	oldp01[0] = 0.0;
	...
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [edx+ecx+284], xmm0
...
; 324  : 	oldp01[1] = 0.0;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+eax+284], xmm0
...
; 325  : 	oldp01[2] = 0.0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+edx+284], xmm0
...
; 351  : 	oldp04[2] = 0.0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+edx+356], xmm0
...
; 355  : 
; 356  : 	/*------------------------------*/
; 357  : 	/* pitch rate correction filter */
; 358  : 	/*------------------------------*/
; 359  : 	if (vt)
...
; 360  : 	{
; 361  : 		//qptchc = GRAVITY*nzcgs/(vt*platform->platformAngles.cosbet);
; 362  : 		qptchc = GRAVITY*nzcgs/vt;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@4200b53f
	mulss	xmm0, DWORD PTR [edx+268]
	mov	eax, DWORD PTR _this$[ebp]
...
; 375  : 
; 376  : 	/*--------------------------------------------*/
; 377  : 	/* initialize roll axis flight control system */
; 378  : 	/*--------------------------------------------*/
; 379  : 	/* roll rate response model */
; 380  : 	/*--------------------------*/
; 381  : 	oldr01[0] = 0.0;
...
; 385  : 
; 386  : 	/*------------------------------------------*/
; 387  : 	/* intialize yaw axis flight control system */
; 388  : 	/*------------------------------------------*/
; 389  : 	/* yaw integral pathway */
; 390  : 	/*----------------------*/
; 391  : 	oldy01[0] = 0.0;
...
; 419  : }
	...
	pop	ebp
	ret	0
?ReInitialize@AirframeClass@@AAEXXZ ENDP		; AirframeClass::ReInitialize
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\airframe\init.cpp
_TEXT	SEGMENT
_mag$ = -8						; size = 4
_this$ = -4						; size = 4
?InitializeEOM@AirframeClass@@AAEXXZ PROC		; AirframeClass::InitializeEOM
; _this$ = ecx
...
; 274  :    EngineModel(SimLibMinorFrameTime);
...
; 276  : 
; 277  : 	groundZ = OTWDriver.GetGroundLevel(x, y, &gndNormal);
...
; 278  : 	mag = (float)sqrt(gndNormal.x*gndNormal.x + gndNormal.y*gndNormal.y + gndNormal.z*gndNormal.z);

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+1288]
	mulss	xmm0, DWORD PTR [edx+1288]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [eax+1292]
	mulss	xmm1, DWORD PTR [ecx+1292]
	addss	xmm0, xmm1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [edx+1296]
	mulss	xmm1, DWORD PTR [eax+1296]
	addss	xmm0, xmm1
	push	ecx
	movss	DWORD PTR [esp], xmm0
...
; 281  : 	gndNormal.z /= mag;
	...
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+1296]
	divss	xmm0, DWORD PTR _mag$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+1296], xmm0

; 282  : 
; 283  :    EquationsOfMotion(SimLibMinorFrameTime);
...
; 284  : }
	...
	pop	ebp
	ret	0
?InitializeEOM@AirframeClass@@AAEXXZ ENDP		; AirframeClass::InitializeEOM
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\airframe\init.cpp
_TEXT	SEGMENT
...
_normal$2 = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
?Initialize@AirframeClass@@AAEXXZ PROC			; AirframeClass::Initialize
; _this$ = ecx
...
; 57   : 	float e10, e20, e30, e40 ,qptchc;
; 58   : 	mlTrig trigMu, trigSig, trigGam;
; 59   : 
; 60   : 	Accelerometers();
...
; 61   : 
; 62   : 	/*--------------------------------------------------*/
; 63   : 	/* initial angles for 1-g straight and level flight */
; 64   : 	/*--------------------------------------------------*/
; 65   : 	beta  = 0.0f;
...
; 68   : 
; 69   : 	xdot  =  vt*platform->platformAngles.cosgam *
; 70   : 		platform->platformAngles.cossig;
...
; 71   : 	ydot  =  vt*platform->platformAngles.cosgam *
; 72   : 		platform->platformAngles.sinsig;
...
; 73   : 	zdot  = -vt*platform->platformAngles.singam ;
...
; 74   : 
; 75   : 	ShiAssert(!_isnan(xdot));
; 76   : 	ShiAssert(!_isnan(ydot));
; 77   : 	ShiAssert(!_isnan(zdot));
; 78   : 	/*------------------------*/
; 79   : 	/* initialize quaternions */
; 80   : 	/*------------------------*/
; 81   : 	  
; 82   : 	mlSinCos (&trigGam, gmma	* 0.5F);
...
; 83   : 	mlSinCos (&trigSig, sigma * 0.5F);
...
; 85   : 	e10 = trigSig.cos*trigGam.cos*trigMu.cos +
; 86   : 			trigSig.sin*trigGam.sin*trigMu.sin;
...
; 87   : 
; 88   : 	e20 = trigSig.sin*trigGam.cos*trigMu.cos -
; 89   : 			trigSig.cos*trigGam.sin*trigMu.sin;
...
; 90   : 
; 91   : 	e30 = trigSig.cos*trigGam.sin*trigMu.cos +
; 92   : 			trigSig.sin*trigGam.cos*trigMu.sin;
...
; 93   : 
; 94   : 	e40 = trigSig.cos*trigGam.cos*trigMu.sin -
; 95   : 			trigSig.sin*trigGam.sin*trigMu.cos;
...
; 101  : 
; 102  : 	/*------------------------------------*/
; 103  : 	/* initial earth coordinate positions */
; 104  : 	/*------------------------------------*/
; 105  : 	if(!IsSet(InAir))
...
; 106  : 	{
; 107  : 		Tpoint normal;
; 108  : 		float groundZ = OTWDriver.GetGroundLevel(x, y, &normal);

	lea	ecx, DWORD PTR _normal$2[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	push	ecx
...
; 109  : 		if (z > groundZ - CheckHeight() + 0.01F)
...
; 148  : 
; 149  : 	/*------------------------------*/
; 150  : 	/* pitch rate correction filter */
; 151  : 	/*------------------------------*/
; 152  : 	if (vt)
...
; 153  : 	{
; 154  : 		//qptchc = GRAVITY*nzcgs/(vt*platform->platformAngles.cosbet);
; 155  : 		qptchc = GRAVITY*nzcgs/vt;
...
; 168  : 
; 169  : 	/*--------------------------------------------*/
; 170  : 	/* initialize roll axis flight control system */
; 171  : 	/*--------------------------------------------*/
; 172  : 	/* roll rate response model */
; 173  : 	/*--------------------------*/
; 174  : 	oldr01[0] = 0.0;
...
; 178  : 
; 179  : 	/*------------------------------------------*/
; 180  : 	/* intialize yaw axis flight control system */
; 181  : 	/*------------------------------------------*/
; 182  : 	/* yaw integral pathway */
; 183  : 	/*----------------------*/
; 184  : 	oldy01[0] = 0.0;
...
; 209  : 
; 210  : 	/*--------------------------------*/
; 211  : 	/* intialize axial control system */
; 212  : 	/*--------------------------------*/
; 213  : 	olda01[0] = thrtab;
...
; 218  : 
; 219  : 	//TJL 01/14/03 multi-engine
; 220  : 	olda012[0] = thrtab2;
	...
	mov	DWORD PTR [eax+edx+572], ecx

; 221  : 	olda012[1] = thrtab2;
...
; 228  : 	oldTurb1[1] = 0.0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+edx+596], xmm0
...
; 229  : 	oldTurb1[2] = 0.0;
	...
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [edx+ecx+596], xmm0
...
; 237  : 
; 238  : 	if(IsSet(InAir)) { // JPO - if in the air only.
...
; 240  : 		oldRpm[0] = 0.75F;
	...
	movss	DWORD PTR [edx+ecx+500], xmm0
...
; 241  : 		oldRpm[1] = 0.75F;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f400000
	movss	DWORD PTR [ecx+eax+500], xmm0
...
; 242  : 		oldRpm[2] = 0.75F;
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f400000
	movss	DWORD PTR [eax+edx+500], xmm0
...
; 247  : 		oldRpm2[0] = 0.75F;
	...
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f400000
	movss	DWORD PTR [edx+ecx+524], xmm0
...
; 248  : 		oldRpm2[1] = 0.75F;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f400000
	movss	DWORD PTR [ecx+eax+524], xmm0
...
; 249  : 		oldRpm2[2] = 0.75F;
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f400000
	movss	DWORD PTR [eax+edx+524], xmm0
...
; 259  : 		rpm2 = 0.0f;//TJL 01/14/03 multi-engine
...
; 264  : }
	...
	pop	ebp
	ret	0
?Initialize@AirframeClass@@AAEXXZ ENDP			; AirframeClass::Initialize
_TEXT	ENDS
; Function compile flags: /Odtp
