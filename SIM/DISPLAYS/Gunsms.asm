; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\DISPLAYS\Gunsms.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?GunDisplay@SmsDrawable@@AAEXXZ			; SmsDrawable::GunDisplay
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_05OJCIAPCD@00GUN?$AA@
CONST	SEGMENT
??_C@_05OJCIAPCD@00GUN?$AA@ DB '00GUN', 00H		; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_04DMIELPAB@SCOR?$AA@
CONST	SEGMENT
??_C@_04DMIELPAB@SCOR?$AA@ DB 'SCOR', 00H		; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\gunsms.cpp
_TEXT	SEGMENT
_x$1 = -52						; size = 4
tv136 = -48						; size = 4
_station$ = -44						; size = 4
...
_FCC$ = -36						; size = 4
_y$3 = -32						; size = 4
_tempstr$4 = -28					; size = 4
_numRounds$ = -24					; size = 4
_this$ = -20						; size = 4
_tmpStr$ = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
?GunDisplay@SmsDrawable@@AAEXXZ PROC			; SmsDrawable::GunDisplay
; _this$ = ecx
...
; 14   :     char tmpStr[12];
; 15   :     int station, numRounds;
; 16   :     FireControlComputer *FCC = Sms->ownship->GetFCC();
...
; 17   : 
; 18   :     // JPO - moved a lot of it into these two routines.
; 19   :     TopRow(0);
...
; 21   :     
; 22   : 	//MI
; 23   : 	if(g_bRealisticAvionics && FCC && FCC->GetSubMode() ==
; 24   : 		FireControlComputer::EEGS)

	movzx	ecx, BYTE PTR ?g_bRealisticAvionics@@3_NA ; g_bRealisticAvionics
	test	ecx, ecx
	je	SHORT $LN17@GunDisplay
...
; 26   : 		char tempstr[4] = "";
	...
	xor	eax, eax
	mov	WORD PTR _tempstr$4[ebp+1], ax
	mov	BYTE PTR _tempstr$4[ebp+3], al

; 27   : 		sprintf(tempstr,"%s", Sms->FEDS == TRUE ? "ON" : "OFF");

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+296]
	movzx	eax, BYTE PTR [edx+14]
	cmp	eax, 1
	jne	SHORT $LN20@GunDisplay
	mov	DWORD PTR tv136[ebp], OFFSET ??_C@_02BFICIOJL@ON?$AA@
	jmp	SHORT $LN21@GunDisplay
$LN20@GunDisplay:
	mov	DWORD PTR tv136[ebp], OFFSET ??_C@_03MPPIHBHJ@OFF?$AA@
$LN21@GunDisplay:
...
; 28   : 		LabelButton (19, "SCOR", tempstr);

	push	0
	lea	eax, DWORD PTR _tempstr$4[ebp]
	push	eax
	push	OFFSET ??_C@_04DMIELPAB@SCOR?$AA@
	push	19					; 00000013H
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LabelButton@DrawableClass@@QAEXHPAD0H@Z ; DrawableClass::LabelButton
	jmp	SHORT $LN14@GunDisplay
$LN17@GunDisplay:

; 29   : 	}
; 30   : 	else if(g_bRealisticAvionics)

	movzx	ecx, BYTE PTR ?g_bRealisticAvionics@@3_NA ; g_bRealisticAvionics
	test	ecx, ecx
	je	SHORT $LN15@GunDisplay
...
; 35   :     if (Sms->ownship)
	...
	je	SHORT $LN13@GunDisplay

; 36   :     {
; 37   : 	if (FCC->GetMasterMode() == FireControlComputer::Dogfight)

	mov	ecx, DWORD PTR _FCC$[ebp]
	call	?GetMasterMode@FireControlComputer@@QAE?AW4FCCMasterMode@1@XZ ; FireControlComputer::GetMasterMode
	cmp	eax, 9
	jne	SHORT $LN12@GunDisplay
...
; 39   : 	else
	...
	jmp	SHORT $LN11@GunDisplay
$LN12@GunDisplay:

; 40   : 	    station = Sms->curHardpoint;
...
; 41   : 	
; 42   : 	GunClass *gun = Sms->GetGun(station);
...
; 43   : 	if (gun)
	...
	je	SHORT $LN10@GunDisplay

; 44   : 	    numRounds = gun->numRoundsRemaining / 10;

	mov	eax, DWORD PTR _gun$2[ebp]
...
; 50   :     
; 51   : 	//MI I think this should only show RDY when we are in ARM, like all the other weapons
; 52   :     if (numRounds)

	cmp	DWORD PTR _numRounds$[ebp], 0
	je	$LN7@GunDisplay

; 53   :     {
; 54   : 		if(!g_bRealisticAvionics)

	movzx	edx, BYTE PTR ?g_bRealisticAvionics@@3_NA ; g_bRealisticAvionics
	test	edx, edx
	jne	SHORT $LN6@GunDisplay

; 55   : 		{
; 56   : 			
; 57   : 			sprintf (tmpStr, "%02dGUN", numRounds);
...
; 58   : 			display->TextCenter (0.3F, 0.6F, "RDY");
...
; 63   : 			GetButtonPos(5, &x, &y);	//button for Gun
...
; 64   : 			sprintf (tmpStr, "%02dGUN", numRounds);
...
; 65   : 			if(Sms->MasterArm() == SMSBaseClass::Arm)

	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+296]
	call	?MasterArm@SMSBaseClass@@QAE?AW4MasterArmState@1@XZ ; SMSBaseClass::MasterArm
	cmp	eax, 2
	jne	SHORT $LN4@GunDisplay

; 66   : 				display->TextCenter (0.3F, y, "RDY");
	...
	call	edx
	jmp	SHORT $LN2@GunDisplay
$LN4@GunDisplay:

; 67   : 			else if(Sms->MasterArm() == SMSBaseClass::Sim)

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+296]
	call	?MasterArm@SMSBaseClass@@QAE?AW4MasterArmState@1@XZ ; SMSBaseClass::MasterArm
	cmp	eax, 1
	jne	SHORT $LN2@GunDisplay

; 68   : 				display->TextCenter (0.3F, y, "SIM");
...
; 71   :     else
	...
	jmp	SHORT $LN1@GunDisplay
$LN7@GunDisplay:

; 72   : 	sprintf (tmpStr, "00GUN");

	push	OFFSET ??_C@_05OJCIAPCD@00GUN?$AA@
	lea	ecx, DWORD PTR _tmpStr$[ebp]
	push	ecx
	call	_sprintf
	add	esp, 8
...
; 75   : }
	...
	pop	ebp
	ret	0
?GunDisplay@SmsDrawable@@AAEXXZ ENDP			; SmsDrawable::GunDisplay
_TEXT	ENDS
; Function compile flags: /Odtp
