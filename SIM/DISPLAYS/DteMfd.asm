; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\DISPLAYS\DteMfd.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Display@DteMfdDrawable@@UAEXPAVVirtualDisplay@@@Z ; DteMfdDrawable::Display
PUBLIC	?PushButton@DteMfdDrawable@@UAEXHH@Z		; DteMfdDrawable::PushButton
...
PUBLIC	??_C@_06BBPHIKOD@DTC?5ID?$AA@			; `string'
PUBLIC	??_C@_06FBKGMFEK@126534?$AA@			; `string'
...
PUBLIC	??_C@_04LNCPCCHO@PROF?$AA@			; `string'
PUBLIC	??_C@_03KOECGNEM@INV?$AA@			; `string'
PUBLIC	??_C@_04NIGMENML@COMM?$AA@			; `string'
PUBLIC	??_C@_03EPGMAELC@MPD?$AA@			; `string'
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_03EPGMAELC@MPD?$AA@
CONST	SEGMENT
??_C@_03EPGMAELC@MPD?$AA@ DB 'MPD', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_04NIGMENML@COMM?$AA@
CONST	SEGMENT
??_C@_04NIGMENML@COMM?$AA@ DB 'COMM', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_03KOECGNEM@INV?$AA@
CONST	SEGMENT
??_C@_03KOECGNEM@INV?$AA@ DB 'INV', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_04LNCPCCHO@PROF?$AA@
CONST	SEGMENT
??_C@_04LNCPCCHO@PROF?$AA@ DB 'PROF', 00H		; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_06FBKGMFEK@126534?$AA@
CONST	SEGMENT
??_C@_06FBKGMFEK@126534?$AA@ DB '126534', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_06BBPHIKOD@DTC?5ID?$AA@
CONST	SEGMENT
??_C@_06BBPHIKOD@DTC?5ID?$AA@ DB 'DTC ID', 00H		; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\dtemfd.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_whichButton$ = 8					; size = 4
_whichMFD$ = 12						; size = 4
?PushButton@DteMfdDrawable@@UAEXHH@Z PROC		; DteMfdDrawable::PushButton
; _this$ = ecx
...
; 66   :     MfdDrawable::PushButton(whichButton, whichMFD);
...
; 67   : }
	...
	pop	ebp
	ret	8
?PushButton@DteMfdDrawable@@UAEXHH@Z ENDP		; DteMfdDrawable::PushButton
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\dtemfd.cpp
_TEXT	SEGMENT
...
?Display@DteMfdDrawable@@UAEXPAVVirtualDisplay@@@Z PROC	; DteMfdDrawable::Display
; _this$ = ecx
...
; 23   : 	AircraftClass *playerAC = SimDriver.GetPlayerAircraft();

	mov	ecx, OFFSET ?SimDriver@@3VSimulationDriver@@A ; SimDriver
	call	?GetPlayerAircraft@SimulationDriver@@QBEPAVAircraftClass@@XZ ; SimulationDriver::GetPlayerAircraft
	mov	DWORD PTR _playerAC$[ebp], eax

; 24   : 	RadarDopplerClass* theRadar = (RadarDopplerClass*)FindSensor(playerAC, SensorClass::Radar);
...
; 26   : 	{
; 27   : 		ShiWarning("Oh Oh shouldn't be here without a radar!");
; 28   : 		return;
...
; 31   : 	{
; 32   : 		theRadar->GetCursorPosition (&cX, &cY);
...
; 33   : 	}
; 34   :     display = newDisplay;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _newDisplay$[ebp]
	mov	DWORD PTR [ecx+20], edx

; 35   :     display->TextCenter(0.0f,0.2f, "DTC ID");

	push	0
	push	OFFSET ??_C@_06BBPHIKOD@DTC?5ID?$AA@
	push	ecx
...
; 36   :     float height = display->TextHeight();
...
; 37   :     display->TextCenter(0.0f,0.2f - height, "126534");

	push	0
	push	OFFSET ??_C@_06FBKGMFEK@126534?$AA@
	movss	xmm0, DWORD PTR __real@3e4ccccd
...
; 44   :     LabelButton(15, "MSMD");

	push	0
	push	0
	push	OFFSET ??_C@_04KMFBKAME@MSMD?$AA@
	push	15					; 0000000fH
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LabelButton@DrawableClass@@QAEXHPAD0H@Z ; DrawableClass::LabelButton

; 45   :     LabelButton(16, "PROF");

	push	0
	push	0
	push	OFFSET ??_C@_04LNCPCCHO@PROF?$AA@
	push	16					; 00000010H
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LabelButton@DrawableClass@@QAEXHPAD0H@Z ; DrawableClass::LabelButton

; 46   :     LabelButton(17, "INV");
...
; 47   :     LabelButton(18, "COMM");

	push	0
	push	0
	push	OFFSET ??_C@_04NIGMENML@COMM?$AA@
	push	18					; 00000012H
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LabelButton@DrawableClass@@QAEXHPAD0H@Z ; DrawableClass::LabelButton

; 48   :     LabelButton(19, "MPD");

	push	0
	push	0
	push	OFFSET ??_C@_03EPGMAELC@MPD?$AA@
	push	19					; 00000013H
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LabelButton@DrawableClass@@QAEXHPAD0H@Z ; DrawableClass::LabelButton

; 49   : 	//MI changed
; 50   : 	if(g_bRealisticAvionics)
...
; 51   : 	{
; 52   : 		if(OTWDriver.pCockpitManager && OTWDriver.pCockpitManager->mpIcp &&
; 53   : 			OTWDriver.pCockpitManager->mpIcp->ShowBullseyeInfo)
...
; 54   : 		{
; 55   : 			DrawBullseyeCircle(display, cX, cY);
...
; 58   : 			DrawReference(MfdDisplay[OnMFD()]->GetOwnShip());
...
; 61   : 		DrawReference (MfdDisplay[OnMFD()]->GetOwnShip());
...
; 62   : }
	...
	pop	ebp
	ret	4
?Display@DteMfdDrawable@@UAEXPAVVirtualDisplay@@@Z ENDP	; DteMfdDrawable::Display
_TEXT	ENDS
; Function compile flags: /Odtp
