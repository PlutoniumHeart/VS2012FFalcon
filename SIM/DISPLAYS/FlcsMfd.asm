; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\DISPLAYS\FlcsMfd.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z ; FlcsMfdDrawable::Display
PUBLIC	?PushButton@FlcsMfdDrawable@@UAEXHH@Z		; FlcsMfdDrawable::PushButton
...
PUBLIC	??_C@_04FDILGOHP@D234?$AA@			; `string'
PUBLIC	??_C@_03KPOLBBFN@LOC?$AA@			; `string'
PUBLIC	??_C@_03IECIMIEG@HEX?$AA@			; `string'
PUBLIC	??_C@_07HPFEHCIK@CONTENT?$AA@			; `string'
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_07HPFEHCIK@CONTENT?$AA@
CONST	SEGMENT
??_C@_07HPFEHCIK@CONTENT?$AA@ DB 'CONTENT', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_03IECIMIEG@HEX?$AA@
CONST	SEGMENT
??_C@_03IECIMIEG@HEX?$AA@ DB 'HEX', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_03KPOLBBFN@LOC?$AA@
CONST	SEGMENT
??_C@_03KPOLBBFN@LOC?$AA@ DB 'LOC', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_04FDILGOHP@D234?$AA@
CONST	SEGMENT
??_C@_04FDILGOHP@D234?$AA@ DB 'D234', 00H		; `string'
CONST	ENDS
;	COMDAT ?arrowW@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
CONST	SEGMENT
?arrowW@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB DD 03d315b57r ; 0.0433 ; `FlcsMfdDrawable::Display'::`7'::arrowW
CONST	ENDS
;	COMDAT ?arrowH@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
CONST	SEGMENT
?arrowH@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB DD 03d19999ar ; 0.0375 ; `FlcsMfdDrawable::Display'::`7'::arrowH
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\flcsmfd.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_whichButton$ = 8					; size = 4
_whichMFD$ = 12						; size = 4
?PushButton@FlcsMfdDrawable@@UAEXHH@Z PROC		; FlcsMfdDrawable::PushButton
; _this$ = ecx
...
; 78   :     MfdDrawable::PushButton(whichButton, whichMFD);
...
; 79   : }
	...
	pop	ebp
	ret	8
?PushButton@FlcsMfdDrawable@@UAEXHH@Z ENDP		; FlcsMfdDrawable::PushButton
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\flcsmfd.cpp
_TEXT	SEGMENT
...
?Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z PROC ; FlcsMfdDrawable::Display
; _this$ = ecx
...
; 25   : 	AircraftClass *playerAC = SimDriver.GetPlayerAircraft();

	mov	ecx, OFFSET ?SimDriver@@3VSimulationDriver@@A ; SimDriver
	call	?GetPlayerAircraft@SimulationDriver@@QBEPAVAircraftClass@@XZ ; SimulationDriver::GetPlayerAircraft
	mov	DWORD PTR _playerAC$[ebp], eax

; 26   : 	RadarDopplerClass* theRadar = (RadarDopplerClass*)FindSensor(playerAC, SensorClass::Radar);
...
; 28   : 	{
; 29   : 		ShiWarning("Oh Oh shouldn't be here without a radar!");
; 30   : 		return;
...
; 33   : 	{
; 34   : 		theRadar->GetCursorPosition (&cX, &cY);
...
; 35   : 	}
; 36   :     static const float arrowH = 0.0375f;
; 37   :     static const float arrowW = 0.0433f;
; 38   :     display = newDisplay;
...
; 39   : 
; 40   :     LabelButton(6, "LOC", "D234");

	push	0
	push	OFFSET ??_C@_04FDILGOHP@D234?$AA@
	push	OFFSET ??_C@_03KPOLBBFN@LOC?$AA@
	push	6
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LabelButton@DrawableClass@@QAEXHPAD0H@Z ; DrawableClass::LabelButton

; 41   :     LabelButton(8, "HEX");
...
; 43   :     float x5, y5;
; 44   :     float x7, y7;
; 45   :     GetButtonPos(5, &x5, &y5);

	lea	eax, DWORD PTR _y5$[ebp]
	push	eax
	lea	ecx, DWORD PTR _x5$[ebp]
	push	ecx
	push	5
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetButtonPos@DrawableClass@@QAEXHPAM0@Z ; DrawableClass::GetButtonPos

; 46   :     GetButtonPos(7, &x7, &y7);

	lea	edx, DWORD PTR _y7$[ebp]
	push	edx
	lea	eax, DWORD PTR _x7$[ebp]
	push	eax
	push	7
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetButtonPos@DrawableClass@@QAEXHPAM0@Z ; DrawableClass::GetButtonPos
...
; 47   : 
; 48   :     display->AdjustOriginInViewport(x5 + arrowW, y5 + arrowH/2);

	movss	xmm0, DWORD PTR ?arrowH@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
	divss	xmm0, DWORD PTR __real@40000000
	addss	xmm0, DWORD PTR _y5$[ebp]
	push	ecx
	movss	DWORD PTR [esp], xmm0
	movss	xmm0, DWORD PTR _x5$[ebp]
	addss	xmm0, DWORD PTR ?arrowW@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
	push	ecx
	movss	DWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _this$[ebp]
...
; 49   :     display->Tri (0.0F, arrowH, arrowW, -arrowH, -arrowW, -arrowH);

	movss	xmm0, DWORD PTR ?arrowH@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	push	ecx
	movss	DWORD PTR [esp], xmm0
	movss	xmm0, DWORD PTR ?arrowW@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	push	ecx
	movss	DWORD PTR [esp], xmm0
	movss	xmm0, DWORD PTR ?arrowH@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
...
; 51   : 	/* down arrow */
; 52   : 	/*------------*/
; 53   :     display->CenterOriginInViewport();    

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+20]
	call	?CenterOriginInViewport@VirtualDisplay@@QAEXXZ ; VirtualDisplay::CenterOriginInViewport

; 54   :     display->AdjustOriginInViewport( x7 + arrowW, y7 - arrowH/2);

	movss	xmm0, DWORD PTR ?arrowH@?6??Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z@4MB
	divss	xmm0, DWORD PTR __real@40000000
	movss	xmm1, DWORD PTR _y7$[ebp]
	subss	xmm1, xmm0
	push	ecx
...
; 55   :     display->Tri (0.0F, -arrowH, arrowW, arrowH, -arrowW, arrowH);
...
; 56   :     display->CenterOriginInViewport();    
...
; 57   : 
; 58   :     //LabelButton (19, "MORE");
; 59   :     display->TextCenterVertical (0.0f, 0.0f, "CONTENT");

	push	0
	push	OFFSET ??_C@_07HPFEHCIK@CONTENT?$AA@
	push	ecx
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [esp], xmm0
	push	ecx
...
; 62   : 	{
; 63   : 		if(OTWDriver.pCockpitManager && OTWDriver.pCockpitManager->mpIcp &&
; 64   : 			OTWDriver.pCockpitManager->mpIcp->ShowBullseyeInfo)
...
; 65   : 		{
; 66   : 			DrawBullseyeCircle(display, cX, cY);
...
; 72   : 		DrawReference (MfdDisplay[OnMFD()]->GetOwnShip());
...
; 74   : }
	...
	pop	ebp
	ret	4
?Display@FlcsMfdDrawable@@UAEXPAVVirtualDisplay@@@Z ENDP ; FlcsMfdDrawable::Display
_TEXT	ENDS
; Function compile flags: /Odtp
