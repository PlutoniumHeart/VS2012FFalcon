; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\DISPLAYS\BlankMfd.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Display@BlankMfdDrawable@@UAEXPAVVirtualDisplay@@@Z ; BlankMfdDrawable::Display
PUBLIC	?PushButton@BlankMfdDrawable@@UAEXHH@Z		; BlankMfdDrawable::PushButton
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\blankmfd.cpp
_TEXT	SEGMENT
_this$ = -16						; size = 4
_otherMfd$1 = -12					; size = 4
tv75 = -8						; size = 4
_nextMode$2 = -4					; size = 4
_whichButton$ = 8					; size = 4
_whichMFD$ = 12						; size = 4
?PushButton@BlankMfdDrawable@@UAEXHH@Z PROC		; BlankMfdDrawable::PushButton
; _this$ = ecx
...
; 59   :         MfdDrawable::PushButton(whichButton, whichMFD);
...
; 62   : 	MFDClass::MfdMode nextMode = MFDClass::MfdOff;

	mov	DWORD PTR _nextMode$2[ebp], 0

; 63   : 	int otherMfd;
; 64   : 	
; 65   : 	// For in cockpit, you can't have two of the same thing
; 66   : 	if (whichMFD == 0)

	cmp	DWORD PTR _whichMFD$[ebp], 0
	jne	SHORT $LN13@PushButton

; 67   : 	    otherMfd = 1;

	mov	DWORD PTR _otherMfd$1[ebp], 1
	jmp	SHORT $LN12@PushButton
$LN13@PushButton:

; 68   : 	else if (whichMFD == 1)

	cmp	DWORD PTR _whichMFD$[ebp], 1
	jne	SHORT $LN11@PushButton

; 69   : 	    otherMfd = 0;

	mov	DWORD PTR _otherMfd$1[ebp], 0
...
; 74   : 	switch (whichButton)
	...
	cmp	DWORD PTR tv75[ebp], 11			; 0000000bH
	ja	SHORT $LN8@PushButton
	mov	edx, DWORD PTR tv75[ebp]
	movzx	eax, BYTE PTR $LN18@PushButton[edx]
	jmp	DWORD PTR $LN19@PushButton[eax*4]
$LN7@PushButton:

; 75   : 	{
; 76   : 	case 1:
; 77   : 	    nextMode = MFDClass::FCCMode;

	mov	DWORD PTR _nextMode$2[ebp], 9
...
; 79   : 	    
; 80   : 	case 2:
; 81   : 	    nextMode = MFDClass::FCRMode;

	mov	DWORD PTR _nextMode$2[ebp], 10		; 0000000aH
...
; 83   : 	    
; 84   : 	case 3:
; 85   : 	    nextMode = MFDClass::SMSMode;

	mov	DWORD PTR _nextMode$2[ebp], 11		; 0000000bH
...
; 87   : 	    
; 88   : 	case 11:
; 89   : 	    nextMode = MFDClass::RWRMode;

	mov	DWORD PTR _nextMode$2[ebp], 12		; 0000000cH
...
; 91   : 	    
; 92   : 	case 12:
; 93   : 	    //nextMode = MFDClass::HUDMode; 
; 94   : 		nextMode = MFDClass::HADMode; // RV - I-Hawk 

	mov	DWORD PTR _nextMode$2[ebp], 13		; 0000000dH
$LN8@PushButton:

; 95   : 	    break;
; 96   : 	    
; 97   : 	}
; 98   : 	// Check other MFD if needed;
; 99   : 	if (nextMode != MFDClass::MfdOff && (otherMfd < 0 || MfdDisplay[otherMfd]->mode != nextMode))

	cmp	DWORD PTR _nextMode$2[ebp], 0
	je	SHORT $LN16@PushButton
	cmp	DWORD PTR _otherMfd$1[ebp], 0
	jl	SHORT $LN1@PushButton
	mov	ecx, DWORD PTR _otherMfd$1[ebp]
	mov	edx, DWORD PTR ?MfdDisplay@@3PAPAVMFDClass@@A[ecx*4]
	mov	eax, DWORD PTR [edx+8]
	cmp	eax, DWORD PTR _nextMode$2[ebp]
	je	SHORT $LN16@PushButton
$LN1@PushButton:

; 100  : 	    MfdDisplay[whichMFD]->SetNewMode(nextMode);

	mov	ecx, DWORD PTR _nextMode$2[ebp]
	push	ecx
...
$LN18@PushButton:
	...
	DB	3
	DB	4
?PushButton@BlankMfdDrawable@@UAEXHH@Z ENDP		; BlankMfdDrawable::PushButton
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\displays\blankmfd.cpp
_TEXT	SEGMENT
...
?Display@BlankMfdDrawable@@UAEXPAVVirtualDisplay@@@Z PROC ; BlankMfdDrawable::Display
; _this$ = ecx
...
; 22   : 	AircraftClass *playerAC = SimDriver.GetPlayerAircraft();

	mov	ecx, OFFSET ?SimDriver@@3VSimulationDriver@@A ; SimDriver
	call	?GetPlayerAircraft@SimulationDriver@@QBEPAVAircraftClass@@XZ ; SimulationDriver::GetPlayerAircraft
	mov	DWORD PTR _playerAC$[ebp], eax

; 23   : 	RadarDopplerClass* theRadar = (RadarDopplerClass*)FindSensor(playerAC, SensorClass::Radar);
...
; 25   : 	{
; 26   : 		ShiWarning("Oh Oh shouldn't be here without a radar!");
; 27   : 		return;
...
; 31   : 	//MI
; 32   : 	if(g_bRealisticAvionics && theRadar)
...
; 41   : 	//MI changed
; 42   : 	if(OTWDriver.pCockpitManager && OTWDriver.pCockpitManager->mpIcp &&
; 43   : 		OTWDriver.pCockpitManager->mpIcp->ShowBullseyeInfo)
...
; 44   : 	{
; 45   : 		DrawBullseyeCircle(display, cX, cY);
...
; 48   : 		DrawReference(MfdDisplay[OnMFD()]->GetOwnShip());
...
; 53   : 	display->TextCenterVertical (0.0f, 0.0f, "Off");
...
; 54   : }
	...
	pop	ebp
	ret	4
?Display@BlankMfdDrawable@@UAEXPAVVirtualDisplay@@@Z ENDP ; BlankMfdDrawable::Display
_TEXT	ENDS
; Function compile flags: /Odtp
