; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\FCC\Harmfcc.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?HarmMode@FireControlComputer@@AAEXXZ		; FireControlComputer::HarmMode
...
PUBLIC	?GetRange@HarmTargetingPod@@QAEHXZ		; HarmTargetingPod::GetRange
...
EXTRN	?LockTargetUnderCursor@HarmTargetingPod@@QAEXXZ:PROC ; HarmTargetingPod::LockTargetUnderCursor
...
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\include\harmpod.h
;	COMDAT ?GetRange@HarmTargetingPod@@QAEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetRange@HarmTargetingPod@@QAEHXZ PROC			; HarmTargetingPod::GetRange, COMDAT
; _this$ = ecx

; 87   : 	int				GetRange (void)				{ return trueDisplayRange; };
	...
	pop	ebp
	ret	0
?GetRange@HarmTargetingPod@@QAEHXZ ENDP			; HarmTargetingPod::GetRange
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\include\harmpod.h
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\fcc\harmfcc.cpp
_TEXT	SEGMENT
tv528 = -44						; size = 4
tv564 = -40						; size = 4
tv371 = -36						; size = 4
...
?HarmMode@FireControlComputer@@AAEXXZ PROC		; FireControlComputer::HarmMode
; _this$ = ecx
...
; 18   : 	MissileClass		*theMissile;
; 19   : 	HarmTargetingPod	*theHTS;
; 20   : 	Tpoint				pos;
; 21   : 	
; 22   : 	theHTS = (HarmTargetingPod*)FindSensor(platform, SensorClass::HTS);
...
; 23   : 	theMissile = (MissileClass *)(Sms->GetCurrentWeapon());
...
; 26   : 	{
; 27   : 		if ( !(platform->IsPlayer()) )

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+140]
	call	?IsPlayer@FalconEntity@@QAEHXZ		; FalconEntity::IsPlayer
	test	eax, eax
	jne	SHORT $LN25@HarmMode

; 28   : 		{
; 29   : 			theHTS->SetRange(FloatToInt32(HSDRange)); // RV - I-Hawk - HTS controls range on its own
...
; 31   : 		else
	...
	jmp	SHORT $LN24@HarmMode
$LN25@HarmMode:

; 32   : 			platform->SOIManager (SimVehicleClass::SOI_WEAPON); // FRB - Test
...
; 33   : 		
; 34   : 		if (designateCmd && !lastDesignate)

	mov	ecx, DWORD PTR _this$[ebp]
	movsx	edx, BYTE PTR [ecx+184]
	test	edx, edx
	je	SHORT $LN23@HarmMode
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+96], 0
	jne	SHORT $LN23@HarmMode

; 35   : 		{
; 36   : 			// In POS mode the Lock is done via WPN OSBs
; 37   : 			if ( theHTS->GetSubMode() == HarmTargetingPod::HAS || theHTS->GetSubMode() == HarmTargetingPod::HAD ) 

	mov	ecx, DWORD PTR _theHTS$[ebp]
	call	?GetSubMode@HarmTargetingPod@@QAE?AW4Submode@1@XZ ; HarmTargetingPod::GetSubMode
	cmp	eax, 1
	je	SHORT $LN21@HarmMode
	mov	ecx, DWORD PTR _theHTS$[ebp]
	call	?GetSubMode@HarmTargetingPod@@QAE?AW4Submode@1@XZ ; HarmTargetingPod::GetSubMode
	cmp	eax, 5
	jne	SHORT $LN22@HarmMode
$LN21@HarmMode:

; 38   : 			{
; 39   :                 theHTS->LockTargetUnderCursor();

	mov	ecx, DWORD PTR _theHTS$[ebp]
	call	?LockTargetUnderCursor@HarmTargetingPod@@QAEXXZ ; HarmTargetingPod::LockTargetUnderCursor
$LN22@HarmMode:

; 40   : 			}
; 41   : 		}

	jmp	SHORT $LN18@HarmMode
$LN23@HarmMode:

; 42   : 
; 43   : 		else if (dropTrackCmd)

	mov	ecx, DWORD PTR _this$[ebp]
	movsx	edx, BYTE PTR [ecx+185]
	test	edx, edx
	je	SHORT $LN18@HarmMode

; 44   : 		{
; 45   : 			dropTrackCmd = FALSE; // JB 010726

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+185], 0

; 46   : 			theHTS->ClearSensorTarget();
...
; 49   : 				theMissile->SetTargetPosition (-1.0F, -1.0F, -1.0F);
...
; 56   : 		{
; 57   : 			if (!targetPtr || targetPtr->BaseData() != theHTS->CurrentTarget()->BaseData())

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+132], 0
	je	SHORT $LN14@HarmMode
	mov	ecx, DWORD PTR _this$[ebp]
	...
	call	?BaseData@SimObjectType@@QAEPAVFalconEntity@@XZ ; SimObjectType::BaseData
	cmp	esi, eax
	je	SHORT $LN15@HarmMode
$LN14@HarmMode:

; 58   : 			{
; 59   : 				SetTarget (theHTS->CurrentTarget());
...
; 60   : 			}
; 61   : 			
; 62   : 			// Cobra - Target only ground targets
; 63   : 			if (targetPtr->BaseData()->IsAirplane())
	...
	call	eax
	test	eax, eax
	je	SHORT $LN13@HarmMode

; 64   : 			{
; 65   : 				dropTrackCmd = FALSE; // JB 010726

	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+185], 0

; 66   : 				theHTS->ClearSensorTarget();

	mov	edx, DWORD PTR _theHTS$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _theHTS$[ebp]
	mov	edx, DWORD PTR [eax+40]
	call	edx

; 67   : 				ClearCurrentTarget();
...
; 73   : 			{
; 74   : 				/* JB 010624 Why? Setting the position like this screws up multiplayer and entitys' movement
; 75   : 				if (targetPtr->BaseData()->IsSim() && ((SimBaseClass*)targetPtr->BaseData())->IsAwake())
; 76   : 				{
; 77   : 					((SimBaseClass*)targetPtr->BaseData())->drawPointer->GetPosition (&pos);
; 78   : 					((SimBaseClass*)targetPtr->BaseData())->SetPosition (pos.x, pos.y, pos.z);
; 79   : 				}
; 80   : 				*/
; 81   : 
; 82   : 				// TODO:  Just pass the target to the missile and let it deal with things...
; 83   : 				pos.x = targetPtr->BaseData()->XPos();
...
; 84   : 				pos.y = targetPtr->BaseData()->YPos();
...
; 85   : 
; 86   : 				if (targetPtr->BaseData()->IsSim()) {
	...
	test	eax, eax
	je	SHORT $LN11@HarmMode

; 87   : 					pos.z = targetPtr->BaseData()->ZPos();
...
; 88   : 				} else {
	...
	jmp	SHORT $LN10@HarmMode
$LN11@HarmMode:

; 89   : 					pos.z = OTWDriver.GetGroundLevel( pos.x, pos.y );
...
; 90   : 				}
; 91   : 				theMissile->SetTargetPosition( pos.x, pos.y, pos.z );
...
; 92   : 		   
; 93   : 				CalcRelGeom(platform, targetPtr, NULL, 1.0F / SimLibMajorFrameTime);
...
; 94   : 				missileRMax   = theMissile->GetRMax (-platform->ZPos(), platform->GetVt(), targetPtr->localData->az, 0.0f, 0.0f);
...
; 95   : 				missileActiveRange = 0.0f;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [edx+284], xmm0

; 96   : 				missileActiveTime  = -1.0f;
...
; 97   : 
; 98   : 				//LRKLUDGE
; 99   : 				missileRMin   = 0.075F * missileRMax;
...
; 100  : 				missileRneMax = 0.8F * missileRMax;
...
; 101  : 				missileRneMin = 0.2F * missileRMax;
...
; 102  : 				missileTOF    = theMissile->GetTOF(-platform->ZPos(), platform->GetVt(), 0.0f, 0.0f, targetPtr->localData->range);
...
; 103  : 				missileSeekerAz = targetPtr->localData->az;
...
; 104  : 				missileSeekerEl = targetPtr->localData->el;
...
; 105  : 			   
; 106  : 				missileWEZDisplayRange = theHTS->GetRange() * NM_TO_FT;

	mov	ecx, DWORD PTR _theHTS$[ebp]
	call	?GetRange@HarmTargetingPod@@QAEHXZ	; HarmTargetingPod::GetRange
	cvtsi2ss xmm0, eax
...
; 110  : 			else {
	...
	jmp	SHORT $LN9@HarmMode
$LN12@HarmMode:

; 111  : 				missileTarget = FALSE;
...
; 115  : 			// RV - Biker - better do check on targetPtr first
; 116  : 			// Cobra - Target only ground targets
; 117  : 			if (targetPtr)

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+132], 0
	je	SHORT $LN6@HarmMode

; 118  : 			{
; 119  : 				if (targetPtr->BaseData()->IsAirplane())
...
; 120  : 				{
; 121  : 					dropTrackCmd = FALSE; // JB 010726

	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+185], 0

; 122  : 					theHTS->ClearSensorTarget();
...
; 123  : 					ClearCurrentTarget();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ClearCurrentTarget@FireControlComputer@@QAEXXZ ; FireControlComputer::ClearCurrentTarget

; 124  : 					releaseConsent = 0;
...
; 128  : 			if (theMissile)
	...
	cmp	DWORD PTR _theMissile$[ebp], 0
	je	SHORT $LN5@HarmMode

; 129  : 			{
; 130  : 				theHTS->GetAGCenter (&pos.x, &pos.y);

	lea	ecx, DWORD PTR _pos$[ebp+4]
	push	ecx
	lea	edx, DWORD PTR _pos$[ebp]
	push	edx
	mov	eax, DWORD PTR _theHTS$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _theHTS$[ebp]
	mov	eax, DWORD PTR [edx+80]
	call	eax

; 131  : 				pos.z = OTWDriver.GetGroundLevel( pos.x, pos.y );
...
; 132  : 				theMissile->SetTargetPosition( pos.x, pos.y, pos.z );
...
; 138  : 		if (targetPtr)
	...
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+132], 0
	je	SHORT $LN3@HarmMode

; 139  : 		{
; 140  : 			if (theHTS)

	cmp	DWORD PTR _theHTS$[ebp], 0
	je	SHORT $LN2@HarmMode

; 141  : 				theHTS->ClearSensorTarget();
...
; 145  : 	}
; 146  : 	
; 147  : 	if (!releaseConsent)

	mov	ecx, DWORD PTR _this$[ebp]
	movsx	edx, BYTE PTR [ecx+181]
	test	edx, edx
	jne	SHORT $LN1@HarmMode
...
; 151  : }
	...
	pop	ebp
	ret	0
?HarmMode@FireControlComputer@@AAEXXZ ENDP		; FireControlComputer::HarmMode
_TEXT	ENDS
; Function compile flags: /Odtp
