; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\GROUND\gndapi.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Next_WayPoint@GNDAIClass@@QAEPAVWayPointClass@@XZ ; GNDAIClass::Next_WayPoint
PUBLIC	?Fire@GNDAIClass@@QAEXXZ			; GNDAIClass::Fire
...
EXTRN	?DoWeapons@GroundClass@@QAEHXZ:PROC		; GroundClass::DoWeapons
EXTRN	?RotateTurret@GroundClass@@QAEXXZ:PROC		; GroundClass::RotateTurret
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\ground\gndapi.cpp
_TEXT	SEGMENT
tv616 = -132						; size = 4
tv568 = -128						; size = 4
tv645 = -124						; size = 4
...
_vc$2 = -64						; size = 4
_ret$3 = -60						; size = 4
_hasWeapons$4 = -56					; size = 4
tv184 = -52						; size = 4
tv171 = -48						; size = 4
_realRange$5 = -44					; size = 4
_nextFire$ = -40					; size = 4
_xtraFireTime$ = -36					; size = 4
_theWeapon$6 = -32					; size = 4
_tof$7 = -28						; size = 4
_i$8 = -24						; size = 4
_target$9 = -20						; size = 4
_zft$10 = -16						; size = 4
...
_yft$12 = -8						; size = 4
_this$ = -4						; size = 4
?Fire@GNDAIClass@@QAEXXZ PROC				; GNDAIClass::Fire
; _this$ = ecx
...
; 202  : 	int xtraFireTime;
; 203  : 	ulong nextFire;
; 204  : 	// Do Weapons Control
; 205  : 	// Here we decide if it is time to fire
; 206  : 	if (self->targetPtr){
...
; 207  : 		// If a unit is hidden, increase its fire time
; 208  : 		if ( self->IsSetLocalFlag( IS_HIDDEN ) )
...
; 209  : 			xtraFireTime = 10000;

	mov	DWORD PTR _xtraFireTime$[ebp], 10000	; 00002710H
...
; 211  : 			xtraFireTime = 0;
	...
	mov	DWORD PTR _xtraFireTime$[ebp], 0
$LN28@Fire:

; 212  : 		
; 213  : 		if (self->targetPtr->BaseData()->OnGround())
...
; 214  : 			nextFire = nextGroundFire + xtraFireTime;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+88]
	add	ecx, DWORD PTR _xtraFireTime$[ebp]
	mov	DWORD PTR _nextFire$[ebp], ecx
...
; 216  : 			nextFire = nextAirFire + xtraFireTime;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	add	eax, DWORD PTR _xtraFireTime$[ebp]
	mov	DWORD PTR _nextFire$[ebp], eax
$LN26@Fire:

; 217  : 		
; 218  : 		// RV - Biker - Chech if we do have any weapons (radar units should not have)
; 219  : 		VehicleClassDataType* vc = GetVehicleClassData(self->Type() - VU_LAST_ENTITY_TYPE);
...
; 220  : 
; 221  : 		int hasWeapons = 0;

	mov	DWORD PTR _hasWeapons$4[ebp], 0

; 222  : 
; 223  : 		for (int i = 0; i < HARDPOINT_MAX; i++) {
...
$LN25@Fire:
	cmp	DWORD PTR _i$8[ebp], 16			; 00000010H
	jge	SHORT $LN23@Fire

; 224  : 			if (vc->Weapon[i] && vc->Weapons[i]) {
...
; 225  : 				hasWeapons = 1;
	...
	mov	DWORD PTR _hasWeapons$4[ebp], 1
...
; 229  : 
; 230  : 		// RV - Biker - Radar vehicles shouldn't do this
; 231  : 		if (SimLibElapsedTime > nextFire && !(self->isEmitter && !hasWeapons)) {

	mov	eax, DWORD PTR ?SimLibElapsedTime@@3KA	; SimLibElapsedTime
	cmp	eax, DWORD PTR _nextFire$[ebp]
	jbe	$LN21@Fire
	mov	ecx, DWORD PTR _this$[ebp]
	...
	and	eax, 1
	je	SHORT $LN20@Fire
	cmp	DWORD PTR _hasWeapons$4[ebp], 0
	je	$LN21@Fire
$LN20@Fire:

; 232  : 		// FRB - The weapns search above seems to break the SAM firing (decreases it or stops it)
; 233  : 		//if (SimLibElapsedTime > nextFire && !(self->isEmitter && !self->Sms->GetCurrentWeapon())) {
; 234  : 			nextTurretCalc = SimLibElapsedTime + TURRET_CALC_RATE;
...
; 235  : 
; 236  : 			if(!self->targetPtr->BaseData()->OnGround())
...
; 237  : 				self->SelectWeapon(!battalionCommand->self->allowSamFire);
...
; 240  : 			// 2000-10-12 MODIFIED BY S.G. WE NEED TO KNOW IF IT IS A GUN SHOT. IF SO, SHOOT AGAIN VERY SOON
; 241  : 			//if (self->DoWeapons()) {
; 242  : 			//	nextAirFire	= SimLibElapsedTime + airFireRate;	// Shot -- wait a while
; 243  : 			int ret;
; 244  : 			if (ret = self->DoWeapons()) {

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+72]
	call	?DoWeapons@GroundClass@@QAEHXZ		; GroundClass::DoWeapons
	mov	DWORD PTR _ret$3[ebp], eax
	cmp	DWORD PTR _ret$3[ebp], 0
	je	SHORT $LN17@Fire

; 245  : 				// If it's just TRUE, it's a missile launch, wait 'airFireRate' otherwise wait half a second
; 246  : 				if (ret == TRUE)

	cmp	DWORD PTR _ret$3[ebp], 1
	jne	SHORT $LN16@Fire

; 247  : 					nextAirFire	= SimLibElapsedTime + airFireRate;	// Shot -- wait a while
...
; 249  : 					// 2000-10-27 ADDED BY S.G. 
; 250  : 					// SO GUNS CAN HAVE DIFFERENT FIRE RATE... NOT IN RP4, SIMPLY ADD 500 TO MAKE IT LIKE RP4
; 251  : 					//if (ret == TRUE + 1) // It's a slow fire rate
; 252  : 					//	nextAirFire	= SimLibElapsedTime + 2000;
; 253  : 					//else
; 254  : 						nextAirFire	= SimLibElapsedTime + 500;
...
; 255  : 				}
; 256  : 				// END OF MODIFIED SECTION
; 257  : 			} else {

	jmp	SHORT $LN13@Fire
$LN17@Fire:

; 258  : 				if (SimLibElapsedTime > nextFire + 2000) {

	mov	ecx, DWORD PTR _nextFire$[ebp]
	add	ecx, 2000				; 000007d0H
	cmp	DWORD PTR ?SimLibElapsedTime@@3KA, ecx	; SimLibElapsedTime
	jbe	SHORT $LN13@Fire

; 259  : 					// No shot, exceeded window -- Try again soon
; 260  : 					nextAirFire	= SimLibElapsedTime + 2000;
...
; 261  : 				}
; 262  : 				else {
; 263  : 					// No shot, still in window -- Try again next frame
; 264  : 				}
; 265  : 			}
; 266  : 			nextGroundFire	= SimLibElapsedTime + gndFireRate;	// Shot or not shot, wait a while
...
; 272  : 			}
; 273  : 			// RV - Biker - Radar vehicles without weapons should do this also
; 274  : 			//if(SimLibElapsedTime > nextTurretCalc) {
; 275  : 			if (SimLibElapsedTime > nextTurretCalc || (self->isEmitter && !self->Sms->GetCurrentWeapon())) {
...
; 276  : 				float xft, yft, zft;
; 277  : 				float realRange, tof;
; 278  : 				FalconEntity	*target;
; 279  : 
; 280  : 				SimWeaponClass *theWeapon = self->Sms->GetCurrentWeapon();
	...
	call	edx
	mov	DWORD PTR _theWeapon$6[ebp], eax

; 281  : 
; 282  : 				// RV - Biker - Adjust this
; 283  : 				//if(!theWeapon)
; 284  : 				if (!theWeapon && !self->isEmitter)

	cmp	DWORD PTR _theWeapon$6[ebp], 0
	jne	SHORT $LN7@Fire
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+72]
	mov	edx, DWORD PTR [ecx+772]
...
; 286  : 
; 287  : 				target = self->targetPtr->BaseData();

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+72]
	mov	ecx, DWORD PTR [ecx+656]
	call	?BaseData@SimObjectType@@QAEPAVFalconEntity@@XZ ; SimObjectType::BaseData
	mov	DWORD PTR _target$9[ebp], eax
...
; 290  : 
; 291  : 				nextTurretCalc = SimLibElapsedTime + TURRET_CALC_RATE;
...
; 293  : 				xft = target->XPos() - self->XPos();
	...
	movss	DWORD PTR _xft$11[ebp], xmm0

; 294  : 				yft = target->YPos() - self->YPos();
	...
	subss	xmm0, DWORD PTR tv564[ebp]
	movss	DWORD PTR _yft$12[ebp], xmm0

; 295  : 				zft = target->ZPos() - self->ZPos() + 4.0f;
	...
	movss	DWORD PTR _zft$10[ebp], xmm0

; 296  : 				realRange = (float)sqrt( xft * xft + yft * yft + zft * zft );

	movss	xmm0, DWORD PTR _xft$11[ebp]
	mulss	xmm0, DWORD PTR _xft$11[ebp]
	movss	xmm1, DWORD PTR _yft$12[ebp]
	mulss	xmm1, DWORD PTR _yft$12[ebp]
	addss	xmm0, xmm1
	movss	xmm1, DWORD PTR _zft$10[ebp]
	mulss	xmm1, DWORD PTR _zft$10[ebp]
	addss	xmm0, xmm1
	push	ecx
	movss	DWORD PTR [esp], xmm0
	call	?SqrtSSE@@YAMM@Z			; SqrtSSE
	add	esp, 4
	fstp	DWORD PTR _realRange$5[ebp]

; 297  : 
; 298  : 				// RV - Biker - Check if we have a weapon first
; 299  : 				//if(theWeapon->IsGun()) {
; 300  : 				if(theWeapon && theWeapon->IsGun()) {

	cmp	DWORD PTR _theWeapon$6[ebp], 0
	je	$LN5@Fire
	mov	ecx, DWORD PTR _theWeapon$6[ebp]
...
; 301  : 					GunClass	*Gun = (GunClass*)theWeapon;

	mov	ecx, DWORD PTR _theWeapon$6[ebp]
	mov	DWORD PTR _Gun$1[ebp], ecx

; 302  : 
; 303  : 					// Guess TOF
; 304  : 					tof = realRange / Gun->initBulletVelocity + 0.25F;

	mov	edx, DWORD PTR _Gun$1[ebp]
	movss	xmm0, DWORD PTR _realRange$5[ebp]
	divss	xmm0, DWORD PTR [edx+792]
	addss	xmm0, DWORD PTR __real@3e800000
	movss	DWORD PTR _tof$7[ebp], xmm0

; 305  : 
; 306  : 					// now get vector to where we're aiming
; 307  : 					xft += target->XDelta() * tof;

	mov	ecx, DWORD PTR _target$9[ebp]
	call	?XDelta@VuEntity@@QBEMXZ		; VuEntity::XDelta
	fstp	DWORD PTR tv589[ebp]
	movss	xmm0, DWORD PTR tv589[ebp]
	mulss	xmm0, DWORD PTR _tof$7[ebp]
	addss	xmm0, DWORD PTR _xft$11[ebp]
	movss	DWORD PTR _xft$11[ebp], xmm0

; 308  : 					yft += target->YDelta() * tof;
	...
	mulss	xmm0, DWORD PTR _tof$7[ebp]
	addss	xmm0, DWORD PTR _yft$12[ebp]
	movss	DWORD PTR _yft$12[ebp], xmm0

; 309  : 					zft += target->ZDelta() * tof;
	...
	mulss	xmm0, DWORD PTR _tof$7[ebp]
	addss	xmm0, DWORD PTR _zft$10[ebp]
	movss	DWORD PTR _zft$10[ebp], xmm0

; 310  : 
; 311  : 					// Correct for gravity
; 312  : 					zft += 0.5F * GRAVITY * tof * tof;
...
; 313  : 				}
; 314  : 
; 315  : 				// KCK : Copy these values into our targetPtr.
; 316  : 				// Note: This factors our induced error and target's vector into the Rel Geometry data,
; 317  : 				// but as we use this only for aiming and targetting, it shouldn't matter.
; 318  : 				self->targetPtr->localData->az = (float)atan2(yft,xft);

	cvtss2sd xmm0, DWORD PTR _xft$11[ebp]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	cvtss2sd xmm0, DWORD PTR _yft$12[ebp]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
...
; 319  : 				self->targetPtr->localData->el = (float)atan(-zft/(float)sqrt(xft*xft + yft*yft +0.1F));

	movss	xmm0, DWORD PTR _zft$10[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	movss	xmm1, DWORD PTR _xft$11[ebp]
	mulss	xmm1, DWORD PTR _xft$11[ebp]
	movss	xmm2, DWORD PTR _yft$12[ebp]
	mulss	xmm2, DWORD PTR _yft$12[ebp]
	addss	xmm1, xmm2
	...
	divss	xmm0, DWORD PTR tv616[ebp]
	push	ecx
	movss	DWORD PTR [esp], xmm0
...
; 320  : 				self->targetPtr->localData->range = realRange;
...
; 326  : 		// Wait until we have a target before we even start counting
; 327  : 		if ( self->needKeepAlive )
...
; 329  : 		if ( SimLibElapsedTime > nextAirFire + 2000 )
...
; 330  : 			// We'll wait from 0 to airFireRate to shoot when we get a targetPtr.
; 331  : 			nextAirFire = SimLibElapsedTime + airFireRate;		
...
; 332  : 		if ( SimLibElapsedTime > nextGroundFire + 2000 )
...
; 333  : 			// We'll wait from 0 to gndFireRate to shoot when we get a targetPtr.
; 334  : 			nextGroundFire = SimLibElapsedTime + gndFireRate;	
...
; 337  : }
	...
	pop	ebp
	ret	0
?Fire@GNDAIClass@@QAEXXZ ENDP				; GNDAIClass::Fire
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\ground\gndapi.cpp
_TEXT	SEGMENT
...
_waypoint$ = -24					; size = 4
_dy$ = -20						; size = 4
_theBattalion$ = -16					; size = 4
_dx$ = -12						; size = 4
_vel$ = -8						; size = 4
_this$ = -4						; size = 4
?Next_WayPoint@GNDAIClass@@QAEPAVWayPointClass@@XZ PROC	; GNDAIClass::Next_WayPoint
; _this$ = ecx
...
; 75   : 				dz;
; 76   : 
; 77   : 	// Used for the campaign movement..
; 78   : 	//
; 79   : 	BattalionClass	*theBattalion;
; 80   : 	WayPoint		waypoint = NULL;		

	mov	DWORD PTR _waypoint$[ebp], 0
...
; 86   :    mlTrig trig;
; 87   : 
; 88   : 	//MonoPrint("GNDAI: %s, called going for next waypoint\n", RankText[rank] );
; 89   : 
; 90   : 	// Determine whether we are follow way points, or a campaign path
; 91   : 	//
; 92   : 	if (self->curWaypoint)
...
; 93   : 	{
; 94   : 
; 95   : 		// First find the location of the current way point
; 96   : 		//
; 97   : 		self->curWaypoint->GetLocation (&dx, &dy, &dz);

	lea	edx, DWORD PTR _dz$[ebp]
	push	edx
...
; 98   : 		distance = (float) sqrt ( ((self->XPos() - dx) * (self->XPos() - dx)) + 
; 99   : 									((self->YPos() - dy) * (self->YPos() - dy)) );
...
; 100  : 
; 101  : 		// Assume we are at the current way point if we are very close (!)
; 102  : 		//
; 103  : 		if ( distance < MIN_DIST )
...
; 104  : 		{
; 105  : 
; 106  : 			// Get the next way point, if one is available.
; 107  : 			//
; 108  : 			waypoint = self->curWaypoint = self->curWaypoint->GetNextWP ();
...
; 109  : 			// LRKLUDGE need to make sure there is a waypoint.
; 110  : 			if (self->curWaypoint)
...
; 111  : 			{
; 112  : 				self->curWaypoint->GetLocation (&dx, &dy, &dz);

	lea	ecx, DWORD PTR _dz$[ebp]
	push	ecx
...
; 113  : 				self->SetYPR ( (float)atan2(dy - self->YPos (), dx - self->XPos () ), 0.0F, 0.0F );
...
; 114  : 				distance = (float) sqrt ( ((self->XPos() - dx) * (self->XPos() - dx)) + 
; 115  : 											((self->YPos() - dy) * (self->YPos() - dy)) );
	...
	subss	xmm0, DWORD PTR _dx$[ebp]
	movss	xmm1, DWORD PTR tv752[ebp]
	mulss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+72]
	movss	DWORD PTR tv754[ebp], xmm1
	call	?YPos@VuEntity@@QBEMXZ			; VuEntity::YPos
...
; 116  : 	
; 117  : 				// Setup the movement for the next frame
; 118  : 				//
; 119  : 				vel = distance / ((self->curWaypoint->GetWPArrivalTime() - SimLibElapsedTime) / SEC_TO_MSEC);
	...
	cvtsi2sd xmm0, DWORD PTR tv608[ebp]
	mov	edx, DWORD PTR tv608[ebp]
	shr	edx, 31					; 0000001fH
	addsd	xmm0, QWORD PTR __xmm@41f00000000000000000000000000000[edx*8]
	movsd	QWORD PTR tv611[ebp], xmm0
	cvtsd2ss xmm0, QWORD PTR tv611[ebp]
	movss	xmm1, DWORD PTR _distance$[ebp]
	divss	xmm1, xmm0
	movss	DWORD PTR _vel$[ebp], xmm1

; 120  : 	 		}
; 121  : 			else

	jmp	SHORT $LN7@Next_WayPo
$LN8@Next_WayPo:
...
; 124  : 		   		self->SetYPR ( 0.0F, 0.0F, 0.0F );
...
; 125  : 	  		}
; 126  : 
; 127  : 			// sfr: no setter on this anymore
; 128  : 			//self->SetVt ( vel );
; 129  : 			//self->SetKias ( vel * FTPSEC_TO_KNOTS);
; 130  : 
; 131  : 			// Set the movement deltas
; 132  : 			//
; 133  : 			self->SetDelta (	vel * (float)cos(self->Yaw()),
; 134  : 								vel * (float)sin(self->Yaw()), 0.0F);
...
; 135  : 			self->SetYPRDelta (0.0F, 0.0F, 0.0F);
...
; 138  : 	else if ( self->GetCampaignObject() )
...
; 139  : 	{
; 140  : 
; 141  : 		// Needs some changes here!
; 142  : 		// (MCC - UnitMove routines)
; 143  : 		// VP_changes this part should be modified
; 144  : 		theBattalion = (BattalionClass *)self->GetCampaignObject();

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+72]
	call	?GetCampaignObject@SimBaseClass@@QAEPAVCampBaseClass@@XZ ; SimBaseClass::GetCampaignObject
	mov	DWORD PTR _theBattalion$[ebp], eax

; 145  : 
; 146  : 		theBattalion->GetLocation ( &ox, &oy);

	lea	ecx, DWORD PTR _oy$[ebp]
	push	ecx
	lea	edx, DWORD PTR _ox$[ebp]
	push	edx
	mov	ecx, DWORD PTR _theBattalion$[ebp]
	call	?GetLocation@FalconEntity@@QBEXPAF0@Z	; FalconEntity::GetLocation

; 147  : 		self->SetPosition (	self->XPos() + (self->XDelta() * SimLibMajorFrameTime),
; 148  : 								self->YPos() + (self->YDelta() * SimLibMajorFrameTime),
; 149  : 								OTWDriver.GetGroundLevel(self->XPos(), self->YPos() )
; 150  : 								);
	...
	movss	xmm1, DWORD PTR tv758[ebp]
	addss	xmm1, xmm0
	push	ecx
	movss	DWORD PTR [esp], xmm1
	mov	ecx, DWORD PTR _this$[ebp]
...
; 151  : 		theBattalion->GetLocation ( &x, &y);
...
; 152  : 
; 153  : 		// Check if the vehicle hasn't moved
; 154  : 		// (recalculate the velocity to get some movement
; 155  : 		// - can be speed up)
; 156  : 		//
; 157  : 		if ( (ox != x) || (oy != y) )
...
; 158  : 		{
; 159  : 			dir = theBattalion->GetNextMoveDirection();
...
; 160  : 			if (dir >= 0)
	...
	jl	SHORT $LN2@Next_WayPo

; 161  : 			{
; 162  : 				self->SetYPR (45.0F * DTR * dir, 0.0F, 0.0F);
	...
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [esp], xmm0
	cvtsi2ss xmm0, DWORD PTR _dir$[ebp]
...
; 163  : 				vel = theBattalion->GetUnitSpeed() * KPH_TO_FPS ;

	mov	edx, DWORD PTR _theBattalion$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _theBattalion$[ebp]
...
; 165  : 			else
	...
	jmp	SHORT $LN1@Next_WayPo
$LN2@Next_WayPo:

; 166  : 			{
; 167  : 				self->SetYPR (0.0F, 0.0F, 0.0F);
...
; 171  : 			self->SetDelta (vel * trig.cos, vel * trig.sin, 0.0F);
...
; 172  : 			self->SetYPRDelta (0.0F, 0.0F, 0.0F);
...
; 173  : 		}
; 174  : 		waypoint = (WayPoint)&waypoint;	// MCC WARNING - this tells the AI code we 

	lea	edx, DWORD PTR _waypoint$[ebp]
	mov	DWORD PTR _waypoint$[ebp], edx
$LN5@Next_WayPo:

; 175  : 														// are still moving.....!!!!!!!!
; 176  : 	}
; 177  : 
; 178  : 	return ( waypoint );
...
; 179  : }
	...
	pop	ebp
	ret	0
?Next_WayPoint@GNDAIClass@@QAEPAVWayPointClass@@XZ ENDP	; GNDAIClass::Next_WayPoint
_TEXT	ENDS
; Function compile flags: /Odtp
