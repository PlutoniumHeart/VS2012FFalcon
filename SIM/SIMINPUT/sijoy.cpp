...
#pragma warning(default:4127)
		...
		case DI_OK:
			...
			{
			case DX_XAXIS:	theDeviceValue = joyState.lX; break;
			case DX_YAXIS:	theDeviceValue = joyState.lY; break;
			case DX_ZAXIS:	theDeviceValue = joyState.lZ; break;
			case DX_RXAXIS:	theDeviceValue = joyState.lRx; break;
			case DX_RYAXIS:	theDeviceValue = joyState.lRy; break;
			case DX_RZAXIS:	theDeviceValue = joyState.lRz; break;
			case DX_SLIDER0:	theDeviceValue = joyState.rglSlider[0]; break;
			case DX_SLIDER1:	theDeviceValue = joyState.rglSlider[1]; break;
			}
...
BOOL FAR PASCAL EnumDeviceObjects(LPCDIDEVICEOBJECTINSTANCE lpddoi, LPVOID pvRef)
{
	...
	switch (lpddoi->dwOfs)
	{
		case DIJOFS_X:				DIAxisNames[AxisCount].DXAxisID = DX_XAXIS; break;
		case DIJOFS_Y:				DIAxisNames[AxisCount].DXAxisID = DX_YAXIS; break;
		case DIJOFS_Z:				DIAxisNames[AxisCount].DXAxisID = DX_ZAXIS; break;
		case DIJOFS_RX:				DIAxisNames[AxisCount].DXAxisID = DX_RXAXIS; break;
		case DIJOFS_RY:				DIAxisNames[AxisCount].DXAxisID = DX_RYAXIS; break;
		case DIJOFS_RZ:				DIAxisNames[AxisCount].DXAxisID = DX_RZAXIS; break;
		case DIJOFS_SLIDER(0):		DIAxisNames[AxisCount].DXAxisID = DX_SLIDER0; break;
		case DIJOFS_SLIDER(1):		DIAxisNames[AxisCount].DXAxisID = DX_SLIDER1; break;	
	}
