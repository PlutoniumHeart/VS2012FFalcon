; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\MISSILE\Yaw.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Yaw@MissileClass@@AAEXXZ			; MissileClass::Yaw
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\yaw.cpp
_TEXT	SEGMENT
_betdt1$ = -60						; size = 4
_eintg$ = -56						; size = 4
_eprop$ = -52						; size = 4
...
_nycmd$ = -8						; size = 4
_this$ = -4						; size = 4
?Yaw@MissileClass@@AAEXXZ PROC				; MissileClass::Yaw
; _this$ = ecx
...
; 6    : float eintg,eprop,error, error1,eintg1,betdt1,betcmd;
; 7    : float nycmd;
; 8    : 
; 9    :  	if (!ifd)
...
; 11   : //me123 added the /1.41 which is approimatly sqrt(2)
; 12   : //total Gz^2 = yaw^2 +  pitch^2 so
; 13   : // yaw max = gZ/sqrt(2)
; 14   : // this is still not totaly true since it will be limited to less then max g only in the yaw direction, but better imo
; 15   :    nycmd = -ifd->augCommand.yaw;
...
; 17   : 	nycmd = min ( max (nycmd, -auxData->maxGNormal/1.41f), auxData->maxGNormal/1.41f);
	...
	movss	xmm1, DWORD PTR _nycmd$[ebp]
	comiss	xmm1, xmm0
	jbe	SHORT $LN8@Yaw
...
; 19   : 	nycmd = min ( max (nycmd, -auxData->maxGTerminal/1.41f), auxData->maxGTerminal/1.41f);
...
; 20   : 
; 21   :    /*-----------------------------*/
; 22   :    /* ny load factor loop closure */
; 23   :    /*-----------------------------*/
; 24   :    error1 = nycmd + ifd->nycgb;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	movss	xmm0, DWORD PTR _nycmd$[ebp]
	addss	xmm0, DWORD PTR [eax+860]
	movss	DWORD PTR _error1$[ebp], xmm0

; 25   :    error  = error1*ifd->ky05;
...
; 28   :    eintg  = Math.FITust(eintg1,SimLibMinorFrameTime,ifd->oldy02);
...
; 35   :    {
; 36   :       ifd->oldy02[0] = inputData->betmax;
	...
	mov	DWORD PTR [edx+ecx+640], eax

; 37   :       ifd->oldy02[1] = inputData->betmax;
...
; 38   :       ifd->oldy02[2] = 0.0;
	...
	movss	DWORD PTR [ecx+edx+640], xmm0
...
; 41   :    }   
; 42   : 
; 43   :    if(betcmd <= inputData->betmin)

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+848]
	movss	xmm0, DWORD PTR [eax+44]
	comiss	xmm0, DWORD PTR _betcmd$[ebp]
	jb	$LN1@Yaw

; 44   :    {
; 45   :       ifd->oldy02[0] = inputData->betmin;
...
; 46   :       ifd->oldy02[1] = inputData->betmin;
...
; 50   :    }
; 51   : 
; 52   :    beta   = Math.F7Tust(betcmd,ifd->ty02,ifd->ty03,ifd->ty04,SimLibMinorFrameTime,ifd->oldy03,&ifd->oldbet);
	...
	mov	edx, DWORD PTR _this$[ebp]
	fstp	DWORD PTR [edx+752]

; 53   :    betdt1 = Math.F8Tust(betcmd,ifd->ty02,ifd->ty03,ifd->ty04,SimLibMinorFrameTime,ifd->oldy04,&ifd->oldbetdt);
	...
	fstp	DWORD PTR _betdt1$[ebp]

; 54   :    ifd->betdot = betdt1*DTR;

	movss	xmm0, DWORD PTR _betdt1$[ebp]
...
; 55   : }
	...
	pop	ebp
	ret	0
?Yaw@MissileClass@@AAEXXZ ENDP				; MissileClass::Yaw
_TEXT	ENDS
; Function compile flags: /Odtp
