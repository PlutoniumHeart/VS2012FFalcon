; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\MISSILE\Apprch.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?ClosestApproach@MissileClass@@AAEXXZ		; MissileClass::ClosestApproach
...
_BSS	ENDS
;	COMDAT ?count@?BA@??ClosestApproach@MissileClass@@AAEXXZ@4HA
_BSS	SEGMENT
?count@?BA@??ClosestApproach@MissileClass@@AAEXXZ@4HA DD 01H DUP (?) ; `MissileClass::ClosestApproach'::`16'::count
_BSS	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\apprch.cpp
_TEXT	SEGMENT
tv377 = -84						; size = 4
tv389 = -80						; size = 4
tv408 = -76						; size = 4
...
?ClosestApproach@MissileClass@@AAEXXZ PROC		; MissileClass::ClosestApproach
; _this$ = ecx
...
; 12   : float newMin;
; 13   : 
; 14   : 	// Don't do proximity checking for surface to surface missiles, let them hit the ground
; 15   : 	if(GetSType() == STYPE_MISSILE_SURF_SURF)

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetSType@SimBaseClass@@QBEEXZ		; SimBaseClass::GetSType
	movzx	eax, al
	cmp	eax, 6
	jne	SHORT $LN8@ClosestApp
...
; 17   : 
; 18   :    if (targetPtr && range <= auxData->proximityfuserange && range >= 5.0F)
...
; 23   :       a.z = z;
	...
	movss	DWORD PTR _a$[ebp+8], xmm0

; 24   :       b.x = xdot * SimLibMajorFrameTime;
...
; 25   :       b.y = ydot * SimLibMajorFrameTime;
...
; 26   :       b.z = zdot * SimLibMajorFrameTime;
...
; 27   :       c.x = targetPtr->BaseData()->XPos();
...
; 28   :       c.y = targetPtr->BaseData()->YPos();
...
; 29   :       c.z = targetPtr->BaseData()->ZPos();
...
; 30   :       d.x = (targetPtr->BaseData()->XDelta() + 0.5F) * SimLibMajorFrameTime;
...
; 31   :       d.y = targetPtr->BaseData()->YDelta() * SimLibMajorFrameTime;
...
; 32   :       d.z = targetPtr->BaseData()->ZDelta() * SimLibMajorFrameTime;
...
; 33   : 
; 34   : 	  if (targetPtr->BaseData()->IsCampaign()) {
	...
	test	eax, eax
	je	SHORT $LN6@ClosestApp

; 35   : 		  // To save time, we're using the appoximate ground level at the target's location.
; 36   : 		  // This will potentially introduce some error in the ultimate impact point, but should be acceptable.
; 37   : 		  // We have to make this corection since all campaign entities store
; 38   : 		  // their z position as "AGL" instead of world space height above sea level.
; 39   : 		  c.z += OTWDriver.GetApproxGroundLevel( targetPtr->BaseData()->XPos(), targetPtr->BaseData()->YPos() );
...
; 40   : 
; 41   : 		  // Could probably also just use "groundZ" since we're close to the target at this point...
; 42   : 	  }
; 43   : 	  
; 44   :       newMin = FindMinDistance(&a, &b, &c, &d);
	...
	fstp	DWORD PTR _newMin$[ebp]

; 45   :       if (newMin > 1.2F * ricept)

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f99999a
	mulss	xmm0, DWORD PTR [ecx+980]
	movss	xmm1, DWORD PTR _newMin$[ebp]
	comiss	xmm1, xmm0
	jbe	SHORT $LN5@ClosestApp

; 46   :          flags |= ClosestApprch;
...
; 47   :       ricept = min (newMin, ricept);

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+980]
	comiss	xmm0, DWORD PTR _newMin$[ebp]
	jbe	SHORT $LN11@ClosestApp
	movss	xmm0, DWORD PTR _newMin$[ebp]
	movss	DWORD PTR tv270[ebp], xmm0
	jmp	SHORT $LN12@ClosestApp
$LN11@ClosestApp:
	mov	eax, DWORD PTR _this$[ebp]
...
; 48   :    }
; 49   :    else if ( auxData && range <= auxData->proximityfuserange ) 

	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+860], 0
	je	SHORT $LN3@ClosestApp
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+860]
	cvtsi2ss xmm0, DWORD PTR [ecx+64]
	mov	edx, DWORD PTR _this$[ebp]
	comiss	xmm0, DWORD PTR [edx+984]
	jb	SHORT $LN3@ClosestApp

; 50   :    { static int count = 0;
; 51   : 	  if (rand()%100 < auxData->ProximityfuseChange)
	...
	comiss	xmm1, xmm0
	jbe	SHORT $LN2@ClosestApp

; 52   : 	  {
; 53   : 		  flags |= ClosestApprch;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+864]
	or	edx, 2
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+864], edx
$LN2@ClosestApp:

; 54   : 	  }
; 55   : 	  count++;

	mov	ecx, DWORD PTR ?count@?BA@??ClosestApproach@MissileClass@@AAEXXZ@4HA
	add	ecx, 1
	mov	DWORD PTR ?count@?BA@??ClosestApproach@MissileClass@@AAEXXZ@4HA, ecx

; 56   :    }
; 57   :    else

	jmp	SHORT $LN1@ClosestApp
$LN3@ClosestApp:

; 58   :    {
; 59   :       ricept = min (range, ricept);

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax+980]
	comiss	xmm0, DWORD PTR [edx+984]
	jbe	SHORT $LN13@ClosestApp
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+984]
	movss	DWORD PTR tv298[ebp], xmm0
	jmp	SHORT $LN14@ClosestApp
$LN13@ClosestApp:
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+980]
	movss	DWORD PTR tv298[ebp], xmm0
...
; 61   : }
	...
	pop	ebp
	ret	0
?ClosestApproach@MissileClass@@AAEXXZ ENDP		; MissileClass::ClosestApproach
_TEXT	ENDS
; Function compile flags: /Odtp
