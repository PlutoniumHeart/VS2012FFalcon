; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\MISSILE\Atmos.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Atmosphere@MissileClass@@AAEXXZ		; MissileClass::Atmosphere
...
CONST	ENDS
;	COMDAT __real@46a28ea4
CONST	SEGMENT
__real@46a28ea4 DD 046a28ea4r			; 20807.3
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\atmos.cpp
_TEXT	SEGMENT
_catchx$1 = -44						; size = 4
tv248 = -40						; size = 4
tv281 = -36						; size = 4
...
_ttheta$ = -8						; size = 4
_this$ = -4						; size = 4
?Atmosphere@MissileClass@@AAEXXZ PROC			; MissileClass::Atmosphere
; _this$ = ecx
...
; 6    : float ttheta;     /* Temp Ratio */
; 7    : float rsigma;     /* Density Ration */
; 8    : float pdelta;     /* Pressure Delta */
; 9    : float sound;      /* Speed of sound at altitude */
; 10   : 
; 11   :    /*-----------------------------------------------*/
; 12   :    /* calculate temperature ratio and density ratio */
; 13   :    /*-----------------------------------------------*/
; 14   :    if (alt <= 36089.0F)

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@470cf900
	comiss	xmm0, DWORD PTR [eax+768]
	jb	SHORT $LN9@Atmosphere

; 15   :    {   
; 16   :       ttheta = 1.0F - 0.000006875F*alt;
...
; 17   :       rsigma = (float)pow (ttheta,4.256F);
...
; 22   :       rsigma = 0.2971F*(float)exp((36089.0F - alt)/20807.32F);

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@470cf900
	subss	xmm0, DWORD PTR [edx+768]
	divss	xmm0, DWORD PTR __real@46a28ea4
	push	ecx
	movss	DWORD PTR [esp], xmm0
	call	?exp@@YAMM@Z				; exp
	add	esp, 4
...
; 24   : 
; 25   :    /*------------------------------*/
; 26   :    /* Density, Pressure, Temp, SOS */
; 27   :    /*------------------------------*/
; 28   :    pdelta = ttheta*rsigma;

	movss	xmm0, DWORD PTR _ttheta$[ebp]
	mulss	xmm0, DWORD PTR _rsigma$[ebp]
	movss	DWORD PTR _pdelta$[ebp], xmm0

; 29   :    sound  = AASL*(float)sqrt(ttheta);
...
; 30   :    rho    = RHOASL*rsigma;

	movss	xmm0, DWORD PTR __real@3b1bc5c4
	mulss	xmm0, DWORD PTR _rsigma$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+892], xmm0

; 31   :    ps     = PASL*pdelta;

	movss	xmm0, DWORD PTR __real@45044385
	mulss	xmm0, DWORD PTR _pdelta$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [ecx+896], xmm0

; 32   :            
; 33   :    /*-----------------------------*/
; 34   :    /* calculate dynamic pressure  */
; 35   :    /*-----------------------------*/
; 36   :    //Cobra TJL We have a problem of VT being 0.0000.  Using the same methodology as AirframeClass Atmos
; 37   :    //I will do a sanity check on VT and subsequent code
; 38   :    if (fabs(vt)>1)
...
; 40   :    mach   = vt/sound;
	...
	divss	xmm0, DWORD PTR _sound$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [ecx+888], xmm0

; 41   : 	 if (ifd) // JB 010718 CTD

	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+988], 0
	je	SHORT $LN6@Atmosphere

; 42   : 	   ifd->qbar   = 0.5F*rho*vt*vt;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f000000
	mulss	xmm0, DWORD PTR [eax+892]
	mov	ecx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [ecx+880]
	mov	edx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [edx+880]
	mov	eax, DWORD PTR _this$[ebp]
...
; 43   : 
; 44   :    /*------------------------------------------------------------------*/
; 45   :    /* calculate equivalent and calibrated airspeed and impact pressure */
; 46   :    /*------------------------------------------------------------------*/
; 47   :    vcas = FTPSEC_TO_KNOTS*vt*(float)sqrt(rsigma);

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f17ac60
	mulss	xmm0, DWORD PTR [edx+880]
	push	ecx
	movss	xmm1, DWORD PTR _rsigma$[ebp]
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+900], xmm0

; 48   : 
; 49   : 	 if (!ifd) // JB 010718 CTD

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+988], 0
	jne	SHORT $LN5@Atmosphere
...
; 51   : 
; 52   :    /*------------------------*/
; 53   :    /* normalizing parameters */
; 54   :    /*------------------------*/
; 55   : 	 if (mass && !F4IsBadReadPtr(inputData, sizeof(MissileInputData))) // JB 010317 CTD
	...
	movzx	edx, al
	test	edx, edx
	jne	SHORT $LN4@Atmosphere

; 56   : 		ifd->qsom = ifd->qbar*inputData->area/mass;
...
; 57   : 
; 58   :    ifd->qovt = ifd->qbar/vt;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+768]
	divss	xmm0, DWORD PTR [eax+880]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	DWORD PTR [edx+764], xmm0

; 59   :    if (_isnan(ifd->qovt))//Cobra

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	cvtss2sd xmm0, DWORD PTR [ecx+764]
	sub	esp, 8
...
; 72   : } 
	...
	pop	ebp
	ret	0
?Atmosphere@MissileClass@@AAEXXZ ENDP			; MissileClass::Atmosphere
_TEXT	ENDS
; Function compile flags: /Odtp
