; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\MISSILE\Launch.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?SetLaunchPosition@MissileClass@@QAEXMMM@Z	; MissileClass::SetLaunchPosition
PUBLIC	?SetLaunchData@MissileClass@@QAEXXZ		; MissileClass::SetLaunchData
PUBLIC	?Launch@MissileClass@@AAEXXZ			; MissileClass::Launch
...
EXTRN	?Aerodynamics@MissileClass@@AAEXXZ:PROC		; MissileClass::Aerodynamics
EXTRN	?Atmosphere@MissileClass@@AAEXXZ:PROC		; MissileClass::Atmosphere
EXTRN	?Engine@MissileClass@@AAEXXZ:PROC		; MissileClass::Engine
EXTRN	?Init2@MissileClass@@AAEXXZ:PROC		; MissileClass::Init2
...
EXTRN	?misPos@@3UACMIMissilePositionRecord@@A:BYTE	; misPos
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\launch.cpp
_TEXT	SEGMENT
$T1 = -112						; size = 8
tv708 = -104						; size = 8
tv724 = -96						; size = 8
...
?Launch@MissileClass@@AAEXXZ PROC			; MissileClass::Launch
; _this$ = ecx
...
; 25   : float ubody, vbody, wbody; /* Body axis forces */
; 26   : float xbreak;              /* x force needed to begin moving on rail */
; 27   : float xforce, deltu, deltx;
; 28   : mlTrig trigAlpha, trigBeta;
; 29   : 
; 30   : 
; 31   :    /*--------------------------------*/
; 32   :    /* pass aircraft state to missile */ 
; 33   :    /*--------------------------------*/
; 34   :    SetLaunchData();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetLaunchData@MissileClass@@QAEXXZ	; MissileClass::SetLaunchData
...
; 38   : 
; 39   : 	//MI CTD?
; 40   : 	ShiAssert(FALSE==F4IsBadReadPtr(ifd, sizeof *ifd));
; 41   : 
; 42   :    /*--------------------------------*/
; 43   :    /* missile velocity during launch */
; 44   :    /*--------------------------------*/
; 45   :    mlSinCos (&trigAlpha, alpha*DTR);
	...
	lea	edx, DWORD PTR _trigAlpha$[ebp]
	push	edx
	call	?mlSinCos@@YAXPAUmlTrig@@M@Z		; mlSinCos
	add	esp, 8

; 46   :    mlSinCos (&trigBeta,  beta*DTR);
...
; 47   : 
; 48   :    ubody = vt*trigAlpha.cos * trigBeta.cos +
; 49   :            q*initZLoc - r*initYLoc + (float)ifd->olddu[1];

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+880]
	mulss	xmm0, DWORD PTR _trigAlpha$[ebp+4]
	mulss	xmm0, DWORD PTR _trigBeta$[ebp+4]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [eax+968]
	mulss	xmm1, DWORD PTR [ecx+936]
	addss	xmm0, xmm1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [edx+972]
	mulss	xmm1, DWORD PTR [eax+932]
	subss	xmm0, xmm1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	mov	eax, 4
	shl	eax, 0
	addss	xmm0, DWORD PTR [edx+eax+472]
	movss	DWORD PTR _ubody$[ebp], xmm0

; 50   : 
; 51   :    vbody = vt*trigBeta.sin + r*initXLoc -
; 52   :            p*initZLoc;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+880]
	mulss	xmm0, DWORD PTR _trigBeta$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [edx+972]
	mulss	xmm1, DWORD PTR [eax+928]
	addss	xmm0, xmm1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+964]
	mulss	xmm1, DWORD PTR [edx+936]
	subss	xmm0, xmm1
	movss	DWORD PTR _vbody$[ebp], xmm0

; 53   : 
; 54   :    wbody = vt*trigAlpha.sin * trigBeta.cos +
; 55   :            p*initYLoc - q*initXLoc;
	...
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+964]
	mulss	xmm1, DWORD PTR [edx+932]
	addss	xmm0, xmm1
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [eax+968]
	mulss	xmm1, DWORD PTR [ecx+928]
	subss	xmm0, xmm1
	movss	DWORD PTR _wbody$[ebp], xmm0

; 56   : 
; 57   :    vt    = ubody*ubody + wbody*wbody;

	movss	xmm0, DWORD PTR _ubody$[ebp]
	mulss	xmm0, DWORD PTR _ubody$[ebp]
	movss	xmm1, DWORD PTR _wbody$[ebp]
	mulss	xmm1, DWORD PTR _wbody$[ebp]
	addss	xmm0, xmm1
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+880], xmm0

; 58   : 
; 59   :    alpha = (float)atan2(wbody, ubody)*RTD;

	cvtss2sd xmm0, DWORD PTR _ubody$[ebp]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	cvtss2sd xmm0, DWORD PTR _wbody$[ebp]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
...
; 61   :    if (vt > 1.0F)
	...
	jbe	SHORT $LN6@Launch

; 62   :       beta = (float)atan2(vbody,sqrt(vt))*RTD;
	...
	add	esp, -4					; fffffffcH
	fstp	QWORD PTR [esp]
	cvtss2sd xmm0, DWORD PTR _vbody$[ebp]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	call	?checked_atan2@@YANNN@Z			; checked_atan2
	add	esp, 16					; 00000010H
	fstp	QWORD PTR tv724[ebp]
...
; 65   : 
; 66   :    vt    = (float)sqrt(vt + vbody*vbody);

	movss	xmm0, DWORD PTR _vbody$[ebp]
	mulss	xmm0, DWORD PTR _vbody$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	addss	xmm0, DWORD PTR [edx+880]
	push	ecx
	movss	DWORD PTR [esp], xmm0
	call	?SqrtSSE@@YAMM@Z			; SqrtSSE
	add	esp, 4
...
; 67   : 
; 68   :    /*----------------------------*/
; 69   :    /* aero and propulsive forces */
; 70   :    /*----------------------------*/
; 71   :  
; 72   :    Atmosphere();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?Atmosphere@MissileClass@@AAEXXZ	; MissileClass::Atmosphere
...
; 74   :    Aerodynamics();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Aerodynamics@MissileClass@@AAEXXZ	; MissileClass::Aerodynamics

; 75   :    Engine();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?Engine@MissileClass@@AAEXXZ		; MissileClass::Engine

; 76   : 
; 77   :    /*-------------------------------*/
; 78   :    /* force breakout on launch rail */
; 79   :    /*-------------------------------*/
; 80   :    xforce = ifd->xaero + ifd->xprop;
	...
	movss	DWORD PTR _xforce$[ebp], xmm0

; 81   :    xbreak = 200.0F/(m0 + mp0);

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+832]
	addss	xmm0, DWORD PTR [eax+836]
	movss	xmm1, DWORD PTR __real@43480000
	divss	xmm1, xmm0
	movss	DWORD PTR _xbreak$[ebp], xmm1

; 82   :    if(xforce <= xbreak)

	movss	xmm0, DWORD PTR _xbreak$[ebp]
	comiss	xmm0, DWORD PTR _xforce$[ebp]
	jb	SHORT $LN4@Launch
...
; 86   : 
; 87   :    /*--------------------------------------------*/
; 88   :    /* increment in forward velocity and position */
; 89   :    /*--------------------------------------------*/
; 90   :    deltu = Math.FITust(xforce,SimLibMinorFrameTime,ifd->olddu);
	...
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _xforce$[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	ecx, OFFSET ?Math@@3VSIMLIB_MATH_CLASS@@A ; Math
	call	?FITust@SIMLIB_MATH_CLASS@@QAEMMMQAM@Z	; SIMLIB_MATH_CLASS::FITust
	fstp	DWORD PTR _deltu$[ebp]

; 91   :    deltx = Math.FITust(deltu ,SimLibMinorFrameTime,ifd->olddx);
	...
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _deltu$[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	ecx, OFFSET ?Math@@3VSIMLIB_MATH_CLASS@@A ; Math
	call	?FITust@SIMLIB_MATH_CLASS@@QAEMMMQAM@Z	; SIMLIB_MATH_CLASS::FITust
	fstp	DWORD PTR _deltx$[ebp]

; 92   : 
; 93   :    /*-------------------*/
; 94   :    /* earth coordinates */
; 95   :    /*-------------------*/
; 96   :    xdot =  vt*ifd->geomData.cosgam*ifd->geomData.cossig;
...
; 97   :    ydot =  vt*ifd->geomData.cosgam*ifd->geomData.sinsig;
...
; 98   :    zdot = -vt*ifd->geomData.singam;
...
; 100  : 
; 101  :    /*---------------------------------------------------*/
; 102  :    /* applied body axis accels on missile during launch */
; 103  :    /*---------------------------------------------------*/
; 104  :    ifd->nxcgb  = ifd->nxcgb + (xforce - initXLoc*(q*q + r*r) +
; 105  :               initYLoc*(p*q) + initZLoc*(p*r))/GRAVITY;
	...
	mulss	xmm0, DWORD PTR [edx+968]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+972]
	mulss	xmm1, DWORD PTR [edx+972]
	addss	xmm0, xmm1
	mov	ecx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [ecx+928]
	movss	xmm1, DWORD PTR _xforce$[ebp]
	subss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+964]
	mulss	xmm0, DWORD PTR [ecx+968]
	mov	edx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [edx+932]
	addss	xmm1, xmm0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+964]
	mulss	xmm0, DWORD PTR [edx+972]
	mov	ecx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [ecx+936]
	addss	xmm1, xmm0
	divss	xmm1, DWORD PTR __real@4200b53f
	addss	xmm1, DWORD PTR [eax+856]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	movss	DWORD PTR [eax+856], xmm1

; 106  : 
; 107  :    ifd->nycgb  = ifd->nycgb + (initXLoc*(p*q) - initYLoc*(r*r +
; 108  :             p*p) + initZLoc*(q*r))/GRAVITY;
	...
	mulss	xmm0, DWORD PTR [ecx+968]
	mov	eax, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [eax+928]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+972]
	mulss	xmm1, DWORD PTR [eax+972]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm2, DWORD PTR [ecx+964]
	mulss	xmm2, DWORD PTR [eax+964]
	addss	xmm1, xmm2
	mov	ecx, DWORD PTR _this$[ebp]
	mulss	xmm1, DWORD PTR [ecx+932]
	subss	xmm0, xmm1
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [eax+968]
	mulss	xmm1, DWORD PTR [ecx+972]
	mov	eax, DWORD PTR _this$[ebp]
	mulss	xmm1, DWORD PTR [eax+936]
	addss	xmm0, xmm1
	divss	xmm0, DWORD PTR __real@4200b53f
	addss	xmm0, DWORD PTR [edx+860]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	DWORD PTR [edx+860], xmm0

; 109  : 
; 110  :    ifd->nzcgb  = ifd->nzcgb + (initZLoc*(q*q + p*p) - initXLoc*(r*p) -
; 111  :             initYLoc*(q*r))/GRAVITY;
	...
	mulss	xmm0, DWORD PTR [eax+968]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [edx+964]
	mulss	xmm1, DWORD PTR [eax+964]
	addss	xmm0, xmm1
	mov	edx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [edx+936]
	mov	eax, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [eax+972]
	mulss	xmm1, DWORD PTR [edx+964]
	mov	eax, DWORD PTR _this$[ebp]
	mulss	xmm1, DWORD PTR [eax+928]
	subss	xmm0, xmm1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [edx+968]
	mulss	xmm1, DWORD PTR [eax+972]
	mov	edx, DWORD PTR _this$[ebp]
	mulss	xmm1, DWORD PTR [edx+932]
	subss	xmm0, xmm1
	divss	xmm0, DWORD PTR __real@4200b53f
	addss	xmm0, DWORD PTR [ecx+864]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
...
; 112  : 
; 113  :    /*-------------------------------*/
; 114  :    /* applied stability axis accels */
; 115  :    /*-------------------------------*/
; 116  :    ifd->nxcgs  = ifd->nxcgb*ifd->geomData.cosalp - ifd->nzcgb*ifd->geomData.sinalp;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	xmm0, DWORD PTR [eax+856]
	mulss	xmm0, DWORD PTR [edx+128]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	movss	xmm1, DWORD PTR [ecx+864]
	mulss	xmm1, DWORD PTR [eax+124]
	subss	xmm0, xmm1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	DWORD PTR [edx+868], xmm0

; 117  :    ifd->nycgs  = ifd->nycgb;
...
; 118  :    ifd->nzcgs  = ifd->nzcgb*ifd->geomData.cosalp + ifd->nxcgb*ifd->geomData.sinalp;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	xmm0, DWORD PTR [eax+864]
	mulss	xmm0, DWORD PTR [edx+128]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	movss	xmm1, DWORD PTR [ecx+856]
	mulss	xmm1, DWORD PTR [eax+124]
	addss	xmm0, xmm1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
...
; 119  : 
; 120  :    /*------------------*/
; 121  :    /* wind axis accels */
; 122  :    /*------------------*/
; 123  :    ifd->nxcgw  =  ifd->nxcgs*ifd->geomData.cosbet + ifd->nycgs*ifd->geomData.sinbet;
...
; 124  :    ifd->nycgw  = -ifd->nxcgs*ifd->geomData.sinbet + ifd->nycgs*ifd->geomData.cosbet;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	xmm1, DWORD PTR [eax+872]
	mulss	xmm1, DWORD PTR [edx+140]
	addss	xmm0, xmm1
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	movss	DWORD PTR [ecx+848], xmm0

; 125  :    ifd->nzcgw  =  ifd->nzcgs;
...
; 128  :    /* velocity vector */
; 129  :    /*-----------------*/
; 130  :    vtdot  = GRAVITY*(ifd->nxcgw - ifd->geomData.singam);
...
; 131  :    //Cobra TJL we are div 0 here because of VT being 0.0000
; 132  :    //I will set VT if 0.000
; 133  :    if (vt == 0.0f)
...
; 135  : 
; 136  :    ifd->alpdot = q - (p*ifd->geomData.cosalp + r*ifd->geomData.sinalp)*ifd->geomData.tanbet - GRAVITY*(ifd->nzcgw -
; 137  :             ifd->geomData.cosgam*ifd->geomData.cosmu)/(vt*ifd->geomData.cosbet);
	...
	mulss	xmm0, DWORD PTR [ecx+168]
	movss	xmm2, DWORD PTR [eax+852]
	subss	xmm2, xmm0
	mulss	xmm2, DWORD PTR __real@4200b53f
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+880]
...
; 138  : 
; 139  :    ifd->betdot = p*ifd->geomData.sinalp - r*ifd->geomData.cosalp + GRAVITY *
; 140  :             (ifd->nycgw + ifd->geomData.cosgam*ifd->geomData.sinmu)/vt;
	...
	mulss	xmm1, DWORD PTR [eax+164]
	addss	xmm1, DWORD PTR [edx+848]
	mulss	xmm1, DWORD PTR __real@4200b53f
	mov	ecx, DWORD PTR _this$[ebp]
	divss	xmm1, DWORD PTR [ecx+880]
	addss	xmm0, xmm1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
...
; 141  : 
; 142  :    /*--------------------------------*/
; 143  :    /* test for free flight condition */ 
; 144  :    /*--------------------------------*/
; 145  :    
; 146  :    //if(deltx > 0.6667*inputData->length)  // MLR 1/5/2005 - Uh, Why?  This causes the missles to lag behind the a/c
; 147  :    {
; 148  : 	  
; 149  :       launchState = InFlight;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+724], 2

; 150  : 	  Init2();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?Init2@MissileClass@@AAEXXZ		; MissileClass::Init2

; 151  : 
; 152  : 	  // missile launch effect
; 153  : 	  Tpoint pos, vec;
; 154  : 	 
; 155  : 	  pos.x = x;
...
; 158  : 
; 159  : 	  
; 160  : 	  // test for drawpointer because we may be calling this
; 161  : 	  // via FindRocketGroundImpact
; 162  : 	  // MLR - drawPointer is valid due to a bug somewhere else
; 163  : 	  //       added FindingImpact flag
; 164  : 	  if ( drawPointer && !(flags & FindingImpact))
...
; 165  : 	  {
; 166  : 
; 167  : 		  // MLR - Note - this is causing the smoke trail when rockets are selected.
; 168  : 		  //RV I-Hawk this is a missile launch event so
; 169  : 		  //changed type from LIGHT_CLOUD to MISSILE_LAUNCH
; 170  : 		  /*
; 171  : 		  OTWDriver.AddSfxRequest(
; 172  : 				new SfxClass ( SFX_MISSILE_LAUNCH,		// type
; 173  : 				0,
; 174  : 				&pos,					// world pos
; 175  : 				&vec,					// vel vector
; 176  : 				5.3F,					// time to live
; 177  : 				5.0f ) );				// scale
; 178  : 				*/
; 179  : 		  DrawableParticleSys::PS_AddParticleEx((SFX_MISSILE_LAUNCH + 1),
; 180  : 												&pos,
; 181  : 												&vec);
...
; 185  : 			{
; 186  : 				misPos.hdr.time = SimLibElapsedTime * MSEC_TO_SEC + OTWDriver.todOffset;

	mov	ecx, DWORD PTR ?SimLibElapsedTime@@3KA	; SimLibElapsedTime
	mov	DWORD PTR tv931[ebp], ecx
	cvtsi2sd xmm0, DWORD PTR tv931[ebp]
	mov	edx, DWORD PTR tv931[ebp]
	shr	edx, 31					; 0000001fH
	addsd	xmm0, QWORD PTR __xmm@41f00000000000000000000000000000[edx*8]
	movsd	QWORD PTR tv935[ebp], xmm0
	cvtsd2ss xmm0, QWORD PTR tv935[ebp]
...
; 188  : 				misPos.data.uniqueID = ACMIIDTable->Add(Id(),NULL,TeamInfo[GetTeam()]->GetColor());//.num_;
...
; 189  : 				misPos.data.x = x;
	...
	movss	DWORD PTR ?misPos@@3UACMIMissilePositionRecord@@A+13, xmm0

; 190  : 				misPos.data.y = y;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+760]
	movss	DWORD PTR ?misPos@@3UACMIMissilePositionRecord@@A+17, xmm0

; 191  : 				misPos.data.z = z;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+764]
	movss	DWORD PTR ?misPos@@3UACMIMissilePositionRecord@@A+21, xmm0

; 192  : 				misPos.data.roll = phi;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax+788]
	movss	DWORD PTR ?misPos@@3UACMIMissilePositionRecord@@A+33, xmm0

; 193  : 				misPos.data.pitch = theta;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+784]
	movss	DWORD PTR ?misPos@@3UACMIMissilePositionRecord@@A+29, xmm0

; 194  : 				misPos.data.yaw = psi;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+792]
	movss	DWORD PTR ?misPos@@3UACMIMissilePositionRecord@@A+25, xmm0

; 195  : // remove				misPos.data.teamColor = TeamInfo[GetTeam()]->GetColor();
; 196  : 
; 197  : 				gACMIRec.MissilePositionRecord( &misPos );
...
; 202  : }
	...
	pop	ebp
	ret	0
?Launch@MissileClass@@AAEXXZ ENDP			; MissileClass::Launch
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\launch.cpp
_TEXT	SEGMENT
...
tv319 = -28						; size = 4
tv229 = -24						; size = 4
_disp_az$2 = -20					; size = 4
_disp_el$3 = -16					; size = 4
tv73 = -12						; size = 4
_pv$4 = -8						; size = 4
_this$ = -4						; size = 4
?SetLaunchData@MissileClass@@QAEXXZ PROC		; MissileClass::SetLaunchData
; _this$ = ecx
...
; 206  : 	vt    = parent->GetVt();
	...
	call	eax
	mov	ecx, DWORD PTR _this$[ebp]
	fstp	DWORD PTR [ecx+880]

; 207  : 
; 208  : 	if (parent && parent->IsSim()){
...
; 209  : 		SimBaseClass *ptr = (SimBaseClass*)parent.get();
...
; 210  : 
; 211  : 		// Transform position from parent's object space into world space
; 212  : 		//      x = parent->XPos() + ptr->dmx[0][0]*initXLoc + ptr->dmx[1][0]*initYLoc + ptr->dmx[2][0]*initZLoc;
; 213  : 		//      y = parent->YPos() + ptr->dmx[0][1]*initXLoc + ptr->dmx[1][1]*initYLoc + ptr->dmx[2][1]*initZLoc;
; 214  : 		//      z = parent->ZPos() + ptr->dmx[0][2]*initXLoc + ptr->dmx[1][2]*initYLoc + ptr->dmx[2][2]*initZLoc;
; 215  : 		x=XPos();
...
; 218  : 
; 219  : 		// Cobra - removed - fixed missile launching through the wing
; 220  : 		//	  xdot=XDelta();
; 221  : 		//	  ydot=YDelta();
; 222  : 		//	  zdot=ZDelta();
; 223  : 
; 224  : 		float disp_az,disp_el; // MLR 1/17/2004 - Added random dispersion
; 225  : 		if(flags && FindingImpact){   

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+864], 0
	je	SHORT $LN6@SetLaunchD
	mov	ecx, 8
	test	ecx, ecx
	je	SHORT $LN6@SetLaunchD

; 226  : 			// MLR - if we are computing the Impact Point, don't randomize the azimuth & elevation, 
; 227  : 			// MLR - or the HUD's impact predictor jumps around wildly
; 228  : 			disp_az=0;

	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR _disp_az$2[ebp], xmm0

; 229  : 			disp_el=0;

	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR _disp_el$3[ebp], xmm0

; 230  : 		}
; 231  : 		else {

	jmp	SHORT $LN5@SetLaunchD
$LN6@SetLaunchD:

; 232  : 			// MLR it's not so much a cone, as it is a 4 sided pyramid :)
; 233  : 			disp_az=((float)rand()/RAND_MAX - 0.5f) * auxData->rocketDispersionConeAngle / 180.0f * 3.14159f;
	...
	mulss	xmm0, DWORD PTR __real@40490fd0
	movss	DWORD PTR _disp_az$2[ebp], xmm0

; 234  : 			disp_el=((float)rand()/RAND_MAX - 0.5f) * auxData->rocketDispersionConeAngle / 180.0f * 3.14159f ;
...
; 235  : 		}
; 236  : 
; 237  : 		SimVehicleClass *pv = static_cast<SimVehicleClass*>(parent.get());
...
; 238  : 		theta = pv->Pitch() + initEl + disp_el; // MLR 1/18/2004 - added disp_el

	mov	ecx, DWORD PTR _pv$4[ebp]
	call	?Pitch@VuEntity@@QBEMXZ			; VuEntity::Pitch
	fstp	DWORD PTR tv500[ebp]
	movss	xmm0, DWORD PTR tv500[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	addss	xmm0, DWORD PTR [eax+944]
	addss	xmm0, DWORD PTR _disp_el$3[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 240  : 		psi   = pv->Yaw() + initAz + disp_az; // MLR 1/18/2004 - added disp_az
	...
	mov	eax, DWORD PTR _this$[ebp]
	addss	xmm0, DWORD PTR [eax+940]
	addss	xmm0, DWORD PTR _disp_az$2[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [ecx+792], xmm0

; 241  : 		// M.N. add vt > 200.0F check fixes hovering helicopters firing missiles not going ballistic
; 242  : 		if ( !parent->OnGround() && vt > 200.0F){
...
; 245  : 			r     = pv->GetR();
	...
	call	eax
	mov	ecx, DWORD PTR _this$[ebp]
	fstp	DWORD PTR [ecx+972]

; 246  : 			ifd->nxcgb = pv->GetNx();
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	fstp	DWORD PTR [ecx+856]

; 247  : 			ifd->nycgb = pv->GetNy();
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	fstp	DWORD PTR [ecx+860]

; 248  : 			ifd->nzcgb = pv->GetNz();
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	fstp	DWORD PTR [ecx+864]

; 249  : 			//alpha = 0; //((SimVehicleClass*)parent)->GetAlpha(); // MLR 5/30/2004 - 
; 250  : 			//beta  = 0; //((SimVehicleClass*)parent)->GetBeta(); // MLR 5/30/2004 - 
; 251  : 			alpha = pv->GetAlpha();
...
; 255  : 				alpha *= parent->GetKias() / 250.0F;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mulss	xmm0, DWORD PTR [ecx+744]
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+744], xmm0

; 256  : 				q *= parent->GetKias() / 250.0F;
...
; 260  : 			// edg: give ground launched missiles some extra oomph at
; 261  : 			// launch since this seems to cause problems
; 262  : 			vt = 200.0f;
...
; 274  : 		// Use parent's world space position corrected for terrain height
; 275  : 		x = parent->XPos();
...
; 277  : 		z = parent->ZPos() + OTWDriver.GetGroundLevel( x, y );
	...
	mov	edx, DWORD PTR _this$[ebp]
	push	ecx
	movss	xmm1, DWORD PTR [edx+760]
	movss	DWORD PTR [esp], xmm1
	mov	eax, DWORD PTR _this$[ebp]
	push	ecx
	movss	xmm1, DWORD PTR [eax+756]
	movss	DWORD PTR [esp], xmm1
	mov	ecx, OFFSET ?OTWDriver@@3VOTWDriverClass@@A ; OTWDriver
	movss	DWORD PTR tv661[ebp], xmm0
	...
	addss	xmm0, DWORD PTR tv633[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 283  : 		q     = 0.0F;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+968], xmm0

; 284  : 		r     = 0.0F;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [edx+972], xmm0
...
; 291  : }
	...
	pop	ebp
	ret	0
?SetLaunchData@MissileClass@@QAEXXZ ENDP		; MissileClass::SetLaunchData
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\launch.cpp
_TEXT	SEGMENT
...
_ny$ = 12						; size = 4
_nz$ = 16						; size = 4
?SetLaunchPosition@MissileClass@@QAEXMMM@Z PROC		; MissileClass::SetLaunchPosition
; _this$ = ecx
...
; 14   :     SimBaseClass *ptr = (SimBaseClass*)parent.get();
...
; 15   : 
; 16   :     x = parent->XPos() + ptr->dmx[0][0]*nx + ptr->dmx[1][0]*ny + ptr->dmx[2][0]*nz;
	...
	addss	xmm0, xmm1
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+756], xmm0

; 17   :     y = parent->YPos() + ptr->dmx[0][1]*nx + ptr->dmx[1][1]*ny + ptr->dmx[2][1]*nz;
...
; 18   :     z = parent->ZPos() + ptr->dmx[0][2]*nx + ptr->dmx[1][2]*ny + ptr->dmx[2][2]*nz;
...
; 20   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?SetLaunchPosition@MissileClass@@QAEXMMM@Z ENDP		; MissileClass::SetLaunchPosition
_TEXT	ENDS
; Function compile flags: /Odtp
