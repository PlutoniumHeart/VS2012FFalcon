; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\MISSILE\Gains.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Gains@MissileClass@@AAEXXZ			; MissileClass::Gains
...
CONST	ENDS
;	COMDAT __real@400570a4
CONST	SEGMENT
__real@400570a4 DD 0400570a4r			; 2.085
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\missile\gains.cpp
_TEXT	SEGMENT
tv633 = -76						; size = 4
_yradcl$ = -72						; size = 4
_ycoef2$ = -68						; size = 4
...
_pcoef1$ = -8						; size = 4
_this$ = -4						; size = 4
?Gains@MissileClass@@AAEXXZ PROC			; MissileClass::Gains
; _this$ = ecx
...
; 6    : float pcoef1;        /* Used in calculating pitch axis gains */
; 7    : float pcoef2;
; 8    : float pfreq1;
; 9    : float pfreq2;
; 10   : float pradcl;
; 11   : float ycoef1;        /* Used in calculating yaw axis gains */
; 12   : float ycoef2;
; 13   : float yfreq1;
; 14   : float yfreq2;
; 15   : float yradcl;
...
; 19   : 
; 20   :    /*----------------------------------------*/
; 21   :    /* pitch axis gains and filter parameters */
; 22   :    /*----------------------------------------*/
; 23   :    ifd->tp01 = 0.100F;
...
; 26   :    ifd->wp01 = 3.0F*(ifd->qovt - 0.12F) + 0.5F;
...
; 27   : 
; 28   :    /*-----------------------------*/
; 29   :    /* limit closed loop frequency */
; 30   :    /*-----------------------------*/
; 31   : 	ifd->wp01 = min ( max (ifd->wp01, 0.5F), 5.0F);
...
; 34   :    ifd->kp04 = 2.085F;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	xmm0, DWORD PTR __real@400570a4
	movss	DWORD PTR [edx+12], xmm0

; 35   : 
; 36   :    /*----------------------------------------------*/
; 37   :    /* calculate inner loop dynamics for pitch axis */
; 38   :    /*----------------------------------------------*/
; 39   :    pcoef1 =  ifd->tp02*ifd->kp04*ifd->wp01*ifd->wp01/ifd->kp03 -
; 40   :                2*ifd->zp01*ifd->wp01 - ifd->kp04;
...
; 41   :    pcoef2 = (1 - ifd->kp04*(1/ifd->kp03 + ifd->tp02))*
; 42   :             ifd->wp01*ifd->wp01 + 2*ifd->zp01*ifd->wp01*ifd->kp04;
	...
	mulss	xmm0, DWORD PTR [edx+12]
	addss	xmm1, xmm0
	movss	DWORD PTR _pcoef2$[ebp], xmm1

; 43   :    pradcl =  pcoef1*pcoef1 - 4.0F*pcoef2;
...
; 44   : 
; 45   :    pfreq1 = ((float)sqrt(pradcl) - pcoef1)/2.0F;
...
; 47   : 
; 48   :    /*------------------------------------------*/
; 49   :    /* time constants for pitch axis inner loop */
; 50   :    /*------------------------------------------*/
; 51   :    ifd->tp03   =  1.0F/pfreq1;
...
; 53   :    ifd->kp05   =  GRAVITY*ifd->kp04*ifd->wp01*ifd->wp01/
; 54   :             (ifd->qsom*ifd->clalph*ifd->kp03*pfreq1*pfreq2);
	...
	mulss	xmm1, DWORD PTR [ecx+880]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	mulss	xmm1, DWORD PTR [eax+8]
	mulss	xmm1, DWORD PTR _pfreq1$[ebp]
	mulss	xmm1, DWORD PTR _pfreq2$[ebp]
	divss	xmm0, xmm1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	DWORD PTR [edx+16], xmm0

; 55   :    ifd->kp06   =  0.002F*ifd->qbar;
...
; 56   :    if(ifd->kp06 >= 20.0) ifd->kp06 = 20.0F;
...
; 58   : 
; 59   :    /*--------------------------------------*/
; 60   :    /* yaw axis gains and filter parameters */
; 61   :    /*--------------------------------------*/
; 62   :    ifd->ty01 = 0.10F;
...
; 65   :    ifd->wy01 = 3.0F*(ifd->qovt - 0.12F) + 0.5F;
...
; 66   : 
; 67   :    /*-----------------------------*/
; 68   :    /* limit closed loop frequency */
; 69   :    /*-----------------------------*/
; 70   : 	ifd->wy01 = min ( max (ifd->wy01, 0.5F), 5.0F);

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	movss	xmm0, DWORD PTR [eax+96]
	comiss	xmm0, DWORD PTR __real@3f000000
	jbe	SHORT $LN12@Gains
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	xmm0, DWORD PTR [edx+96]
	movss	DWORD PTR tv265[ebp], xmm0
	jmp	SHORT $LN13@Gains
$LN12@Gains:
	movss	xmm0, DWORD PTR __real@3f000000
	movss	DWORD PTR tv265[ebp], xmm0
$LN13@Gains:
	...
	jbe	SHORT $LN16@Gains
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	movss	xmm0, DWORD PTR [ecx+96]
	comiss	xmm0, DWORD PTR __real@3f000000
	jbe	SHORT $LN14@Gains
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	movss	xmm0, DWORD PTR [eax+96]
...
; 71   :    ifd->ky01 = 200.00F - ifd->geomData.costhe*ifd->geomData.sinphi;
...
; 75   : 
; 76   :    /*--------------------------------------------*/
; 77   :    /* calculate inner loop dynamics for yaw axis */
; 78   :    /*--------------------------------------------*/
; 79   :    ycoef1 =  ifd->ty02*ifd->ky04*ifd->wy01*ifd->wy01/ifd->ky03 -
; 80   :                2*ifd->zy01*ifd->wy01 - ifd->ky04;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	divss	xmm0, DWORD PTR [eax+60]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+988]
	movss	xmm1, DWORD PTR __real@40000000
	mulss	xmm1, DWORD PTR [edx+100]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+988]
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+988]
	subss	xmm0, DWORD PTR [eax+64]
	movss	DWORD PTR _ycoef1$[ebp], xmm0

; 81   :    ycoef2 = (1 - ifd->ky04*(1/ifd->ky03 + ifd->ty02))*
; 82   :                ifd->wy01*ifd->wy01 + 2*ifd->zy01*ifd->wy01*ifd->ky04;
	...
	mulss	xmm0, DWORD PTR [edx+64]
	addss	xmm1, xmm0
	movss	DWORD PTR _ycoef2$[ebp], xmm1

; 83   :    yradcl =  ycoef1*ycoef1 - 4.0F*ycoef2;
...
; 84   :    yfreq1 = ((float)sqrt(yradcl) - ycoef1)/2.0F;
...
; 86   : 
; 87   :    /*----------------------------------------*/
; 88   :    /* time constants for yaw axis inner loop */
; 89   :    /*----------------------------------------*/
; 90   :    ifd->ty03   =  1/yfreq1;
...
; 92   :    ifd->ky05   = -GRAVITY*ifd->ky04*ifd->wy01*ifd->wy01/
; 93   :             (ifd->qsom*ifd->cybeta*ifd->ky03*yfreq1*yfreq2);
...
; 95   :    if(ifd->ky06 >= 20.0)ifd->ky06 = 20.0F;
...
; 97   : }
	...
	pop	ebp
	ret	0
?Gains@MissileClass@@AAEXXZ ENDP			; MissileClass::Gains
_TEXT	ENDS
; Function compile flags: /Odtp
