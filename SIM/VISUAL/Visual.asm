; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\VISUAL\Visual.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?VisualDataTable@@3PAUVisualDataType@@A		; VisualDataTable
PUBLIC	?NumVisualEntries@@3FA				; NumVisualEntries
...
_BSS	SEGMENT
?VisualDataTable@@3PAUVisualDataType@@A DD 01H DUP (?)	; VisualDataTable
?NumVisualEntries@@3FA DW 01H DUP (?)			; NumVisualEntries
_BSS	ENDS
...
PUBLIC	??0VisualClass@@QAE@HPAVSimMoverClass@@@Z	; VisualClass::VisualClass
PUBLIC	??1VisualClass@@UAE@XZ				; VisualClass::~VisualClass
PUBLIC	?CanSeeObject@VisualClass@@UAEHPAVSimObjectType@@@Z ; VisualClass::CanSeeObject
PUBLIC	?CanSeeObject@VisualClass@@UAEHMM@Z		; VisualClass::CanSeeObject
PUBLIC	?GetSignature@VisualClass@@UAEMPAVSimObjectType@@@Z ; VisualClass::GetSignature
PUBLIC	?CanDetectObject@VisualClass@@UAEHPAVSimObjectType@@@Z ; VisualClass::CanDetectObject
PUBLIC	??_GVisualClass@@UAEPAXI@Z			; VisualClass::`scalar deleting destructor'
...
PUBLIC	??_7VisualClass@@6B@				; VisualClass::`vftable'
...
PUBLIC	??_R4VisualClass@@6B@				; VisualClass::`RTTI Complete Object Locator'
...
EXTRN	??_EVisualClass@@UAEPAXI@Z:PROC			; VisualClass::`vector deleting destructor'
...
_DATA	ENDS
;	COMDAT ??_R4VisualClass@@6B@
rdata$r	SEGMENT
??_R4VisualClass@@6B@ DD 00H				; VisualClass::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVVisualClass@@@8
	DD	FLAT:??_R3VisualClass@@8
rdata$r	ENDS
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ??_7VisualClass@@6B@
CONST	SEGMENT
??_7VisualClass@@6B@ DD FLAT:??_R4VisualClass@@6B@	; VisualClass::`vftable'
	DD	FLAT:??_EVisualClass@@UAEPAXI@Z
...
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ??_GVisualClass@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GVisualClass@@UAEPAXI@Z PROC				; VisualClass::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GVisualClass@@UAEPAXI@Z ENDP				; VisualClass::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\visual\visual.cpp
_TEXT	SEGMENT
_signalStr$ = -16					; size = 4
_wc$1 = -12						; size = 4
_classPtr$2 = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?CanDetectObject@VisualClass@@UAEHPAVSimObjectType@@@Z PROC ; VisualClass::CanDetectObject
; _this$ = ecx

; 101  : int VisualClass::CanDetectObject(SimObjectType* obj){
...
; 102  : 	// 2002-04-17 MN "GPS type" weapons can see and detect always
; 103  : 	if (g_nMissileFix & 0x100){

	mov	eax, DWORD PTR ?g_nMissileFix@@3HA	; g_nMissileFix
	and	eax, 256				; 00000100H
	je	SHORT $LN4@CanDetectO

; 104  : 		Falcon4EntityClassType* classPtr = NULL;

	mov	DWORD PTR _classPtr$2[ebp], 0

; 105  : 		classPtr = (Falcon4EntityClassType*)platform->EntityType();
...
; 106  : 		WeaponClassDataType *wc = NULL;

	mov	DWORD PTR _wc$1[ebp], 0

; 107  : 		//Cobra added this check because aircraft got in here were detected incorrect due to flag confusion
; 108  : 		if (classPtr->vuClassData.classInfo_[VU_TYPE] == STYPE_BOMB_GPS)
	...
	cmp	ecx, 4
	jne	SHORT $LN4@CanDetectO

; 109  : 			{
; 110  : 			ShiAssert(classPtr);
; 111  : 
; 112  : 			if (classPtr)

	cmp	DWORD PTR _classPtr$2[ebp], 0
	je	SHORT $LN5@CanDetectO

; 113  : 				wc = (WeaponClassDataType*)classPtr->dataPtr; // this is important
...
; 114  : 
; 115  : 			ShiAssert(wc);
; 116  : 			if (wc && (wc->Flags & WEAP_BOMBGPS))
...
; 121  : 	float signalStr;
; 122  : 	
; 123  : 	// edg: this is how we LOD ground vehicles.  1st determine if the
; 124  : 	// object is a ground vehicle.  If so, see if it has its inView variable
; 125  : 	// set.  If not return FALSE immediately since that vehicle will be LOD'd
; 126  : 	// out
; 127  : 	if (obj->BaseData()->IsSim() && ((SimBaseClass *)obj->BaseData())->IsSetLocalFlag(IS_HIDDEN)){
...
; 128  : 		return FALSE;
	...
	xor	eax, eax
	jmp	SHORT $LN8@CanDetectO
$LN3@CanDetectO:

; 129  : 	}
; 130  : 	//Cobra moved this above signalStr ... why check all that if don't have LOS?
; 131  : 	if (platform->CheckCompositeLOS(obj)){
	...
	call	eax
	test	eax, eax
	je	SHORT $LN2@CanDetectO

; 132  : 		// Get Observer Signature
; 133  : 		signalStr = GetSignature(obj);
...
; 136  : 		signalStr = 0; //Can't See

	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR _signalStr$[ebp], xmm0
$LN1@CanDetectO:

; 137  : 	}
; 138  : 	return (FloatToInt32(signalStr));

	push	ecx
	movss	xmm0, DWORD PTR _signalStr$[ebp]
...
; 139  : 	
; 140  : 	//Cobra GetSig now returns visDetNM
; 141  : 	// Scale for range squared
; 142  : 	//signalStr *= typeData->nominalRange * typeData->nominalRange;
; 143  : 	//signalStr /= obj->localData->range  * obj->localData->range;
; 144  : 
; 145  : 	// Check threshold
; 146  : 	//if (signalStr < 1.0F)
; 147  : 		//return FALSE;
; 148  : 	
; 149  : 	// Check line of sight (terrain and clouds)
; 150  : 	//signalStr *= OTWDriver.CheckCompositLOS( platform, obj->BaseData() );
; 151  : 	//signalStr *= platform->CheckCompositeLOS( obj );
; 152  : 	
; 153  : 
; 154  : 	// Return our decision
; 155  : 	//return (signalStr >= 1.0F);
; 156  : }

	mov	esp, ebp
	pop	ebp
	ret	4
?CanDetectObject@VisualClass@@UAEHPAVSimObjectType@@@Z ENDP ; VisualClass::CanDetectObject
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\visual\visual.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
___formal$ = 8						; size = 4
?GetSignature@VisualClass@@UAEMPAVSimObjectType@@@Z PROC ; VisualClass::GetSignature
; _this$ = ecx
...
; 79   : #if 0 // SCR 10/23/98:  This seems nice and all, but we don't have any data for this...
; 80   : /*
; 81   : 	SIGNATURE_DATA_TYPE* visData;
; 82   : 	Falcon4EntityClassType* classPtr;
; 83   : 	static int i, j;
; 84   : 	
; 85   : 	classPtr = (Falcon4EntityClassType *) obj->BaseData()->EntityType();
; 86   : 	
; 87   : 	visData = VisDataTable[min (classPtr->visType[0], NumSignaturesLoaded - 1)];
; 88   : 	
; 89   : 	// TODO:  Factor in light level
; 90   : 	return Math.TwodInterp (obj->localData->azFrom, obj->localData->elFrom,
; 91   : 							visData->azData, visData->elData,
; 92   : 							visData->signature, visData->numAz, visData->numEl, &i, &j);
; 93   : */
; 94   : #else
; 95   : 	// Return a unit signal strength (could/should this be based on object size?)
; 96   : 	return 1.0f;
...
; 98   : }
	...
	pop	ebp
	ret	4
?GetSignature@VisualClass@@UAEMPAVSimObjectType@@@Z ENDP ; VisualClass::GetSignature
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\visual\visual.cpp
;	COMDAT ?CanSeeObject@VisualClass@@UAEHMM@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_az$ = 8						; size = 4
_el$ = 12						; size = 4
?CanSeeObject@VisualClass@@UAEHMM@Z PROC		; VisualClass::CanSeeObject, COMDAT
; _this$ = ecx
...
; 67   : 	// This test seems a little weird.  Could it be optimized by moving the adds and using fabs()?
; 68   : 	if (az < (seekerAzCenter + typeData->right) &&
; 69   : 		az > (seekerAzCenter + typeData->left) &&
; 70   : 		el < (seekerElCenter + typeData->top) &&
; 71   : 		el > (seekerElCenter + typeData->bottom))
...
; 75   : }
	...
	pop	ebp
	ret	8
?CanSeeObject@VisualClass@@UAEHMM@Z ENDP		; VisualClass::CanSeeObject
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\visual\visual.cpp
_TEXT	SEGMENT
_wc$1 = -16						; size = 4
_classPtr$2 = -12					; size = 4
_objData$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?CanSeeObject@VisualClass@@UAEHPAVSimObjectType@@@Z PROC ; VisualClass::CanSeeObject
; _this$ = ecx
...
; 33   : // 2002-04-17 MN "GPS type" weapons can see and detect always
; 34   : 
; 35   : 	// RV - Biker - Add check for bomb or missile to avoid AI AC to always see target
; 36   : 	if ((g_nMissileFix & 0x100) && (platform->IsBomb() || platform->IsMissile()))

	mov	eax, DWORD PTR ?g_nMissileFix@@3HA	; g_nMissileFix
	and	eax, 256				; 00000100H
	je	SHORT $LN3@CanSeeObje
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+32]
	mov	eax, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [edx]
...
; 37   : 	{
; 38   : 	
; 39   : 		Falcon4EntityClassType* classPtr = NULL;

	mov	DWORD PTR _classPtr$2[ebp], 0

; 40   : 		classPtr = (Falcon4EntityClassType*)platform->EntityType();
...
; 41   : 		WeaponClassDataType *wc = NULL;

	mov	DWORD PTR _wc$1[ebp], 0

; 42   : 
; 43   : 		ShiAssert(classPtr);
; 44   : 
; 45   : 		if (classPtr)

	cmp	DWORD PTR _classPtr$2[ebp], 0
	je	SHORT $LN4@CanSeeObje

; 46   : 			wc = (WeaponClassDataType*)classPtr->dataPtr; // this is important
...
; 47   : 
; 48   : 		ShiAssert(wc);
; 49   : 		if (wc && (wc->Flags & WEAP_BOMBGPS))
...
; 51   : 	}
; 52   : 
; 53   : 	SimObjectLocalData* objData = obj->localData;
...
; 54   : 	
; 55   : 	// This test seems a little weird.  Could it be optimized by moving the adds and using fabs()?
; 56   : 	if (objData->az < (seekerAzCenter + typeData->right) &&
; 57   : 		objData->az > (seekerAzCenter + typeData->left) &&
; 58   : 		objData->el < (seekerElCenter + typeData->top) &&
; 59   : 		objData->el > (seekerElCenter + typeData->bottom))
...
; 63   : }
	...
	pop	ebp
	ret	4
?CanSeeObject@VisualClass@@UAEHPAVSimObjectType@@@Z ENDP ; VisualClass::CanSeeObject
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\visual\visual.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1VisualClass@@UAE@XZ PROC				; VisualClass::~VisualClass
; _this$ = ecx
...
; 27   : {
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7VisualClass@@6B@
...
; 28   : }
	...
	pop	ebp
	ret	0
??1VisualClass@@UAE@XZ ENDP				; VisualClass::~VisualClass
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\visual\visual.cpp
_TEXT	SEGMENT
...
_idx$ = 8						; size = 4
_self$ = 12						; size = 4
??0VisualClass@@QAE@HPAVSimMoverClass@@@Z PROC		; VisualClass::VisualClass
; _this$ = ecx
...
; 19   : {
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7VisualClass@@6B@

; 20   : 	dataProvided = PositionAndOrientation;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+28], 4

; 21   : 	typeData = &(VisualDataTable[min ( max ( idx, 0), NumVisualEntries - 1)]);

	cmp	DWORD PTR _idx$[ebp], 0
	jle	SHORT $LN3@VisualClas
	mov	eax, DWORD PTR _idx$[ebp]
	mov	DWORD PTR tv88[ebp], eax
	jmp	SHORT $LN4@VisualClas
$LN3@VisualClas:
	mov	DWORD PTR tv88[ebp], 0
$LN4@VisualClas:
	movsx	ecx, WORD PTR ?NumVisualEntries@@3FA	; NumVisualEntries
	sub	ecx, 1
	cmp	DWORD PTR tv88[ebp], ecx
	jge	SHORT $LN7@VisualClas
	cmp	DWORD PTR _idx$[ebp], 0
	jle	SHORT $LN5@VisualClas
	mov	edx, DWORD PTR _idx$[ebp]
	mov	DWORD PTR tv93[ebp], edx
	jmp	SHORT $LN6@VisualClas
$LN5@VisualClas:
	mov	DWORD PTR tv93[ebp], 0
$LN6@VisualClas:
	mov	eax, DWORD PTR tv93[ebp]
	mov	DWORD PTR tv128[ebp], eax
	jmp	SHORT $LN8@VisualClas
$LN7@VisualClas:
	movsx	ecx, WORD PTR ?NumVisualEntries@@3FA	; NumVisualEntries
	sub	ecx, 1
...
$LN8@VisualClas:
	...
	add	edx, DWORD PTR ?VisualDataTable@@3PAUVisualDataType@@A ; VisualDataTable
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+72], edx

; 22   : 	sensorType = Visual;
...
; 23   : }
	...
	pop	ebp
	ret	8
??0VisualClass@@QAE@HPAVSimMoverClass@@@Z ENDP		; VisualClass::VisualClass
_TEXT	ENDS
; Function compile flags: /Odtp
