; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\hdigi\h_Wingman.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?CheckOrders@HeliBrain@@QAEXXZ			; HeliBrain::CheckOrders
PUBLIC	?FollowOrders@HeliBrain@@QAEXXZ			; HeliBrain::FollowOrders
PUBLIC	?FollowLead@HeliBrain@@QAEXXZ			; HeliBrain::FollowLead
PUBLIC	?ReceiveOrders@HeliBrain@@QAEXPAVFalconEvent@@@Z ; HeliBrain::ReceiveOrders
...
EXTRN	?GetFormationPos@HelicopterClass@@QAEXPAM00@Z:PROC ; HelicopterClass::GetFormationPos
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_wingman.cpp
_TEXT	SEGMENT
tv229 = -24						; size = 4
tv215 = -20						; size = 4
_goLead$ = -16						; size = 4
tv78 = -12						; size = 4
_wingCommand$ = -8					; size = 4
_this$ = -4						; size = 4
_theEvent$ = 8						; size = 4
?ReceiveOrders@HeliBrain@@QAEXPAVFalconEvent@@@Z PROC	; HeliBrain::ReceiveOrders
; _this$ = ecx
...
; 17   : 	FalconWingmanMsg *wingCommand = (FalconWingmanMsg *)theEvent;

	mov	eax, DWORD PTR _theEvent$[ebp]
	mov	DWORD PTR _wingCommand$[ebp], eax

; 18   : 	int goLead = FALSE;

	mov	DWORD PTR _goLead$[ebp], 0
...
; 22   : 
; 23   : 	switch (wingCommand->dataBlock.command)

	mov	edx, DWORD PTR _wingCommand$[ebp]
	mov	eax, DWORD PTR [edx+58]
	mov	DWORD PTR tv78[ebp], eax
	cmp	DWORD PTR tv78[ebp], 39			; 00000027H
	ja	$LN4@ReceiveOrd
	mov	ecx, DWORD PTR tv78[ebp]
	movzx	edx, BYTE PTR $LN20@ReceiveOrd[ecx]
	jmp	DWORD PTR $LN21@ReceiveOrd[edx*4]
$LN14@ReceiveOrd:

; 24   : 	{
; 25   : 		case FalconWingmanMsg::WMSpread:
; 26   : 		case FalconWingmanMsg::WMWedge:
; 27   : 		case FalconWingmanMsg::WMTrail:
; 28   : 		case FalconWingmanMsg::WMLadder:
; 29   : 		case FalconWingmanMsg::WMStack:
; 30   : 		case FalconWingmanMsg::WMResCell:
; 31   : 		case FalconWingmanMsg::WMBox:
; 32   : 		case FalconWingmanMsg::WMArrowHead:
; 33   : 		case FalconWingmanMsg::WMFluidFour:
; 34   : 	        curFormation = wingCommand->dataBlock.command;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _wingCommand$[ebp]
	mov	edx, DWORD PTR [ecx+58]
	mov	DWORD PTR [eax+176], edx
$LN13@ReceiveOrd:

; 35   : 		case FalconWingmanMsg::WMRejoin:
; 36   : 			underOrders = FALSE;
...
; 38   : 
; 39   : 		case FalconWingmanMsg::WMBreakRight:
; 40   : 			underOrders = TRUE;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+168], 1

; 41   : 			headingOrdered = self->Yaw() + 90.0F * DTR;
...
; 43   : 			curOrder = wingCommand->dataBlock.command;
...
; 45   : 
; 46   : 		case FalconWingmanMsg::WMBreakLeft:
; 47   : 			underOrders = TRUE;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+168], 1

; 48   : 			headingOrdered = self->Yaw() - 90.0F * DTR;
...
; 50   : 			curOrder = wingCommand->dataBlock.command;
...
; 52   : 
; 53   : 		case FalconWingmanMsg::WMAssignTarget:
; 54   : 			break;
...
; 55   : 
; 56   : 		case FalconWingmanMsg::WMPosthole:
; 57   : 		case FalconWingmanMsg::WMPince:
; 58   : 		case FalconWingmanMsg::WMChainsaw:
; 59   : 			break;
...
; 60   : 
; 61   : 		case FalconWingmanMsg::WMFree:
; 62   : 			goLead = TRUE;

	mov	DWORD PTR _goLead$[ebp], 1

; 63   : 			underOrders = FALSE;
...
; 64   : 			break;
	...
	jmp	SHORT $LN15@ReceiveOrd
$LN7@ReceiveOrd:

; 65   : 
; 66   : 		case FalconWingmanMsg::WMPromote:
; 67   : 			isWing --;
...
; 72   : 			else
	...
	jmp	SHORT $LN5@ReceiveOrd
$LN6@ReceiveOrd:

; 73   : 				self->flightLead = (HelicopterClass *)self->GetCampaignObject()->GetComponentLead();
...
; 75   : 
; 76   : 		default:
; 77   : 			curFormation = FalconWingmanMsg::WMWedge;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+176], 1
$LN15@ReceiveOrd:

; 78   : 			//MonoPrint ("Digi %d received bad order %d at\n", self->Id().num_,
; 79   :             //wingCommand->dataBlock.command, SimLibElapsedTime);
; 80   : 			break;
; 81   : 	}
; 82   : 
; 83   : 	if (goLead && isWing) {

	cmp	DWORD PTR _goLead$[ebp], 0
...
; 88   : 	}
; 89   : 
; 90   : 	//MonoPrint ("Message received %d at %.2f\n",
; 91   : 	//self->Id().num_, SimLibElapsedTime);
; 92   : }
...
$LN20@ReceiveOrd:
	...
	DB	6
	DB	7
?ReceiveOrders@HeliBrain@@QAEXPAVFalconEvent@@@Z ENDP	; HeliBrain::ReceiveOrders
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_wingman.cpp
_TEXT	SEGMENT
_leadBrain$ = -84					; size = 4
tv379 = -80						; size = 4
tv468 = -76						; size = 4
tv470 = -72						; size = 4
_rng$ = -68						; size = 4
...
?FollowLead@HeliBrain@@QAEXXZ PROC			; HeliBrain::FollowLead
; _this$ = ecx
...
; 139  : 	Tpoint newpos;
; 140  : 	
; 141  : 	HeliBrain *leadBrain = NULL;

	mov	DWORD PTR _leadBrain$[ebp], 0
...
; 144  : 	float dx = 0.0F, dy = 0.0F, dz = 0.0F;
...
; 147  : 	if (self->OnGround()) {
	...
	call	edx
	test	eax, eax
	je	SHORT $LN12@FollowLead

; 148  :         self->UnSetFlag(ON_GROUND);
...
; 149  : 	}	
; 150  : 	
; 151  : 	// RV - Biker - Stay on ground if lead does also
; 152  : 	if (self->flightLead->curWaypoint->GetWPFlags() & WPF_TAKEOFF  &&
; 153  : 		self->flightLead->curWaypoint->GetWPDepartureTime() > SimLibElapsedTime &&
; 154  : 		self->flightLead->curWaypoint->GetPrevWP() == NULL)
	...
	test	eax, eax
	jne	SHORT $LN11@FollowLead

; 155  : 	{
; 156  : 		LevelTurn(0.0f, 0.0f, TRUE);
...
; 158  : 		// RV - Biker - Extend landing gear
; 159  : 		((DrawableBSP*)self->drawPointer)->SetSwitchMask(2, 1);
...
; 161  : 	}
; 162  : 
; 163  : 	// FRB - Get the lead's WP altitude
; 164  : 	self->SetWPalt(self->flightLead->GetWPalt());
...
; 165  : 
; 166  : 	// RV - Biker - Retract landing gear
; 167  : 	((DrawableBSP*)self->drawPointer)->SetSwitchMask(2, 0);
...
; 168  : 
; 169  : 	// maybe there is a variable with speed in XY plane already
; 170  : 	speedXY = sqrt(self->XDelta()*self->XDelta() + self->YDelta()*self->YDelta());
	...
	mulss	xmm0, DWORD PTR tv384[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+4]
	...
	mulss	xmm0, DWORD PTR tv394[ebp]
	...
	add	esp, 4
	fstp	DWORD PTR _speedXY$[ebp]

; 171  : 	
; 172  : 	if ((self->flightLead->hBrain->onStation == Landed || self->flightLead->hBrain->onStation == Landing) && speedXY <= 20.0f) {
	...
	je	SHORT $LN9@FollowLead
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	eax, DWORD PTR [edx+860]
	mov	ecx, DWORD PTR [eax+808]
	cmp	DWORD PTR [ecx+32], 4
	jne	SHORT $LN10@FollowLead
$LN9@FollowLead:
	movss	xmm0, DWORD PTR __real@41a00000
	comiss	xmm0, DWORD PTR _speedXY$[ebp]
	jb	SHORT $LN10@FollowLead

; 173  : 		if (onStation < Arrived)

	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+32], 1
	jge	SHORT $LN8@FollowLead

; 174  : 			onStation = Arrived;
...
; 178  : 	else {
	...
	jmp	SHORT $LN7@FollowLead
$LN10@FollowLead:

; 179  : 		onStation = NotThereYet;
...
; 185  : 	}
; 186  : 
; 187  : 	if (self->FCC->GetMasterMode() == FireControlComputer::AirGroundMissile) {
	...
	cmp	eax, 6
	jne	SHORT $LN5@FollowLead

; 188  : 		self->GetFormationPos( &newpos.x, &newpos.y, &newpos.z);
...
; 189  : 		trackX = newpos.x + 8000.0F;

	movss	xmm0, DWORD PTR _newpos$[ebp]
	addss	xmm0, DWORD PTR __real@45fa0000
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+148], xmm0

; 190  :         trackY = newpos.y + 100.0F;
...
; 192  : 		//MonoPrint ("AGM Formation\n");
; 193  : 	}
; 194  :     else if (self->FCC->GetMasterMode() == FireControlComputer::AirGroundBomb ||

	jmp	$LN1@FollowLead
$LN5@FollowLead:

; 195  : 			  self->FCC->GetMasterMode() == FireControlComputer::AirGroundRocket) {
	...
	call	?GetMasterMode@FireControlComputer@@QAE?AW4FCCMasterMode@1@XZ ; FireControlComputer::GetMasterMode
	cmp	eax, 5
	je	SHORT $LN2@FollowLead
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR [eax+756]
	call	?GetMasterMode@FireControlComputer@@QAE?AW4FCCMasterMode@1@XZ ; FireControlComputer::GetMasterMode
	cmp	eax, 13					; 0000000dH
	jne	SHORT $LN3@FollowLead
$LN2@FollowLead:

; 196  : 		self->GetFormationPos( &newpos.x, &newpos.y, &newpos.z);

	lea	ecx, DWORD PTR _newpos$[ebp+8]
	push	ecx
	lea	edx, DWORD PTR _newpos$[ebp+4]
	push	edx
...
; 197  : 		trackX = newpos.x + 2000.0F;

	movss	xmm0, DWORD PTR _newpos$[ebp]
	addss	xmm0, DWORD PTR __real@44fa0000
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+148], xmm0

; 198  :         trackY = newpos.y + 2000.0F;
...
; 200  : 		//MonoPrint ("Rocket Formation\n");
; 201  : 	}
; 202  : 	else {
...
; 203  : 		self->GetFormationPos( &newpos.x, &newpos.y, &newpos.z );
...
; 208  : 		dx = newpos.x - self->XPos();
	...
	movss	xmm0, DWORD PTR _newpos$[ebp]
	subss	xmm0, DWORD PTR tv447[ebp]
	movss	DWORD PTR _dx$[ebp], xmm0

; 209  : 		dy = newpos.y - self->YPos();
...
; 215  : }
	...
	pop	ebp
	ret	0
?FollowLead@HeliBrain@@QAEXXZ ENDP			; HeliBrain::FollowLead
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_wingman.cpp
_TEXT	SEGMENT
...
tv70 = -8						; size = 4
_this$ = -4						; size = 4
?FollowOrders@HeliBrain@@QAEXXZ PROC			; HeliBrain::FollowOrders
; _this$ = ecx
...
; 110  : 	{
; 111  : 		case FalconWingmanMsg::WMBreakRight:
; 112  : 		case FalconWingmanMsg::WMBreakLeft:
; 113  : 			trackX = self->XPos() + 5000.0F * (float)cos(headingOrdered);
	...
	addss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+148], xmm1

; 114  : 			trackY = self->YPos() + 5000.0F * (float)sin(headingOrdered);
	...
	addss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+152], xmm1

; 115  : 			desSpeed = CORNER_SPEED;
...
; 116  : 			turnType = 1;
	...
	mov	DWORD PTR _turnType$[ebp], 1

; 117  : 			break;

	jmp	SHORT $LN5@FollowOrde
$LN3@FollowOrde:

; 118  : 
; 119  : 		case FalconWingmanMsg::WMPosthole:
; 120  : 			trackX = self->XPos();
...
; 125  : 			break;
; 126  : 
; 127  : 		case FalconWingmanMsg::WMChainsaw:
; 128  : 			break;
; 129  : 
; 130  : 		case FalconWingmanMsg::WMPince:
; 131  : 			break;
; 132  : 	}
; 133  : 
...
; 135  : }
	...
	pop	ebp
	ret	0
?FollowOrders@HeliBrain@@QAEXXZ ENDP			; HeliBrain::FollowOrders
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_wingman.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?CheckOrders@HeliBrain@@QAEXXZ PROC			; HeliBrain::CheckOrders
; _this$ = ecx
...
; 96   : 	if (underOrders) {
	...
	je	SHORT $LN2@CheckOrder

; 97   : 		AddMode(FollowOrdersMode);
...
; 99   : }
	...
	pop	ebp
	ret	0
?CheckOrders@HeliBrain@@QAEXXZ ENDP			; HeliBrain::CheckOrders
_TEXT	ENDS
; Function compile flags: /Odtp
