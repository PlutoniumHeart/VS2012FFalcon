; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\hdigi\h_waypoint.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?SetWPalt@HelicopterClass@@QAEXM@Z		; HelicopterClass::SetWPalt
PUBLIC	?GetWPalt@HelicopterClass@@QAEMXZ		; HelicopterClass::GetWPalt
PUBLIC	?FollowWaypoints@HeliBrain@@QAEXXZ		; HeliBrain::FollowWaypoints
PUBLIC	?GoToCurrentWaypoint@HeliBrain@@QAEXXZ		; HeliBrain::GoToCurrentWaypoint
PUBLIC	?SelectNextWaypoint@HeliBrain@@QAEXXZ		; HeliBrain::SelectNextWaypoint
PUBLIC	?ChooseBrain@HeliBrain@@QAEXXZ			; HeliBrain::ChooseBrain
...
EXTRN	?LandMe@HeliBrain@@QAEXXZ:PROC			; HeliBrain::LandMe
...
EXTRN	?GetCargo@UnitClass@@QAEPAVCampBaseClass@@XZ:PROC ; UnitClass::GetCargo
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_waypoint.cpp
_TEXT	SEGMENT
tv79 = -8						; size = 4
_this$ = -4						; size = 4
?ChooseBrain@HeliBrain@@QAEXXZ PROC			; HeliBrain::ChooseBrain
; _this$ = ecx
...
; 271  : 	if (self->curWaypoint) {

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	cmp	DWORD PTR [ecx+728], 0
	je	SHORT $LN12@ChooseBrai

; 272  : 		switch (self->curWaypoint->GetWPAction()) {
...
; 273  : 			case WP_NOTHING:
; 274  : 			case WP_TAKEOFF:
; 275  : 			case WP_ASSEMBLE:
; 276  : 			case WP_POSTASSEMBLE:
; 277  : 			case WP_REFUEL:
; 278  : 			case WP_REARM:
; 279  : 			case WP_LAND:
; 280  : 			case WP_ELINT:
...
; 286  : 			case WP_JAM:
; 287  : 			case WP_PICKUP:
; 288  : 				// MonoPrint ("Helo Digi Chose Waypoint BRAIN\n");
; 289  : 				// modeData = digitalBrains->brainData[AIR_SWEEP_BRAIN];
; 290  : 				break;
; 291  : 
; 292  : 			case WP_ESCORT:
; 293  : 				// MonoPrint ("Helo Digi Chose ESCORT BRAIN\n");
; 294  : 				break;
; 295  : 
; 296  : 			case WP_CA:
; 297  : 				// MonoPrint ("Helo Digi Chose AIR SWEEP BRAIN\n");
; 298  : 				break;
; 299  : 
; 300  : 			case WP_CAP:
; 301  : 				// MonoPrint ("Helo Digi Chose AIR CAP BRAIN\n");
; 302  : 				break;
; 303  : 
; 304  : 			case WP_INTERCEPT:
; 305  : 				// MonoPrint ("Helo Digi Chose AIR INTERCEPT BRAIN\n");
; 306  : 				break;
; 307  : 
; 308  : 			case WP_GNDSTRIKE:
; 309  : 			case WP_NAVSTRIKE:
; 310  : 			case WP_STRIKE:
; 311  : 			case WP_BOMB:
; 312  : 			case WP_SAD:
; 313  : 				// MonoPrint ("Helo Digi Chose STRIKE BRAIN\n");
; 314  : 				break;
; 315  : 
; 316  : 			case WP_SEAD:
; 317  : 				// MonoPrint ("Helo Digi Chose SEAD BRAIN\n");
; 318  : 				break;
; 319  : 
; 320  : 			default:
; 321  : 				// MonoPrint ("Why am I here (Helo Digi GetBrain)\n");
; 322  : 				// MonoPrint ("===>Waypoint action %d\n", self->curWaypoint->GetWPAction());
; 323  : 				break;
; 324  : 		}
; 325  : 	}
; 326  : }
	...
	pop	ebp
	ret	0
?ChooseBrain@HeliBrain@@QAEXXZ ENDP			; HeliBrain::ChooseBrain
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_waypoint.cpp
_TEXT	SEGMENT
_tmpWaypoint$ = -28					; size = 4
_waypointIndex$ = -24					; size = 4
_i$ = -20						; size = 4
_wlist$ = -16						; size = 4
_campUnit$ = -12					; size = 4
_campCurWP$ = -8					; size = 4
_this$ = -4						; size = 4
?SelectNextWaypoint@HeliBrain@@QAEXXZ PROC		; HeliBrain::SelectNextWaypoint
; _this$ = ecx
...
; 214  : 	WayPointClass* tmpWaypoint = self->curWaypoint;
...
; 215  : 	WayPointClass* wlist = self->waypoint;
...
; 216  : 	UnitClass *campUnit = NULL;

	mov	DWORD PTR _campUnit$[ebp], 0

; 217  : 	WayPointClass *campCurWP = NULL;

	mov	DWORD PTR _campCurWP$[ebp], 0

; 218  : 	int waypointIndex,i;
; 219  : 
; 220  : 	// first get our current waypoint index in the list
; 221  : 	for ( waypointIndex = 0;

	mov	DWORD PTR _waypointIndex$[ebp], 0

; 222  : 		  wlist && wlist != tmpWaypoint;

	jmp	SHORT $LN11@SelectNext
$LN10@SelectNext:

; 223  : 		  wlist = wlist->GetNextWP(), waypointIndex++ );
...
$LN11@SelectNext:
	...
	je	SHORT $LN9@SelectNext
	jmp	SHORT $LN10@SelectNext
$LN9@SelectNext:

; 224  : 
; 225  : 	// see if we're running in tactical or campaign.  If so, we want to
; 226  : 	// synch the campaign's waypoints with ours
; 227  : 	// if ( SimDriver.RunningCampaignOrTactical() )
; 228  : 	{
; 229  : 		// get the pointer to our campaign unit
; 230  : 		campUnit = (UnitClass *)self->GetCampaignObject();
...
; 233  : 			campCurWP = campUnit->GetFirstUnitWP();
...
; 234  : 
; 235  : 			// now get the camp waypoint that corresponds to our next in the
; 236  : 			// list by index
; 237  : 			for (i = 0; i <= waypointIndex; i++) {
...
; 239  : 					campCurWP = campCurWP->GetNextWP();
...
; 243  : 	}
; 244  : 
; 245  : 	onStation = NotThereYet;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+32], 0

; 246  : 	self->curWaypoint = self->curWaypoint->GetNextWP();
...
; 247  : 
; 248  : 	// KCK: This isn't working anyway - so I'm commentting it out in order to prevent bugs
; 249  : 	// in the ATC and Campaign
; 250  : 	// edg: this should be OK now that an obsolute waypoint index is used to
; 251  : 	// synch the current WP between sim and camp units.
; 252  : 	if (campCurWP) {

	cmp	DWORD PTR _campCurWP$[ebp], 0
	je	SHORT $LN3@SelectNext

; 253  : 		campUnit->SetCurrentUnitWP( campCurWP );

	mov	edx, DWORD PTR _campCurWP$[ebp]
	push	edx
	mov	ecx, DWORD PTR _campUnit$[ebp]
...
; 256  : 
; 257  :    	if (!self->curWaypoint) {

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	cmp	DWORD PTR [edx+728], 0
	jne	SHORT $LN2@SelectNext

; 258  : 		// go back to the beginning
; 259  :       	self->curWaypoint = self->waypoint;
...
; 260  : 		campUnit->SetCurrentUnitWP( campUnit->GetFirstUnitWP() );
...
; 266  :    	ChooseBrain();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?ChooseBrain@HeliBrain@@QAEXXZ		; HeliBrain::ChooseBrain
...
; 267  : }
	...
	pop	ebp
	ret	0
?SelectNextWaypoint@HeliBrain@@QAEXXZ ENDP		; HeliBrain::SelectNextWaypoint
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_waypoint.cpp
_TEXT	SEGMENT
...
_rollLoad$ = -24					; size = 4
_wpalt$ = -20						; size = 4
_desHeading$ = -16					; size = 4
_desSpeed$ = -12					; size = 4
_cargo$ = -8						; size = 4
_this$ = -4						; size = 4
?GoToCurrentWaypoint@HeliBrain@@QAEXXZ PROC		; HeliBrain::GoToCurrentWaypoint
; _this$ = ecx
...
; 48   : 	float rng, desHeading;
; 49   : 	float rollLoad;
; 50   : 	float rollDir;
; 51   : 	float desSpeed;
; 52   : 	float wpX, wpY, wpZ;
; 53   : 	float dx, dy, time;
; 54   : 
; 55   : 	Unit cargo;
; 56   : 	Unit unit;
; 57   : 	self->SetWPalt(0.0f);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	call	?SetWPalt@HelicopterClass@@QAEXM@Z	; HelicopterClass::SetWPalt
...
; 59   : 	if (self->OnGround()) {
	...
	call	eax
	test	eax, eax
	je	SHORT $LN36@GoToCurren

; 60   : 		self->UnSetFlag(ON_GROUND);
...
; 61   : 	}
; 62   : 
; 63   : 	unit = (Unit)self->GetCampaignObject();
...
; 64   : 
; 65   : 	// RV - Biker - If we did miss our pickup do it now
; 66   : 	if (self->curWaypoint->GetWPAction() == WP_AIRDROP && !unit->GetCargo() && onStation == NotThereYet) {
	...
	test	eax, eax
	jne	SHORT $LN34@GoToCurren
	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+32], 0
	jne	SHORT $LN34@GoToCurren

; 67   : 		cargo = (Unit) self->curWaypoint->GetWPTarget();
...
; 74   : 	}
; 75   : 
; 76   : 	if ( self->curWaypoint->GetWPAction() == WP_PICKUP && onStation == NotThereYet) {
	...
	call	?GetWPAction@WayPointClass@@QAEHXZ	; WayPointClass::GetWPAction
	cmp	eax, 6
	jne	SHORT $LN33@GoToCurren
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+32], 0
	jne	SHORT $LN33@GoToCurren

; 77   : 		cargo = (Unit) self->curWaypoint->GetWPTarget();
...
; 78   : 		if (cargo) {
	...
	cmp	DWORD PTR _cargo$[ebp], 0
	je	SHORT $LN32@GoToCurren

; 79   : 			wpX = cargo->XPos();

	mov	ecx, DWORD PTR _cargo$[ebp]
	call	?XPos@VuEntity@@QBEMXZ			; VuEntity::XPos
	fstp	DWORD PTR _wpX$[ebp]

; 80   : 			wpY = cargo->YPos();

	mov	ecx, DWORD PTR _cargo$[ebp]
	call	?YPos@VuEntity@@QBEMXZ			; VuEntity::YPos
	fstp	DWORD PTR _wpY$[ebp]

; 81   : 			wpZ = cargo->ZPos();

	mov	ecx, DWORD PTR _cargo$[ebp]
	call	?ZPos@VuEntity@@QBEMXZ			; VuEntity::ZPos
	fstp	DWORD PTR _wpZ$[ebp]

; 82   : 		}
; 83   : 		else {

	jmp	SHORT $LN31@GoToCurren
$LN32@GoToCurren:

; 84   :    			self->curWaypoint->GetLocation (&wpX, &wpY, &wpZ);
...
; 87   : 	else {
	...
	jmp	SHORT $LN30@GoToCurren
$LN33@GoToCurren:

; 88   : 	   self->curWaypoint->GetLocation (&wpX, &wpY, &wpZ);

	lea	edx, DWORD PTR _wpZ$[ebp]
	push	edx
	lea	eax, DWORD PTR _wpY$[ebp]
	push	eax
	lea	ecx, DWORD PTR _wpX$[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR [eax+728]
...
; 89   : 	}
; 90   : 
; 91   : 	// If we are at starting WP stay on ground
; 92   : 	if (self->curWaypoint->GetWPFlags() & WPF_TAKEOFF  &&
; 93   : 		self->curWaypoint->GetWPDepartureTime() > SimLibElapsedTime &&
; 94   : 		self->curWaypoint->GetPrevWP() == NULL)
	...
	jbe	SHORT $LN29@GoToCurren
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR [eax+728]
	call	?GetPrevWP@WayPointClass@@QAEPAV1@XZ	; WayPointClass::GetPrevWP
	test	eax, eax
	jne	SHORT $LN29@GoToCurren

; 95   : 	{
; 96   : 		LevelTurn (0.0f, 0.0f, TRUE);
...
; 98   : 		// RV - Biker - Extend landing gear
; 99   : 		((DrawableBSP*)self->drawPointer)->SetSwitchMask(2, 1);
...
; 101  : 	}
; 102  : 
; 103  : 	// RV - Biker - Retract landing gear
; 104  : 	((DrawableBSP*)self->drawPointer)->SetSwitchMask(2, 0);
...
; 105  : 
; 106  : 	float wpalt = (float)self->curWaypoint->GetWPAltitude();
	...
	cvtsi2ss xmm0, eax
	movss	DWORD PTR _wpalt$[ebp], xmm0

; 107  : 	// Max altitude
; 108  : 	if (wpalt > 12000.0f)

	movss	xmm0, DWORD PTR _wpalt$[ebp]
	comiss	xmm0, DWORD PTR __real@463b8000
	jbe	SHORT $LN28@GoToCurren
...
; 110  : 	// Convert to AGL
; 111  : 	wpalt = wpalt - OTWDriver.GetGroundLevel(wpX, wpY);
...
; 112  : 	if (wpalt < 20.0f)
	...
	comiss	xmm0, DWORD PTR _wpalt$[ebp]
	jbe	SHORT $LN27@GoToCurren
...
; 123  : 	}
; 124  : 
; 125  : 	// Range to current waypoint - sqrt???
; 126  : 	dx = (wpX - self->XPos());
...
; 129  : 
; 130  : 	// Heading error for current waypoint
; 131  : 	desHeading = (float)atan2 (dy, dx) - self->Yaw();
	...
	movsd	xmm0, QWORD PTR tv588[ebp]
	cvtsd2ss xmm0, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+4]
...
; 132  : 	if (desHeading > 180.0F * DTR)

	movss	xmm0, DWORD PTR _desHeading$[ebp]
	comiss	xmm0, DWORD PTR __real@40490fd9
	jbe	SHORT $LN25@GoToCurren

; 133  : 		desHeading -= 360.0F * DTR;

	movss	xmm0, DWORD PTR _desHeading$[ebp]
	subss	xmm0, DWORD PTR __real@40c90fd9
	movss	DWORD PTR _desHeading$[ebp], xmm0
	jmp	SHORT $LN23@GoToCurren
$LN25@GoToCurren:

; 134  : 	else if (desHeading < -180.0F * DTR)

	movss	xmm0, DWORD PTR __real@c0490fd9
	comiss	xmm0, DWORD PTR _desHeading$[ebp]
	jbe	SHORT $LN23@GoToCurren

; 135  : 		desHeading += 360.0F * DTR;
...
; 136  : 
; 137  : 	// rollLoad is normalized (0-1) factor of how far off-heading we are to target
...
; 145  : 
; 146  : 	// Reached the next waypoint?
; 147  : 	// RV - Biker - Never skip waypoints
; 148  : 	if (rng < (600.0F * 600.0F) || (onStation != NotThereYet) /*|| SimLibElapsedTime > self->curWaypoint->GetWPDepartureTime()*/) {

	movss	xmm0, DWORD PTR __real@48afc800
	comiss	xmm0, DWORD PTR _rng$[ebp]
	ja	SHORT $LN18@GoToCurren
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+32], 0
	je	SHORT $LN15@GoToCurren
$LN18@GoToCurren:

; 149  : 		if (onStation == NotThereYet) {

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+32], 0
	jne	SHORT $LN17@GoToCurren

; 150  : 			onStation = Arrived;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+32], 1
	jmp	SHORT $LN15@GoToCurren
$LN17@GoToCurren:

; 151  : 		}
; 152  : 		else if (onStation == OnStation && SimLibElapsedTime > self->curWaypoint->GetWPDepartureTime()) {
...
; 156  : 
; 157  : 	// landing?
; 158  : 	if (onStation == Landing ||
; 159  : 		onStation == DropOff ||
; 160  : 		onStation == Landed ||
; 161  : 		onStation == PickUp)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+32], 4
	je	SHORT $LN13@GoToCurren
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+32], 6
	je	SHORT $LN13@GoToCurren
	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+32], 5
	je	SHORT $LN13@GoToCurren
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+32], 7
	jne	SHORT $LN14@GoToCurren
$LN13@GoToCurren:
...
; 163  :         LandMe();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?LandMe@HeliBrain@@QAEXXZ		; HeliBrain::LandMe
...
; 166  : 
; 167  : 	// On Station ?
; 168  : 	if (onStation == Arrived) {

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+32], 1
	jne	SHORT $LN12@GoToCurren

; 169  :    		if (self->curWaypoint->GetWPFlags() & WPF_LAND) {
...
; 175  : 	}
; 176  : 
; 177  : 	// get waypoint speed based on our dist and arrival time
; 178  : 	if (rng < 600.0f * 600.0f) {

	movss	xmm0, DWORD PTR __real@48afc800
	comiss	xmm0, DWORD PTR _rng$[ebp]
	jbe	SHORT $LN10@GoToCurren
...
; 184  : 		if (self->curWaypoint->GetWPArrivalTime() > SimLibElapsedTime) 
	...
	cmp	eax, DWORD PTR ?SimLibElapsedTime@@3KA	; SimLibElapsedTime
	jbe	SHORT $LN8@GoToCurren

; 185  : 			time =  (float)(self->curWaypoint->GetWPArrivalTime() - SimLibElapsedTime) / SEC_TO_MSEC;
...
; 189  : 		if (time <= 0.0f) {
	...
	movss	xmm0, DWORD PTR __real@00000000
	comiss	xmm0, DWORD PTR _time$[ebp]
	jb	SHORT $LN6@GoToCurren
...
; 193  : 		else {
	...
	jmp	SHORT $LN2@GoToCurren
$LN6@GoToCurren:

; 194  : 			desSpeed = (rng/time)/MAX_HELI_FPS;

	movss	xmm0, DWORD PTR _rng$[ebp]
	divss	xmm0, DWORD PTR _time$[ebp]
	divss	xmm0, DWORD PTR __real@4397e7be
	movss	DWORD PTR _desSpeed$[ebp], xmm0

; 195  : 			if (desSpeed > 1.0f)
...
; 197  : 			//TJL 11/20/03 Minimum speed
; 198  : 			else if (desSpeed < 0.5f)

	movss	xmm0, DWORD PTR __real@3f000000
	comiss	xmm0, DWORD PTR _desSpeed$[ebp]
	jbe	SHORT $LN2@GoToCurren
...
; 202  : 	}
; 203  : 
; 204  : 	// if we're close, just point to spot then go
; 205  : 	if (fabs(rollLoad) > 0.1f && rng < 1000.0f * 1000.0f)
...
; 207  : 	LevelTurn (rollLoad, rollDir, TRUE);
...
; 208  : 	MachHold(desSpeed, self->GetWPalt(), TRUE);
...
; 209  : 	//MachHold(desSpeed, 300.0f, TRUE);
; 210  : }

	mov	esp, ebp
	pop	ebp
	ret	0
?GoToCurrentWaypoint@HeliBrain@@QAEXXZ ENDP		; HeliBrain::GoToCurrentWaypoint
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_waypoint.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?FollowWaypoints@HeliBrain@@QAEXXZ PROC			; HeliBrain::FollowWaypoints
; _this$ = ecx
...
; 24   : 	if (self->curWaypoint == NULL) {

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	cmp	DWORD PTR [ecx+728], 0
	jne	SHORT $LN1@FollowWayp

; 25   : 		AddMode (LoiterMode);
...
; 26   : 		return;
	...
	jmp	SHORT $LN2@FollowWayp
$LN1@FollowWayp:

; 27   : 	}
; 28   : 
; 29   : 	GoToCurrentWaypoint();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GoToCurrentWaypoint@HeliBrain@@QAEXXZ	; HeliBrain::GoToCurrentWaypoint
$LN2@FollowWayp:

; 30   : 
; 31   : 	//switch (self->curWaypoint->GetWPAction())
; 32   : 	//{
; 33   : 	//   case WP_LAND:
; 34   : 	//		if ( onStation == Arrived || onStation == Stabilizing )
; 35   : 	//	 		LandMe();
; 36   : 	//		else if ( !(onStation == OnStation) )
; 37   : 	//			GoToCurrentWaypoint();
; 38   : 	//		break;
; 39   : 	//
; 40   : 	//	default:
; 41   : 	//		GoToCurrentWaypoint();
; 42   : 	//		break;
; 43   : 	//}
; 44   : }
	...
	pop	ebp
	ret	0
?FollowWaypoints@HeliBrain@@QAEXXZ ENDP			; HeliBrain::FollowWaypoints
_TEXT	ENDS
; Function compile flags: /Odtp
...
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\include\helo.h
;	COMDAT ?SetWPalt@HelicopterClass@@QAEXM@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_Alt$ = 8						; size = 4
?SetWPalt@HelicopterClass@@QAEXM@Z PROC			; HelicopterClass::SetWPalt, COMDAT
; _this$ = ecx

; 78   : 	void SetWPalt(float Alt) { wpAlt = Alt; };
	...
	pop	ebp
	ret	4
?SetWPalt@HelicopterClass@@QAEXM@Z ENDP			; HelicopterClass::SetWPalt
_TEXT	ENDS
; Function compile flags: /Odtp
