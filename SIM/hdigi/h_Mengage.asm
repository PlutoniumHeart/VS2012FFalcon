; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\hdigi\h_Mengage.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?MissileEngage@HeliBrain@@QAEXXZ		; HeliBrain::MissileEngage
PUBLIC	?MissileEngageCheck@HeliBrain@@QAEXXZ		; HeliBrain::MissileEngageCheck
...
CONST	ENDS
;	COMDAT __real@c328c89a
CONST	SEGMENT
__real@c328c89a DD 0c328c89ar			; -168.784
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_mengage.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?MissileEngageCheck@HeliBrain@@QAEXXZ PROC		; HeliBrain::MissileEngageCheck
; _this$ = ecx
...
; 13   :    /*-----------------------*/
; 14   :    /* return if null target */
; 15   :    /*-----------------------*/
; 16   :    if (targetPtr == NULL)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+192], 0
	jne	SHORT $LN5@MissileEng

; 17   :    {
; 18   :       if (curMode == MissileEngageMode) 
; 19   :       {
; 20   : //		 MonoPrint( "HELO BRAIN Exiting Missile Engange 1\n" );
; 21   :       }
; 22   :       return;
...
; 26   :    /* entry */
; 27   :    /*-------*/
; 28   :    if (curMode != MissileEngageMode && curMissile)

	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+36], 9
...
; 29   :    {
; 30   : //	  MonoPrint( "HELO BRAIN ENTERING Missile Engange 1\n" );
; 31   :       AddMode(MissileEngageMode);
...
; 34   :    /* exit */
; 35   :    /*------*/
; 36   :    else if (curMissile == NULL)
; 37   :    {
; 38   : //	  MonoPrint( "HELO BRAIN Exiting Missile Engange 2\n" );
; 39   :    }
; 40   : }
	...
	pop	ebp
	ret	0
?MissileEngageCheck@HeliBrain@@QAEXXZ ENDP		; HeliBrain::MissileEngageCheck
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_mengage.cpp
_TEXT	SEGMENT
...
_yDot$ = -28						; size = 4
_xDot$ = -24						; size = 4
_newSubMode$1 = -20					; size = 4
_zDot$ = -16						; size = 4
_desiredClosure$ = -12					; size = 4
_tof$ = -8						; size = 4
_this$ = -4						; size = 4
?MissileEngage@HeliBrain@@QAEXXZ PROC			; HeliBrain::MissileEngage
; _this$ = ecx
...
; 44   : float desiredClosure, rdes,rngdot, desSpeed;
; 45   : float xDot, yDot, zDot;
; 46   : float tof, rMax;
; 47   : 
; 48   :    if (!targetPtr || !curMissile)
	...
	jne	SHORT $LN15@MissileEng
$LN14@MissileEng:

; 49   :    {
; 50   : //	  MonoPrint( "HELO BRAIN Exiting Missile Engange 3\n" );
; 51   :       return;
...
; 52   :    }
; 53   : 
; 54   :    // Set up for missile engage
; 55   :    if (curMode != lastMode)
...
; 56   :    {
; 57   :    FireControlComputer::FCCSubMode newSubMode;
; 58   : 
; 59   :       self->FCC->SetMasterMode (FireControlComputer::Missile);
...
; 60   :       switch (self->Sms->hardPoint[curMissileStation]->GetWeaponType())
...
; 61   :       {
; 62   :          case wtAim9:
; 63   :             newSubMode = FireControlComputer::Aim9;

	mov	DWORD PTR _newSubMode$1[ebp], 5

; 64   :          break;

	jmp	SHORT $LN11@MissileEng
$LN9@MissileEng:

; 65   : 
; 66   :          case wtAim120:
; 67   :             newSubMode = FireControlComputer::Aim120;
...
; 69   : 
; 70   :          default:
; 71   :             newSubMode = FireControlComputer::Aim9;
...
; 72   :          break;
; 73   :       }
; 74   :       self->FCC->SetSubMode (newSubMode);
...
; 76   : 
; 77   : 	/*---------------------------------------*/
; 78   : 	/* Find current missile's tof, rmax, etc */
; 79   : 	/*---------------------------------------*/
; 80   : 
; 81   :    if(curMissile->IsMissile())
...
; 82   :    {
; 83   : 		tof  = ((MissileClass *)curMissile)->GetTOF((-self->ZPos()), self->GetVt(), targetData->ataFrom,
; 84   : 			targetPtr->BaseData()->GetVt(), targetData->range);
...
; 85   : 
; 86   : 		rMax = ((MissileClass *)curMissile)->GetRMax((-self->ZPos()), self->GetVt(), targetData->az,
; 87   : 			targetPtr->BaseData()->GetVt(), targetData->ataFrom);
...
; 97   : 
; 98   :    /*---------------------------------*/
; 99   :    /* Put a deadband on target's zdot */
; 100  :    /*---------------------------------*/
; 101  : 	xDot = targetPtr->BaseData()->XDelta();
...
; 102  : 	yDot = targetPtr->BaseData()->YDelta();
...
; 103  : 	zDot = targetPtr->BaseData()->ZDelta();
...
; 104  : 	zDot = Math.DeadBand(zDot, -10.0F, 10.0F);
...
; 105  : 
; 106  :    /*----------------------------------*/
; 107  :    /* Ownship ahead of target 3/9 line */
; 108  :    /*----------------------------------*/
; 109  :    if (fabs (targetData->azFrom) < 90.0F)
...
; 110  :    {
; 111  :       /*----------------------*/
; 112  :       /* Find the track point */
; 113  :       /*----------------------*/
; 114  :       trackX = targetPtr->BaseData()->XPos() + xDot * tof;
...
; 115  :       trackY = targetPtr->BaseData()->YPos() + yDot * tof;
...
; 116  :       trackZ = targetPtr->BaseData()->ZPos() + zDot * tof;
...
; 117  : 
; 118  :       desSpeed = 2.0F * CORNER_SPEED;
...
; 119  :    }
; 120  :    /*-----------------------------------*/
; 121  :    /* Ownship behind of target 3/9 line */
; 122  :    /*-----------------------------------*/
; 123  :    else
...
; 124  :    {
; 125  :       /*-------------------------------------------------------------*/
; 126  :       /* Calculate desired closure                                   */
; 127  :       /* desired closure is 10% of range in feet, expressed as knots */
; 128  :       /* -100.0 Kts <= desired closure <= 300 Kts                    */
; 129  :       /*-------------------------------------------------------------*/
; 130  :       rdes = 0.40F * rMax;
...
; 131  :       desiredClosure = 0.1F * (targetData->range - rdes);

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+200]
	movss	xmm0, DWORD PTR [eax+44]
	subss	xmm0, DWORD PTR _rdes$[ebp]
	mulss	xmm0, DWORD PTR __real@3dcccccd
	movss	DWORD PTR _desiredClosure$[ebp], xmm0

; 132  :       desiredClosure = min (max (desiredClosure, -100.0F * KNOTS_TO_FTPSEC),
; 133  :             300.0F * KNOTS_TO_FTPSEC);

	movss	xmm0, DWORD PTR _desiredClosure$[ebp]
	comiss	xmm0, DWORD PTR __real@c328c89a
	jbe	SHORT $LN18@MissileEng
	movss	xmm0, DWORD PTR _desiredClosure$[ebp]
	movss	DWORD PTR tv321[ebp], xmm0
	jmp	SHORT $LN19@MissileEng
$LN18@MissileEng:
	movss	xmm0, DWORD PTR __real@c328c89a
	movss	DWORD PTR tv321[ebp], xmm0
$LN19@MissileEng:
	movss	xmm0, DWORD PTR __real@43fd2ce8
	comiss	xmm0, DWORD PTR tv321[ebp]
	jbe	SHORT $LN22@MissileEng
	movss	xmm0, DWORD PTR _desiredClosure$[ebp]
	comiss	xmm0, DWORD PTR __real@c328c89a
	jbe	SHORT $LN20@MissileEng
	movss	xmm0, DWORD PTR _desiredClosure$[ebp]
...
; 136  :       /* Closing to fast */
; 137  :       /*-----------------*/
; 138  :       if (-targetData->rangedot > desiredClosure)
...
; 139  :       {
; 140  :          /*---------------------------------------*/
; 141  :          /* Find the track point - Lag the target */
; 142  :          /*---------------------------------------*/
; 143  :       	trackX = targetPtr->BaseData()->XPos() + xDot * tof * 0.9F;
...
; 144  :       	trackY = targetPtr->BaseData()->YPos() + yDot * tof * 0.9F;
...
; 145  :       	trackZ = targetPtr->BaseData()->ZPos() + zDot * tof * 0.9F;
...
; 148  :       /*-------------------------*/
; 149  :       /* Not closing fast enough */
; 150  :       /*-------------------------*/
; 151  :       {
; 152  : 
; 153  :          /*----------------------*/
; 154  :          /* Find the track point */
; 155  :          /*----------------------*/
; 156  :       	trackX = targetPtr->BaseData()->XPos() + xDot * tof;
...
; 157  :       	trackY = targetPtr->BaseData()->YPos() + yDot * tof;
...
; 158  :       	trackZ = targetPtr->BaseData()->ZPos() + zDot * tof;
...
; 160  : 
; 161  :       /*--------------------------------------*/
; 162  :       /* Set the throttle for desired closure */
; 163  :       /*--------------------------------------*/
; 164  :       rngdot = (targetData->rangedot) * FTPSEC_TO_KNOTS;
...
; 165  :       desSpeed = self->GetKias() + desiredClosure - rngdot;
...
; 166  : 
; 167  :       if (desSpeed < 200.0) desSpeed = 200.0F;

	cvtss2sd xmm0, DWORD PTR _desSpeed$[ebp]
	movsd	xmm1, QWORD PTR __real@4069000000000000
	comisd	xmm1, xmm0
	jbe	SHORT $LN1@MissileEng
...
; 174  : }
	...
	pop	ebp
	ret	0
?MissileEngage@HeliBrain@@QAEXXZ ENDP			; HeliBrain::MissileEngage
_TEXT	ENDS
; Function compile flags: /Odtp
