; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\hdigi\h_landme.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?FindRunway@HeliBrain@@QAEXXZ			; HeliBrain::FindRunway
PUBLIC	?LandMe@HeliBrain@@QAEXXZ			; HeliBrain::LandMe
PUBLIC	?SetupLanding@HeliBrain@@QAEXXZ			; HeliBrain::SetupLanding
PUBLIC	?CleanupLanding@HeliBrain@@QAEXXZ		; HeliBrain::CleanupLanding
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_landme.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?CleanupLanding@HeliBrain@@QAEXXZ PROC			; HeliBrain::CleanupLanding
; _this$ = ecx
...
; 30   : }
	...
	pop	ebp
	ret	0
?CleanupLanding@HeliBrain@@QAEXXZ ENDP			; HeliBrain::CleanupLanding
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_landme.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?SetupLanding@HeliBrain@@QAEXXZ PROC			; HeliBrain::SetupLanding
; _this$ = ecx
...
; 26   : }
	...
	pop	ebp
	ret	0
?SetupLanding@HeliBrain@@QAEXXZ ENDP			; HeliBrain::SetupLanding
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_landme.cpp
_TEXT	SEGMENT
...
tv142 = -32						; size = 4
_selfAlt$ = -28						; size = 4
_groundAlt$ = -24					; size = 4
_unit$ = -20						; size = 4
_cargo$ = -16						; size = 4
_this$ = -12						; size = 4
_x$ = -8						; size = 2
_y$ = -4						; size = 2
?LandMe@HeliBrain@@QAEXXZ PROC				; HeliBrain::LandMe
; _this$ = ecx
...
; 39   : 	GridIndex x, y;
; 40   : 
; 41   : 	float groundAlt = OTWDriver.GetGroundLevel(self->XPos() + self->XDelta(), self->YPos() + self->YDelta());
	...
	addss	xmm0, DWORD PTR tv418[ebp]
	push	ecx
...
; 42   : 	float selfAlt = self->ZPos() + self->offsetZ;
	...
	movss	DWORD PTR _selfAlt$[ebp], xmm0
...
; 44   : 	switch (onStation) {
	...
	jmp	DWORD PTR $LN31@LandMe[ecx*4]
...
; 48   : 
; 49   : 		case Arrived:
; 50   : 			jinkTime = SimLibElapsedTime + 30000;
...
; 53   : 
; 54   : 		case Landing:
; 55   : 			if ((selfAlt >= (groundAlt - 0.25f)) && (selfAlt < groundAlt) || SimLibElapsedTime > jinkTime) {

	movss	xmm0, DWORD PTR _groundAlt$[ebp]
	subss	xmm0, DWORD PTR __real@3e800000
	movss	xmm1, DWORD PTR _selfAlt$[ebp]
	comiss	xmm1, xmm0
	jb	SHORT $LN21@LandMe
	movss	xmm0, DWORD PTR _groundAlt$[ebp]
	comiss	xmm0, DWORD PTR _selfAlt$[ebp]
	ja	SHORT $LN22@LandMe
$LN21@LandMe:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR ?SimLibElapsedTime@@3KA	; SimLibElapsedTime
	cmp	eax, DWORD PTR [edx+108]
	jbe	SHORT $LN23@LandMe
$LN22@LandMe:
...
; 57   : 				jinkTime = SimLibElapsedTime + (90 + rand()%90)*1000;
...
; 60   : 			}
; 61   : 			else if ((selfAlt >= (groundAlt - 3.5f) || SimLibElapsedTime > (jinkTime - 10000)) && (selfAlt < groundAlt)) {

	movss	xmm0, DWORD PTR _groundAlt$[ebp]
	subss	xmm0, DWORD PTR __real@40600000
	movss	xmm1, DWORD PTR _selfAlt$[ebp]
	comiss	xmm1, xmm0
	jae	SHORT $LN18@LandMe
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+108]
	sub	eax, 10000				; 00002710H
	cmp	DWORD PTR ?SimLibElapsedTime@@3KA, eax	; SimLibElapsedTime
	jbe	SHORT $LN19@LandMe
$LN18@LandMe:
	movss	xmm0, DWORD PTR _groundAlt$[ebp]
	comiss	xmm0, DWORD PTR _selfAlt$[ebp]
	jbe	SHORT $LN19@LandMe

; 62   : 				LevelTurn(0.0f, 0.0f, TRUE);
...
; 64   : 			}
; 65   : 			else if ((selfAlt >= (groundAlt - 10.0f) || SimLibElapsedTime > (jinkTime - 15000)) && (selfAlt < groundAlt)) {

	movss	xmm0, DWORD PTR _groundAlt$[ebp]
	subss	xmm0, DWORD PTR __real@41200000
	movss	xmm1, DWORD PTR _selfAlt$[ebp]
	comiss	xmm1, xmm0
	jae	SHORT $LN15@LandMe
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+108]
	sub	edx, 15000				; 00003a98H
	cmp	DWORD PTR ?SimLibElapsedTime@@3KA, edx	; SimLibElapsedTime
	jbe	SHORT $LN16@LandMe
$LN15@LandMe:
	movss	xmm0, DWORD PTR _groundAlt$[ebp]
	comiss	xmm0, DWORD PTR _selfAlt$[ebp]
	jbe	SHORT $LN16@LandMe

; 66   : 				LevelTurn(0.0f, 0.0f, TRUE);
...
; 69   : 			else {
	...
	jmp	SHORT $LN14@LandMe
$LN16@LandMe:

; 70   : 				LevelTurn(0.0f, 0.0f, TRUE);
...
; 74   : 			if (self->OnGround()) {
	...
	call	edx
	test	eax, eax
	je	SHORT $LN13@LandMe

; 75   : 				self->UnSetFlag(ON_GROUND);
...
; 76   : 			}
; 77   : 			
; 78   : 			// RV - Biker - Extend landing gear
; 79   : 			((DrawableBSP*)self->drawPointer)->SetSwitchMask(2, 1);
...
; 84   : 			if (SimLibElapsedTime > jinkTime) {

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR ?SimLibElapsedTime@@3KA	; SimLibElapsedTime
	cmp	edx, DWORD PTR [ecx+108]
	jbe	SHORT $LN7@LandMe

; 85   : 				if (self->curWaypoint->GetWPAction() == WP_PICKUP) {
...
; 87   : 					self->UnSetFlag(ON_GROUND);

	push	128					; 00000080H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	call	?UnSetFlag@SimBaseClass@@QAEXH@Z	; SimBaseClass::UnSetFlag
	jmp	SHORT $LN7@LandMe
$LN10@LandMe:

; 88   : 				}
; 89   : 				else if (self->curWaypoint->GetWPAction() == WP_AIRDROP) {
	...
	jne	SHORT $LN8@LandMe

; 90   : 					onStation = DropOff;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+32], 6

; 91   : 					self->UnSetFlag(ON_GROUND);
...
; 95   : 			}
; 96   : 			// RV - Biker - Extend landing gear
; 97   : 			((DrawableBSP*)self->drawPointer)->SetSwitchMask(2, 1);
...
; 99   : 
; 100  : 		// Load the airborne battalion.
; 101  : 		case PickUp:
; 102  : 			cargo = (Unit) self->curWaypoint->GetWPTarget();
...
; 103  : 			unit = (Unit)self->GetCampaignObject();
...
; 114  : 
; 115  : 		// Unload the airborne battalion.
; 116  : 		case DropOff:
; 117  : 			cargo = (Unit) self->curWaypoint->GetWPTarget();
...
; 118  : 			unit = (Unit)self->GetCampaignObject();
...
; 122  : 				cargo->SetCargoId(FalconNullId);
...
; 123  : 				cargo->SetInactive(0);

	push	0
	mov	ecx, DWORD PTR _cargo$[ebp]
	call	?SetInactive@UnitClass@@QAEXH@Z		; UnitClass::SetInactive

; 124  : 				self->curWaypoint->GetWPLocation(&x,&y);
...
$LN31@LandMe:
	...
	DD	$LN4@LandMe
	DD	$LN6@LandMe
?LandMe@HeliBrain@@QAEXXZ ENDP				; HeliBrain::LandMe
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\hdigi\h_landme.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?FindRunway@HeliBrain@@QAEXXZ PROC			; HeliBrain::FindRunway
; _this$ = ecx
...
; 34   : }
	...
	pop	ebp
	ret	0
?FindRunway@HeliBrain@@QAEXXZ ENDP			; HeliBrain::FindRunway
_TEXT	ENDS
; Function compile flags: /Odtp
