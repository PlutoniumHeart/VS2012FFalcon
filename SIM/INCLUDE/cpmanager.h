...
public:
...
#if CPMANAGER_VERSION
	unsigned int GetMajorVersion() const { return mVersion.major; }
	unsigned int GetMinorVersion() const { return mVersion.minor; }
#endif
	...
	int      AltPanel(void) { return mAltPanel;};		//Wombat778 4-13-04
	...
	*/
	...
	//Wombat778 3-12-04
	int			GetNumPanels(void) {return mNumPanels;};
	CPPanel* 	GetPanel(int num) {return mpPanels[num];}
	float		GetLightLevel() {return lightLevel;};		//Wombat778 11-15-04
