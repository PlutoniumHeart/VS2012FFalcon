; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\DIGI\HandleThreat.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?HandleThreat@DigitalBrain@@IAEHXZ		; DigitalBrain::HandleThreat
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\digi\handlethreat.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?HandleThreat@DigitalBrain@@IAEHXZ PROC			; DigitalBrain::HandleThreat
; _this$ = ecx
...
; 18   : 	// no threat?
; 19   : 	if ( threatPtr == NULL )

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+664], 0
	jne	SHORT $LN6@HandleThre
...
; 21   : 
; 22   : 	// decrement threat timer
; 23   : 	threatTimer -= SimLibMajorFrameTime;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [ecx+672]
	subss	xmm0, DWORD PTR ?SimLibMajorFrameTime@@3MA
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+672], xmm0

; 24   : 
; 25   : 	// we re-evaluate our threat after time has expired
; 26   : 	if ( threatTimer <= 0.0f )

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	comiss	xmm0, DWORD PTR [eax+672]
	jb	$LN1@HandleThre

; 27   : 	{
; 28   : 		// base it on range and threat's ata
; 29   : 		// NOTE: the current targetPtr should be the threat at this point
; 30   : 		if (!targetPtr ||
; 31   : 			(targetPtr != threatPtr) ||
; 32   : 			(targetPtr->BaseData()->IsSim() && !((SimBaseClass*)targetPtr->BaseData())->IsAwake()) ||
; 33   : 			targetData->range > 8.0F * NM_TO_FT || //me123 changes here
; 34   : 			(targetData->range > 5.0F * NM_TO_FT && targetData->ataFrom > 90.0f * DTR))

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+12], 0
	je	SHORT $LN3@HandleThre
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+12]
	cmp	ecx, DWORD PTR [eax+664]
	jne	SHORT $LN3@HandleThre
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+12]
...
; 35   : 		{
; 36   : 			// we drop concern of this threat
; 37   : 			SetThreat(NULL);
...
; 38   : 			self->SetThreat( NULL, THREAT_NONE );
...
; 40   : 			return FALSE;
	...
	xor	eax, eax
	jmp	SHORT $LN7@HandleThre

; 41   : 		}
; 42   : 		else {

	jmp	SHORT $LN1@HandleThre
$LN4@HandleThre:

; 43   : 			wvrCurrTactic = WVR_NONE;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+564], 0

; 44   : 			threatTimer = 10.0F;
...
; 47   :    }
; 48   : 
; 49   : 	// just go into WvrEngage at this point -- needs more smarts
; 50   : 	WvrEngage();
...
; 53   : }
	...
	pop	ebp
	ret	0
?HandleThreat@DigitalBrain@@IAEHXZ ENDP			; DigitalBrain::HandleThreat
_TEXT	ENDS
; Function compile flags: /Odtp
