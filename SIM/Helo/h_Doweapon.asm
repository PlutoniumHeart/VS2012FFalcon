; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\SIM\Helo\h_Doweapon.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?DoWeapons@HelicopterClass@@QAEXXZ		; HelicopterClass::DoWeapons
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\sim\helo\h_doweapon.cpp
_TEXT	SEGMENT
tv240 = -52						; size = 4
tv244 = -48						; size = 4
tv231 = -44						; size = 4
...
?DoWeapons@HelicopterClass@@QAEXXZ PROC			; HelicopterClass::DoWeapons
; _this$ = ecx
...
; 36   :    fireFlag = fireGun;
	...
	mov	DWORD PTR _fireFlag$[ebp], ecx
...
; 38   :    {
; 39   :       Guns->Exec(&fireFlag, gunDmx, &platformAngles, targetPtr, FALSE);
...
; 42   :       {
; 43   : #ifdef MLR_NEWSNDCODE	     
; 44   : 		  SoundPos.Sfx( SFX_MCGUN );
...
; 45   : #else
; 46   : 		 F4SoundFXSetPos( SFX_MCGUN, 0, XPos(), YPos(), ZPos(), 1.0f , 0 , XDelta(),YDelta(),ZDelta());
; 47   : #endif
; 48   : 
; 49   : 		pos.x = XPos();
...
; 51   : 		// RV - Biker - Adjust gun smoke position
; 52   : 		//pos.z = ZPos() - 5.0f;
; 53   : 		pos.z = ZPos() + 1.0f + offsetZ;
...
; 58   : 
; 59   : 		//RV - I-Hawk - changing all LIGHT_CLOUD weapons effects calls
; 60   : 		// to more appropriate GUN_SMOKE effect here
; 61   : 		/*
; 62   : 		OTWDriver.AddSfxRequest(
; 63   : 			new SfxClass ( SFX_GUN_SMOKE,		// type
; 64   : 			SFX_MOVES,
; 65   : 			&pos,					// world pos
; 66   : 			&vec,					// vel vector
; 67   : 			2.3f,					// time to live
; 68   : 			2.0f ) );				// scale
; 69   : 			*/
; 70   : 		DrawableParticleSys::PS_AddParticleEx((SFX_GUN_SMOKE + 1),
; 71   : 												&pos,
; 72   : 												&vec);
...
; 75   :          {
; 76   :             // KCK: This has been moved to GunClass::Exec, since that's where we generate
; 77   :             // new bullets
; 78   : //            SendFireMessage ((SimWeaponClass*)Guns, FalconWeaponsFire::GUN, TRUE, targetPtr);
; 79   : 
; 80   : 			#ifdef _DEBUG
; 81   : 			SimVehicleClass *theObject;
; 82   : 			if ( targetPtr )
; 83   : 			{
; 84   : 				theObject = (SimVehicleClass *)targetPtr->BaseData();
; 85   : /*				if ( theObject->IsAirplane() )
; 86   : 					MonoPrint( "HELO BRAIN Firing Guns at Air Unit\n" );
; 87   : 				else if ( theObject->IsHelicopter() )
; 88   : 					MonoPrint( "HELO BRAIN Firing Guns at Helo Unit\n" );
; 89   : 				else if ( theObject->IsGroundVehicle() )
; 90   : 					MonoPrint( "HELO BRAIN Firing Guns at Ground Unit\n" );
; 91   : */			}
; 92   : 			#endif
; 93   :          }
; 94   :          SetFiring(TRUE);
...
; 99   :          {
; 100  :             SendFireMessage ((SimWeaponClass*)Guns, FalconWeaponsFire::GUN, FALSE, targetPtr);
...
; 105  : 
; 106  :    /*
; 107  :    ** edg: no more FCC stuff here.  All done in hdigi now
; 108  :    if ( FCC->releaseConsent && Sms->curWeapon )
; 109  :    {
; 110  : 	   if (FCC->GetMasterMode() == FireControlComputer::Missile ||
; 111  : 		   FCC->GetMasterMode() == FireControlComputer::Dogfight ||
; 112  : 		   FCC->GetMasterMode() == FireControlComputer::MissileOverride)
; 113  : 	   {
; 114  : 			 theMissile = (MissileClass *)Sms->curWeapon;
; 115  : 			 if (Sms->LaunchMissile())
; 116  : 			 {
; 117  : 				SendFireMessage ((SimWeaponClass*)theMissile, FalconWeaponsFire::SRM, TRUE, targetPtr);
; 118  : 	
; 119  : 			   	fireMissile = FALSE;
; 120  : 			   	F4SoundFXSetPos( SFX_MISSILE1, 0, XPos(), YPos(), ZPos(), 1.0f );
; 121  : 			 }
; 122  : 	
; 123  : 	   } 
; 124  : 	   else if (FCC->GetMasterMode() == FireControlComputer::AirGroundMissile)
; 125  : 	   {
; 126  : 			 theMissile = (MissileClass *)Sms->curWeapon;
; 127  : 			 if (Sms->LaunchMissile())
; 128  : 			 {
; 129  : 				SendFireMessage ((SimWeaponClass*)theMissile, FalconWeaponsFire::AGM, TRUE, targetPtr);
; 130  : 	
; 131  : 				fireMissile = FALSE;
; 132  : 				F4SoundFXSetPos( SFX_MISSILE2, 0, XPos(), YPos(), ZPos(), 1.0f );
; 133  : 			 }
; 134  : 	
; 135  : 	   } 
; 136  :       else if (FCC->GetMasterMode() == FireControlComputer::AirGroundBomb &&
; 137  :          FCC->GetSubMode() == FireControlComputer::RCKT)
; 138  :       {
; 139  :          if (FCC->bombPickle && Sms->curWeapon && !OnGround())
; 140  :          {
; 141  :             // Play the sound
; 142  :             F4SoundFXSetPos( SFX_RCKTLOOP, TRUE, XPos(), YPos(), ZPos(), 1.0f );
; 143  : 
; 144  : 			theMissile = (MissileClass *)Sms->curWeapon;
; 145  : 
; 146  :             if (Sms->LaunchRocket())
; 147  :             {
; 148  : 
; 149  :                // Stop firing
; 150  :                FCC->bombPickle = FALSE;
; 151  :                FCC->postDrop = TRUE;
; 152  : 
; 153  :                // Play the sound
; 154  :                F4SoundFXSetPos( SFX_MISSILE3, TRUE, XPos(), YPos(), ZPos(), 1.0f );
; 155  : 
; 156  :                // Drop a message
; 157  :                SendFireMessage (theMissile, FalconWeaponsFire::Rocket, TRUE, targetPtr);
; 158  :             }
; 159  :          }
; 160  :       }
; 161  :    }
...
; 163  : 
; 164  :    /*
; 165  :    else if (FCC->GetMasterMode() == FireControlComputer::AirGroundBomb)
; 166  :    {
; 167  :       curWeapon = Sms->curWeapon;
; 168  :       if (FCC->bombPickle)
; 169  :       {
; 170  :          SendFireMessage ((SimWeaponClass*)curWeapon, FalconWeaponsFire::BMB, TRUE, targetPtr);
; 171  :          if (Sms->DropBomb())
; 172  :          {
; 173  :             FCC->bombPickle = FALSE;
; 174  :             FCC->postDrop = TRUE;
; 175  :          }
; 176  :       }
; 177  :    }
; 178  :    */
; 179  : 
; 180  :    // Handle missiles launched but still on the rail
; 181  : 	Sms->Exec();
...
; 182  : }
	...
	pop	ebp
	ret	0
?DoWeapons@HelicopterClass@@QAEXXZ ENDP			; HelicopterClass::DoWeapons
_TEXT	ENDS
; Function compile flags: /Odtp
