; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\UI\SRC\taceng\ui_taceng.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?LoadTacEngSelectWindows@@YAXXZ			; LoadTacEngSelectWindows
PUBLIC	?LoadTacticalWindows@@YAXXZ			; LoadTacticalWindows
...
PUBLIC	??_C@_0L@MCLOOGLL@ts_res?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@IPPGECIL@ts_art?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@BCMAIAPM@ts_snd?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@DONPEADH@ts_scf?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@OIAOBHBE@te_res?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@KFEGLDCE@te_art?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@DIHAHBFD@te_snd?4lst?$AA@		; `string'
PUBLIC	??_C@_0L@BEGPLBJI@te_scf?4lst?$AA@		; `string'
...
EXTRN	?hookup_tactical_controls@@YAXJ@Z:PROC		; hookup_tactical_controls
...
EXTRN	?tactical_select_training@@YAXJFPAVC_Base@@@Z:PROC ; tactical_select_training
...
EXTRN	?TACLoaded@@3HA:DWORD				; TACLoaded
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@BEGPLBJI@te_scf?4lst?$AA@
CONST	SEGMENT
??_C@_0L@BEGPLBJI@te_scf?4lst?$AA@ DB 'te_scf.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@DIHAHBFD@te_snd?4lst?$AA@
CONST	SEGMENT
??_C@_0L@DIHAHBFD@te_snd?4lst?$AA@ DB 'te_snd.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@KFEGLDCE@te_art?4lst?$AA@
CONST	SEGMENT
??_C@_0L@KFEGLDCE@te_art?4lst?$AA@ DB 'te_art.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@OIAOBHBE@te_res?4lst?$AA@
CONST	SEGMENT
??_C@_0L@OIAOBHBE@te_res?4lst?$AA@ DB 'te_res.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@DONPEADH@ts_scf?4lst?$AA@
CONST	SEGMENT
??_C@_0L@DONPEADH@ts_scf?4lst?$AA@ DB 'ts_scf.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@BCMAIAPM@ts_snd?4lst?$AA@
CONST	SEGMENT
??_C@_0L@BCMAIAPM@ts_snd?4lst?$AA@ DB 'ts_snd.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@IPPGECIL@ts_art?4lst?$AA@
CONST	SEGMENT
??_C@_0L@IPPGECIL@ts_art?4lst?$AA@ DB 'ts_art.lst', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@MCLOOGLL@ts_res?4lst?$AA@
CONST	SEGMENT
??_C@_0L@MCLOOGLL@ts_res?4lst?$AA@ DB 'ts_res.lst', 00H	; `string'
CONST	ENDS
...
xdata$x	ENDS
xdata$x	SEGMENT
__unwindtable$?LoadTacticalWindows@@YAXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?LoadTacticalWindows@@YAXXZ$0
__ehfuncinfo$?LoadTacticalWindows@@YAXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?LoadTacticalWindows@@YAXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui\src\taceng\ui_taceng.cpp
_TEXT	SEGMENT
$T2 = -36						; size = 4
_win$ = -32						; size = 4
tv91 = -28						; size = 4
...
_tmr$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?LoadTacticalWindows@@YAXXZ PROC			; LoadTacticalWindows
...
; 130  : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?LoadTacticalWindows@@YAXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 135  : 	if (TACLoaded)
	...
	cmp	DWORD PTR ?TACLoaded@@3HA, 0		; TACLoaded
	je	SHORT $LN6@LoadTactic
...
; 138  : 	}
; 139  : 
; 140  : 	if( _LOAD_ART_RESOURCES_)

	cmp	DWORD PTR ?_LOAD_ART_RESOURCES_@@3JA, 0	; _LOAD_ART_RESOURCES_
	je	SHORT $LN5@LoadTactic

; 141  : 		gMainParser->LoadImageList ("te_res.lst");

	push	OFFSET ??_C@_0L@OIAOBHBE@te_res?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadImageList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadImageList

; 142  : 	else

	jmp	SHORT $LN4@LoadTactic
$LN5@LoadTactic:

; 143  : 		gMainParser->LoadImageList ("te_art.lst");

	push	OFFSET ??_C@_0L@KFEGLDCE@te_art?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadImageList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadImageList
$LN4@LoadTactic:

; 144  : 
; 145  : 	gMainParser->LoadSoundList ("te_snd.lst");

	push	OFFSET ??_C@_0L@DIHAHBFD@te_snd?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadSoundList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadSoundList

; 146  : 
; 147  : 	gMainParser->LoadWindowList ("te_scf.lst");

	push	OFFSET ??_C@_0L@BEGPLBJI@te_scf?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadWindowList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadWindowList

; 148  : 
; 149  : 	ID=gMainParser->GetFirstWindowLoaded ();
...
; 151  : 	while(ID)
	...
	je	SHORT $LN2@LoadTactic

; 152  : 	{
; 153  : 		hookup_tactical_controls (ID);

	mov	eax, DWORD PTR _ID$[ebp]
	push	eax
	call	?hookup_tactical_controls@@YAXJ@Z	; hookup_tactical_controls
	add	esp, 4

; 154  : 		ID = gMainParser->GetNextWindowLoaded ();
...
; 156  : 
; 157  : 	win=gMainHandler->FindWindow(TAC_PLAY_SCREEN);
...
; 161  : 		tmr->Setup(C_DONT_CARE,C_TYPE_TIMER);
...
; 162  : 		tmr->SetUpdateCallback(GenericTimerCB);
...
; 163  : 		tmr->SetRefreshCallback(BlinkCommsButtonTimerCB);
...
; 164  : 		tmr->SetUserNumber(_UI95_TIMER_DELAY_,1*_UI95_TICKS_PER_SECOND_); // Timer activates every 2 seconds (Only when this window is open)
...
; 168  : 	TACLoaded = TRUE;
	...
	mov	DWORD PTR ?TACLoaded@@3HA, 1		; TACLoaded
$LN7@LoadTactic:
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?LoadTacticalWindows@@YAXXZ$0:
	mov	eax, DWORD PTR $T3[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?LoadTacticalWindows@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-28]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?LoadTacticalWindows@@YAXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?LoadTacticalWindows@@YAXXZ ENDP			; LoadTacticalWindows
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui\src\taceng\ui_taceng.cpp
_TEXT	SEGMENT
_win$ = -12						; size = 4
_tac_train$ = -8					; size = 4
_ID$ = -4						; size = 4
?LoadTacEngSelectWindows@@YAXXZ PROC			; LoadTacEngSelectWindows
...
; 89   : 	C_Window *win;
; 90   : 	C_Button *tac_train = NULL;

	mov	DWORD PTR _tac_train$[ebp], 0
...
; 93   : 	if(!PlannerLoaded)
	...
	jne	SHORT $LN8@LoadTacEng

; 94   : 		LoadPlannerWindows();

	call	?LoadPlannerWindows@@YAXXZ		; LoadPlannerWindows
$LN8@LoadTacEng:

; 95   : 
; 96   : 	LoadCommonWindows();
...
; 99   : 	{
; 100  : 		if( _LOAD_ART_RESOURCES_)

	cmp	DWORD PTR ?_LOAD_ART_RESOURCES_@@3JA, 0	; _LOAD_ART_RESOURCES_
	je	SHORT $LN6@LoadTacEng

; 101  : 			gMainParser->LoadImageList ("ts_res.lst");

	push	OFFSET ??_C@_0L@MCLOOGLL@ts_res?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadImageList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadImageList

; 102  : 		else

	jmp	SHORT $LN5@LoadTacEng
$LN6@LoadTacEng:

; 103  : 			gMainParser->LoadImageList ("ts_art.lst");

	push	OFFSET ??_C@_0L@IPPGECIL@ts_art?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadImageList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadImageList
$LN5@LoadTacEng:

; 104  : 
; 105  : 		gMainParser->LoadSoundList ("ts_snd.lst");

	push	OFFSET ??_C@_0L@BCMAIAPM@ts_snd?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadSoundList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadSoundList

; 106  : 
; 107  : 		gMainParser->LoadWindowList ("ts_scf.lst");

	push	OFFSET ??_C@_0L@DONPEADH@ts_scf?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadWindowList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadWindowList

; 108  : 
; 109  : 		ID=gMainParser->GetFirstWindowLoaded ();
...
; 111  : 		while(ID)
	...
	cmp	DWORD PTR _ID$[ebp], 0
	je	SHORT $LN3@LoadTacEng

; 112  : 		{
; 113  : 			hookup_tactical_controls (ID);
...
; 114  : 			ID = gMainParser->GetNextWindowLoaded ();
...
; 115  : 		}
	...
	jmp	SHORT $LN4@LoadTacEng
$LN3@LoadTacEng:

; 116  : 		TACSelLoaded++;

	mov	ecx, DWORD PTR ?TACSelLoaded@@3HA	; TACSelLoaded
	add	ecx, 1
	mov	DWORD PTR ?TACSelLoaded@@3HA, ecx	; TACSelLoaded
$LN7@LoadTacEng:

; 117  : 	}
; 118  : 
; 119  : 	win = gMainHandler->FindWindow (TAC_MISSION_WIN);
...
; 121  : 	if (win) // JPO
	...
	cmp	DWORD PTR _win$[ebp], 0
	je	SHORT $LN2@LoadTacEng

; 122  : 	    tac_train=(C_Button *)win->FindControl(TAC_TRAIN_CTRL);

	push	30203					; 000075fbH
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
	mov	DWORD PTR _tac_train$[ebp], eax
$LN2@LoadTacEng:

; 123  : 	if(tac_train)

	cmp	DWORD PTR _tac_train$[ebp], 0
	je	SHORT $LN1@LoadTacEng

; 124  : 		tactical_select_training(TAC_TRAIN_CTRL,C_TYPE_LMOUSEUP,tac_train);

	mov	edx, DWORD PTR _tac_train$[ebp]
	push	edx
	push	52					; 00000034H
	push	30203					; 000075fbH
	call	?tactical_select_training@@YAXJFPAVC_Base@@@Z ; tactical_select_training
	add	esp, 12					; 0000000cH
$LN1@LoadTacEng:

; 125  : 
; 126  : 	SetSingle_Comms_Ctrls();
...
; 127  : }
	...
	pop	ebp
	ret	0
?LoadTacEngSelectWindows@@YAXXZ ENDP			; LoadTacEngSelectWindows
_TEXT	ENDS
; Function compile flags: /Odtp
