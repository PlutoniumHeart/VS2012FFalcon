; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\UI\Src\ui_help.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?TestSoundCB@@YAXJFPAVC_Base@@@Z		; TestSoundCB
PUBLIC	?UI_Help_Guide_CB@@YAXJFPAVC_Base@@@Z		; UI_Help_Guide_CB
PUBLIC	?HookupHelpGuideWindows@@YAXJ@Z			; HookupHelpGuideWindows
PUBLIC	?LoadHelpGuideWindows@@YAXXZ			; LoadHelpGuideWindows
...
PUBLIC	??_C@_0N@LNEOJNHD@help_res?4lst?$AA@		; `string'
PUBLIC	??_C@_0N@PAAGDJED@help_art?4lst?$AA@		; `string'
PUBLIC	??_C@_0N@GNDAPLDE@help_snd?4lst?$AA@		; `string'
PUBLIC	??_C@_0N@EBCPDLPP@help_scf?4lst?$AA@		; `string'
...
EXTRN	?HelpLoaded@@3HA:DWORD				; HelpLoaded
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@EBCPDLPP@help_scf?4lst?$AA@
CONST	SEGMENT
??_C@_0N@EBCPDLPP@help_scf?4lst?$AA@ DB 'help_scf.lst', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@GNDAPLDE@help_snd?4lst?$AA@
CONST	SEGMENT
??_C@_0N@GNDAPLDE@help_snd?4lst?$AA@ DB 'help_snd.lst', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@PAAGDJED@help_art?4lst?$AA@
CONST	SEGMENT
??_C@_0N@PAAGDJED@help_art?4lst?$AA@ DB 'help_art.lst', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LNEOJNHD@help_res?4lst?$AA@
CONST	SEGMENT
??_C@_0N@LNEOJNHD@help_res?4lst?$AA@ DB 'help_res.lst', 00H ; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui\src\ui_help.cpp
_TEXT	SEGMENT
_ID$ = -4						; size = 4
?LoadHelpGuideWindows@@YAXXZ PROC			; LoadHelpGuideWindows
...
; 132  : 	long ID;
; 133  : 
; 134  : 	if(HelpLoaded) return;

	cmp	DWORD PTR ?HelpLoaded@@3HA, 0		; HelpLoaded
	je	SHORT $LN5@LoadHelpGu
	jmp	$LN6@LoadHelpGu
$LN5@LoadHelpGu:

; 135  : 
; 136  : 	if( _LOAD_ART_RESOURCES_)

	cmp	DWORD PTR ?_LOAD_ART_RESOURCES_@@3JA, 0	; _LOAD_ART_RESOURCES_
	je	SHORT $LN4@LoadHelpGu

; 137  : 		gMainParser->LoadImageList("help_res.lst");

	push	OFFSET ??_C@_0N@LNEOJNHD@help_res?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadImageList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadImageList

; 138  : 	else

	jmp	SHORT $LN3@LoadHelpGu
$LN4@LoadHelpGu:

; 139  : 		gMainParser->LoadImageList("help_art.lst");

	push	OFFSET ??_C@_0N@PAAGDJED@help_art?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadImageList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadImageList
$LN3@LoadHelpGu:

; 140  : 	gMainParser->LoadSoundList("help_snd.lst");

	push	OFFSET ??_C@_0N@GNDAPLDE@help_snd?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadSoundList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadSoundList

; 141  : 	gMainParser->LoadWindowList("help_scf.lst");  // Modified by M.N. - add art/art1024 by LoadWindowList

	push	OFFSET ??_C@_0N@EBCPDLPP@help_scf?4lst?$AA@
	mov	ecx, DWORD PTR ?gMainParser@@3PAVC_Parser@@A ; gMainParser
	call	?LoadWindowList@C_Parser@@QAEHPAD@Z	; C_Parser::LoadWindowList

; 142  : 
; 143  : 	ID=gMainParser->GetFirstWindowLoaded();
...
; 144  : 	while(ID)
	...
	je	SHORT $LN1@LoadHelpGu

; 145  : 	{
; 146  : 		HookupHelpGuideWindows(ID);

	mov	eax, DWORD PTR _ID$[ebp]
	push	eax
	call	?HookupHelpGuideWindows@@YAXJ@Z		; HookupHelpGuideWindows
	add	esp, 4

; 147  : 		ID=gMainParser->GetNextWindowLoaded();
...
; 148  : 	}
	...
	jmp	SHORT $LN2@LoadHelpGu
$LN1@LoadHelpGu:

; 149  : 	HelpLoaded++;

	mov	ecx, DWORD PTR ?HelpLoaded@@3HA		; HelpLoaded
	add	ecx, 1
	mov	DWORD PTR ?HelpLoaded@@3HA, ecx		; HelpLoaded
$LN6@LoadHelpGu:
...
; 150  : }
	...
	pop	ebp
	ret	0
?LoadHelpGuideWindows@@YAXXZ ENDP			; LoadHelpGuideWindows
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui\src\ui_help.cpp
_TEXT	SEGMENT
...
_lbox$ = -4						; size = 4
_ID$ = 8						; size = 4
?HookupHelpGuideWindows@@YAXJ@Z PROC			; HookupHelpGuideWindows
...
; 95   : 	C_ListBox *lbox;
; 96   : 
; 97   : 	win=gMainHandler->FindWindow(ID);
...
; 99   : 	{
; 100  : 		btn=(C_Button*)win->FindControl(CLOSE_WINDOW);
...
; 101  : 		if(btn)
	...
	je	SHORT $LN7@HookupHelp

; 102  : 			btn->SetCallback(CloseWindowCB);
...
; 103  : 
; 104  : 		lbox=(C_ListBox*)win->FindControl(TEST_GENERAL_ID);

	push	1324001					; 001433e1H
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
...
; 105  : 		if(lbox)
	...
	je	SHORT $LN6@HookupHelp

; 106  : 			lbox->SetCallback(TestSoundCB);

	push	OFFSET ?TestSoundCB@@YAXJFPAVC_Base@@@Z	; TestSoundCB
...
; 107  : 
; 108  : 		lbox=(C_ListBox*)win->FindControl(TEST_MUSIC_ID);

	push	1324002					; 001433e2H
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
	mov	DWORD PTR _lbox$[ebp], eax
...
; 109  : 		if(lbox)
	...
	cmp	DWORD PTR _lbox$[ebp], 0
	je	SHORT $LN5@HookupHelp

; 110  : 			lbox->SetCallback(TestSoundCB);
...
; 111  : 
; 112  : 		lbox=(C_ListBox*)win->FindControl(TEST_IA_STREAM_ID);

	push	1324003					; 001433e3H
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
	mov	DWORD PTR _lbox$[ebp], eax
...
; 113  : 		if(lbox)
	...
	cmp	DWORD PTR _lbox$[ebp], 0
	je	SHORT $LN4@HookupHelp

; 114  : 			lbox->SetCallback(TestSoundCB);
...
; 115  : 
; 116  : 		lbox=(C_ListBox*)win->FindControl(TEST_DF_STREAM_ID);

	push	1324004					; 001433e4H
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
	mov	DWORD PTR _lbox$[ebp], eax
...
; 117  : 		if(lbox)
	...
	cmp	DWORD PTR _lbox$[ebp], 0
	je	SHORT $LN3@HookupHelp

; 118  : 			lbox->SetCallback(TestSoundCB);
...
; 119  : 
; 120  : 		lbox=(C_ListBox*)win->FindControl(TEST_CP_STREAM_ID);

	push	1324005					; 001433e5H
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
	mov	DWORD PTR _lbox$[ebp], eax
...
; 121  : 		if(lbox)
	...
	cmp	DWORD PTR _lbox$[ebp], 0
	je	SHORT $LN2@HookupHelp

; 122  : 			lbox->SetCallback(TestSoundCB);
...
; 123  : 
; 124  : 		lbox=(C_ListBox*)win->FindControl(TEST_CP2_STREAM_ID);

	push	1324006					; 001433e6H
	mov	ecx, DWORD PTR _win$[ebp]
	call	?FindControl@C_Window@@QAEPAVC_Base@@J@Z ; C_Window::FindControl
	mov	DWORD PTR _lbox$[ebp], eax
...
; 125  : 		if(lbox)
	...
	cmp	DWORD PTR _lbox$[ebp], 0
	je	SHORT $LN9@HookupHelp

; 126  : 			lbox->SetCallback(TestSoundCB);
...
; 128  : }
	...
	pop	ebp
	ret	0
?HookupHelpGuideWindows@@YAXJ@Z ENDP			; HookupHelpGuideWindows
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui\src\ui_help.cpp
_TEXT	SEGMENT
...
_hittype$ = 12						; size = 2
_ctrl$ = 16						; size = 4
?UI_Help_Guide_CB@@YAXJFPAVC_Base@@@Z PROC		; UI_Help_Guide_CB
...
; 65   : 	if(hittype != C_TYPE_LMOUSEUP)

	movsx	eax, WORD PTR _hittype$[ebp]
	cmp	eax, 52					; 00000034H
	je	SHORT $LN8@UI_Help_Gu
...
; 68   : 	if(ctrl->GetGroup())
	...
	test	eax, eax
	je	SHORT $LN7@UI_Help_Gu

; 69   : 	{
; 70   : 		gMainHandler->EnableWindowGroup(ctrl->GetGroup());
...
; 72   : 	else
	...
	jmp	SHORT $LN9@UI_Help_Gu
$LN7@UI_Help_Gu:

; 73   : 	{
; 74   : 		if(MainLastGroup == 4000) // Campaign

	cmp	DWORD PTR ?MainLastGroup@@3HA, 4000	; MainLastGroup, 00000fa0H
	jne	SHORT $LN5@UI_Help_Gu

; 75   : 		{
; 76   : 			if(ctrl->GetUserNumber(CampaignLastGroup))
	...
	test	eax, eax
	je	SHORT $LN4@UI_Help_Gu

; 77   : 			{
; 78   : 				gMainHandler->EnableWindowGroup(ctrl->GetUserNumber(CampaignLastGroup));
...
; 81   : 		else if(MainLastGroup == 3000) // Campaign

	cmp	DWORD PTR ?MainLastGroup@@3HA, 3000	; MainLastGroup, 00000bb8H
	jne	SHORT $LN9@UI_Help_Gu

; 82   : 		{
; 83   : 			if(ctrl->GetUserNumber(TacLastGroup))
	...
	call	?GetUserNumber@C_Base@@QAEJJ@Z		; C_Base::GetUserNumber
	test	eax, eax
	je	SHORT $LN9@UI_Help_Gu

; 84   : 			{
; 85   : 				gMainHandler->EnableWindowGroup(ctrl->GetUserNumber(TacLastGroup));
...
; 89   : }
	...
	pop	ebp
	ret	0
?UI_Help_Guide_CB@@YAXJFPAVC_Base@@@Z ENDP		; UI_Help_Guide_CB
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui\src\ui_help.cpp
_TEXT	SEGMENT
...
_hittype$ = 12						; size = 2
_ctrl$ = 16						; size = 4
?TestSoundCB@@YAXJFPAVC_Base@@@Z PROC			; TestSoundCB
...
; 42   : 	SOUND_RES *snd;
; 43   : 
; 44   : 	if(hittype != C_TYPE_SELECT)

	movsx	eax, WORD PTR _hittype$[ebp]
	cmp	eax, 28					; 0000001cH
	je	SHORT $LN4@TestSoundC

; 45   : 		return;

	jmp	SHORT $LN5@TestSoundC
$LN4@TestSoundC:

; 46   : 
; 47   : 	lbox=(C_ListBox*)ctrl;
...
; 48   : 	if(lbox)
	...
	cmp	DWORD PTR _lbox$[ebp], 0
	je	SHORT $LN5@TestSoundC

; 49   : 	{
; 50   : 		itemID=lbox->GetTextID();
...
; 52   : 		{
; 53   : 			snd=gSoundMgr->GetSound(itemID);
...
; 61   : }
	...
	pop	ebp
	ret	0
?TestSoundCB@@YAXJFPAVC_Base@@@Z ENDP			; TestSoundCB
_TEXT	ENDS
; Function compile flags: /Odtp
