; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\BSPlib\Scripts.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?ScriptArray@@3PAP6AXXZA			; ScriptArray
PUBLIC	?ScriptArrayLength@@3HA				; ScriptArrayLength
...
CONST	ENDS
_DATA	SEGMENT
?ScriptArray@@3PAP6AXXZA DD FLAT:?UH1@@YAXXZ		; ScriptArray
	DD	FLAT:?AH64@@YAXXZ
	DD	FLAT:?Hokum@@YAXXZ
	DD	FLAT:?OneProp@@YAXXZ
	DD	FLAT:?C130@@YAXXZ
	DD	FLAT:?E3@@YAXXZ
	DD	FLAT:?VASIF@@YAXXZ
	DD	FLAT:?VASIN@@YAXXZ
	DD	FLAT:?Chaff@@YAXXZ
	DD	FLAT:?Beacon@@YAXXZ
	DD	FLAT:?CollapseChute@@YAXXZ
	DD	FLAT:?LongBow@@YAXXZ
	DD	FLAT:?Cycle2@@YAXXZ
	DD	FLAT:?Cycle4@@YAXXZ
	DD	FLAT:?Cycle10@@YAXXZ
	DD	FLAT:?TStrobe@@YAXXZ
	DD	FLAT:?TU95@@YAXXZ
	DD	FLAT:?MeatBall@@YAXXZ
	DD	FLAT:?ComplexProp@@YAXXZ
?ScriptArrayLength@@3HA DD 013H				; ScriptArrayLength
_DATA	ENDS
...
PUBLIC	?GetDeltaTime@TimeManager@@QAEKXZ		; TimeManager::GetDeltaTime
...
_BSS	ENDS
;	COMDAT ?angles@?1??MeatBall@@YAXXZ@4QBMB
_BSS	SEGMENT
?angles@?1??MeatBall@@YAXXZ@4QBMB DD 0dH DUP (?)	; `MeatBall'::`2'::angles
_BSS	ENDS
;	COMDAT ?$S1@?1??MeatBall@@YAXXZ@4IA
_BSS	SEGMENT
?$S1@?1??MeatBall@@YAXXZ@4IA DD 01H DUP (?)		; `MeatBall'::`2'::$S1
_BSS	ENDS
...
CONST	ENDS
;	COMDAT __real@43430000
CONST	SEGMENT
__real@43430000 DD 043430000r			; 195
CONST	ENDS
...
??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@ DB 'invalid string posi'
	DB	'tion', 00H					; `string'
CONST	ENDS
;	COMDAT ?GS@?1??MeatBall@@YAXXZ@4MB
CONST	SEGMENT
?GS@?1??MeatBall@@YAXXZ@4MB DD 040400000r	; 3	; `MeatBall'::`2'::GS
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
tv92 = -28						; size = 8
_delta$ = -20						; size = 4
tv73 = -16						; size = 4
...
_maxd$ = -8						; size = 4
_i$1 = -4						; size = 4
?ComplexProp@@YAXXZ PROC				; ComplexProp
...
; 389  : 	float delta = TheTimeManager.GetDeltaTime() * 200.0f * DegreesPerSecond;

	mov	ecx, OFFSET ?TheTimeManager@@3VTimeManager@@A ; TheTimeManager
	call	?GetDeltaTime@TimeManager@@QAEKXZ	; TimeManager::GetDeltaTime
...
; 390  : 
; 391  : 	int maxd = TheStateStack.CurrentInstance->ParentObject->nDOFs;
...
; 392  : 	ShiAssert( maxd > 31);
; 393  : 	maxd = min(maxd, 38);

	cmp	DWORD PTR _maxd$[ebp], 38		; 00000026H
	jge	SHORT $LN6@ComplexPro
	mov	ecx, DWORD PTR _maxd$[ebp]
	mov	DWORD PTR tv73[ebp], ecx
	jmp	SHORT $LN7@ComplexPro
$LN6@ComplexPro:
	mov	DWORD PTR tv73[ebp], 38			; 00000026H
$LN7@ComplexPro:
	mov	edx, DWORD PTR tv73[ebp]
	mov	DWORD PTR _maxd$[ebp], edx

; 394  : 	for (int i = 31; i < maxd; i++)

	mov	DWORD PTR _i$1[ebp], 31			; 0000001fH
	jmp	SHORT $LN3@ComplexPro
$LN2@ComplexPro:
...
$LN3@ComplexPro:
	...
	cmp	ecx, DWORD PTR _maxd$[ebp]
	jge	SHORT $LN1@ComplexPro

; 395  : 		TheStateStack.CurrentInstance->DOFValues[i].rotation += delta;
...
; 396  : }
	...
	pop	ebp
	ret	0
?ComplexProp@@YAXXZ ENDP				; ComplexProp
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
...
; 365  : 	float angle = (float)atan2( -TheStateStack.ObjSpaceEye.z, TheStateStack.ObjSpaceEye.x );

	cvtss2sd xmm0, DWORD PTR ?ObjSpaceEye@StateStackClass@@2UTpoint@@A
	sub	esp, 8
...
; 366  : 	static const float GS = 3;
; 367  : 	static const float angles[] = 
; 368  : 	{
; 369  : 		GS+2.3f, GS+2, GS+1.7f, GS+1.3f, GS+1, GS+0.7F, GS+0.3f, 

	mov	eax, DWORD PTR ?$S1@?1??MeatBall@@YAXXZ@4IA
	and	eax, 1
	jne	$LN7@MeatBall
	mov	ecx, DWORD PTR ?$S1@?1??MeatBall@@YAXXZ@4IA
	or	ecx, 1
	mov	DWORD PTR ?$S1@?1??MeatBall@@YAXXZ@4IA, ecx
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@40133333
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@40000000
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+4, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@3fd9999a
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+8, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@3fa66666
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+12, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+16, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@3f333333
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+20, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	addss	xmm0, DWORD PTR __real@3e99999a
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+24, xmm0

; 370  : 		GS, 

	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+28, xmm0

; 371  : 		GS-0.3f, GS-0.7f, GS-1, GS-1.3f, GS-1.7f

	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	subss	xmm0, DWORD PTR __real@3e99999a
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+32, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	subss	xmm0, DWORD PTR __real@3f333333
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+36, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	subss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+40, xmm0
	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	subss	xmm0, DWORD PTR __real@3fa66666
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+44, xmm0

; 372  : 	};

	movss	xmm0, DWORD PTR ?GS@?1??MeatBall@@YAXXZ@4MB
	subss	xmm0, DWORD PTR __real@3fd9999a
	movss	DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB+48, xmm0
$LN7@MeatBall:

; 373  : 	static const int NANGLES = sizeof(angles)/sizeof(angles[0]);
; 374  : 
; 375  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches >= NANGLES -2);
; 376  : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= NANGLES -2) return;

	mov	edx, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	eax, DWORD PTR [edx+32]
	movsx	ecx, WORD PTR [eax+52]
	cmp	ecx, 11					; 0000000bH
	jg	SHORT $LN6@MeatBall
	jmp	SHORT $LN8@MeatBall
$LN6@MeatBall:
...
; 378  : 	for (int i = 0; i < NANGLES-1; i++) 

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN5@MeatBall
$LN4@MeatBall:
...
$LN5@MeatBall:
	...
	jge	SHORT $LN3@MeatBall

; 379  : 	{
; 380  : 	  if (angle < angles[i] && angle > angles[i+1])

	mov	eax, DWORD PTR _i$1[ebp]
	movss	xmm0, DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB[eax*4]
	comiss	xmm0, DWORD PTR _angle$[ebp]
	jbe	SHORT $LN2@MeatBall
	mov	ecx, DWORD PTR _i$1[ebp]
	movss	xmm0, DWORD PTR _angle$[ebp]
	comiss	xmm0, DWORD PTR ?angles@?1??MeatBall@@YAXXZ@4QBMB[ecx*4+4]
	jbe	SHORT $LN2@MeatBall

; 381  : 			TheStateStack.CurrentInstance->SetSwitch(i, 1);
...
; 382  : 	  else
	...
	jmp	SHORT $LN1@MeatBall
$LN2@MeatBall:

; 383  : 			TheStateStack.CurrentInstance->SetSwitch(i, 0);
...
; 347  : 	float delta = TheTimeManager.GetDeltaTime() * 200.0f * DegreesPerSecond;

	mov	ecx, OFFSET ?TheTimeManager@@3VTimeManager@@A ; TheTimeManager
	call	?GetDeltaTime@TimeManager@@QAEKXZ	; TimeManager::GetDeltaTime
	mov	DWORD PTR tv195[ebp], eax
	cvtsi2sd xmm0, DWORD PTR tv195[ebp]
	mov	eax, DWORD PTR tv195[ebp]
	shr	eax, 31					; 0000001fH
	addsd	xmm0, QWORD PTR __xmm@41f00000000000000000000000000000[eax*8]
	movsd	QWORD PTR tv198[ebp], xmm0
	cvtsd2ss xmm0, QWORD PTR tv198[ebp]
	mulss	xmm0, DWORD PTR __real@43480000
	mulss	xmm0, DWORD PTR _DegreesPerSecond
	movss	DWORD PTR _delta$[ebp], xmm0

; 348  : 
; 349  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 9 );
; 350  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 9) return;
...
; 351  : 
; 352  : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;
...
; 353  : 	TheStateStack.CurrentInstance->DOFValues[3].rotation += delta;
...
; 354  : 	TheStateStack.CurrentInstance->DOFValues[4].rotation += delta;
...
; 355  : 	TheStateStack.CurrentInstance->DOFValues[5].rotation += delta;
...
; 356  : 	TheStateStack.CurrentInstance->DOFValues[6].rotation += delta;
...
; 357  : 	TheStateStack.CurrentInstance->DOFValues[7].rotation += delta;
...
; 358  : 	TheStateStack.CurrentInstance->DOFValues[8].rotation += delta;
...
; 359  : 	TheStateStack.CurrentInstance->DOFValues[9].rotation += delta;
...
; 360  : }
	...
	pop	ebp
	ret	0
?TU95@@YAXXZ ENDP					; TU95
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
?TStrobe@@YAXXZ PROC					; TStrobe
...
; 334  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 7 );
; 335  : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 7) return;
	...
	cmp	edx, 7
	jg	SHORT $LN4@TStrobe
	jmp	SHORT $LN5@TStrobe
$LN4@TStrobe:

; 336  : 	
; 337  : 	if (TheStateStack.CurrentInstance->SwitchValues[7] >= 0x10) {

	mov	eax, 4
	imul	eax, 7
	mov	ecx, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 16			; 00000010H
	jb	SHORT $LN3@TStrobe

; 338  : 		TheStateStack.CurrentInstance->SwitchValues[7] = 1;
...
; 339  : 	} else if (TheStateStack.CurrentInstance->SwitchValues[7] > 0) {
	...
	jbe	SHORT $LN5@TStrobe

; 340  : 		TheStateStack.CurrentInstance->SwitchValues[7] <<= 1;
...
; 342  : }
	...
	pop	ebp
	ret	0
?TStrobe@@YAXXZ ENDP					; TStrobe
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
?Cycle10@@YAXXZ PROC					; Cycle10
...
; 318  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 319  : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 0) return;

	mov	eax, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	ecx, DWORD PTR [eax+32]
	movsx	edx, WORD PTR [ecx+52]
	test	edx, edx
	jg	SHORT $LN5@Cycle10
	jmp	$LN6@Cycle10
$LN5@Cycle10:

; 320  : 
; 321  : 	if (TheStateStack.CurrentInstance->SwitchValues[0] >= 0x200) {

	mov	eax, 4
	imul	eax, 0
	mov	ecx, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 512		; 00000200H
	jb	SHORT $LN4@Cycle10

; 322  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
	...
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR [eax+edx], 1
	jmp	SHORT $LN6@Cycle10
$LN4@Cycle10:

; 323  : 	} else if (TheStateStack.CurrentInstance->SwitchValues[0] > 0) {
	...
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 0
	jbe	SHORT $LN2@Cycle10

; 324  : 		TheStateStack.CurrentInstance->SwitchValues[0] <<= 1;
...
; 326  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
...
; 328  : }
	...
	pop	ebp
	ret	0
?Cycle10@@YAXXZ ENDP					; Cycle10
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
?Cycle4@@YAXXZ PROC					; Cycle4
...
; 302  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 303  : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 0) return;
...
; 304  : 
; 305  : 	if (TheStateStack.CurrentInstance->SwitchValues[0] >= 8) {

	mov	eax, 4
	imul	eax, 0
	mov	ecx, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 8
	jb	SHORT $LN4@Cycle4

; 306  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
	...
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR [eax+edx], 1
	jmp	SHORT $LN6@Cycle4
$LN4@Cycle4:

; 307  : 	} else if (TheStateStack.CurrentInstance->SwitchValues[0] > 0) {
	...
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 0
	jbe	SHORT $LN2@Cycle4

; 308  : 		TheStateStack.CurrentInstance->SwitchValues[0] <<= 1;
...
; 310  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
...
; 312  : }
	...
	pop	ebp
	ret	0
?Cycle4@@YAXXZ ENDP					; Cycle4
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
?Cycle2@@YAXXZ PROC					; Cycle2
...
; 288  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 289  : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 0) return;
	...
	test	edx, edx
	jg	SHORT $LN3@Cycle2
	jmp	SHORT $LN4@Cycle2
$LN3@Cycle2:

; 290  : 
; 291  : 	if (TheStateStack.CurrentInstance->SwitchValues[0] == 1) {
	...
	jne	SHORT $LN2@Cycle2

; 292  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 2;
...
; 294  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
...
; 276  : 	float delta = TheTimeManager.GetDeltaTime() * 600.0f * DegreesPerSecond;
...
; 277  : 
; 278  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 2 );
; 279  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 2) return;

	mov	ecx, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	edx, DWORD PTR [ecx+32]
	movsx	eax, WORD PTR [edx+54]
	cmp	eax, 2
	jg	SHORT $LN1@OneProp
	jmp	SHORT $LN2@OneProp
$LN1@OneProp:

; 280  : 
; 281  : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;
...
; 263  : 	float delta = TheTimeManager.GetDeltaTime() * 360.0f * DegreesPerSecond;
...
; 264  : 
; 265  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 4 );
; 266  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 4) return;
...
; 267  : 
; 268  : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;
...
; 269  : 	TheStateStack.CurrentInstance->DOFValues[3].rotation += delta;
...
; 270  : 	TheStateStack.CurrentInstance->DOFValues[4].rotation += delta;
...
; 249  : 	float delta = TheTimeManager.GetDeltaTime() * 540.0f * DegreesPerSecond;
	...
	mulss	xmm0, DWORD PTR __real@44070000
	mulss	xmm0, DWORD PTR _DegreesPerSecond
	movss	DWORD PTR _delta$[ebp], xmm0

; 250  : 
; 251  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 5 );
; 252  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 5) return;

	mov	ecx, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	edx, DWORD PTR [ecx+32]
	movsx	eax, WORD PTR [edx+54]
	cmp	eax, 5
	jg	SHORT $LN1@LongBow
	jmp	$LN2@LongBow
$LN1@LongBow:

; 253  : 
; 254  : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;			// Main rotor
...
; 255  : 	TheStateStack.CurrentInstance->DOFValues[3].rotation += delta * 1.6f;	// Tail rotor
...
; 256  : 	TheStateStack.CurrentInstance->DOFValues[4].rotation += delta * 2.1f;	// Muzzle flash
...
; 257  : 	TheStateStack.CurrentInstance->DOFValues[5].rotation += delta * 0.1f;	// Radar
...
; 237  : 	float delta = TheTimeManager.GetDeltaTime() * 500.0f * DegreesPerSecond;
...
; 238  : 
; 239  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 3 );
; 240  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 3) return;
...
; 241  : 
; 242  : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;
...
; 243  : 	TheStateStack.CurrentInstance->DOFValues[3].rotation += delta*2.1f;
...
; 226  : 	float delta = TheTimeManager.GetDeltaTime() * 135.0f * DegreesPerSecond;
...
; 227  : 
; 228  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 3 );
; 229  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 3) return;
...
; 230  : 
; 231  : 	TheStateStack.CurrentInstance->DOFValues[14].rotation += delta;
...
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
?CollapseChute@@YAXXZ PROC				; CollapseChute
...
; 208  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 209  : 
; 210  : 	if (TheStateStack.CurrentInstance->SwitchValues[0] == 0) {
	...
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 0
	jne	SHORT $LN8@CollapseCh

; 211  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
...
; 212  : 	} else if (TheStateStack.CurrentInstance->SwitchValues[0] < 0x40) {
	...
	jae	SHORT $LN6@CollapseCh

; 213  : 		TheStateStack.CurrentInstance->SwitchValues[0] <<= 1;
	...
	mov	edx, DWORD PTR [edx]
	mov	DWORD PTR [ecx+edx], eax
	jmp	SHORT $LN9@CollapseCh
$LN6@CollapseCh:

; 214  : 	} else if (TheStateStack.CurrentInstance->SwitchValues[0] == 0x40) {
	...
	mov	edx, DWORD PTR [ecx]
	cmp	DWORD PTR [eax+edx], 64			; 00000040H
	jne	SHORT $LN4@CollapseCh

; 215  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 0x10000020;
...
; 216  : 	} else if (TheStateStack.CurrentInstance->SwitchValues[0] == 0x10000020) {
	...
	jne	SHORT $LN2@CollapseCh

; 217  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 0x10000010;
...
; 219  : 		TheStateStack.CurrentInstance->SwitchValues[0] = 0x00000008;
...
; 221  : }
	...
	pop	ebp
	ret	0
?CollapseChute@@YAXXZ ENDP				; CollapseChute
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
...
; 121  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 1 );
; 122  : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 0 );
; 123  : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 0) return;

	mov	eax, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	ecx, DWORD PTR [eax+32]
	movsx	edx, WORD PTR [ecx+54]
	test	edx, edx
	jg	SHORT $LN20@Beacon
	jmp	$LN21@Beacon
$LN20@Beacon:

; 124  : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 1) return;

	mov	eax, DWORD PTR ?CurrentInstance@StateStackClass@@2PAVObjectInstance@@A ; StateStackClass::CurrentInstance
	mov	ecx, DWORD PTR [eax+32]
	movsx	edx, WORD PTR [ecx+52]
	cmp	edx, 1
	jg	SHORT $LN19@Beacon
	jmp	$LN21@Beacon
$LN19@Beacon:

; 125  : 
; 126  : 	DWORD sw = TheStateStack.CurrentInstance->SwitchValues[1];
...
; 127  : 	float delta = TheTimeManager.GetDeltaTime() * 36.0f * DegreesPerSecond;

	mov	ecx, OFFSET ?TheTimeManager@@3VTimeManager@@A ; TheTimeManager
	call	?GetDeltaTime@TimeManager@@QAEKXZ	; TimeManager::GetDeltaTime
	mov	DWORD PTR tv224[ebp], eax
	cvtsi2sd xmm0, DWORD PTR tv224[ebp]
	mov	ecx, DWORD PTR tv224[ebp]
	shr	ecx, 31					; 0000001fH
	addsd	xmm0, QWORD PTR __xmm@41f00000000000000000000000000000[ecx*8]
	movsd	QWORD PTR tv227[ebp], xmm0
	cvtsd2ss xmm0, QWORD PTR tv227[ebp]
	mulss	xmm0, DWORD PTR __real@42100000
	mulss	xmm0, DWORD PTR _DegreesPerSecond
	movss	DWORD PTR _delta$[ebp], xmm0

; 128  : 	float rot;			// Rotation of beacon head
; 129  : 	float dx, dy;		// Eye vector in light beam space
; 130  : 	float da;			// Signed angle between light beam and vector to the eye point
; 131  : 	mlTrig trig;
; 132  : 
; 133  : 
; 134  : //	delta = 0.0f;
; 135  : 
; 136  : 	// Compute the beacon's orientation and angle away from the viewer
; 137  : 	rot = TheStateStack.CurrentInstance->DOFValues[0].rotation + delta;
...
; 138  : 
; 139  : 	// 0 degree green light
; 140  : 	mlSinCos(&trig, rot);
...
; 141  : 	dx =  TheStateStack.ObjSpaceEye.x * trig.cos + TheStateStack.ObjSpaceEye.y * trig.sin;

	movss	xmm0, DWORD PTR ?ObjSpaceEye@StateStackClass@@2UTpoint@@A
	mulss	xmm0, DWORD PTR _trig$[ebp+4]
	movss	xmm1, DWORD PTR ?ObjSpaceEye@StateStackClass@@2UTpoint@@A+4
	mulss	xmm1, DWORD PTR _trig$[ebp]
	addss	xmm0, xmm1
	movss	DWORD PTR _dx$[ebp], xmm0

; 142  : 	dy = -TheStateStack.ObjSpaceEye.x * trig.sin + TheStateStack.ObjSpaceEye.y * trig.cos;
...
; 144  : 
; 145  : 	if (fabs(da) > 5.0f*Degrees) {

	push	ecx
	movss	xmm0, DWORD PTR _da$[ebp]
	movss	DWORD PTR [esp], xmm0
	...
	mulss	xmm1, DWORD PTR _Degrees
	comiss	xmm0, xmm1
	jbe	SHORT $LN18@Beacon

; 146  : 		sw &= 0xFFFFFFF8;				// All off
...
; 147  : 	} else {
	...
	jmp	SHORT $LN13@Beacon
$LN18@Beacon:

; 148  : 		if (da < 0.0f) {

	movss	xmm0, DWORD PTR __real@00000000
	comiss	xmm0, DWORD PTR _da$[ebp]
	jbe	SHORT $LN16@Beacon

; 149  : 			if ((sw & 0x4) == 0) {

	mov	ecx, DWORD PTR _sw$[ebp]
	and	ecx, 4
	jne	SHORT $LN15@Beacon

; 150  : 				sw |= 0x7;				// Flash on, has flashed, visible
...
; 151  : 			} else {
	...
	jmp	SHORT $LN14@Beacon
$LN15@Beacon:

; 152  : 				sw &= 0xFFFFFFFD;		// Flash off
...
; 157  : 	}
; 158  : 
; 159  : 	// 165 degree white light
; 160  : 	mlSinCos(&trig, rot + 165.0F*Degrees);

	movss	xmm0, DWORD PTR __real@43250000
	mulss	xmm0, DWORD PTR _Degrees
	addss	xmm0, DWORD PTR _rot$[ebp]
	push	ecx
	movss	DWORD PTR [esp], xmm0
	lea	edx, DWORD PTR _trig$[ebp]
	push	edx
...
; 161  : 	dx =  TheStateStack.ObjSpaceEye.x * trig.cos + TheStateStack.ObjSpaceEye.y * trig.sin;
...
; 162  : 	dy = -TheStateStack.ObjSpaceEye.x * trig.sin + TheStateStack.ObjSpaceEye.y * trig.cos;
...
; 165  : 	if (fabs(da) > 5.0f*Degrees) {
	...
	mulss	xmm1, DWORD PTR _Degrees
	comiss	xmm0, xmm1
	jbe	SHORT $LN12@Beacon

; 166  : 		sw &= 0xFFFFFF8F;				// All off
...
; 168  : 		if (da < 0.0f) {
	...
	movss	xmm0, DWORD PTR __real@00000000
	comiss	xmm0, DWORD PTR _da$[ebp]
	jbe	SHORT $LN10@Beacon

; 169  : 			if ((sw & 0x40) == 0) {

	mov	ecx, DWORD PTR _sw$[ebp]
	and	ecx, 64					; 00000040H
	jne	SHORT $LN9@Beacon

; 170  : 				sw |= 0x70;				// Flash on, has flashed, visible
...
; 171  : 			} else {
	...
	jmp	SHORT $LN8@Beacon
$LN9@Beacon:

; 172  : 				sw &= 0xFFFFFFDF;		// Flash off
...
; 177  : 	}
; 178  : 
; 179  : 	// 195 degree white light
; 180  : 	mlSinCos(&trig, rot + 195.0F * Degrees);

	movss	xmm0, DWORD PTR __real@43430000
	mulss	xmm0, DWORD PTR _Degrees
	addss	xmm0, DWORD PTR _rot$[ebp]
	push	ecx
	movss	DWORD PTR [esp], xmm0
...
; 181  : 	dx =  TheStateStack.ObjSpaceEye.x * trig.cos + TheStateStack.ObjSpaceEye.y * trig.sin;
...
; 182  : 	dy = -TheStateStack.ObjSpaceEye.x * trig.sin + TheStateStack.ObjSpaceEye.y * trig.cos;
...
; 185  : 	if (fabs(da) > 5.0f*Degrees) {
	...
	mulss	xmm1, DWORD PTR _Degrees
	comiss	xmm0, xmm1
	jbe	SHORT $LN6@Beacon

; 186  : 		sw &= 0xFFFFF8FF;				// All off
...
; 188  : 		if (da < 0.0f) {
	...
	movss	xmm0, DWORD PTR __real@00000000
	comiss	xmm0, DWORD PTR _da$[ebp]
	jbe	SHORT $LN4@Beacon

; 189  : 			if ((sw & 0x400) == 0) {

	mov	ecx, DWORD PTR _sw$[ebp]
	and	ecx, 1024				; 00000400H
	jne	SHORT $LN3@Beacon

; 190  : 				sw |= 0x700;			// Flash on, has flashed, visible

	mov	edx, DWORD PTR _sw$[ebp]
	or	edx, 1792				; 00000700H
	mov	DWORD PTR _sw$[ebp], edx

; 191  : 			} else {

	jmp	SHORT $LN2@Beacon
$LN3@Beacon:

; 192  : 				sw &= 0xFFFFFDFF;		// Flash off
...
; 197  : 	}
; 198  : 
; 199  : 	// Now store the computed results
; 200  : 	TheStateStack.CurrentInstance->DOFValues[0].rotation = (float)fmod( rot, 2.0f*PI );
...
; 201  : 	TheStateStack.CurrentInstance->SwitchValues[1] = sw;
...
; 202  : }
	...
	pop	ebp
	ret	0
?Beacon@@YAXXZ ENDP					; Beacon
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
?Chaff@@YAXXZ PROC					; Chaff
...
; 94   : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 95   : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 0) return;
...
; 96   : 
; 97   : 	if (TheStateStack.CurrentInstance->SwitchValues[0] == 0)
...
; 98   : 	{
; 99   : 		TheStateStack.CurrentInstance->SwitchValues[0] = 1;
...
; 100  : 	}
; 101  : //	else if (TheStateStack.CurrentInstance->SwitchValues[0] < 0x80)
; 102  : //	{
; 103  : //		TheStateStack.CurrentInstance->SwitchValues[0] <<= 1;
; 104  : //	}
; 105  : }

	pop	ebp
	ret	0
?Chaff@@YAXXZ ENDP					; Chaff
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
_angle$ = -4						; size = 4
?VASIN@@YAXXZ PROC					; VASIN
...
; 78   : 	float angle = (float)atan2( -TheStateStack.ObjSpaceEye.z, TheStateStack.ObjSpaceEye.x );
...
; 79   : 
; 80   : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 81   : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 0) return;
...
; 84   : 		TheStateStack.CurrentInstance->SetSwitch( 0, 2 );	// White
...
; 86   : 		TheStateStack.CurrentInstance->SetSwitch( 0, 1 );	// Red
...
; 88   : }
	...
	pop	ebp
	ret	0
?VASIN@@YAXXZ ENDP					; VASIN
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\scripts.cpp
_TEXT	SEGMENT
_angle$ = -4						; size = 4
?VASIF@@YAXXZ PROC					; VASIF
...
; 63   : 	float angle = (float)atan2( -TheStateStack.ObjSpaceEye.z, TheStateStack.ObjSpaceEye.x );
...
; 64   : 
; 65   : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nSwitches > 0 );
; 66   : 	if (TheStateStack.CurrentInstance->ParentObject->nSwitches <= 0) return;
...
; 69   : 		TheStateStack.CurrentInstance->SetSwitch( 0, 2 );	// White
...
; 71   : 		TheStateStack.CurrentInstance->SetSwitch( 0, 1 );	// Red
...
; 49   : 	float delta = TheTimeManager.GetDeltaTime() * 200.0f * DegreesPerSecond;
	...
	cvtsd2ss xmm0, QWORD PTR tv154[ebp]
	mulss	xmm0, DWORD PTR __real@43480000
	mulss	xmm0, DWORD PTR _DegreesPerSecond
	movss	DWORD PTR _delta$[ebp], xmm0

; 50   : 
; 51   : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 5 );
; 52   : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 5) return;
...
; 53   : 
; 54   : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;
...
; 55   : 	TheStateStack.CurrentInstance->DOFValues[3].rotation += delta;
...
; 56   : 	TheStateStack.CurrentInstance->DOFValues[4].rotation += delta;
...
; 57   : 	TheStateStack.CurrentInstance->DOFValues[5].rotation += delta;
...
; 36   : 	float delta = TheTimeManager.GetDeltaTime() * 540.0f * DegreesPerSecond;
	...
	cvtsd2ss xmm0, QWORD PTR tv145[ebp]
	mulss	xmm0, DWORD PTR __real@44070000
	mulss	xmm0, DWORD PTR _DegreesPerSecond
	movss	DWORD PTR _delta$[ebp], xmm0

; 37   : 
; 38   : 	ShiAssert( TheStateStack.CurrentInstance->ParentObject->nDOFs > 4 );
; 39   : 	if (TheStateStack.CurrentInstance->ParentObject->nDOFs <= 4) return;
...
; 40   : 
; 41   : 	TheStateStack.CurrentInstance->DOFValues[2].rotation += delta;		// Main rotor
...
; 42   : 	TheStateStack.CurrentInstance->DOFValues[3].rotation += delta * 1.6f;	// Tail rotor
...
; 43   : 	TheStateStack.CurrentInstance->DOFValues[4].rotation += delta * 2.1f;	// Muzzle flash
...
; 21   : static const float	DegreesPerSecond	= Degrees * Seconds;
...
; 19   : static const float	Hours				= Minutes / (60.0f);
...
; 18   : static const float	Minutes				= Seconds / (60.0f);
...
;	COMDAT ?GetDeltaTime@TimeManager@@QAEKXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetDeltaTime@TimeManager@@QAEKXZ PROC			; TimeManager::GetDeltaTime, COMDAT
; _this$ = ecx

; 49   : 	DWORD	GetDeltaTime( void )		{ return deltaTime; };
	...
	pop	ebp
	ret	0
?GetDeltaTime@TimeManager@@QAEKXZ ENDP			; TimeManager::GetDeltaTime
_TEXT	ENDS
; Function compile flags: /Odtp
