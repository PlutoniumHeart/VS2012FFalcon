; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\BSPlib\PolyLib.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?RenderStateTable@@3PBHB			; RenderStateTable
PUBLIC	?RenderStateTablePC@@3PBHB			; RenderStateTablePC
PUBLIC	?RenderStateTableNPC@@3PBHB			; RenderStateTableNPC
PUBLIC	?RenderStateTableNoTex@@3QBHB			; RenderStateTableNoTex
PUBLIC	?RenderStateTableWithPCTex@@3QBHB		; RenderStateTableWithPCTex
PUBLIC	?RenderStateTableWithNPCTex@@3QBHB		; RenderStateTableWithNPCTex
PUBLIC	?DrawPrimJumpTable@@3PBQ6AXPAUPrim@@@ZB		; DrawPrimJumpTable
PUBLIC	?DrawPrimNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB	; DrawPrimNoClipJumpTable
PUBLIC	?ClipPrimJumpTable@@3PBQ6AXPAUPrim@@K@ZB	; ClipPrimJumpTable
PUBLIC	?DrawPrimNoFogNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB ; DrawPrimNoFogNoClipJumpTable
PUBLIC	?ClipPrimNoFogJumpTable@@3PBQ6AXPAUPrim@@K@ZB	; ClipPrimNoFogJumpTable
PUBLIC	?DrawPrimFogNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB ; DrawPrimFogNoClipJumpTable
PUBLIC	?ClipPrimFogJumpTable@@3PBQ6AXPAUPrim@@K@ZB	; ClipPrimFogJumpTable
PUBLIC	?is_signed@?$numeric_limits@F@std@@2_NB		; std::numeric_limits<short>::is_signed
PUBLIC	?DrawPrimWithClipJumpTable@@3QBQ6AXPAUPrim@@@ZB	; DrawPrimWithClipJumpTable
PUBLIC	?DrawPrimNoClipWithTexJumpTable@@3QBQ6AXPAUPrim@@@ZB ; DrawPrimNoClipWithTexJumpTable
PUBLIC	?DrawPrimNoClipNoTexJumpTable@@3QBQ6AXPAUPrim@@@ZB ; DrawPrimNoClipNoTexJumpTable
PUBLIC	?DrawPrimFogNoClipWithTexJumpTable@@3QBQ6AXPAUPrim@@@ZB ; DrawPrimFogNoClipWithTexJumpTable
PUBLIC	?digits@?$numeric_limits@F@std@@2HB		; std::numeric_limits<short>::digits
PUBLIC	?DrawPrimFogNoClipNoTexJumpTable@@3QBQ6AXPAUPrim@@@ZB ; DrawPrimFogNoClipNoTexJumpTable
PUBLIC	?ClipPrimWithTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB	; ClipPrimWithTexJumpTable
PUBLIC	?ClipPrimNoTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB	; ClipPrimNoTexJumpTable
PUBLIC	__GUID_00000000_0000_0000_0000_000000000000
PUBLIC	?ClipPrimFogWithTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB ; ClipPrimFogWithTexJumpTable
PUBLIC	?digits10@?$numeric_limits@F@std@@2HB		; std::numeric_limits<short>::digits10
PUBLIC	?MAX_VALUE@CRegParser@ATL@@1HB			; ATL::CRegParser::MAX_VALUE
PUBLIC	?ClipPrimFogNoTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB ; ClipPrimFogNoTexJumpTable
...
PUBLIC	?DrawClippedPrim@@YAXPAUPrim@@@Z		; DrawClippedPrim
...
EXTRN	?ClipPrimPoint@@YAXPAUPrimPointFC@@K@Z:PROC	; ClipPrimPoint
EXTRN	?ClipPrimLine@@YAXPAUPrimLineFC@@K@Z:PROC	; ClipPrimLine
EXTRN	?ClipPoly@@YAXPAUPolyFC@@K@Z:PROC		; ClipPoly
EXTRN	?ClipPolyL@@YAXPAUPolyFCN@@K@Z:PROC		; ClipPolyL
EXTRN	?ClipPolyG@@YAXPAUPolyVC@@K@Z:PROC		; ClipPolyG
EXTRN	?ClipPolyGL@@YAXPAUPolyVCN@@K@Z:PROC		; ClipPolyGL
EXTRN	?ClipPolyT@@YAXPAUPolyTexFC@@K@Z:PROC		; ClipPolyT
EXTRN	?ClipPolyTL@@YAXPAUPolyTexFCN@@K@Z:PROC		; ClipPolyTL
EXTRN	?ClipPolyTG@@YAXPAUPolyTexVC@@K@Z:PROC		; ClipPolyTG
EXTRN	?ClipPolyTGL@@YAXPAUPolyTexVCN@@K@Z:PROC	; ClipPolyTGL
EXTRN	?ClipPrimFPoint@@YAXPAUPrimPointFC@@K@Z:PROC	; ClipPrimFPoint
EXTRN	?ClipPrimFLine@@YAXPAUPrimLineFC@@K@Z:PROC	; ClipPrimFLine
EXTRN	?ClipPolyF@@YAXPAUPolyFC@@K@Z:PROC		; ClipPolyF
EXTRN	?ClipPolyFL@@YAXPAUPolyFCN@@K@Z:PROC		; ClipPolyFL
EXTRN	?ClipPolyFG@@YAXPAUPolyVC@@K@Z:PROC		; ClipPolyFG
EXTRN	?ClipPolyFGL@@YAXPAUPolyVCN@@K@Z:PROC		; ClipPolyFGL
EXTRN	?ClipPolyFT@@YAXPAUPolyTexFC@@K@Z:PROC		; ClipPolyFT
EXTRN	?ClipPolyFTL@@YAXPAUPolyTexFCN@@K@Z:PROC	; ClipPolyFTL
EXTRN	?ClipPolyFTG@@YAXPAUPolyTexVC@@K@Z:PROC		; ClipPolyFTG
EXTRN	?ClipPolyFTGL@@YAXPAUPolyTexVCN@@K@Z:PROC	; ClipPolyFTGL
EXTRN	?ClipPolyAT@@YAXPAUPolyTexFC@@K@Z:PROC		; ClipPolyAT
EXTRN	?ClipPolyATL@@YAXPAUPolyTexFCN@@K@Z:PROC	; ClipPolyATL
EXTRN	?ClipPolyATG@@YAXPAUPolyTexVC@@K@Z:PROC		; ClipPolyATG
EXTRN	?ClipPolyATGL@@YAXPAUPolyTexVCN@@K@Z:PROC	; ClipPolyATGL
...
_BSS	ENDS
_BSS	SEGMENT
?RenderStateTable@@3PBHB DD 01H DUP (?)			; RenderStateTable
?RenderStateTablePC@@3PBHB DD 01H DUP (?)		; RenderStateTablePC
?RenderStateTableNPC@@3PBHB DD 01H DUP (?)		; RenderStateTableNPC
?DrawPrimJumpTable@@3PBQ6AXPAUPrim@@@ZB DD 01H DUP (?)	; DrawPrimJumpTable
?DrawPrimNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB DD 01H DUP (?) ; DrawPrimNoClipJumpTable
?ClipPrimJumpTable@@3PBQ6AXPAUPrim@@K@ZB DD 01H DUP (?)	; ClipPrimJumpTable
?DrawPrimNoFogNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB DD 01H DUP (?) ; DrawPrimNoFogNoClipJumpTable
?ClipPrimNoFogJumpTable@@3PBQ6AXPAUPrim@@K@ZB DD 01H DUP (?) ; ClipPrimNoFogJumpTable
?DrawPrimFogNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB DD 01H DUP (?) ; DrawPrimFogNoClipJumpTable
?ClipPrimFogJumpTable@@3PBQ6AXPAUPrim@@K@ZB DD 01H DUP (?) ; ClipPrimFogJumpTable
_BSS	ENDS
...
?RenderStateTableNoTex@@3QBHB DD 00H			; RenderStateTableNoTex
	DD	00H
	DD	00H
	DD	00H
	DD	02H
	...
	DD	00H
	ORG $+4
?RenderStateTableWithPCTex@@3QBHB DD 01H		; RenderStateTableWithPCTex
	DD	01H
	DD	01H
	DD	01H
	DD	02H
	...
	DD	024H
	ORG $+4
?RenderStateTableWithNPCTex@@3QBHB DD 01H		; RenderStateTableWithNPCTex
	DD	01H
	DD	01H
	DD	01H
	DD	02H
	...
	DD	024H
	ORG $+4
?DrawPrimWithClipJumpTable@@3QBQ6AXPAUPrim@@@ZB DD FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z ; DrawPrimWithClipJumpTable
	DD	FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z
	DD	FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z
	DD	FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z
	DD	FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z
	DD	FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z
	...
	DD	FLAT:?DrawClippedPrim@@YAXPAUPrim@@@Z
	ORG $+4
?DrawPrimNoClipWithTexJumpTable@@3QBQ6AXPAUPrim@@@ZB DD FLAT:?DrawPrimPoint@@YAXPAUPrimPointFC@@@Z ; DrawPrimNoClipWithTexJumpTable
	DD	FLAT:?DrawPrimLine@@YAXPAUPrimLineFC@@@Z
	DD	FLAT:?DrawPoly@@YAXPAUPolyFC@@@Z
	DD	FLAT:?DrawPolyL@@YAXPAUPolyFCN@@@Z
	DD	FLAT:?DrawPolyG@@YAXPAUPolyVC@@@Z
	DD	FLAT:?DrawPolyGL@@YAXPAUPolyVCN@@@Z
	DD	FLAT:?DrawPolyT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyTL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyTG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyTGL@@YAXPAUPolyTexVCN@@@Z
	DD	FLAT:?DrawPolyT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyTL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyTG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyTGL@@YAXPAUPolyTexVCN@@@Z
	...
	DD	FLAT:?DrawPolyG@@YAXPAUPolyVC@@@Z
	DD	FLAT:?DrawPolyGL@@YAXPAUPolyVCN@@@Z
	DD	FLAT:?DrawPolyAT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyATL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyATG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyATGL@@YAXPAUPolyTexVCN@@@Z
	DD	FLAT:?DrawPolyAT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyATL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyATG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyATGL@@YAXPAUPolyTexVCN@@@Z
	DD	FLAT:?DrawPolyT@@YAXPAUPolyTexFC@@@Z
	ORG $+4
?DrawPrimNoClipNoTexJumpTable@@3QBQ6AXPAUPrim@@@ZB DD FLAT:?DrawPrimPoint@@YAXPAUPrimPointFC@@@Z ; DrawPrimNoClipNoTexJumpTable
	DD	FLAT:?DrawPrimLine@@YAXPAUPrimLineFC@@@Z
	DD	FLAT:?DrawPoly@@YAXPAUPolyFC@@@Z
	DD	FLAT:?DrawPolyL@@YAXPAUPolyFCN@@@Z
	DD	FLAT:?DrawPolyG@@YAXPAUPolyVC@@@Z
	...
	DD	FLAT:?DrawPoly@@YAXPAUPolyFC@@@Z
	ORG $+4
?DrawPrimFogNoClipWithTexJumpTable@@3QBQ6AXPAUPrim@@@ZB DD FLAT:?DrawPrimFPoint@@YAXPAUPrimPointFC@@@Z ; DrawPrimFogNoClipWithTexJumpTable
	DD	FLAT:?DrawPrimFLine@@YAXPAUPrimLineFC@@@Z
	DD	FLAT:?DrawPolyF@@YAXPAUPolyFC@@@Z
	DD	FLAT:?DrawPolyFL@@YAXPAUPolyFCN@@@Z
	DD	FLAT:?DrawPolyFG@@YAXPAUPolyVC@@@Z
	DD	FLAT:?DrawPolyFGL@@YAXPAUPolyVCN@@@Z
	DD	FLAT:?DrawPolyFT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyFTL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyFTG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyFTGL@@YAXPAUPolyTexVCN@@@Z
	DD	FLAT:?DrawPolyFT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyFTL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyFTG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyFTGL@@YAXPAUPolyTexVCN@@@Z
	...
	DD	FLAT:?DrawPolyFG@@YAXPAUPolyVC@@@Z
	DD	FLAT:?DrawPolyFGL@@YAXPAUPolyVCN@@@Z
	DD	FLAT:?DrawPolyFAT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyFATL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyFATG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyFATGL@@YAXPAUPolyTexVCN@@@Z
	DD	FLAT:?DrawPolyFAT@@YAXPAUPolyTexFC@@@Z
	DD	FLAT:?DrawPolyFATL@@YAXPAUPolyTexFCN@@@Z
	DD	FLAT:?DrawPolyFATG@@YAXPAUPolyTexVC@@@Z
	DD	FLAT:?DrawPolyFATGL@@YAXPAUPolyTexVCN@@@Z
	DD	FLAT:?DrawPolyFT@@YAXPAUPolyTexFC@@@Z
	ORG $+4
?DrawPrimFogNoClipNoTexJumpTable@@3QBQ6AXPAUPrim@@@ZB DD FLAT:?DrawPrimFPoint@@YAXPAUPrimPointFC@@@Z ; DrawPrimFogNoClipNoTexJumpTable
	DD	FLAT:?DrawPrimFLine@@YAXPAUPrimLineFC@@@Z
	DD	FLAT:?DrawPolyF@@YAXPAUPolyFC@@@Z
	DD	FLAT:?DrawPolyFL@@YAXPAUPolyFCN@@@Z
	DD	FLAT:?DrawPolyFG@@YAXPAUPolyVC@@@Z
	...
	DD	FLAT:?DrawPolyF@@YAXPAUPolyFC@@@Z
	ORG $+4
?ClipPrimWithTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB DD FLAT:?ClipPrimPoint@@YAXPAUPrimPointFC@@K@Z ; ClipPrimWithTexJumpTable
	DD	FLAT:?ClipPrimLine@@YAXPAUPrimLineFC@@K@Z
	DD	FLAT:?ClipPoly@@YAXPAUPolyFC@@K@Z
	DD	FLAT:?ClipPolyL@@YAXPAUPolyFCN@@K@Z
	DD	FLAT:?ClipPolyG@@YAXPAUPolyVC@@K@Z
	DD	FLAT:?ClipPolyGL@@YAXPAUPolyVCN@@K@Z
	DD	FLAT:?ClipPolyT@@YAXPAUPolyTexFC@@K@Z
	DD	FLAT:?ClipPolyTL@@YAXPAUPolyTexFCN@@K@Z
	DD	FLAT:?ClipPolyTG@@YAXPAUPolyTexVC@@K@Z
	DD	FLAT:?ClipPolyTGL@@YAXPAUPolyTexVCN@@K@Z
	DD	FLAT:?ClipPolyT@@YAXPAUPolyTexFC@@K@Z
	DD	FLAT:?ClipPolyTL@@YAXPAUPolyTexFCN@@K@Z
	DD	FLAT:?ClipPolyTG@@YAXPAUPolyTexVC@@K@Z
	DD	FLAT:?ClipPolyTGL@@YAXPAUPolyTexVCN@@K@Z
	...
	DD	FLAT:?ClipPolyG@@YAXPAUPolyVC@@K@Z
	DD	FLAT:?ClipPolyGL@@YAXPAUPolyVCN@@K@Z
	DD	FLAT:?ClipPolyAT@@YAXPAUPolyTexFC@@K@Z
	DD	FLAT:?ClipPolyATL@@YAXPAUPolyTexFCN@@K@Z
	DD	FLAT:?ClipPolyATG@@YAXPAUPolyTexVC@@K@Z
	DD	FLAT:?ClipPolyATGL@@YAXPAUPolyTexVCN@@K@Z
	DD	FLAT:?ClipPolyAT@@YAXPAUPolyTexFC@@K@Z
	DD	FLAT:?ClipPolyATL@@YAXPAUPolyTexFCN@@K@Z
	DD	FLAT:?ClipPolyATG@@YAXPAUPolyTexVC@@K@Z
	DD	FLAT:?ClipPolyATGL@@YAXPAUPolyTexVCN@@K@Z
	DD	FLAT:?ClipPolyT@@YAXPAUPolyTexFC@@K@Z
	ORG $+4
?ClipPrimNoTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB DD FLAT:?ClipPrimPoint@@YAXPAUPrimPointFC@@K@Z ; ClipPrimNoTexJumpTable
	DD	FLAT:?ClipPrimLine@@YAXPAUPrimLineFC@@K@Z
	DD	FLAT:?ClipPoly@@YAXPAUPolyFC@@K@Z
	DD	FLAT:?ClipPolyL@@YAXPAUPolyFCN@@K@Z
	DD	FLAT:?ClipPolyG@@YAXPAUPolyVC@@K@Z
	...
	DD	FLAT:?ClipPoly@@YAXPAUPolyFC@@K@Z
	ORG $+4
?ClipPrimFogWithTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB DD FLAT:?ClipPrimFPoint@@YAXPAUPrimPointFC@@K@Z ; ClipPrimFogWithTexJumpTable
	DD	FLAT:?ClipPrimFLine@@YAXPAUPrimLineFC@@K@Z
	DD	FLAT:?ClipPolyF@@YAXPAUPolyFC@@K@Z
	DD	FLAT:?ClipPolyFL@@YAXPAUPolyFCN@@K@Z
	DD	FLAT:?ClipPolyFG@@YAXPAUPolyVC@@K@Z
	DD	FLAT:?ClipPolyFGL@@YAXPAUPolyVCN@@K@Z
	DD	FLAT:?ClipPolyFT@@YAXPAUPolyTexFC@@K@Z
	DD	FLAT:?ClipPolyFTL@@YAXPAUPolyTexFCN@@K@Z
	DD	FLAT:?ClipPolyFTG@@YAXPAUPolyTexVC@@K@Z
	DD	FLAT:?ClipPolyFTGL@@YAXPAUPolyTexVCN@@K@Z
	DD	FLAT:?ClipPolyFT@@YAXPAUPolyTexFC@@K@Z
	DD	FLAT:?ClipPolyFTL@@YAXPAUPolyTexFCN@@K@Z
	DD	FLAT:?ClipPolyFTG@@YAXPAUPolyTexVC@@K@Z
	DD	FLAT:?ClipPolyFTGL@@YAXPAUPolyTexVCN@@K@Z
	...
	DD	FLAT:?ClipPolyFT@@YAXPAUPolyTexFC@@K@Z
	ORG $+4
?ClipPrimFogNoTexJumpTable@@3QBQ6AXPAUPrim@@K@ZB DD FLAT:?ClipPrimFPoint@@YAXPAUPrimPointFC@@K@Z ; ClipPrimFogNoTexJumpTable
	DD	FLAT:?ClipPrimFLine@@YAXPAUPrimLineFC@@K@Z
	DD	FLAT:?ClipPolyF@@YAXPAUPolyFC@@K@Z
	DD	FLAT:?ClipPolyFL@@YAXPAUPolyFCN@@K@Z
	DD	FLAT:?ClipPolyFG@@YAXPAUPolyVC@@K@Z
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\polylib.cpp
_TEXT	SEGMENT
_end$ = -20						; size = 4
_clipFlagAND$ = -16					; size = 4
_clipFlagOR$ = -12					; size = 4
_clipFlag$ = -8						; size = 4
_xyzIdxPtr$ = -4					; size = 4
_prim$ = 8						; size = 4
?DrawClippedPrim@@YAXPAUPrim@@@Z PROC			; DrawClippedPrim
...
; 445  : 	int *xyzIdxPtr,*end;
; 446  : 	UInt32 clipFlag,clipFlagAND,clipFlagOR;
; 447  : 
; 448  : 	ShiAssert(prim->nVerts > 0);
; 449  : 
; 450  : 	xyzIdxPtr = prim->xyz;

	mov	eax, DWORD PTR _prim$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR _xyzIdxPtr$[ebp], ecx

; 451  : 	end = xyzIdxPtr + prim->nVerts;

	mov	edx, DWORD PTR _prim$[ebp]
...
; 452  : 
; 453  : 	// Check the clipping flags for all our vertices
; 454  : 	clipFlag = TheStateStack.ClipInfoPool[*xyzIdxPtr++].clipFlag;
...
; 455  : 	clipFlagAND	= clipFlag;

	mov	edx, DWORD PTR _clipFlag$[ebp]
	mov	DWORD PTR _clipFlagAND$[ebp], edx

; 456  : 	clipFlagOR	= clipFlag;

	mov	eax, DWORD PTR _clipFlag$[ebp]
	mov	DWORD PTR _clipFlagOR$[ebp], eax
$LN6@DrawClippe:

; 457  : 
; 458  : 	while(xyzIdxPtr < end)

	mov	ecx, DWORD PTR _xyzIdxPtr$[ebp]
	cmp	ecx, DWORD PTR _end$[ebp]
	jae	SHORT $LN5@DrawClippe

; 459  : 	{
; 460  : 		clipFlag = TheStateStack.ClipInfoPool[*xyzIdxPtr++].clipFlag;
...
; 461  : 		clipFlagAND	&= clipFlag;

	mov	ecx, DWORD PTR _clipFlagAND$[ebp]
	and	ecx, DWORD PTR _clipFlag$[ebp]
	mov	DWORD PTR _clipFlagAND$[ebp], ecx

; 462  : 		clipFlagOR	|= clipFlag;

	mov	edx, DWORD PTR _clipFlagOR$[ebp]
	or	edx, DWORD PTR _clipFlag$[ebp]
	mov	DWORD PTR _clipFlagOR$[ebp], edx

; 463  : 	};

	jmp	SHORT $LN6@DrawClippe
$LN5@DrawClippe:

; 464  : 
; 465  : 	// See if we're on, off, or straddling the screen
; 466  : 	if(clipFlagAND)

	cmp	DWORD PTR _clipFlagAND$[ebp], 0
	je	SHORT $LN4@DrawClippe

; 467  : 	{
; 468  : 		// All verts clipped by the same edge, so skip
; 469  : 		return;

	jmp	SHORT $LN7@DrawClippe
	jmp	SHORT $LN7@DrawClippe
$LN4@DrawClippe:

; 470  : 	}
; 471  : 	else if(clipFlagOR == ON_SCREEN)

	cmp	DWORD PTR _clipFlagOR$[ebp], 0
	jne	SHORT $LN2@DrawClippe

; 472  : 	{
; 473  : 		// All verts on screen, so just draw
; 474  : 		DrawPrimNoClipJumpTable[prim->type](prim);

	mov	eax, DWORD PTR _prim$[ebp]
	push	eax
	mov	ecx, DWORD PTR _prim$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	eax, DWORD PTR ?DrawPrimNoClipJumpTable@@3PBQ6AXPAUPrim@@@ZB ; DrawPrimNoClipJumpTable
...
; 478  : 	{
; 479  : 		// Do a full clip operation
; 480  : 		ClipPrimJumpTable[prim->type](prim,clipFlagOR);
	...
	mov	ecx, DWORD PTR _prim$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	eax, DWORD PTR ?ClipPrimJumpTable@@3PBQ6AXPAUPrim@@K@ZB ; ClipPrimJumpTable
	mov	ecx, DWORD PTR [eax+edx*4]
	call	ecx
	add	esp, 8
$LN7@DrawClippe:
...
; 482  : }
	...
	pop	ebp
	ret	0
?DrawClippedPrim@@YAXPAUPrim@@@Z ENDP			; DrawClippedPrim
_TEXT	ENDS
; Function compile flags: /Odtp
