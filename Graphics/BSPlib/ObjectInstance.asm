; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\BSPlib\ObjectInstance.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0ObjectInstance@@QAE@H@Z			; ObjectInstance::ObjectInstance
PUBLIC	??1ObjectInstance@@QAE@XZ			; ObjectInstance::~ObjectInstance
PUBLIC	?SetTextureSet@ObjectInstance@@QAEXH@Z		; ObjectInstance::SetTextureSet
PUBLIC	?SetDynamicVertex@ObjectInstance@@QAEXHMMM@Z	; ObjectInstance::SetDynamicVertex
PUBLIC	?GetDynamicVertex@ObjectInstance@@QAEXHPAM00@Z	; ObjectInstance::GetDynamicVertex
PUBLIC	?GetDynamicCoords@ObjectInstance@@QAEXHPAM00@Z	; ObjectInstance::GetDynamicCoords
...
EXTRN	?Reference@ObjectParent@@QAEXXZ:PROC		; ObjectParent::Reference
...
EXTRN	?ReleaseTexSet@ObjectParent@@QAEXKK@Z:PROC	; ObjectParent::ReleaseTexSet
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\objectinstance.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_id$ = 8						; size = 4
_dx$ = 12						; size = 4
_dy$ = 16						; size = 4
_dz$ = 20						; size = 4
?GetDynamicCoords@ObjectInstance@@QAEXHPAM00@Z PROC	; ObjectInstance::GetDynamicCoords
; _this$ = ecx
...
; 189  : }
	...
	pop	ebp
	ret	16					; 00000010H
?GetDynamicCoords@ObjectInstance@@QAEXHPAM00@Z ENDP	; ObjectInstance::GetDynamicCoords
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\objectinstance.cpp
_TEXT	SEGMENT
...
_dy$ = 16						; size = 4
_dz$ = 20						; size = 4
?GetDynamicVertex@ObjectInstance@@QAEXHPAM00@Z PROC	; ObjectInstance::GetDynamicVertex
; _this$ = ecx
...
; 172  : 	Ppoint	*original;
; 173  : 
; 174  : 	ShiAssert(id<ParentObject->nDynamicCoords);
; 175  : 	
; 176  : 	original = ParentObject->pSlotAndDynamicPositions + ParentObject->nSlots + id;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+32]
	movzx	edx, BYTE PTR [eax+51]
...
; 177  : 
; 178  : 	*dx = DynamicCoords[id].x - original->x;
...
; 179  : 	*dy = DynamicCoords[id].y - original->y;
...
; 180  : 	*dz = DynamicCoords[id].z - original->z;
...
; 181  : }
	...
	pop	ebp
	ret	16					; 00000010H
?GetDynamicVertex@ObjectInstance@@QAEXHPAM00@Z ENDP	; ObjectInstance::GetDynamicVertex
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\objectinstance.cpp
_TEXT	SEGMENT
...
_dy$ = 16						; size = 4
_dz$ = 20						; size = 4
?SetDynamicVertex@ObjectInstance@@QAEXHMMM@Z PROC	; ObjectInstance::SetDynamicVertex
; _this$ = ecx
...
; 146  : 	Ppoint	*original;
; 147  : 
; 148  : 	ShiAssert(id<ParentObject->nDynamicCoords);
; 149  : 	
; 150  : 	original = ParentObject->pSlotAndDynamicPositions + ParentObject->nSlots + id;
...
; 151  : 
; 152  :     // Pu239 not checking for the moment
; 153  : //#ifdef _DEBUG
; 154  : //	float r1 = Radius()*Radius();
; 155  : //#endif
; 156  : 
; 157  : 	DynamicCoords[id].x = original->x + dx;
...
; 158  : 	DynamicCoords[id].y = original->y + dy;
...
; 159  : 	DynamicCoords[id].z = original->z + dz;
...
; 160  : 
; 161  : //#ifdef _DEBUG
; 162  : //	float r2 = DynamicCoords[id].x*DynamicCoords[id].x + DynamicCoords[id].y*DynamicCoords[id].y + DynamicCoords[id].z*DynamicCoords[id].z;
; 163  : //
; 164  : //	ShiAssert( r2 <= r1 + 0.00001f );	// Illegal for dynamic verts to exceed object bounding volume
; 165  : //										// so we require movement to be only toward the origin.
; 166  : //#endif
; 167  : }
	...
	pop	ebp
	ret	16					; 00000010H
?SetDynamicVertex@ObjectInstance@@QAEXHMMM@Z ENDP	; ObjectInstance::SetDynamicVertex
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\objectinstance.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_id$ = 8						; size = 4
?SetTextureSet@ObjectInstance@@QAEXH@Z PROC		; ObjectInstance::SetTextureSet
; _this$ = ecx

; 193  : void	ObjectInstance::SetTextureSet( int id )	{
...
; 194  : 	// edg: sanity check texture setting
; 195  : 	if (id >= ParentObject->nTextureSets) id = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	movsx	edx, WORD PTR [ecx+44]
	cmp	DWORD PTR _id$[ebp], edx
	jl	SHORT $LN3@SetTexture
	mov	DWORD PTR _id$[ebp], 0
$LN3@SetTexture:

; 196  : 	// check if we already hold a texture set
; 197  : 	if(TexSetReferenced){
...
; 198  : 		// if same texture set, exit
; 199  : 		if(id == TextureSet ) return;
...
; 200  : 		// else release the owned one
; 201  : 		ParentObject->ReleaseTexSet(TextureSet);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	call	?ReleaseTexSet@ObjectParent@@QAEXKK@Z	; ObjectParent::ReleaseTexSet
$LN2@SetTexture:
...
; 205  : 	// get it, and mark as owning a Tex Set
; 206  : 	ParentObject->ReferenceTexSet(TextureSet);
...
; 208  : };
	...
	pop	ebp
	ret	4
?SetTextureSet@ObjectInstance@@QAEXH@Z ENDP		; ObjectInstance::SetTextureSet
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\objectinstance.cpp
_TEXT	SEGMENT
...
$T4 = -8						; size = 4
_this$ = -4						; size = 4
??1ObjectInstance@@QAE@XZ PROC				; ObjectInstance::~ObjectInstance
; _this$ = ecx
...
; 114  : 	if(TexSetReferenced) ParentObject->ReleaseTexSet(TextureSet);

	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, BYTE PTR [eax+24]
	test	ecx, ecx
	je	SHORT $LN5@ObjectInst
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
; 116  : 	ParentObject = NULL;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+32], 0

; 117  : #ifdef USE_SH_POOLS
; 118  : 	if( SwitchValues )
; 119  : 		MemFreePtr( SwitchValues );
; 120  : 	if( DOFValues )
; 121  : 		MemFreePtr( DOFValues );
; 122  : 	if( SlotChildren )
; 123  : 		MemFreePtr( SlotChildren );
; 124  : 	if( DynamicCoords )
; 125  : 		MemFreePtr( DynamicCoords );
; 126  : #else
; 127  : 	// sfr: checking for NULL values first
; 128  : 	if (SwitchValues != NULL){

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx], 0
	je	SHORT $LN4@ObjectInst

; 129  : 		delete[] SwitchValues;
...
; 130  : 	}
; 131  : 	if (DOFValues != NULL){

	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+4], 0
	je	SHORT $LN3@ObjectInst

; 132  : 		delete[] DOFValues;
...
; 133  : 	}
; 134  : 	if (SlotChildren != NULL){

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 0
	je	SHORT $LN2@ObjectInst

; 135  : 		delete[] SlotChildren;
...
; 136  : 	}
; 137  : 	if (DynamicCoords != NULL){

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+12], 0
	je	SHORT $LN6@ObjectInst

; 138  : 		delete[] DynamicCoords;
...
; 141  : }
	...
	pop	ebp
	ret	0
??1ObjectInstance@@QAE@XZ ENDP				; ObjectInstance::~ObjectInstance
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\bsplib\objectinstance.cpp
_TEXT	SEGMENT
...
_this$ = -4						; size = 4
_tid$ = 8						; size = 4
??0ObjectInstance@@QAE@H@Z PROC				; ObjectInstance::ObjectInstance
; _this$ = ecx
...
; 19   : 
; 20   : 	ShiAssert(TheObjectList);
; 21   : 	ShiAssert(id < TheObjectListLength);	// Make sure the requested object ID is in
; 22   : 	ShiAssert(TheObjectList[tid].nLODs);		// the current object set (IDS.TXT, etc).
; 23   : 
; 24   : 	ParentObject = &TheObjectList[tid];
...
; 25   : 
; 26   : 	/***** BEGIN HACK HACK HACK HACK - Billy forced me to do it :-) -RH *****/
; 27   : 	if
; 28   : 	(	// F16c
; 29   : 		(tid == 1052) ||
; 30   : 		(tid == 564) ||
...
; 34   : 	)
	...
	cmp	DWORD PTR _tid$[ebp], 1052		; 0000041cH
	je	SHORT $LN11@ObjectInst
	cmp	DWORD PTR _tid$[ebp], 564		; 00000234H
	je	SHORT $LN11@ObjectInst
	cmp	DWORD PTR _tid$[ebp], 563		; 00000233H
	je	SHORT $LN11@ObjectInst
	cmp	DWORD PTR _tid$[ebp], 562		; 00000232H
	je	SHORT $LN11@ObjectInst
	cmp	DWORD PTR _tid$[ebp], 5
	jne	SHORT $LN12@ObjectInst
$LN11@ObjectInst:

; 35   : 	{
; 36   : 		ParentObject->radius = 40.0;
...
; 39   : 	if (tid == 1329)		// B1
	...
	cmp	DWORD PTR _tid$[ebp], 1329		; 00000531H
	jne	SHORT $LN10@ObjectInst

; 40   : 	{
; 41   : 		ParentObject->radius = 100.0;
...
; 42   : 	}
; 43   : 	/***** END HACK HACK HACK HACK - Billy forced me to do it :-) -RH *****/
; 44   : 
; 45   : 	ParentObject->Reference();

	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+32]
	call	?Reference@ObjectParent@@QAEXXZ		; ObjectParent::Reference

; 46   : 
; 47   : 	if (ParentObject->nSwitches == 0) {

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	movsx	edx, WORD PTR [ecx+52]
	test	edx, edx
	jne	SHORT $LN9@ObjectInst

; 48   : 		SwitchValues = NULL;
...
; 49   : 	} else {
	...
	jmp	SHORT $LN8@ObjectInst
$LN9@ObjectInst:

; 50   : 		#ifdef USE_SH_POOLS
; 51   : 		SwitchValues = (DWORD *)MemAllocPtr(gBSPLibMemPool, sizeof(DWORD)*(ParentObject->nSwitches), 0 );
; 52   : 		#else
; 53   : 		SwitchValues = new DWORD[ParentObject->nSwitches];
...
; 54   : 		#endif
; 55   : 		memset( SwitchValues, 0, sizeof(*SwitchValues)*ParentObject->nSwitches );
...
; 56   : 	}
; 57   : 
; 58   : 	if (ParentObject->nDOFs == 0) {

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+32]
	movsx	eax, WORD PTR [edx+54]
	test	eax, eax
	jne	SHORT $LN7@ObjectInst
...
; 60   : 	} else {
	...
	jmp	SHORT $LN6@ObjectInst
$LN7@ObjectInst:

; 61   : 		#ifdef USE_SH_POOLS
; 62   : 		DOFValues = (DOFvalue *)MemAllocPtr(gBSPLibMemPool, sizeof(DOFvalue)*(ParentObject->nDOFs), 0 );
; 63   : 		#else
; 64   : 		DOFValues = new DOFvalue[ParentObject->nDOFs];
...
; 65   : 		#endif
; 66   : 		memset( DOFValues, 0, sizeof(*DOFValues)*ParentObject->nDOFs );
...
; 67   : 	}
; 68   : 
; 69   : 	if (ParentObject->nSlots == 0) {

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+32]
	movzx	eax, BYTE PTR [edx+51]
	test	eax, eax
	jne	SHORT $LN5@ObjectInst

; 70   : 		SlotChildren = NULL;
...
; 71   : 	} else {
	...
	jmp	SHORT $LN4@ObjectInst
$LN5@ObjectInst:

; 72   : 		#ifdef USE_SH_POOLS
; 73   : 		SlotChildren = (ObjectInstance **)MemAllocPtr(gBSPLibMemPool, sizeof(ObjectInstance *)*(ParentObject->nSlots), 0 );
; 74   : 		#else
; 75   : 		SlotChildren = new ObjectInstance*[ParentObject->nSlots];
...
; 76   : 		#endif
; 77   : 		memset( SlotChildren, 0, sizeof(*SlotChildren)*ParentObject->nSlots );
...
; 78   : 	}
; 79   : 
; 80   : 	if ((ParentObject->nDynamicCoords == 0) || (ParentObject->nDynamicCoords > 10)) {
	...
	jle	SHORT $LN3@ObjectInst
$LN2@ObjectInst:

; 81   : 		DynamicCoords = NULL;
...
; 83   : 		#ifdef USE_SH_POOLS
; 84   : 		DynamicCoords = (Ppoint *)MemAllocPtr(gBSPLibMemPool, sizeof(Ppoint)*(ParentObject->nDynamicCoords), 0 );
; 85   : 		#else
; 86   : 		DynamicCoords = new Ppoint[ParentObject->nDynamicCoords];
...
; 87   : 		#endif
; 88   : 		memcpy( DynamicCoords, 
; 89   : 				ParentObject->pSlotAndDynamicPositions + ParentObject->nSlots, 
; 90   : 				sizeof(*DynamicCoords)*ParentObject->nDynamicCoords );
...
; 95   : 	
; 96   : 	/*// Setup RadarSign
; 97   : 	RadarSignal = BoxTop() - BoxBottom();
; 98   : 	if(abs(RadarSignal) <= 1.0f) RadarSignal = 200.0f;
; 99   : 	else {
; 100  : 		RadarSignal *= BoxFront() - BoxBack();
; 101  : 		RadarSignal *= BoxRight() - BoxLeft();
; 102  : 	}
; 103  : 	RadarSignal = sqrtf(fabs(RadarSignal));*/
; 104  : 
; 105  : 	RadarSignal = ParentObject->RadarSign;
...
; 109  : }
	...
	pop	ebp
	ret	4
??0ObjectInstance@@QAE@H@Z ENDP				; ObjectInstance::ObjectInstance
_TEXT	ENDS
; Function compile flags: /Odtp
