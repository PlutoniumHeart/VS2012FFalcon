; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\Objects\DrawGrnd.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?RadarSign@ObjectInstance@@QAEMXZ		; ObjectInstance::RadarSign
PUBLIC	??0DrawableBSP@@IAE@MH@Z			; DrawableBSP::DrawableBSP
...
PUBLIC	??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z	; DrawableGroundVehicle::DrawableGroundVehicle
PUBLIC	??1DrawableGroundVehicle@@UAE@XZ		; DrawableGroundVehicle::~DrawableGroundVehicle
PUBLIC	?SetParentList@DrawableGroundVehicle@@UAEXPAVObjectDisplayList@@@Z ; DrawableGroundVehicle::SetParentList
PUBLIC	?Update@DrawableGroundVehicle@@QAEXPAUTpoint@@M@Z ; DrawableGroundVehicle::Update
PUBLIC	?SetUpon@DrawableGroundVehicle@@QAEXPAVDrawableBridge@@@Z ; DrawableGroundVehicle::SetUpon
PUBLIC	?Draw@DrawableGroundVehicle@@UAEXPAVRenderOTW@@H@Z ; DrawableGroundVehicle::Draw
...
xdata$x	ENDS
xdata$x	SEGMENT
__unwindtable$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z$0
__ehfuncinfo$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0DrawableBSP@@IAE@MH@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0DrawableBSP@@IAE@MH@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$??0DrawableBSP@@IAE@MH@Z$1
__ehfuncinfo$??0DrawableBSP@@IAE@MH@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$??0DrawableBSP@@IAE@MH@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\objects\drawgrnd.cpp
_TEXT	SEGMENT
tv304 = -68						; size = 4
tv291 = -64						; size = 4
tv364 = -60						; size = 4
...
_s$7 = -24						; size = 4
_this$ = -20						; size = 4
_normal$8 = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
_renderer$ = 8						; size = 4
_LOD$ = 12						; size = 4
?Draw@DrawableGroundVehicle@@UAEXPAVRenderOTW@@H@Z PROC	; DrawableGroundVehicle::Draw
; _this$ = ecx
...
; 81   : 	// See if we need to update our ground position
; 82   : 	if (LOD != previousLOD) {
...
; 90   : 			// Get the normal and update our height to conform to the platform we're driving on
; 91   : 			// COBRA - RED - Little Offset to avoid ZBuffering conflicts
; 92   : 			position.z = drivingOn->GetGroundLevel( position.x, position.y, &normal ) - .1f;
...
; 95   : 			// Get the normal and update our height to reflect the terrain beneath us
; 96   : 			// COBRA - RED - Little Offset to avoid ZBuffering conflict
; 97   : 			position.z = renderer->viewpoint->GetGroundLevel( position.x, position.y, &normal ) - .1f;
...
; 100  : 
; 101  : 		// Construct the rotation matrix to orient the object correctly
; 102  : 		// The "old" axes are those of a pure rotation about Z (for heading).
; 103  : 		// The "new" axes include the alignment of "up" with the terrain normal.
; 104  : 		// New Z axis (Inverted Terrain Normal)
; 105  : 		Nx = -normal.x,
; 106  : 		Ny = -normal.y,
; 107  : 		Nz = -normal.z;
	...
	movss	DWORD PTR _Nx$2[ebp], xmm0
	movss	xmm0, DWORD PTR _normal$8[ebp+4]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	movss	DWORD PTR _Ny$1[ebp], xmm0
	movss	xmm0, DWORD PTR _normal$8[ebp+8]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	movss	DWORD PTR _Nz$3[ebp], xmm0

; 108  : 		s =  1.0f / (float)sqrt( Nx*Nx + Ny*Ny + Nz*Nz );

	movss	xmm0, DWORD PTR _Nx$2[ebp]
	mulss	xmm0, DWORD PTR _Nx$2[ebp]
	movss	xmm1, DWORD PTR _Ny$1[ebp]
	mulss	xmm1, DWORD PTR _Ny$1[ebp]
	addss	xmm0, xmm1
	...
	divss	xmm0, DWORD PTR tv318[ebp]
	movss	DWORD PTR _s$7[ebp], xmm0

; 109  : 		orientation.M13 = Nx*s, orientation.M23 = Ny*s, orientation.M33 = Nz*s;

	movss	xmm0, DWORD PTR _Nx$2[ebp]
	mulss	xmm0, DWORD PTR _s$7[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+56], xmm0
	movss	xmm0, DWORD PTR _Ny$1[ebp]
	mulss	xmm0, DWORD PTR _s$7[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 110  : 
; 111  : 		// New X axis (New Z axis cross negative old Y axis)
; 112  : 		x =  Nz*cosYaw,
; 113  : 		y =  Nz*sinYaw,
; 114  : 		z = -Nx*cosYaw-Ny*sinYaw;
...
; 115  : 		s =  1.0f / (float)sqrt( x*x + y*y + z*z );
	...
	addss	xmm0, xmm1
	movss	xmm1, DWORD PTR _z$5[ebp]
	mulss	xmm1, DWORD PTR _z$5[ebp]
	addss	xmm0, xmm1
	push	ecx
	movss	DWORD PTR [esp], xmm0
	call	?SqrtSSE@@YAMM@Z			; SqrtSSE
	...
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR tv341[ebp]
	movss	DWORD PTR _s$7[ebp], xmm0

; 116  : 		orientation.M11 = x*s, orientation.M21 = y*s, orientation.M31 = z*s;
...
; 117  : 
; 118  : 		// New Y axis (New Z axis cross old X axis)
; 119  : 		x = -Nz*sinYaw,				   
; 120  : 		y =  Nz*cosYaw,				   
; 121  : 		z =  Nx*sinYaw-Ny*cosYaw;
...
; 122  : 		s =  1.0f / (float)sqrt( x*x + y*y + z*z );
	...
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR tv364[ebp]
	movss	DWORD PTR _s$7[ebp], xmm0

; 123  : 		orientation.M12 = x*s, orientation.M22 = y*s, orientation.M32 = z*s;
...
; 124  : 	}
; 125  : 
; 126  : 	// Tell our parent class to draw us now
; 127  : 	DrawableBSP::Draw( renderer, LOD );
...
; 128  : }
	...
	pop	ebp
	ret	8
?Draw@DrawableGroundVehicle@@UAEXPAVRenderOTW@@H@Z ENDP	; DrawableGroundVehicle::Draw
_TEXT	ENDS
; Function compile flags: /Odtp
...
_pos$ = 8						; size = 4
_heading$ = 12						; size = 4
?Update@DrawableGroundVehicle@@QAEXPAUTpoint@@M@Z PROC	; DrawableGroundVehicle::Update
; _this$ = ecx
...
; 61   : 	// Compute the sine and cosine of the object's desired heading
; 62   : 	yaw = heading;
...
; 65   : 
; 66   : 	// Record our position (Z will be updated later, as will the orientation matrix)
; 67   : 	position.x = pos->x;
...
; 69   : 
; 70   : 	// Force a reevaluation of the terrain elevation and orientation
; 71   : 	previousLOD = -1;
...
; 72   : }
	...
	pop	ebp
	ret	8
?Update@DrawableGroundVehicle@@QAEXPAUTpoint@@M@Z ENDP	; DrawableGroundVehicle::Update
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\objects\drawgrnd.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_list$ = 8						; size = 4
?SetParentList@DrawableGroundVehicle@@UAEXPAVObjectDisplayList@@@Z PROC ; DrawableGroundVehicle::SetParentList
; _this$ = ecx
...
; 48   : 	DrawableBSP::SetParentList( list );

	mov	eax, DWORD PTR _list$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetParentList@DrawableObject@@MAEXPAVObjectDisplayList@@@Z ; DrawableObject::SetParentList

; 49   : 
; 50   : 	// If we're changing lists, this will be invalid now...
; 51   : 	SetUpon( NULL );
...
; 52   : }
	...
	pop	ebp
	ret	4
?SetParentList@DrawableGroundVehicle@@UAEXPAVObjectDisplayList@@@Z ENDP ; DrawableGroundVehicle::SetParentList
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\include\drawgrnd.h
...
_heading$ = 16						; size = 4
_s$ = 20						; size = 4
??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z PROC	; DrawableGroundVehicle::DrawableGroundVehicle
; _this$ = ecx
...
; 26   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	push	esi
	...
	movss	DWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0DrawableBSP@@IAE@MH@Z		; DrawableBSP::DrawableBSP
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7DrawableGroundVehicle@@6B@

; 27   : 	// Store this objects properties
; 28   : 	drivingOn = NULL;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+188], 0

; 29   : 	drawClassID = GroundVehicle;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+24], 2

; 30   : 
; 31   : 	// Initialize our position and orientation values
; 32   : 	Update( pos, heading );
...
; 33   : 
; 34   : 	// insure our z position is initialized
; 35   : 	position.z = pos->z;
...
; 36   : 
; 37   : 	// insure orientation has default value
; 38   : 	orientation = IMatrix;
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1DrawableBSP@@UAE@XZ			; DrawableBSP::~DrawableBSP
__ehhandler$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-16]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0DrawableGroundVehicle@@QAE@HPAUTpoint@@MM@Z ENDP	; DrawableGroundVehicle::DrawableGroundVehicle
; Function compile flags: /Odtp
...
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\include\drawbsp.h
;	COMDAT ??0DrawableBSP@@IAE@MH@Z
_TEXT	SEGMENT
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
_s$ = 8							; size = 4
_ID$ = 12						; size = 4
??0DrawableBSP@@IAE@MH@Z PROC				; DrawableBSP::DrawableBSP, COMDAT
; _this$ = ecx

; 27   : 	DrawableBSP( float s, int ID ): DrawableObject( s ), instance(ID) { inhibitDraw = FALSE; labelLen = 0; id = ID; radius = instance.Radius(); RadarSign = instance.RadarSign(); };

	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0DrawableBSP@@IAE@MH@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	eax, DWORD PTR ___security_cookie
	...
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 84					; 00000054H
	call	?RadarSign@ObjectInstance@@QAEMXZ	; ObjectInstance::RadarSign
	mov	ecx, DWORD PTR _this$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0DrawableBSP@@IAE@MH@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1DrawableObject@@UAE@XZ		; DrawableObject::~DrawableObject
__unwindfunclet$??0DrawableBSP@@IAE@MH@Z$1:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 84					; 00000054H
	jmp	??1ObjectInstance@@QAE@XZ		; ObjectInstance::~ObjectInstance
__ehhandler$??0DrawableBSP@@IAE@MH@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0DrawableBSP@@IAE@MH@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0DrawableBSP@@IAE@MH@Z ENDP				; DrawableBSP::DrawableBSP
; Function compile flags: /Odtp
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?RadarSign@ObjectInstance@@QAEMXZ PROC			; ObjectInstance::RadarSign, COMDAT
; _this$ = ecx

; 32   : 	float	RadarSign(void)			{ return RadarSignal; };
	...
	pop	ebp
	ret	0
?RadarSign@ObjectInstance@@QAEMXZ ENDP			; ObjectInstance::RadarSign
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\include\objectinstance.h
