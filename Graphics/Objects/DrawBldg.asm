; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\Objects\DrawBldg.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z	; DrawableBuilding::DrawableBuilding
PUBLIC	??1DrawableBuilding@@UAE@XZ			; DrawableBuilding::~DrawableBuilding
PUBLIC	?Draw@DrawableBuilding@@UAEXPAVRenderOTW@@H@Z	; DrawableBuilding::Draw
...
EXTRN	_strlen:PROC
EXTRN	_memmove:PROC
EXTRN	?GetGroundLevelApproximation@TViewPoint@@QAEMMM@Z:PROC ; TViewPoint::GetGroundLevelApproximation
...
xdata$x	ENDS
xdata$x	SEGMENT
__unwindtable$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z$0
__ehfuncinfo$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\objects\drawbldg.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_renderer$ = 8						; size = 4
_LOD$ = 12						; size = 4
?Draw@DrawableBuilding@@UAEXPAVRenderOTW@@H@Z PROC	; DrawableBuilding::Draw
; _this$ = ecx
...
; 57   : 	// See if we need to update our ground position
; 58   : 	if (LOD != previousLOD) 
...
; 59   : 	{
; 60   : 		// Update our position to reflect the terrain beneath us
; 61   : 		//position.z = renderer->viewpoint->GetGroundLevel(position.x,position.y);
; 62   : 		position.z = renderer->viewpoint->GetGroundLevelApproximation(position.x,position.y);
...
; 68   : 		DrawableBSP::Draw(renderer,LOD);
...
; 69   : }
	...
	pop	ebp
	ret	8
?Draw@DrawableBuilding@@UAEXPAVRenderOTW@@H@Z ENDP	; DrawableBuilding::Draw
_TEXT	ENDS
; Function compile flags: /Odtp
...
_heading$ = 16						; size = 4
_s$ = 20						; size = 4
??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z PROC		; DrawableBuilding::DrawableBuilding
; _this$ = ecx
...
; 30   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7DrawableBuilding@@6B@

; 31   : 	float	cosYaw;
; 32   : 	float	sinYaw;
; 33   : 
; 34   : 	// Compute the sine and cosine of the objects desired heading
; 35   : 	cosYaw = (float)cos( heading );
...
; 37   : 
; 38   : 	// Store this objects properties
; 39   : 	scale = s;
...
; 41   : 	drawClassID = Building;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+24], 4

; 42   : 	
; 43   : 	// Construct the rotation matrix to orient the object correctly
; 44   : 	orientation.M11 = cosYaw,	orientation.M12 = -sinYaw,	orientation.M13 = 0.0f;
...
; 45   : 	orientation.M21 = sinYaw,	orientation.M22 = cosYaw,	orientation.M23 = 0.0f;
...
; 46   : 	orientation.M31 = 0.0f,		orientation.M32 = 0.0f,		orientation.M33 = 1.0f;
...
; 47   : 
; 48   : 	// Record our position (Z will be updated later)
; 49   : 	position = *pos;
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1DrawableBSP@@UAE@XZ			; DrawableBSP::~DrawableBSP
__ehhandler$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-16]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0DrawableBuilding@@QAE@HPAUTpoint@@MM@Z ENDP		; DrawableBuilding::DrawableBuilding
; Function compile flags: /Odtp
