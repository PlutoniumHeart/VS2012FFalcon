; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\DDstuff\Device.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Release@DXContext@@QAEHXZ			; DXContext::Release
PUBLIC	??_GDXContext@@QAEPAXI@Z			; DXContext::`scalar deleting destructor'
PUBLIC	?targetSurface@ImageBuffer@@QAEPAUIDirectDrawSurface7@@XZ ; ImageBuffer::targetSurface
PUBLIC	??0DisplayDevice@@QAE@XZ			; DisplayDevice::DisplayDevice
PUBLIC	??1DisplayDevice@@QAE@XZ			; DisplayDevice::~DisplayDevice
PUBLIC	?Setup@DisplayDevice@@QAEXHHHHHHHPAUHWND__@@H@Z	; DisplayDevice::Setup
PUBLIC	?Cleanup@DisplayDevice@@QAEXXZ			; DisplayDevice::Cleanup
...
PUBLIC	??_C@_0CM@MAMHOGOE@Requested?5unavilable?5resolution?5@ ; `string'
PUBLIC	??_C@_0M@CFLADCE@Feb?518?52013?$AA@		; `string'
PUBLIC	??_C@_0L@EHPBPKDK@Device?4cpp?$AA@		; `string'
PUBLIC	??_C@_0BE@FGKKLFGH@Error?3?5?5?$CF0d?5?5?$CFs?5?5?$CFs?$AA@ ; `string'
PUBLIC	??_C@_0N@DPBNLDBK@RenderTarget?$AA@		; `string'
PUBLIC	??_C@_0BA@KEEJMHMB@Falcon?54?40?5Demo?$AA@	; `string'
...
EXTRN	??1DXContext@@QAE@XZ:PROC			; DXContext::~DXContext
...
EXTRN	??1ImageBuffer@@UAE@XZ:PROC			; ImageBuffer::~ImageBuffer
...
EXTRN	?CreateContext@DeviceManager@@QAEPAVDXContext@@HHHHPAUHWND__@@@Z:PROC ; DeviceManager::CreateContext
EXTRN	_movieInit:PROC
EXTRN	_movieUnInit:PROC
EXTRN	@__security_check_cookie@4:PROC
EXTRN	__CxxThrowException@8:PROC
EXTRN	___CxxFrameHandler3:PROC
EXTRN	??_7type_info@@6B@:QWORD			; type_info::`vftable'
EXTRN	?StateSetupCounter@ContextMPR@@2HA:DWORD	; ContextMPR::StateSetupCounter
...
CONST	ENDS
;	COMDAT ??_C@_0BA@KEEJMHMB@Falcon?54?40?5Demo?$AA@
CONST	SEGMENT
??_C@_0BA@KEEJMHMB@Falcon?54?40?5Demo?$AA@ DB 'Falcon 4.0 Demo', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@DPBNLDBK@RenderTarget?$AA@
CONST	SEGMENT
??_C@_0N@DPBNLDBK@RenderTarget?$AA@ DB 'RenderTarget', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0L@EHPBPKDK@Device?4cpp?$AA@
CONST	SEGMENT
??_C@_0L@EHPBPKDK@Device?4cpp?$AA@ DB 'Device.cpp', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@CFLADCE@Feb?518?52013?$AA@
CONST	SEGMENT
??_C@_0M@CFLADCE@Feb?518?52013?$AA@ DB 'Feb 18 2013', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CM@MAMHOGOE@Requested?5unavilable?5resolution?5@
CONST	SEGMENT
??_C@_0CM@MAMHOGOE@Requested?5unavilable?5resolution?5@ DB 'Requested una'
	DB	'vilable resolution %0dx%0dx%0d', 00H	; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\device.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Cleanup@DisplayDevice@@QAEXXZ PROC			; DisplayDevice::Cleanup
; _this$ = ecx
...
; 194  : 	    m_DXCtx->Release();
	...
	call	?Release@DXContext@@QAEHXZ		; DXContext::Release
...
; 197  : 	}
; 198  : 
; 199  : 	// Destroy our primary surface and its default context
; 200  : 	image.Cleanup();
...
; 201  : 
; 202  : 	// Make sure we haven't gotten confused about how many contexts we have
; 203  : //	ShiAssert( ContextMPR::StateSetupCounter == 0 );
; 204  : 	if (ContextMPR::StateSetupCounter != 0) {	

	cmp	DWORD PTR ?StateSetupCounter@ContextMPR@@2HA, 0 ; ContextMPR::StateSetupCounter
	je	SHORT $LN2@Cleanup

; 205  : 		ContextMPR::StateSetupCounter = 0;	// Force it for now.  Shouldn't be required.

	mov	DWORD PTR ?StateSetupCounter@ContextMPR@@2HA, 0 ; ContextMPR::StateSetupCounter
$LN2@Cleanup:

; 206  : 	}
; 207  : 
; 208  : 	// Destroy the application window if we created it
; 209  : 	if ( privateWindow ) {

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 0
	je	SHORT $LN1@Cleanup

; 210  : 		DestroyWindow( appWin );
...
; 215  : }
	...
	pop	ebp
	ret	0
?Cleanup@DisplayDevice@@QAEXXZ ENDP			; DisplayDevice::Cleanup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\device.cpp
_TEXT	SEGMENT
...
_this$ = -1264						; size = 4
_rect$ = -1260						; size = 16
_buffer$1 = -1244					; size = 580
_buffer$2 = -664					; size = 580
_message$3 = -84					; size = 80
...
_height$ = 20						; size = 4
_depth$ = 24						; size = 4
_fullScreen$ = 28					; size = 4
_dblBuffer$ = 32					; size = 4
_win$ = 36						; size = 4
_bWillCallSwapBuffer$ = 40				; size = 4
?Setup@DisplayDevice@@QAEXHHHHHHHPAUHWND__@@H@Z PROC	; DisplayDevice::Setup
; _this$ = ecx
...
; 44   : 	UInt		w, h, d;
; 45   : 
; 46   : 	ShiAssert( !IsReady() );
; 47   : 
; 48   : 
; 49   : 	// Remember our driver number so we know if we're software (driver 0) or hardware.
; 50   : 	driverNumber = driverNum;
...
; 52   : 
; 53   : 	#ifdef _DEBUG
; 54   : 	// For now we get the driver name again here.
; 55   : 	// TODO:  Eliminate the need for this by improving the MPR API?
; 56   : 	const char *lpDriverName;
; 57   : 	lpDriverName = FalconDisplay.devmgr.GetDriverName( driverNum);
; 58   : 	if(lpDriverName == NULL) ShiWarning( "Failed to get a name for the driver number" );
; 59   : 	#endif
; 60   : 
; 61   : 	// OW: always create flipping chain in fullscreen (even if we dont flip - we dont)
; 62   : 	dblBuffer = fullScreen;	// warning: C_Handler::Setup relies on this behaviour

	mov	edx, DWORD PTR _fullScreen$[ebp]
	mov	DWORD PTR _dblBuffer$[ebp], edx

; 63   : 
; 64   : 	// For now, we go figure out the number for the resolution we want
; 65   : 	// TODO:  Change the DisplayDevice API to require the resNum to be passed in?
; 66   : 	for (resNum=0; TRUE; resNum++) {

	mov	DWORD PTR _resNum$[ebp], 0
	jmp	SHORT $LN18@Setup
$LN17@Setup:
	mov	eax, DWORD PTR _resNum$[ebp]
	add	eax, 1
	mov	DWORD PTR _resNum$[ebp], eax
$LN18@Setup:
	mov	ecx, 1
	test	ecx, ecx
	je	$LN16@Setup

; 67   : 		if (FalconDisplay.devmgr.GetMode( driverNum, devNum, resNum, &w, &h, &d)) {
...
; 68   : 			if((w == (unsigned) width) && (h == (unsigned)height) && (d == (unsigned)depth)) {
...
; 73   : 			// Ran off the end of the list
; 74   : 			char message[80];
; 75   : 			sprintf( message, "Requested unavilable resolution %0dx%0dx%0d", width, height, depth);
	...
	push	edx
	push	OFFSET ??_C@_0CM@MAMHOGOE@Requested?5unavilable?5resolution?5@
...
; 76   : 			ShiError( message );
	...
	push	OFFSET ??_C@_0L@EHPBPKDK@Device?4cpp?$AA@
	push	76					; 0000004cH
...
; 79   : 
; 80   : 	// Create an MPR device handle for this device
; 81   : 	m_DXCtx = FalconDisplay.devmgr.CreateContext(driverNumber, devNum, resNum, fullScreen, win);
	...
	push	eax
	mov	ecx, OFFSET ?FalconDisplay@@3VFalconDisplayConfiguration@@A+116
	call	?CreateContext@DeviceManager@@QAEPAVDXContext@@HHHHPAUHWND__@@@Z ; DeviceManager::CreateContext
	mov	ecx, DWORD PTR _this$[ebp]
...
; 87   : 
; 88   : 		m_DXCtx = FalconDisplay.devmgr.CreateContext(driverNumber, 0, resNum, fullScreen, win);
...
; 91   : 	}
; 92   : 
; 93   : 	// See if we need to build our own window
; 94   : 	if (win) {
...
; 95   : 
; 96   : 		// Store the applications main window for later use
; 97   : 		appWin = win;
...
; 101  : 
; 102  : 		// set up and register window class
; 103  : 		wc.style = CS_HREDRAW | CS_VREDRAW | CS_OWNDC | CS_DBLCLKS | CS_NOCLOSE;

	mov	DWORD PTR _wc$[ebp], 555		; 0000022bH

; 104  : 		wc.lpfnWndProc = DefWindowProc;
...
; 106  : 		wc.cbWndExtra = sizeof(DWORD);

	mov	DWORD PTR _wc$[ebp+12], 4

; 107  : 		wc.hInstance = NULL;
...
; 110  : 		wc.hbrBackground = (HBRUSH)GetStockObject(BLACK_BRUSH);
...
; 112  : 		wc.lpszClassName = "RenderTarget";

	mov	DWORD PTR _wc$[ebp+36], OFFSET ??_C@_0N@DPBNLDBK@RenderTarget?$AA@

; 113  : 
; 114  : 		// Register this class.
...
; 116  : 
; 117  : 		// Choose an appropriate window style
; 118  : 		if (fullScreen) {
...
; 119  : 			style = WS_POPUP;
	...
	mov	DWORD PTR _style$[ebp], -2147483648	; 80000000H
...
; 121  : 			style = WS_OVERLAPPEDWINDOW;

	mov	DWORD PTR _style$[ebp], 13565952	; 00cf0000H
$LN7@Setup:

; 122  : 		}
; 123  : 
; 124  : 		// Build a window for this application
...
; 126  : 		rect.right = width;

	mov	eax, DWORD PTR _width$[ebp]
	mov	DWORD PTR _rect$[ebp+8], eax

; 127  : 		rect.bottom = height;

	mov	ecx, DWORD PTR _height$[ebp]
	mov	DWORD PTR _rect$[ebp+12], ecx

; 128  : 		AdjustWindowRect(&rect,	style, FALSE);
...
; 129  : 		appWin = CreateWindow(
; 130  : 	    	"RenderTarget",			/* class */
; 131  : 			"Falcon 4.0 Demo",		/* caption */
; 132  : 			style,					/* style */
; 133  : 			50,			/* init. x pos */
; 134  : 			50,			/* init. y pos */
; 135  : 			rect.right-rect.left,	/* init. x size */
; 136  : 			rect.bottom-rect.top,	/* init. y size */
; 137  : 			NULL,					/* parent window */
; 138  : 			NULL,					/* menu handle */
; 139  : 			NULL,					/* program handle */
; 140  : 			NULL					/* create parms */
; 141  : 		);
	...
	push	eax
	push	OFFSET ??_C@_0BA@KEEJMHMB@Falcon?54?40?5Demo?$AA@
	push	OFFSET ??_C@_0N@DPBNLDBK@RenderTarget?$AA@
	push	0
...
; 143  : 			ShiError( "Failed to construct main window" );
...
; 144  : 		}
; 145  : 
; 146  : 		// Make note of the fact that we'll have to release this window when we're done
; 147  : 		privateWindow = TRUE;
...
; 149  : 
; 150  : 
; 151  : 	// Ensure the rendering window is visible
; 152  : 	ShowWindow( appWin, SW_SHOW );
...
; 153  : 
; 154  : 
; 155  : 	// Select the requested mode of operation
; 156  : 	if(fullScreen)
...
; 157  : 	{
; 158  : 		// If this is other than the default primary display, shrink the target window
; 159  : 		// on the desktop and don't let DirectX muck with it.
; 160  : #if 0
; 161  : 		SetWindowPos( appWin, HWND_TOP, 0, 200, 10, 4, SWP_NOCOPYBITS | SWP_SHOWWINDOW );
; 162  : #endif
; 163  : 
; 164  : 		// Create the primary surface(s)
; 165  : 		if(dblBuffer)

	cmp	DWORD PTR _dblBuffer$[ebp], 0
	je	SHORT $LN4@Setup

; 166  : 			image.Setup( this, width, height, Primary, Flip, appWin, FALSE, TRUE, bWillCallSwapBuffer );

	mov	edx, DWORD PTR _bWillCallSwapBuffer$[ebp]
	push	edx
	push	1
	push	0
	mov	eax, DWORD PTR _this$[ebp]
...
; 168  : 			image.Setup( this, width, height, Primary, IsHardware() ? VideoMem : SystemMem, appWin, FALSE, TRUE, bWillCallSwapBuffer);
...
; 172  : 		image.Setup( this, width, height, Primary, IsHardware() ? VideoMem : SystemMem, appWin, TRUE, FALSE, bWillCallSwapBuffer);
...
$LN24@Setup:
	mov	eax, DWORD PTR _bWillCallSwapBuffer$[ebp]
	push	eax
	push	0
	push	1
	mov	ecx, DWORD PTR _this$[ebp]
...
; 173  : 
; 174  : 	// Make sure we haven't gotten confused about how many contexts we have
; 175  : //	ShiAssert( ContextMPR::StateSetupCounter == 0 );
; 176  : 	if(ContextMPR::StateSetupCounter != 0)	

	cmp	DWORD PTR ?StateSetupCounter@ContextMPR@@2HA, 0 ; ContextMPR::StateSetupCounter
	je	SHORT $LN1@Setup

; 177  : 		ContextMPR::StateSetupCounter = 0;	// Force it for now.  Shouldn't be required.

	mov	DWORD PTR ?StateSetupCounter@ContextMPR@@2HA, 0 ; ContextMPR::StateSetupCounter
$LN1@Setup:

; 178  : 
; 179  : 	// Create a rendering context for the primary surface
; 180  : 	m_DXCtx->SetRenderTarget(image.targetSurface());
...
; 183  : 	}
	...
	pop	ebp
	ret	36					; 00000024H
?Setup@DisplayDevice@@QAEXHHHHHHHPAUHWND__@@H@Z ENDP	; DisplayDevice::Setup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\device.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DisplayDevice@@QAE@XZ PROC				; DisplayDevice::~DisplayDevice
; _this$ = ecx
...
; 33   : }
	...
	pop	ebp
	ret	0
??1DisplayDevice@@QAE@XZ ENDP				; DisplayDevice::~DisplayDevice
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\device.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DisplayDevice@@QAE@XZ PROC				; DisplayDevice::DisplayDevice
; _this$ = ecx
...
; 26   : }
	...
	pop	ebp
	ret	0
??0DisplayDevice@@QAE@XZ ENDP				; DisplayDevice::DisplayDevice
_TEXT	ENDS
; Function compile flags: /Odtp
...
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDXContext@@QAEPAXI@Z PROC				; DXContext::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1DXContext@@QAE@XZ			; DXContext::~DXContext
...
tv66 = -8						; size = 4
_this$ = -4						; size = 4
?Release@DXContext@@QAEHXZ PROC				; DXContext::Release, COMDAT
; _this$ = ecx
...
; 336  : 	};
	...
	pop	ebp
	ret	0
?Release@DXContext@@QAEHXZ ENDP				; DXContext::Release
_TEXT	ENDS
; Function compile flags: /Odtp
