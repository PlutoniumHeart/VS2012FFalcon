; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\DDstuff\rotate.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?RotateBitmapMask@@YAXPAVImageBuffer@@0HPAUtagRECT@@1PAH@Z ; RotateBitmapMask
PUBLIC	?RotateBitmap@@YAXPAVImageBuffer@@0HPAUtagRECT@@1@Z ; RotateBitmap
PUBLIC	?RotateBitmapMaskDouble@@YAXPAVImageBuffer@@0HPAUtagRECT@@1PAH@Z ; RotateBitmapMaskDouble
PUBLIC	?RotateBitmapDouble@@YAXPAVImageBuffer@@0HPAUtagRECT@@1@Z ; RotateBitmapDouble
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\rotate.cpp
_TEXT	SEGMENT
_isdVy$ = -152						; size = 4
_desty$ = -148						; size = 4
_isdVx$ = -144						; size = 4
...
_srect$ = 20						; size = 4
_drect$ = 24						; size = 4
?RotateBitmapDouble@@YAXPAVImageBuffer@@0HPAUtagRECT@@1@Z PROC ; RotateBitmapDouble
...
; 422  : 	ShiAssert( drect );
; 423  : 
; 424  : 	char *source = (char *) srcbuf->Lock();

	push	1
	push	0
	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?Lock@ImageBuffer@@QAEPAX_N0@Z		; ImageBuffer::Lock
	mov	DWORD PTR _source$[ebp], eax

; 425  : 	ShiAssert( source );
; 426  : 	char *dest = (char *) destbuf->Lock();
...
; 427  : 	ShiAssert( dest );
; 428  : 
; 429  : 	int dStride	= destbuf->targetStride();

	mov	ecx, DWORD PTR _destbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _dStride$[ebp], eax

; 430  : 	int sStride	= srcbuf->targetStride();

	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _sStride$[ebp], eax

; 431  : 	int destx	= drect->left;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _destx$[ebp], ecx

; 432  : 	int desty	= drect->top;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR _desty$[ebp], eax

; 433  : 	int width	= srect->right - srect->left;

	mov	ecx, DWORD PTR _srect$[ebp]
	mov	edx, DWORD PTR _srect$[ebp]
	mov	eax, DWORD PTR [ecx+8]
	sub	eax, DWORD PTR [edx]
	mov	DWORD PTR _width$[ebp], eax

; 434  : 	int height	= srect->bottom - srect->top;
...
; 435  : 	int sx		= (srect->right + srect->left) >> 1;

	mov	ecx, DWORD PTR _srect$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	mov	eax, DWORD PTR _srect$[ebp]
	add	edx, DWORD PTR [eax]
	sar	edx, 1
	mov	DWORD PTR _sx$[ebp], edx

; 436  : 	int sy		= (srect->bottom + srect->top) >> 1;
...
; 437  : 
; 438  : 	float	sine, cosine;
; 439  : 
; 440  : 	glGetSinCos (&sine, &cosine, angle);
...
; 443  : 	float xc =  x * cosine; 

	movss	xmm0, DWORD PTR _x$[ebp]
	mulss	xmm0, DWORD PTR _cosine$[ebp]
	movss	DWORD PTR _xc$[ebp], xmm0
...
; 446  : 	float yc =  y * cosine;

	movss	xmm0, DWORD PTR _y$[ebp]
	mulss	xmm0, DWORD PTR _cosine$[ebp]
	movss	DWORD PTR _yc$[ebp], xmm0

; 447  : 	x = 1.0f / x; y = 1.0f / y;

	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _x$[ebp]
	movss	DWORD PTR _x$[ebp], xmm0
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _y$[ebp]
	movss	DWORD PTR _y$[ebp], xmm0
...
; 450  : 	sy += (int) (-xs - yc);
	...
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _yc$[ebp]
	cvttss2si ecx, xmm0
	add	ecx, DWORD PTR _sy$[ebp]
	mov	DWORD PTR _sy$[ebp], ecx

; 451  : 
; 452  : 	char *dptr = dest + (destx << 1) + desty * dStride;

	mov	edx, DWORD PTR _destx$[ebp]
	mov	eax, DWORD PTR _dest$[ebp]
	lea	ecx, DWORD PTR [eax+edx*2]
	mov	edx, DWORD PTR _desty$[ebp]
	imul	edx, DWORD PTR _dStride$[ebp]
	add	ecx, edx
	mov	DWORD PTR _dptr$[ebp], ecx

; 453  : 	char *sptr = source + (sx << 1) + sy * sStride;

	mov	eax, DWORD PTR _sx$[ebp]
	mov	ecx, DWORD PTR _source$[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	eax, DWORD PTR _sy$[ebp]
	imul	eax, DWORD PTR _sStride$[ebp]
	add	edx, eax
	mov	DWORD PTR _sptr$[ebp], edx

; 454  : 
; 455  : 	float x1 = x * 1024.0f; 

	movss	xmm0, DWORD PTR _x$[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _x1$[ebp], xmm0

; 456  : 	float y1 = y * 1024.0f; 

	movss	xmm0, DWORD PTR _y$[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _y1$[ebp], xmm0

; 457  : 	int isdHx = (int) (xc * x1);

	movss	xmm0, DWORD PTR _xc$[ebp]
	mulss	xmm0, DWORD PTR _x1$[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdHx$[ebp], ecx

; 458  : 	int isdHy = (int) (xs * x1);

	movss	xmm0, DWORD PTR _xs$[ebp]
	mulss	xmm0, DWORD PTR _x1$[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdHy$[ebp], edx

; 459  : 	int isdVx = (int) (ys * y1);

	movss	xmm0, DWORD PTR _ys$[ebp]
	mulss	xmm0, DWORD PTR _y1$[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdVx$[ebp], eax

; 460  : 	int isdVy = (int) (yc * y1);

	movss	xmm0, DWORD PTR _yc$[ebp]
	mulss	xmm0, DWORD PTR _y1$[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdVy$[ebp], ecx

; 461  : 	int iyx = 0;

	mov	DWORD PTR _iyx$[ebp], 0

; 462  : 	int iyy = 0;

	mov	DWORD PTR _iyy$[ebp], 0
...
; 466  : 	{
; 467  : 		int k = ((iyx >> 10) << 1) + (iyy >> 10) * sStride;

	mov	ecx, DWORD PTR _iyx$[ebp]
	sar	ecx, 10					; 0000000aH
	mov	edx, DWORD PTR _iyy$[ebp]
	sar	edx, 10					; 0000000aH
	imul	edx, DWORD PTR _sStride$[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
	mov	DWORD PTR _k$2[ebp], eax

; 468  : 		char *sptr1 = sptr + k;

	mov	ecx, DWORD PTR _sptr$[ebp]
	add	ecx, DWORD PTR _k$2[ebp]
	mov	DWORD PTR _sptr1$3[ebp], ecx

; 469  : 		char *dptr1 = dptr;

	mov	edx, DWORD PTR _dptr$[ebp]
	mov	DWORD PTR _dptr1$5[ebp], edx

; 470  : 		int ixx = 0;

	mov	DWORD PTR _ixx$7[ebp], 0

; 471  : 		int ixy = 0;

	mov	DWORD PTR _ixy$6[ebp], 0
...
; 475  : 		{
; 476  : 			int k = ((ixx >> 10) << 1) + (ixy >> 10) * sStride;

	mov	edx, DWORD PTR _ixx$7[ebp]
	sar	edx, 10					; 0000000aH
	mov	eax, DWORD PTR _ixy$6[ebp]
...
; 477  : 			ixx += isdHx;
	...
	mov	edx, DWORD PTR _ixx$7[ebp]
	add	edx, DWORD PTR _isdHx$[ebp]
	mov	DWORD PTR _ixx$7[ebp], edx

; 478  : 			ixy += isdHy;

	mov	eax, DWORD PTR _ixy$6[ebp]
	add	eax, DWORD PTR _isdHy$[ebp]
	mov	DWORD PTR _ixy$6[ebp], eax

; 479  : 			short *dptr = (short *) dptr1;

	mov	ecx, DWORD PTR _dptr1$5[ebp]
	mov	DWORD PTR _dptr$9[ebp], ecx

; 480  : 			short *sptr = (short *) (sptr1+k);

	mov	edx, DWORD PTR _sptr1$3[ebp]
	add	edx, DWORD PTR _k$1[ebp]
	mov	DWORD PTR _sptr$8[ebp], edx

; 481  : 
; 482  : 			// Write the pixels (TODO:  If we got it aligned first, we could write DWORDs at a time)
; 483  : 			*(dptr)				= *sptr;

	mov	eax, DWORD PTR _dptr$9[ebp]
...
; 485  : 			*(dptr+dStride/2)	= *sptr;

	mov	eax, DWORD PTR _dStride$[ebp]
	cdq
	sub	eax, edx
	sar	eax, 1
	mov	ecx, DWORD PTR _dptr$9[ebp]
	mov	edx, DWORD PTR _sptr$8[ebp]
	mov	dx, WORD PTR [edx]
	mov	WORD PTR [ecx+eax*2], dx

; 486  : 			*(dptr+dStride/2+1)	= *sptr;
...
; 487  : 
; 488  : 			dptr1 += 4;		// Skip four byte (since we write two pixels each time)

	mov	eax, DWORD PTR _dptr1$5[ebp]
	add	eax, 4
	mov	DWORD PTR _dptr1$5[ebp], eax
...
; 490  : 
; 491  : 		dptr += dStride*2;	// Skip two lines (since we write two each time)

	mov	ecx, DWORD PTR _dStride$[ebp]
	mov	edx, DWORD PTR _dptr$[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
...
; 492  : 		iyx += isdVx;
	...
	mov	ecx, DWORD PTR _iyx$[ebp]
	add	ecx, DWORD PTR _isdVx$[ebp]
	mov	DWORD PTR _iyx$[ebp], ecx

; 493  : 		iyy += isdVy;

	mov	edx, DWORD PTR _iyy$[ebp]
	add	edx, DWORD PTR _isdVy$[ebp]
	mov	DWORD PTR _iyy$[ebp], edx
...
; 498  : }
	...
	pop	ebp
	ret	0
?RotateBitmapDouble@@YAXPAVImageBuffer@@0HPAUtagRECT@@1@Z ENDP ; RotateBitmapDouble
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\rotate.cpp
_TEXT	SEGMENT
...
_k$8 = -284						; size = 4
_stop$9 = -280						; size = 4
_isdVy$10 = -276					; size = 4
_k$11 = -272						; size = 4
_k$12 = -268						; size = 4
_sptr$13 = -264						; size = 4
_stop$14 = -260						; size = 4
_desty$15 = -256					; size = 4
_sptr$16 = -252						; size = 4
_destx$17 = -248					; size = 4
_destx$18 = -244					; size = 4
_width$19 = -240					; size = 4
_width$20 = -236					; size = 4
_sine$21 = -232						; size = 4
_yc$22 = -228						; size = 4
_xc$23 = -224						; size = 4
_isdHy$24 = -220					; size = 4
_height$25 = -216					; size = 4
_cosine$26 = -212					; size = 4
_y1$27 = -208						; size = 4
_height$28 = -204					; size = 4
_yc$29 = -200						; size = 4
_dest$ = -196						; size = 4
_ys$30 = -192						; size = 4
_sine$31 = -188						; size = 4
_x1$32 = -184						; size = 4
_isdHx$33 = -180					; size = 4
_xs$34 = -176						; size = 4
_y1$35 = -172						; size = 4
_xc$36 = -168						; size = 4
_ys$37 = -164						; size = 4
_source$ = -160						; size = 4
_xs$38 = -156						; size = 4
_isdHy$39 = -152					; size = 4
_cosine$40 = -148					; size = 4
_isdHx$41 = -144					; size = 4
_x1$42 = -140						; size = 4
_iyy$43 = -136						; size = 4
_sx$44 = -132						; size = 4
_iyx$45 = -128						; size = 4
...
_dptr$47 = -120						; size = 4
_iyy$48 = -116						; size = 4
_dptr1$49 = -112					; size = 4
_ixy$50 = -108						; size = 4
_ixy$51 = -104						; size = 4
_i$52 = -100						; size = 4
_ixx$53 = -96						; size = 4
_iyx$54 = -92						; size = 4
_sStride$55 = -88					; size = 4
_dptr1$56 = -84						; size = 4
_j$57 = -80						; size = 4
_ixx$58 = -76						; size = 4
_i$59 = -72						; size = 4
...
_sy$62 = -60						; size = 4
_sx$63 = -56						; size = 4
_sStride$64 = -52					; size = 4
_dStride$65 = -48					; size = 4
_sptr$66 = -44						; size = 4
_sptr$67 = -40						; size = 4
_dStride$68 = -36					; size = 4
_dptr$69 = -32						; size = 4
_start$70 = -28						; size = 4
_start$71 = -24						; size = 4
_dptr$72 = -20						; size = 4
...
_srect$ = 20						; size = 4
_drect$ = 24						; size = 4
_startstop$ = 28					; size = 4
?RotateBitmapMaskDouble@@YAXPAVImageBuffer@@0HPAUtagRECT@@1PAH@Z PROC ; RotateBitmapMaskDouble
...
; 258  : 	if (!startstop)
	...
	cmp	DWORD PTR _startstop$[ebp], 0
	jne	SHORT $LN17@RotateBitm

; 259  : 	{
; 260  : 		RotateBitmapDouble (srcbuf, destbuf, angle, srect, drect);
...
; 262  : 	}
; 263  : 
; 264  : 	char *source = (char *) srcbuf ->Lock();
...
; 265  : 	ShiAssert( source );
; 266  : 	char *dest = (char *) destbuf ->Lock();
...
; 270  : 	{
; 271  : 		int dStride	= destbuf->targetStride();

	mov	ecx, DWORD PTR _destbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _dStride$68[ebp], eax

; 272  : 		int sStride	= srcbuf->targetStride();

	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _sStride$64[ebp], eax

; 273  : 		int destx	= drect->left;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR _destx$18[ebp], eax

; 274  : 		int desty	= drect->top;

	mov	ecx, DWORD PTR _drect$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _desty$2[ebp], edx

; 275  : 		int width	= srect->right - srect->left;

	mov	eax, DWORD PTR _srect$[ebp]
	mov	ecx, DWORD PTR _srect$[ebp]
	mov	edx, DWORD PTR [eax+8]
	sub	edx, DWORD PTR [ecx]
	mov	DWORD PTR _width$20[ebp], edx

; 276  : 		int height	= srect->bottom - srect->top;

	mov	eax, DWORD PTR _srect$[ebp]
	mov	ecx, DWORD PTR _srect$[ebp]
	mov	edx, DWORD PTR [eax+12]
	sub	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _height$28[ebp], edx

; 277  : 		int sx		= (srect->right + srect->left) >> 1;
	...
	sar	ecx, 1
	mov	DWORD PTR _sx$44[ebp], ecx

; 278  : 		int sy		= (srect->bottom + srect->top) >> 1;
	...
	sar	ecx, 1
	mov	DWORD PTR _sy$62[ebp], ecx

; 279  : 
; 280  : 		float sine, cosine;
; 281  : 		glGetSinCos (&sine, &cosine, angle);

	mov	eax, DWORD PTR _angle$[ebp]
	push	eax
	lea	ecx, DWORD PTR _cosine$40[ebp]
	push	ecx
	lea	edx, DWORD PTR _sine$21[ebp]
	push	edx
	call	?glGetSinCos@@YAXPAM0H@Z		; glGetSinCos
	add	esp, 12					; 0000000cH

; 282  : 		float x = (float) (width >> 1);

	mov	eax, DWORD PTR _width$20[ebp]
	sar	eax, 1
	cvtsi2ss xmm0, eax
	movss	DWORD PTR _x$74[ebp], xmm0

; 283  : 		float y = (float) (height >> 1);

	mov	ecx, DWORD PTR _height$28[ebp]
	sar	ecx, 1
	cvtsi2ss xmm0, ecx
	movss	DWORD PTR _y$76[ebp], xmm0

; 284  : 		float xc =  x * cosine; 

	movss	xmm0, DWORD PTR _x$74[ebp]
	mulss	xmm0, DWORD PTR _cosine$40[ebp]
	movss	DWORD PTR _xc$23[ebp], xmm0

; 285  : 		float xs = -x * sine;

	movss	xmm0, DWORD PTR _x$74[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	mulss	xmm0, DWORD PTR _sine$21[ebp]
	movss	DWORD PTR _xs$38[ebp], xmm0

; 286  : 		float ys =  y * sine;   

	movss	xmm0, DWORD PTR _y$76[ebp]
	mulss	xmm0, DWORD PTR _sine$21[ebp]
	movss	DWORD PTR _ys$37[ebp], xmm0

; 287  : 		float yc =  y * cosine;

	movss	xmm0, DWORD PTR _y$76[ebp]
	mulss	xmm0, DWORD PTR _cosine$40[ebp]
	movss	DWORD PTR _yc$22[ebp], xmm0

; 288  : 		x = 1.0f / x; y = 1.0f / y;

	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _x$74[ebp]
	movss	DWORD PTR _x$74[ebp], xmm0
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _y$76[ebp]
	movss	DWORD PTR _y$76[ebp], xmm0

; 289  : 
; 290  : 		sx += (int) (-xc - ys);

	movss	xmm0, DWORD PTR _xc$23[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _ys$37[ebp]
	cvttss2si edx, xmm0
	add	edx, DWORD PTR _sx$44[ebp]
	mov	DWORD PTR _sx$44[ebp], edx

; 291  : 		sy += (int) (-xs - yc);

	movss	xmm0, DWORD PTR _xs$38[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _yc$22[ebp]
	cvttss2si eax, xmm0
	add	eax, DWORD PTR _sy$62[ebp]
	mov	DWORD PTR _sy$62[ebp], eax

; 292  : 
; 293  : 		char *dptr = dest + (destx << 1) + desty * dStride;

	mov	ecx, DWORD PTR _destx$18[ebp]
	mov	edx, DWORD PTR _dest$[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
	mov	ecx, DWORD PTR _desty$2[ebp]
	imul	ecx, DWORD PTR _dStride$68[ebp]
	add	eax, ecx
	mov	DWORD PTR _dptr$46[ebp], eax

; 294  : 		char *sptr = source + (sx << 1) + sy * sStride;

	mov	edx, DWORD PTR _sx$44[ebp]
	mov	eax, DWORD PTR _source$[ebp]
	lea	ecx, DWORD PTR [eax+edx*2]
	mov	edx, DWORD PTR _sy$62[ebp]
	imul	edx, DWORD PTR _sStride$64[ebp]
	add	ecx, edx
	mov	DWORD PTR _sptr$16[ebp], ecx

; 295  : 
; 296  : 		float x1 = x * 1024.0f; 

	movss	xmm0, DWORD PTR _x$74[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _x1$42[ebp], xmm0

; 297  : 		float y1 = y * 1024.0f; 

	movss	xmm0, DWORD PTR _y$76[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _y1$35[ebp], xmm0

; 298  : 		int isdHx = (int) (xc * x1);

	movss	xmm0, DWORD PTR _xc$23[ebp]
	mulss	xmm0, DWORD PTR _x1$42[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdHx$33[ebp], eax

; 299  : 		int isdHy = (int) (xs * x1);

	movss	xmm0, DWORD PTR _xs$38[ebp]
	mulss	xmm0, DWORD PTR _x1$42[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdHy$24[ebp], ecx

; 300  : 		int isdVx = (int) (ys * y1);

	movss	xmm0, DWORD PTR _ys$37[ebp]
	mulss	xmm0, DWORD PTR _y1$35[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdVx$6[ebp], edx

; 301  : 		int isdVy = (int) (yc * y1);

	movss	xmm0, DWORD PTR _yc$22[ebp]
	mulss	xmm0, DWORD PTR _y1$35[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdVy$10[ebp], eax

; 302  : 		int iyx = 0;

	mov	DWORD PTR _iyx$54[ebp], 0

; 303  : 		int iyy = 0;

	mov	DWORD PTR _iyy$48[ebp], 0
...
$LN15@RotateBitm:
	...
	cmp	edx, DWORD PTR _height$28[ebp]
	jge	$LN13@RotateBitm

; 307  : 		{
; 308  : 			int start = *startstop++;

	mov	eax, DWORD PTR _startstop$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _start$70[ebp], ecx
	mov	edx, DWORD PTR _startstop$[ebp]
	add	edx, 4
	mov	DWORD PTR _startstop$[ebp], edx

; 309  : 			int stop = *startstop++;

	mov	eax, DWORD PTR _startstop$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _stop$14[ebp], ecx
	mov	edx, DWORD PTR _startstop$[ebp]
	add	edx, 4
	mov	DWORD PTR _startstop$[ebp], edx

; 310  : 			int k = ((iyx >> 10) << 1) + (iyy >> 10) * sStride;

	mov	eax, DWORD PTR _iyx$54[ebp]
	sar	eax, 10					; 0000000aH
	mov	ecx, DWORD PTR _iyy$48[ebp]
	sar	ecx, 10					; 0000000aH
	imul	ecx, DWORD PTR _sStride$64[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _k$8[ebp], edx

; 311  : 			char *sptr1 = sptr + k;

	mov	eax, DWORD PTR _sptr$16[ebp]
	add	eax, DWORD PTR _k$8[ebp]
	mov	DWORD PTR _sptr1$4[ebp], eax

; 312  : 			char *dptr1 = dptr + (start << 2);

	mov	ecx, DWORD PTR _start$70[ebp]
	mov	edx, DWORD PTR _dptr$46[ebp]
	lea	eax, DWORD PTR [edx+ecx*4]
	mov	DWORD PTR _dptr1$56[ebp], eax

; 313  : 
; 314  : 			int ixx = (int) (start * isdHx);

	mov	ecx, DWORD PTR _start$70[ebp]
	imul	ecx, DWORD PTR _isdHx$33[ebp]
	mov	DWORD PTR _ixx$58[ebp], ecx

; 315  : 			int ixy = (int) (start * isdHy);

	mov	edx, DWORD PTR _start$70[ebp]
	imul	edx, DWORD PTR _isdHy$24[ebp]
	mov	DWORD PTR _ixy$50[ebp], edx

; 316  : 			int	j;
; 317  : 
; 318  : 			for(j=start; j < stop; j++)

	mov	eax, DWORD PTR _start$70[ebp]
	mov	DWORD PTR _j$60[ebp], eax
	jmp	SHORT $LN12@RotateBitm
$LN11@RotateBitm:
	mov	ecx, DWORD PTR _j$60[ebp]
	add	ecx, 1
	mov	DWORD PTR _j$60[ebp], ecx
$LN12@RotateBitm:
	mov	edx, DWORD PTR _j$60[ebp]
	cmp	edx, DWORD PTR _stop$14[ebp]
	jge	$LN10@RotateBitm

; 319  : 			{
; 320  : 				int k = ((ixx >> 10) << 1) + (ixy >> 10) * sStride;

	mov	eax, DWORD PTR _ixx$58[ebp]
	sar	eax, 10					; 0000000aH
	mov	ecx, DWORD PTR _ixy$50[ebp]
	sar	ecx, 10					; 0000000aH
	imul	ecx, DWORD PTR _sStride$64[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _k$12[ebp], edx

; 321  : 				ixx += isdHx;

	mov	eax, DWORD PTR _ixx$58[ebp]
	add	eax, DWORD PTR _isdHx$33[ebp]
	mov	DWORD PTR _ixx$58[ebp], eax

; 322  : 				ixy += isdHy;

	mov	ecx, DWORD PTR _ixy$50[ebp]
	add	ecx, DWORD PTR _isdHy$24[ebp]
	mov	DWORD PTR _ixy$50[ebp], ecx

; 323  : 				short *dptr = (short *) dptr1;

	mov	edx, DWORD PTR _dptr1$56[ebp]
	mov	DWORD PTR _dptr$72[ebp], edx

; 324  : 				short *sptr = (short *) (sptr1+k);

	mov	eax, DWORD PTR _sptr1$4[ebp]
	add	eax, DWORD PTR _k$12[ebp]
	mov	DWORD PTR _sptr$66[ebp], eax

; 325  : 
; 326  : 				// Write the pixels (TODO:  If we got it aligned first, we could write DWORDs at a time)
; 327  : 				*(dptr)				= *sptr;

	mov	ecx, DWORD PTR _dptr$72[ebp]
	mov	edx, DWORD PTR _sptr$66[ebp]
	mov	ax, WORD PTR [edx]
	mov	WORD PTR [ecx], ax
...
; 329  : 				*(dptr+dStride/2)	= *sptr;

	mov	eax, DWORD PTR _dStride$68[ebp]
	cdq
	sub	eax, edx
	sar	eax, 1
	mov	ecx, DWORD PTR _dptr$72[ebp]
...
; 331  : 
; 332  : 				dptr1 += 4;		// Skip four byte (since we write two pixels each time)

	mov	eax, DWORD PTR _dptr1$56[ebp]
	add	eax, 4
	mov	DWORD PTR _dptr1$56[ebp], eax
...
; 334  : 
; 335  : 			dptr += dStride*2;	// Skip two lines (since we write two each time)

	mov	ecx, DWORD PTR _dStride$68[ebp]
	mov	edx, DWORD PTR _dptr$46[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
	mov	DWORD PTR _dptr$46[ebp], eax
...
; 336  : 			iyx += isdVx;
	...
	mov	ecx, DWORD PTR _iyx$54[ebp]
	add	ecx, DWORD PTR _isdVx$6[ebp]
	mov	DWORD PTR _iyx$54[ebp], ecx

; 337  : 			iyy += isdVy;

	mov	edx, DWORD PTR _iyy$48[ebp]
	add	edx, DWORD PTR _isdVy$10[ebp]
	mov	DWORD PTR _iyy$48[ebp], edx
...
; 339  : 	}
; 340  : 
; 341  : 	else if(destbuf->PixelSize() == 4)
...
; 342  : 	{
; 343  : 		int dStride	= destbuf->targetStride();

	mov	ecx, DWORD PTR _destbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _dStride$65[ebp], eax

; 344  : 		int sStride	= srcbuf->targetStride();

	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _sStride$55[ebp], eax

; 345  : 		int destx	= drect->left;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _destx$17[ebp], ecx

; 346  : 		int desty	= drect->top;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR _desty$15[ebp], eax

; 347  : 		int width	= srect->right - srect->left;

	mov	ecx, DWORD PTR _srect$[ebp]
	mov	edx, DWORD PTR _srect$[ebp]
	mov	eax, DWORD PTR [ecx+8]
	sub	eax, DWORD PTR [edx]
	mov	DWORD PTR _width$19[ebp], eax

; 348  : 		int height	= srect->bottom - srect->top;

	mov	ecx, DWORD PTR _srect$[ebp]
	mov	edx, DWORD PTR _srect$[ebp]
	mov	eax, DWORD PTR [ecx+12]
	sub	eax, DWORD PTR [edx+4]
	mov	DWORD PTR _height$25[ebp], eax

; 349  : 		int sx		= (srect->right + srect->left) >> 1;
	...
	add	edx, DWORD PTR [eax]
	sar	edx, 1
	mov	DWORD PTR _sx$63[ebp], edx

; 350  : 		int sy		= (srect->bottom + srect->top) >> 1;
	...
	add	edx, DWORD PTR [eax+4]
	sar	edx, 1
	mov	DWORD PTR _sy$61[ebp], edx

; 351  : 
; 352  : 		float sine, cosine;
; 353  : 		glGetSinCos (&sine, &cosine, angle);

	mov	ecx, DWORD PTR _angle$[ebp]
	push	ecx
	lea	edx, DWORD PTR _cosine$26[ebp]
	push	edx
	lea	eax, DWORD PTR _sine$31[ebp]
	push	eax
	call	?glGetSinCos@@YAXPAM0H@Z		; glGetSinCos
	add	esp, 12					; 0000000cH

; 354  : 		float x = (float) (width >> 1);

	mov	ecx, DWORD PTR _width$19[ebp]
	sar	ecx, 1
	cvtsi2ss xmm0, ecx
	movss	DWORD PTR _x$75[ebp], xmm0

; 355  : 		float y = (float) (height >> 1);

	mov	edx, DWORD PTR _height$25[ebp]
	sar	edx, 1
	cvtsi2ss xmm0, edx
	movss	DWORD PTR _y$73[ebp], xmm0

; 356  : 		float xc =  x * cosine; 

	movss	xmm0, DWORD PTR _x$75[ebp]
	mulss	xmm0, DWORD PTR _cosine$26[ebp]
	movss	DWORD PTR _xc$36[ebp], xmm0

; 357  : 		float xs = -x * sine;

	movss	xmm0, DWORD PTR _x$75[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	mulss	xmm0, DWORD PTR _sine$31[ebp]
	movss	DWORD PTR _xs$34[ebp], xmm0

; 358  : 		float ys =  y * sine;   

	movss	xmm0, DWORD PTR _y$73[ebp]
	mulss	xmm0, DWORD PTR _sine$31[ebp]
	movss	DWORD PTR _ys$30[ebp], xmm0

; 359  : 		float yc =  y * cosine;

	movss	xmm0, DWORD PTR _y$73[ebp]
	mulss	xmm0, DWORD PTR _cosine$26[ebp]
	movss	DWORD PTR _yc$29[ebp], xmm0

; 360  : 		x = 1.0f / x; y = 1.0f / y;

	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _x$75[ebp]
	movss	DWORD PTR _x$75[ebp], xmm0
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _y$73[ebp]
	movss	DWORD PTR _y$73[ebp], xmm0

; 361  : 
; 362  : 		sx += (int) (-xc - ys);

	movss	xmm0, DWORD PTR _xc$36[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _ys$30[ebp]
	cvttss2si eax, xmm0
	add	eax, DWORD PTR _sx$63[ebp]
	mov	DWORD PTR _sx$63[ebp], eax

; 363  : 		sy += (int) (-xs - yc);

	movss	xmm0, DWORD PTR _xs$34[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _yc$29[ebp]
	cvttss2si ecx, xmm0
	add	ecx, DWORD PTR _sy$61[ebp]
	mov	DWORD PTR _sy$61[ebp], ecx

; 364  : 
; 365  : 		char *dptr = dest + (destx << 2) + desty * dStride;

	mov	edx, DWORD PTR _destx$17[ebp]
	mov	eax, DWORD PTR _dest$[ebp]
	lea	ecx, DWORD PTR [eax+edx*4]
	mov	edx, DWORD PTR _desty$15[ebp]
	imul	edx, DWORD PTR _dStride$65[ebp]
	add	ecx, edx
	mov	DWORD PTR _dptr$47[ebp], ecx

; 366  : 		char *sptr = source + (sx << 2) + sy * sStride;

	mov	eax, DWORD PTR _sx$63[ebp]
	mov	ecx, DWORD PTR _source$[ebp]
	lea	edx, DWORD PTR [ecx+eax*4]
	mov	eax, DWORD PTR _sy$61[ebp]
	imul	eax, DWORD PTR _sStride$55[ebp]
	add	edx, eax
	mov	DWORD PTR _sptr$13[ebp], edx

; 367  : 
; 368  : 		float x1 = x * 1024.0f; 

	movss	xmm0, DWORD PTR _x$75[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _x1$32[ebp], xmm0

; 369  : 		float y1 = y * 1024.0f; 

	movss	xmm0, DWORD PTR _y$73[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _y1$27[ebp], xmm0

; 370  : 		int isdHx = (int) (xc * x1);

	movss	xmm0, DWORD PTR _xc$36[ebp]
	mulss	xmm0, DWORD PTR _x1$32[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdHx$41[ebp], ecx

; 371  : 		int isdHy = (int) (xs * x1);

	movss	xmm0, DWORD PTR _xs$34[ebp]
	mulss	xmm0, DWORD PTR _x1$32[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdHy$39[ebp], edx

; 372  : 		int isdVx = (int) (ys * y1);

	movss	xmm0, DWORD PTR _ys$30[ebp]
	mulss	xmm0, DWORD PTR _y1$27[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdVx$3[ebp], eax

; 373  : 		int isdVy = (int) (yc * y1);

	movss	xmm0, DWORD PTR _yc$29[ebp]
	mulss	xmm0, DWORD PTR _y1$27[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdVy$1[ebp], ecx

; 374  : 		int iyx = 0;

	mov	DWORD PTR _iyx$45[ebp], 0

; 375  : 		int iyy = 0;

	mov	DWORD PTR _iyy$43[ebp], 0

; 376  : 
; 377  : 		int	i;
; 378  : 		for(i=0; i < height; i++)

	mov	DWORD PTR _i$59[ebp], 0
	jmp	SHORT $LN7@RotateBitm
$LN6@RotateBitm:
	mov	edx, DWORD PTR _i$59[ebp]
	add	edx, 1
	mov	DWORD PTR _i$59[ebp], edx
$LN7@RotateBitm:
	mov	eax, DWORD PTR _i$59[ebp]
	cmp	eax, DWORD PTR _height$25[ebp]
	jge	$LN5@RotateBitm

; 379  : 		{
; 380  : 			int start = *startstop++;

	mov	ecx, DWORD PTR _startstop$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR _start$71[ebp], edx
	mov	eax, DWORD PTR _startstop$[ebp]
	add	eax, 4
	mov	DWORD PTR _startstop$[ebp], eax

; 381  : 			int stop = *startstop++;

	mov	ecx, DWORD PTR _startstop$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR _stop$9[ebp], edx
	mov	eax, DWORD PTR _startstop$[ebp]
	add	eax, 4
	mov	DWORD PTR _startstop$[ebp], eax

; 382  : 			int k = ((iyx >> 10) << 2) + (iyy >> 10) * sStride;

	mov	ecx, DWORD PTR _iyx$45[ebp]
	sar	ecx, 10					; 0000000aH
	mov	edx, DWORD PTR _iyy$43[ebp]
	sar	edx, 10					; 0000000aH
	imul	edx, DWORD PTR _sStride$55[ebp]
	lea	eax, DWORD PTR [edx+ecx*4]
	mov	DWORD PTR _k$11[ebp], eax

; 383  : 			char *sptr1 = sptr + k;

	mov	ecx, DWORD PTR _sptr$13[ebp]
	add	ecx, DWORD PTR _k$11[ebp]
	mov	DWORD PTR _sptr1$7[ebp], ecx

; 384  : 			char *dptr1 = dptr + (start << 3);

	mov	edx, DWORD PTR _start$71[ebp]
	mov	eax, DWORD PTR _dptr$47[ebp]
	lea	ecx, DWORD PTR [eax+edx*8]
	mov	DWORD PTR _dptr1$49[ebp], ecx

; 385  : 
; 386  : 			int ixx = (int) (start * isdHx);

	mov	edx, DWORD PTR _start$71[ebp]
	imul	edx, DWORD PTR _isdHx$41[ebp]
	mov	DWORD PTR _ixx$53[ebp], edx

; 387  : 			int ixy = (int) (start * isdHy);

	mov	eax, DWORD PTR _start$71[ebp]
	imul	eax, DWORD PTR _isdHy$39[ebp]
	mov	DWORD PTR _ixy$51[ebp], eax

; 388  : 			int	j;
; 389  : 
; 390  : 			for (j=start; j < stop; j++)

	mov	ecx, DWORD PTR _start$71[ebp]
	mov	DWORD PTR _j$57[ebp], ecx
	jmp	SHORT $LN4@RotateBitm
$LN3@RotateBitm:
	mov	edx, DWORD PTR _j$57[ebp]
	add	edx, 1
	mov	DWORD PTR _j$57[ebp], edx
$LN4@RotateBitm:
	mov	eax, DWORD PTR _j$57[ebp]
	cmp	eax, DWORD PTR _stop$9[ebp]
	jge	$LN2@RotateBitm

; 391  : 			{
; 392  : 				int k = ((ixx >> 10) << 2) + (ixy >> 10) * sStride;

	mov	ecx, DWORD PTR _ixx$53[ebp]
	sar	ecx, 10					; 0000000aH
	mov	edx, DWORD PTR _ixy$51[ebp]
	sar	edx, 10					; 0000000aH
	imul	edx, DWORD PTR _sStride$55[ebp]
	lea	eax, DWORD PTR [edx+ecx*4]
...
; 393  : 				ixx += isdHx;
	...
	mov	ecx, DWORD PTR _ixx$53[ebp]
	add	ecx, DWORD PTR _isdHx$41[ebp]
	mov	DWORD PTR _ixx$53[ebp], ecx

; 394  : 				ixy += isdHy;

	mov	edx, DWORD PTR _ixy$51[ebp]
	add	edx, DWORD PTR _isdHy$39[ebp]
	mov	DWORD PTR _ixy$51[ebp], edx

; 395  : 				DWORD *dptr = (DWORD *) dptr1;

	mov	eax, DWORD PTR _dptr1$49[ebp]
	mov	DWORD PTR _dptr$69[ebp], eax

; 396  : 				DWORD *sptr = (DWORD *) (sptr1+k);

	mov	ecx, DWORD PTR _sptr1$7[ebp]
	add	ecx, DWORD PTR _k$5[ebp]
	mov	DWORD PTR _sptr$67[ebp], ecx

; 397  : 
; 398  : 				// Write the pixels (TODO:  If we got it aligned first, we could write DWORDs at a time)
; 399  : 				*(dptr)				= *sptr;

	mov	edx, DWORD PTR _dptr$69[ebp]
	mov	eax, DWORD PTR _sptr$67[ebp]
	mov	ecx, DWORD PTR [eax]
...
; 401  : 				*(dptr+(dStride/4))	= *sptr;

	mov	eax, DWORD PTR _dStride$65[ebp]
	cdq
	and	edx, 3
	add	eax, edx
	sar	eax, 2
	mov	edx, DWORD PTR _dptr$69[ebp]
	mov	ecx, DWORD PTR _sptr$67[ebp]
	mov	ecx, DWORD PTR [ecx]
	mov	DWORD PTR [edx+eax*4], ecx

; 402  : 				*(dptr+(dStride/4)+1)	= *sptr;
...
; 403  : 
; 404  : 				dptr1 += 8;		// Skip four byte (since we write two pixels each time)

	mov	edx, DWORD PTR _dptr1$49[ebp]
	add	edx, 8
	mov	DWORD PTR _dptr1$49[ebp], edx
...
; 406  : 
; 407  : 			dptr += dStride*2;	// Skip two lines (since we write two each time)

	mov	eax, DWORD PTR _dStride$65[ebp]
	mov	ecx, DWORD PTR _dptr$47[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	DWORD PTR _dptr$47[ebp], edx

; 408  : 			iyx += isdVx;

	mov	eax, DWORD PTR _iyx$45[ebp]
	add	eax, DWORD PTR _isdVx$3[ebp]
	mov	DWORD PTR _iyx$45[ebp], eax

; 409  : 			iyy += isdVy;

	mov	ecx, DWORD PTR _iyy$43[ebp]
	add	ecx, DWORD PTR _isdVy$1[ebp]
	mov	DWORD PTR _iyy$43[ebp], ecx
...
; 411  : 	}
; 412  : 
; 413  : 	else ShiAssert(false);		// unsupported
; 414  : 
; 415  : 	destbuf -> Unlock();
...
; 417  : }
	...
	pop	ebp
	ret	0
?RotateBitmapMaskDouble@@YAXPAVImageBuffer@@0HPAUtagRECT@@1PAH@Z ENDP ; RotateBitmapMaskDouble
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\rotate.cpp
_TEXT	SEGMENT
...
_srect$ = 20						; size = 4
_drect$ = 24						; size = 4
?RotateBitmap@@YAXPAVImageBuffer@@0HPAUtagRECT@@1@Z PROC ; RotateBitmap
...
; 180  : 	ShiAssert( drect );
; 181  : 
; 182  : 	char *source = (char *) srcbuf ->Lock();
...
; 183  : 	ShiAssert( source );
; 184  : 	char *dest = (char *) destbuf ->Lock();
...
; 185  : 	ShiAssert( dest );
; 186  : 
; 187  : 	int dStride = destbuf -> targetStride();

	mov	ecx, DWORD PTR _destbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _dStride$[ebp], eax

; 188  : 	int sStride = srcbuf -> targetStride();

	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _sStride$[ebp], eax

; 189  : 	int destx = drect -> left;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _destx$[ebp], ecx

; 190  : 	int desty = drect -> top;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR _desty$[ebp], eax

; 191  : 	int width = drect -> right - destx;

	mov	ecx, DWORD PTR _drect$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	sub	edx, DWORD PTR _destx$[ebp]
	mov	DWORD PTR _width$[ebp], edx

; 192  : 	int height = drect -> bottom - desty;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	sub	ecx, DWORD PTR _desty$[ebp]
	mov	DWORD PTR _height$[ebp], ecx

; 193  : 	int sx = (srect -> right + srect -> left) >> 1;
...
; 194  : 	int sy = (srect -> bottom + srect -> top) >> 1;
...
; 197  : 
; 198  : 	glGetSinCos (&sine, &cosine, angle);
...
; 204  : 	float yc =  y * cosine;

	movss	xmm0, DWORD PTR _y$[ebp]
	mulss	xmm0, DWORD PTR _cosine$[ebp]
	movss	DWORD PTR _yc$[ebp], xmm0

; 205  : 	x = 1.0f / x; y = 1.0f / y;
...
; 208  : 	sy += (int) (-xs - yc);
	...
	subss	xmm0, DWORD PTR _yc$[ebp]
	cvttss2si edx, xmm0
	add	edx, DWORD PTR _sy$[ebp]
	mov	DWORD PTR _sy$[ebp], edx

; 209  : 
; 210  : 	char *dptr = dest + (destx << 1) + desty * dStride;

	mov	eax, DWORD PTR _destx$[ebp]
	mov	ecx, DWORD PTR _dest$[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	eax, DWORD PTR _desty$[ebp]
	imul	eax, DWORD PTR _dStride$[ebp]
	add	edx, eax
	mov	DWORD PTR _dptr$[ebp], edx

; 211  : 	char *sptr = source + (sx << 1) + sy * sStride;

	mov	ecx, DWORD PTR _sx$[ebp]
	mov	edx, DWORD PTR _source$[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
	mov	ecx, DWORD PTR _sy$[ebp]
	imul	ecx, DWORD PTR _sStride$[ebp]
	add	eax, ecx
	mov	DWORD PTR _sptr$[ebp], eax

; 212  : 
; 213  : 	float x1 = x * 1024.0f; 

	movss	xmm0, DWORD PTR _x$[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _x1$[ebp], xmm0

; 214  : 	float y1 = y * 1024.0f; 

	movss	xmm0, DWORD PTR _y$[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _y1$[ebp], xmm0

; 215  : 	int isdHx = (int) (xc * x1);

	movss	xmm0, DWORD PTR _xc$[ebp]
	mulss	xmm0, DWORD PTR _x1$[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdHx$[ebp], edx

; 216  : 	int isdHy = (int) (xs * x1);

	movss	xmm0, DWORD PTR _xs$[ebp]
	mulss	xmm0, DWORD PTR _x1$[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdHy$[ebp], eax

; 217  : 	int isdVx = (int) (ys * y1);

	movss	xmm0, DWORD PTR _ys$[ebp]
	mulss	xmm0, DWORD PTR _y1$[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdVx$[ebp], ecx

; 218  : 	int isdVy = (int) (yc * y1);

	movss	xmm0, DWORD PTR _yc$[ebp]
	mulss	xmm0, DWORD PTR _y1$[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdVy$[ebp], edx
...
; 224  : 	{
; 225  : 		int k = ((iyx >> 10) << 1) + (iyy >> 10) * sStride;

	mov	edx, DWORD PTR _iyx$[ebp]
	sar	edx, 10					; 0000000aH
	mov	eax, DWORD PTR _iyy$[ebp]
	sar	eax, 10					; 0000000aH
	imul	eax, DWORD PTR _sStride$[ebp]
	lea	ecx, DWORD PTR [eax+edx*2]
	mov	DWORD PTR _k$3[ebp], ecx

; 226  : 		char *sptr1 = sptr + k;

	mov	edx, DWORD PTR _sptr$[ebp]
	add	edx, DWORD PTR _k$3[ebp]
	mov	DWORD PTR _sptr1$5[ebp], edx

; 227  : 		char *dptr1 = dptr;

	mov	eax, DWORD PTR _dptr$[ebp]
	mov	DWORD PTR _dptr1$7[ebp], eax

; 228  : 		int ixx = 0;

	mov	DWORD PTR _ixx$9[ebp], 0

; 229  : 		int ixy = 0;

	mov	DWORD PTR _ixy$8[ebp], 0
...
$LN3@RotateBitm:
	...
	jge	SHORT $LN1@RotateBitm

; 233  : 		{
; 234  : 			int k = ((ixx >> 10) << 1) + (ixy >> 10) * sStride;

	mov	eax, DWORD PTR _ixx$9[ebp]
	sar	eax, 10					; 0000000aH
	mov	ecx, DWORD PTR _ixy$8[ebp]
	sar	ecx, 10					; 0000000aH
	imul	ecx, DWORD PTR _sStride$[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
...
; 235  : 			ixx += isdHx;
	...
	mov	eax, DWORD PTR _ixx$9[ebp]
	add	eax, DWORD PTR _isdHx$[ebp]
	mov	DWORD PTR _ixx$9[ebp], eax

; 236  : 			ixy += isdHy;

	mov	ecx, DWORD PTR _ixy$8[ebp]
	add	ecx, DWORD PTR _isdHy$[ebp]
	mov	DWORD PTR _ixy$8[ebp], ecx

; 237  : 			short *dptr = (short *) dptr1;

	mov	edx, DWORD PTR _dptr1$7[ebp]
	mov	DWORD PTR _dptr$2[ebp], edx

; 238  : 			short *sptr = (short *) (sptr1+k);

	mov	eax, DWORD PTR _sptr1$5[ebp]
...
; 240  : 			dptr1 += 2;
	...
	mov	ecx, DWORD PTR _dptr1$7[ebp]
	add	ecx, 2
	mov	DWORD PTR _dptr1$7[ebp], ecx

; 241  : 		}

	jmp	SHORT $LN2@RotateBitm
$LN1@RotateBitm:
...
; 243  : 		dptr += dStride;
	...
	mov	edx, DWORD PTR _dptr$[ebp]
	add	edx, DWORD PTR _dStride$[ebp]
	mov	DWORD PTR _dptr$[ebp], edx

; 244  : 		iyx += isdVx;

	mov	eax, DWORD PTR _iyx$[ebp]
	add	eax, DWORD PTR _isdVx$[ebp]
	mov	DWORD PTR _iyx$[ebp], eax

; 245  : 		iyy += isdVy;

	mov	ecx, DWORD PTR _iyy$[ebp]
	add	ecx, DWORD PTR _isdVy$[ebp]
	mov	DWORD PTR _iyy$[ebp], ecx
...
; 250  : }
	...
	pop	ebp
	ret	0
?RotateBitmap@@YAXPAVImageBuffer@@0HPAUtagRECT@@1@Z ENDP ; RotateBitmap
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\ddstuff\rotate.cpp
_TEXT	SEGMENT
...
_width$20 = -236					; size = 4
_sine$21 = -232						; size = 4
_height$22 = -228					; size = 4
_x1$23 = -224						; size = 4
_sine$24 = -220						; size = 4
_xc$25 = -216						; size = 4
_destx$26 = -212					; size = 4
_destx$27 = -208					; size = 4
_isdHy$28 = -204					; size = 4
_y1$29 = -200						; size = 4
_desty$30 = -196					; size = 4
_yc$31 = -192						; size = 4
_cosine$32 = -188					; size = 4
_ys$33 = -184						; size = 4
_dStride$34 = -180					; size = 4
_x1$35 = -176						; size = 4
_isdHx$36 = -172					; size = 4
_xs$37 = -168						; size = 4
_y1$38 = -164						; size = 4
_xc$39 = -160						; size = 4
_ys$40 = -156						; size = 4
_dStride$41 = -152					; size = 4
_xs$42 = -148						; size = 4
_isdHy$43 = -144					; size = 4
_desty$44 = -140					; size = 4
_isdHx$45 = -136					; size = 4
_cosine$46 = -132					; size = 4
_height$47 = -128					; size = 4
_yc$48 = -124						; size = 4
_iyy$49 = -120						; size = 4
_ixy$50 = -116						; size = 4
_iyx$51 = -112						; size = 4
...
_sx$56 = -92						; size = 4
_ixy$57 = -88						; size = 4
_sStride$58 = -84					; size = 4
_ixx$59 = -80						; size = 4
_dest$ = -76						; size = 4
_sStride$60 = -72					; size = 4
_iyx$61 = -68						; size = 4
_j$62 = -64						; size = 4
_dptr1$63 = -60						; size = 4
_i$64 = -56						; size = 4
...
_drect$ = 24						; size = 4
_startstop$ = 28					; size = 4
?RotateBitmapMask@@YAXPAVImageBuffer@@0HPAUtagRECT@@1PAH@Z PROC ; RotateBitmapMask
...
; 15   : 	if (!startstop)
	...
	cmp	DWORD PTR _startstop$[ebp], 0
	jne	SHORT $LN20@RotateBitm

; 16   : 	{
; 17   : 		RotateBitmap (srcbuf, destbuf, angle, srect, drect);
...
; 19   : 	}
; 20   : 
; 21   : 	char *source = (char *) srcbuf ->Lock();
...
; 22   : 	ShiAssert( source );
; 23   : 
; 24   : 	if (!source) // JB 011125 CTD fix when ALT Tab

	cmp	DWORD PTR _source$[ebp], 0
	jne	SHORT $LN19@RotateBitm
...
; 26   : 
; 27   : 	char *dest = (char *) destbuf ->Lock();
...
; 28   : 	ShiAssert( dest );
; 29   : 
; 30   : 	if (!dest) // JB 011125 CTD fix when ALT Tab

	cmp	DWORD PTR _dest$[ebp], 0
	jne	SHORT $LN18@RotateBitm
...
; 37   : 	{
; 38   : 		int dStride = destbuf -> targetStride();

	mov	ecx, DWORD PTR _destbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _dStride$34[ebp], eax

; 39   : 		int sStride = srcbuf -> targetStride();

	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _sStride$58[ebp], eax

; 40   : 		int destx = drect -> left;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR _destx$27[ebp], eax

; 41   : 		int desty = drect -> top;

	mov	ecx, DWORD PTR _drect$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _desty$44[ebp], edx

; 42   : 		int width = drect -> right - destx;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	sub	ecx, DWORD PTR _destx$27[ebp]
	mov	DWORD PTR _width$20[ebp], ecx

; 43   : 		int height = drect -> bottom - desty;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx+12]
	sub	eax, DWORD PTR _desty$44[ebp]
	mov	DWORD PTR _height$22[ebp], eax

; 44   : 		int sx = (srect -> right + srect -> left) >> 1;
	...
	add	edx, DWORD PTR [eax]
	sar	edx, 1
	mov	DWORD PTR _sx$56[ebp], edx

; 45   : 		int sy = (srect -> bottom + srect -> top) >> 1;
	...
	add	edx, DWORD PTR [eax+4]
	sar	edx, 1
	mov	DWORD PTR _sy$68[ebp], edx

; 46   : 
; 47   : 		float sine, cosine;
; 48   : 		glGetSinCos (&sine, &cosine, angle);

	mov	ecx, DWORD PTR _angle$[ebp]
	push	ecx
	lea	edx, DWORD PTR _cosine$46[ebp]
	push	edx
	lea	eax, DWORD PTR _sine$21[ebp]
	push	eax
	call	?glGetSinCos@@YAXPAM0H@Z		; glGetSinCos
	add	esp, 12					; 0000000cH

; 49   : 		float x = (float) (width >> 1);

	mov	ecx, DWORD PTR _width$20[ebp]
	sar	ecx, 1
	cvtsi2ss xmm0, ecx
	movss	DWORD PTR _x$73[ebp], xmm0

; 50   : 		float y = (float) (height >> 1);

	mov	edx, DWORD PTR _height$22[ebp]
	sar	edx, 1
	cvtsi2ss xmm0, edx
	movss	DWORD PTR _y$74[ebp], xmm0

; 51   : 		float xc =  x * cosine; 

	movss	xmm0, DWORD PTR _x$73[ebp]
	mulss	xmm0, DWORD PTR _cosine$46[ebp]
	movss	DWORD PTR _xc$25[ebp], xmm0
...
; 52   : 		float xs = -x * sine;
	...
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	mulss	xmm0, DWORD PTR _sine$21[ebp]
	movss	DWORD PTR _xs$42[ebp], xmm0

; 53   : 		float ys =  y * sine;   

	movss	xmm0, DWORD PTR _y$74[ebp]
	mulss	xmm0, DWORD PTR _sine$21[ebp]
	movss	DWORD PTR _ys$40[ebp], xmm0

; 54   : 		float yc =  y * cosine;

	movss	xmm0, DWORD PTR _y$74[ebp]
	mulss	xmm0, DWORD PTR _cosine$46[ebp]
	movss	DWORD PTR _yc$48[ebp], xmm0

; 55   : 		x = 1.0f / x; y = 1.0f / y;

	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _x$73[ebp]
	movss	DWORD PTR _x$73[ebp], xmm0
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _y$74[ebp]
	movss	DWORD PTR _y$74[ebp], xmm0

; 56   : 
; 57   : 		sx += (int) (-xc - ys);

	movss	xmm0, DWORD PTR _xc$25[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _ys$40[ebp]
	cvttss2si eax, xmm0
	add	eax, DWORD PTR _sx$56[ebp]
	mov	DWORD PTR _sx$56[ebp], eax

; 58   : 		sy += (int) (-xs - yc);

	movss	xmm0, DWORD PTR _xs$42[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _yc$48[ebp]
	cvttss2si ecx, xmm0
	add	ecx, DWORD PTR _sy$68[ebp]
	mov	DWORD PTR _sy$68[ebp], ecx

; 59   : 
; 60   : 		char *dptr = dest + (destx << 1) + desty * dStride;

	mov	edx, DWORD PTR _destx$27[ebp]
	mov	eax, DWORD PTR _dest$[ebp]
	lea	ecx, DWORD PTR [eax+edx*2]
	mov	edx, DWORD PTR _desty$44[ebp]
	imul	edx, DWORD PTR _dStride$34[ebp]
	add	ecx, edx
	mov	DWORD PTR _dptr$70[ebp], ecx

; 61   : 		char *sptr = source + (sx << 1) + sy * sStride;

	mov	eax, DWORD PTR _sx$56[ebp]
	mov	ecx, DWORD PTR _source$[ebp]
	lea	edx, DWORD PTR [ecx+eax*2]
	mov	eax, DWORD PTR _sy$68[ebp]
	imul	eax, DWORD PTR _sStride$58[ebp]
	add	edx, eax
	mov	DWORD PTR _sptr$18[ebp], edx

; 62   : 
; 63   : 		float x1 = x * 1024.0f; 

	movss	xmm0, DWORD PTR _x$73[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _x1$23[ebp], xmm0

; 64   : 		float y1 = y * 1024.0f; 

	movss	xmm0, DWORD PTR _y$74[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _y1$38[ebp], xmm0

; 65   : 		int isdHx = (int) (xc * x1);

	movss	xmm0, DWORD PTR _xc$25[ebp]
	mulss	xmm0, DWORD PTR _x1$23[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdHx$36[ebp], ecx

; 66   : 		int isdHy = (int) (xs * x1);

	movss	xmm0, DWORD PTR _xs$42[ebp]
	mulss	xmm0, DWORD PTR _x1$23[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdHy$28[ebp], edx

; 67   : 		int isdVx = (int) (ys * y1);

	movss	xmm0, DWORD PTR _ys$40[ebp]
	mulss	xmm0, DWORD PTR _y1$38[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdVx$6[ebp], eax

; 68   : 		int isdVy = (int) (yc * y1);

	movss	xmm0, DWORD PTR _yc$48[ebp]
	mulss	xmm0, DWORD PTR _y1$38[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdVy$10[ebp], ecx

; 69   : 		int iyx = 0;

	mov	DWORD PTR _iyx$61[ebp], 0

; 70   : 		int iyy = 0;

	mov	DWORD PTR _iyy$52[ebp], 0
...
; 73   : 		for(i=0; i < height; i++)
	...
	jmp	SHORT $LN16@RotateBitm
$LN15@RotateBitm:
	mov	edx, DWORD PTR _i$54[ebp]
	add	edx, 1
	mov	DWORD PTR _i$54[ebp], edx
$LN16@RotateBitm:
	mov	eax, DWORD PTR _i$54[ebp]
	cmp	eax, DWORD PTR _height$22[ebp]
	jge	$LN14@RotateBitm

; 74   : 		{
; 75   : 			int start = *startstop++;

	mov	ecx, DWORD PTR _startstop$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR _start$72[ebp], edx
	mov	eax, DWORD PTR _startstop$[ebp]
	add	eax, 4
	mov	DWORD PTR _startstop$[ebp], eax

; 76   : 			int stop = *startstop++;

	mov	ecx, DWORD PTR _startstop$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR _stop$16[ebp], edx
	mov	eax, DWORD PTR _startstop$[ebp]
	add	eax, 4
	mov	DWORD PTR _startstop$[ebp], eax

; 77   : 			int k = ((iyx >> 10) << 1) + (iyy >> 10) * sStride;

	mov	ecx, DWORD PTR _iyx$61[ebp]
	sar	ecx, 10					; 0000000aH
	mov	edx, DWORD PTR _iyy$52[ebp]
	sar	edx, 10					; 0000000aH
	imul	edx, DWORD PTR _sStride$58[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
	mov	DWORD PTR _k$2[ebp], eax

; 78   : 			char *sptr1 = sptr + k;

	mov	ecx, DWORD PTR _sptr$18[ebp]
	add	ecx, DWORD PTR _k$2[ebp]
	mov	DWORD PTR _sptr1$8[ebp], ecx

; 79   : 			char *dptr1 = dptr + (start << 1);

	mov	edx, DWORD PTR _start$72[ebp]
	mov	eax, DWORD PTR _dptr$70[ebp]
	lea	ecx, DWORD PTR [eax+edx*2]
	mov	DWORD PTR _dptr1$63[ebp], ecx

; 80   : 
; 81   : 			int ixx = (int) (start * isdHx);

	mov	edx, DWORD PTR _start$72[ebp]
	imul	edx, DWORD PTR _isdHx$36[ebp]
	mov	DWORD PTR _ixx$65[ebp], edx

; 82   : 			int ixy = (int) (start * isdHy);

	mov	eax, DWORD PTR _start$72[ebp]
	imul	eax, DWORD PTR _isdHy$28[ebp]
	mov	DWORD PTR _ixy$50[ebp], eax

; 83   : 			int	j;
; 84   : 
; 85   : 			for(j=start; j < stop; j++)

	mov	ecx, DWORD PTR _start$72[ebp]
	mov	DWORD PTR _j$67[ebp], ecx
	jmp	SHORT $LN13@RotateBitm
$LN12@RotateBitm:
...
$LN13@RotateBitm:
	...
	cmp	eax, DWORD PTR _stop$16[ebp]
	jge	SHORT $LN11@RotateBitm

; 86   : 			{
; 87   : 				int k = ((ixx >> 10) << 1) + (ixy >> 10) * sStride;

	mov	ecx, DWORD PTR _ixx$65[ebp]
	sar	ecx, 10					; 0000000aH
	mov	edx, DWORD PTR _ixy$50[ebp]
	sar	edx, 10					; 0000000aH
	imul	edx, DWORD PTR _sStride$58[ebp]
	lea	eax, DWORD PTR [edx+ecx*2]
	mov	DWORD PTR _k$14[ebp], eax

; 88   : 				ixx += isdHx;

	mov	ecx, DWORD PTR _ixx$65[ebp]
	add	ecx, DWORD PTR _isdHx$36[ebp]
	mov	DWORD PTR _ixx$65[ebp], ecx

; 89   : 				ixy += isdHy;

	mov	edx, DWORD PTR _ixy$50[ebp]
	add	edx, DWORD PTR _isdHy$28[ebp]
	mov	DWORD PTR _ixy$50[ebp], edx

; 90   : 				short *dptr = (short *) dptr1;

	mov	eax, DWORD PTR _dptr1$63[ebp]
	mov	DWORD PTR _dptr$4[ebp], eax

; 91   : 				short *sptr = (short *) (sptr1+k);

	mov	ecx, DWORD PTR _sptr1$8[ebp]
	add	ecx, DWORD PTR _k$14[ebp]
	mov	DWORD PTR _sptr$12[ebp], ecx

; 92   : 				*dptr = *sptr;

	mov	edx, DWORD PTR _dptr$4[ebp]
	mov	eax, DWORD PTR _sptr$12[ebp]
	mov	cx, WORD PTR [eax]
	mov	WORD PTR [edx], cx

; 93   : 				dptr1 += 2;

	mov	edx, DWORD PTR _dptr1$63[ebp]
	add	edx, 2
	mov	DWORD PTR _dptr1$63[ebp], edx
...
; 96   : 			dptr += dStride;
	...
	mov	eax, DWORD PTR _dptr$70[ebp]
	add	eax, DWORD PTR _dStride$34[ebp]
	mov	DWORD PTR _dptr$70[ebp], eax

; 97   : 			iyx += isdVx;

	mov	ecx, DWORD PTR _iyx$61[ebp]
	add	ecx, DWORD PTR _isdVx$6[ebp]
	mov	DWORD PTR _iyx$61[ebp], ecx

; 98   : 			iyy += isdVy;

	mov	edx, DWORD PTR _iyy$52[ebp]
	add	edx, DWORD PTR _isdVy$10[ebp]
	mov	DWORD PTR _iyy$52[ebp], edx
...
; 100  : 	}
; 101  : 
; 102  : 	else if(destbuf->PixelSize() == 4)
...
; 103  : 	{
; 104  : 		int dStride = destbuf -> targetStride();

	mov	ecx, DWORD PTR _destbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _dStride$41[ebp], eax

; 105  : 		int sStride = srcbuf -> targetStride();

	mov	ecx, DWORD PTR _srcbuf$[ebp]
	call	?targetStride@ImageBuffer@@QAEHXZ	; ImageBuffer::targetStride
	mov	DWORD PTR _sStride$60[ebp], eax

; 106  : 		int destx = drect -> left;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _destx$26[ebp], ecx

; 107  : 		int desty = drect -> top;

	mov	edx, DWORD PTR _drect$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR _desty$30[ebp], eax

; 108  : 		int width = drect -> right - destx;

	mov	ecx, DWORD PTR _drect$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	sub	edx, DWORD PTR _destx$26[ebp]
	mov	DWORD PTR _width$19[ebp], edx

; 109  : 		int height = drect -> bottom - desty;

	mov	eax, DWORD PTR _drect$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	sub	ecx, DWORD PTR _desty$30[ebp]
	mov	DWORD PTR _height$47[ebp], ecx

; 110  : 		int sx = (srect -> right + srect -> left) >> 1;
	...
	add	eax, DWORD PTR [ecx]
	sar	eax, 1
	mov	DWORD PTR _sx$69[ebp], eax

; 111  : 		int sy = (srect -> bottom + srect -> top) >> 1;
	...
	add	eax, DWORD PTR [ecx+4]
	sar	eax, 1
	mov	DWORD PTR _sy$66[ebp], eax

; 112  : 
; 113  : 		float sine, cosine;
; 114  : 		glGetSinCos (&sine, &cosine, angle);

	mov	edx, DWORD PTR _angle$[ebp]
	push	edx
	lea	eax, DWORD PTR _cosine$32[ebp]
	push	eax
	lea	ecx, DWORD PTR _sine$24[ebp]
	push	ecx
	call	?glGetSinCos@@YAXPAM0H@Z		; glGetSinCos
	add	esp, 12					; 0000000cH

; 115  : 		float x = (float) (width >> 1);

	mov	edx, DWORD PTR _width$19[ebp]
	sar	edx, 1
	cvtsi2ss xmm0, edx
	movss	DWORD PTR _x$76[ebp], xmm0

; 116  : 		float y = (float) (height >> 1);

	mov	eax, DWORD PTR _height$47[ebp]
	sar	eax, 1
	cvtsi2ss xmm0, eax
	movss	DWORD PTR _y$75[ebp], xmm0

; 117  : 		float xc =  x * cosine; 

	movss	xmm0, DWORD PTR _x$76[ebp]
	mulss	xmm0, DWORD PTR _cosine$32[ebp]
	movss	DWORD PTR _xc$39[ebp], xmm0

; 118  : 		float xs = -x * sine;

	movss	xmm0, DWORD PTR _x$76[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	mulss	xmm0, DWORD PTR _sine$24[ebp]
	movss	DWORD PTR _xs$37[ebp], xmm0

; 119  : 		float ys =  y * sine;   

	movss	xmm0, DWORD PTR _y$75[ebp]
	mulss	xmm0, DWORD PTR _sine$24[ebp]
	movss	DWORD PTR _ys$33[ebp], xmm0

; 120  : 		float yc =  y * cosine;

	movss	xmm0, DWORD PTR _y$75[ebp]
	mulss	xmm0, DWORD PTR _cosine$32[ebp]
	movss	DWORD PTR _yc$31[ebp], xmm0

; 121  : 		x = 1.0f / x; y = 1.0f / y;

	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _x$76[ebp]
	movss	DWORD PTR _x$76[ebp], xmm0
	movss	xmm0, DWORD PTR __real@3f800000
	divss	xmm0, DWORD PTR _y$75[ebp]
	movss	DWORD PTR _y$75[ebp], xmm0

; 122  : 
; 123  : 		sx += (int) (-xc - ys);

	movss	xmm0, DWORD PTR _xc$39[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _ys$33[ebp]
	cvttss2si ecx, xmm0
	add	ecx, DWORD PTR _sx$69[ebp]
	mov	DWORD PTR _sx$69[ebp], ecx

; 124  : 		sy += (int) (-xs - yc);

	movss	xmm0, DWORD PTR _xs$37[ebp]
	xorps	xmm0, DWORD PTR __xmm@80000000800000008000000080000000
	subss	xmm0, DWORD PTR _yc$31[ebp]
	cvttss2si edx, xmm0
	add	edx, DWORD PTR _sy$66[ebp]
	mov	DWORD PTR _sy$66[ebp], edx

; 125  : 
; 126  : 		char *dptr = dest + (destx << 2) + desty * dStride;

	mov	eax, DWORD PTR _destx$26[ebp]
	mov	ecx, DWORD PTR _dest$[ebp]
	lea	edx, DWORD PTR [ecx+eax*4]
	mov	eax, DWORD PTR _desty$30[ebp]
	imul	eax, DWORD PTR _dStride$41[ebp]
	add	edx, eax
	mov	DWORD PTR _dptr$53[ebp], edx

; 127  : 		char *sptr = source + (sx << 2) + sy * sStride;

	mov	ecx, DWORD PTR _sx$69[ebp]
	mov	edx, DWORD PTR _source$[ebp]
	lea	eax, DWORD PTR [edx+ecx*4]
	mov	ecx, DWORD PTR _sy$66[ebp]
	imul	ecx, DWORD PTR _sStride$60[ebp]
	add	eax, ecx
	mov	DWORD PTR _sptr$17[ebp], eax

; 128  : 
; 129  : 		float x1 = x * 1024.0f; 

	movss	xmm0, DWORD PTR _x$76[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _x1$35[ebp], xmm0

; 130  : 		float y1 = y * 1024.0f; 

	movss	xmm0, DWORD PTR _y$75[ebp]
	mulss	xmm0, DWORD PTR __real@44800000
	movss	DWORD PTR _y1$29[ebp], xmm0

; 131  : 		int isdHx = (int) (xc * x1);

	movss	xmm0, DWORD PTR _xc$39[ebp]
	mulss	xmm0, DWORD PTR _x1$35[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdHx$45[ebp], edx

; 132  : 		int isdHy = (int) (xs * x1);

	movss	xmm0, DWORD PTR _xs$37[ebp]
	mulss	xmm0, DWORD PTR _x1$35[ebp]
	cvttss2si eax, xmm0
	mov	DWORD PTR _isdHy$43[ebp], eax

; 133  : 		int isdVx = (int) (ys * y1);

	movss	xmm0, DWORD PTR _ys$33[ebp]
	mulss	xmm0, DWORD PTR _y1$29[ebp]
	cvttss2si ecx, xmm0
	mov	DWORD PTR _isdVx$3[ebp], ecx

; 134  : 		int isdVy = (int) (yc * y1);

	movss	xmm0, DWORD PTR _yc$31[ebp]
	mulss	xmm0, DWORD PTR _y1$29[ebp]
	cvttss2si edx, xmm0
	mov	DWORD PTR _isdVy$1[ebp], edx

; 135  : 		int iyx = 0;

	mov	DWORD PTR _iyx$51[ebp], 0

; 136  : 		int iyy = 0;

	mov	DWORD PTR _iyy$49[ebp], 0
...
$LN8@RotateBitm:
	...
	cmp	ecx, DWORD PTR _height$47[ebp]
	jge	$LN6@RotateBitm

; 140  : 		{
; 141  : 			int start = *startstop++;

	mov	edx, DWORD PTR _startstop$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR _start$71[ebp], eax
	mov	ecx, DWORD PTR _startstop$[ebp]
	add	ecx, 4
	mov	DWORD PTR _startstop$[ebp], ecx

; 142  : 			int stop = *startstop++;

	mov	edx, DWORD PTR _startstop$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR _stop$13[ebp], eax
	mov	ecx, DWORD PTR _startstop$[ebp]
	add	ecx, 4
	mov	DWORD PTR _startstop$[ebp], ecx

; 143  : 			int k = ((iyx >> 10) << 2) + (iyy >> 10) * sStride;

	mov	edx, DWORD PTR _iyx$51[ebp]
	sar	edx, 10					; 0000000aH
	mov	eax, DWORD PTR _iyy$49[ebp]
	sar	eax, 10					; 0000000aH
	imul	eax, DWORD PTR _sStride$60[ebp]
	lea	ecx, DWORD PTR [eax+edx*4]
	mov	DWORD PTR _k$15[ebp], ecx

; 144  : 			char *sptr1 = sptr + k;

	mov	edx, DWORD PTR _sptr$17[ebp]
	add	edx, DWORD PTR _k$15[ebp]
	mov	DWORD PTR _sptr1$11[ebp], edx

; 145  : 			char *dptr1 = dptr + (start << 2);

	mov	eax, DWORD PTR _start$71[ebp]
	mov	ecx, DWORD PTR _dptr$53[ebp]
	lea	edx, DWORD PTR [ecx+eax*4]
	mov	DWORD PTR _dptr1$55[ebp], edx

; 146  : 
; 147  : 			int ixx = (int) (start * isdHx);

	mov	eax, DWORD PTR _start$71[ebp]
	imul	eax, DWORD PTR _isdHx$45[ebp]
	mov	DWORD PTR _ixx$59[ebp], eax

; 148  : 			int ixy = (int) (start * isdHy);

	mov	ecx, DWORD PTR _start$71[ebp]
	imul	ecx, DWORD PTR _isdHy$43[ebp]
	mov	DWORD PTR _ixy$57[ebp], ecx

; 149  : 			int	j;
; 150  : 
; 151  : 			for(j=start; j < stop; j++)

	mov	edx, DWORD PTR _start$71[ebp]
	mov	DWORD PTR _j$62[ebp], edx
	jmp	SHORT $LN5@RotateBitm
$LN4@RotateBitm:
	mov	eax, DWORD PTR _j$62[ebp]
	add	eax, 1
	mov	DWORD PTR _j$62[ebp], eax
$LN5@RotateBitm:
	mov	ecx, DWORD PTR _j$62[ebp]
	cmp	ecx, DWORD PTR _stop$13[ebp]
	jge	SHORT $LN3@RotateBitm

; 152  : 			{
; 153  : 				int k = ((ixx >> 10) << 2) + (ixy >> 10) * sStride;

	mov	edx, DWORD PTR _ixx$59[ebp]
	sar	edx, 10					; 0000000aH
	mov	eax, DWORD PTR _ixy$57[ebp]
	sar	eax, 10					; 0000000aH
	imul	eax, DWORD PTR _sStride$60[ebp]
	lea	ecx, DWORD PTR [eax+edx*4]
...
; 154  : 				ixx += isdHx;
	...
	mov	edx, DWORD PTR _ixx$59[ebp]
	add	edx, DWORD PTR _isdHx$45[ebp]
	mov	DWORD PTR _ixx$59[ebp], edx

; 155  : 				ixy += isdHy;

	mov	eax, DWORD PTR _ixy$57[ebp]
	add	eax, DWORD PTR _isdHy$43[ebp]
	mov	DWORD PTR _ixy$57[ebp], eax

; 156  : 				DWORD *dptr = (DWORD *) dptr1;

	mov	ecx, DWORD PTR _dptr1$55[ebp]
	mov	DWORD PTR _dptr$7[ebp], ecx

; 157  : 				DWORD *sptr = (DWORD *) (sptr1+k);

	mov	edx, DWORD PTR _sptr1$11[ebp]
	add	edx, DWORD PTR _k$9[ebp]
	mov	DWORD PTR _sptr$5[ebp], edx

; 158  : 				*dptr = *sptr;

	mov	eax, DWORD PTR _dptr$7[ebp]
	mov	ecx, DWORD PTR _sptr$5[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR [eax], edx

; 159  : 				dptr1 += 4;

	mov	eax, DWORD PTR _dptr1$55[ebp]
	add	eax, 4
	mov	DWORD PTR _dptr1$55[ebp], eax
...
; 162  : 			dptr += dStride;
	...
	mov	ecx, DWORD PTR _dptr$53[ebp]
	add	ecx, DWORD PTR _dStride$41[ebp]
	mov	DWORD PTR _dptr$53[ebp], ecx

; 163  : 			iyx += isdVx;

	mov	edx, DWORD PTR _iyx$51[ebp]
	add	edx, DWORD PTR _isdVx$3[ebp]
	mov	DWORD PTR _iyx$51[ebp], edx

; 164  : 			iyy += isdVy;

	mov	eax, DWORD PTR _iyy$49[ebp]
	add	eax, DWORD PTR _isdVy$1[ebp]
	mov	DWORD PTR _iyy$49[ebp], eax
...
; 166  : 	}
; 167  : 
; 168  : 	else ShiAssert(false);		// unsupported
; 169  : 
; 170  : 	destbuf -> Unlock();
...
; 171  : 	
; 172  : 	ShiAssert(srcbuf != NULL);
; 173  : 	if (srcbuf) // JB 010318 CTD

	cmp	DWORD PTR _srcbuf$[ebp], 0
	je	SHORT $LN1@RotateBitm
...
; 175  : }
	...
	pop	ebp
	ret	0
?RotateBitmapMask@@YAXPAVImageBuffer@@0HPAUtagRECT@@1PAH@Z ENDP ; RotateBitmapMask
_TEXT	ENDS
; Function compile flags: /Odtp
