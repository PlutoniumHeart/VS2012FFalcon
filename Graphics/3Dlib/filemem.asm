; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\3Dlib\filemem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0CFileMemory@@QAE@XZ				; CFileMemory::CFileMemory
PUBLIC	??1CFileMemory@@UAE@XZ				; CFileMemory::~CFileMemory
PUBLIC	?glOpenFileMem@CFileMemory@@QAEHPBD@Z		; CFileMemory::glOpenFileMem
PUBLIC	?glReadFileMem@CFileMemory@@QAEXXZ		; CFileMemory::glReadFileMem
PUBLIC	?glCloseFileMem@CFileMemory@@QAEXXZ		; CFileMemory::glCloseFileMem
PUBLIC	?glReadCharMem@CFileMemory@@QAEIXZ		; CFileMemory::glReadCharMem
PUBLIC	?glReadMem@CFileMemory@@QAEHPAXH@Z		; CFileMemory::glReadMem
PUBLIC	?glSetFilePosMem@CFileMemory@@QAEHHH@Z		; CFileMemory::glSetFilePosMem
PUBLIC	??_GCFileMemory@@UAEPAXI@Z			; CFileMemory::`scalar deleting destructor'
PUBLIC	??0CImageFileMemory@@QAE@XZ			; CImageFileMemory::CImageFileMemory
...
EXTRN	?openread@CFileIO@@QAEHPBD@Z:PROC		; CFileIO::openread
EXTRN	?closefile@CFileIO@@QAEXXZ:PROC			; CFileIO::closefile
EXTRN	?getfilesize@CFileIO@@QAEHXZ:PROC		; CFileIO::getfilesize
EXTRN	?readdata@CFileIO@@QAEHPAXH@Z:PROC		; CFileIO::readdata
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\3dlib\filemem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0CImageFileMemory@@QAE@XZ PROC			; CImageFileMemory::CImageFileMemory
; _this$ = ecx
...
; 7    : {
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0CFileMemory@@QAE@XZ			; CFileMemory::CFileMemory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7CImageFileMemory@@6B@
...
; 10   : }
	...
	pop	ebp
	ret	0
??0CImageFileMemory@@QAE@XZ ENDP			; CImageFileMemory::CImageFileMemory
_TEXT	ENDS
; Function compile flags: /Odtp
...
_offset$ = 8						; size = 4
_mode$ = 12						; size = 4
?glSetFilePosMem@CFileMemory@@QAEHHH@Z PROC		; CFileMemory::glSetFilePosMem
; _this$ = ecx
...
; 80   : 	switch (mode) {
	...
	je	SHORT $LN5@glSetFileP
	cmp	DWORD PTR tv64[ebp], 1
	je	SHORT $LN4@glSetFileP
	cmp	DWORD PTR tv64[ebp], 2
	je	SHORT $LN3@glSetFileP
	jmp	SHORT $LN6@glSetFileP
$LN5@glSetFileP:

; 81   : 		case 0:	
; 82   : 			CurrentMemoryPointer = buffer + offset;
...
; 84   : 		case 1:
; 85   : 			CurrentMemoryPointer = CurrentMemoryPointer + offset;
...
; 87   : 		case 2:
; 88   : 			CurrentMemoryPointer = bufferEnd + offset;
...
; 90   : 	}
; 91   : 
; 92   : 	if (CurrentMemoryPointer < buffer) return -1;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [ecx+12]
	cmp	eax, DWORD PTR [edx+4]
	jae	SHORT $LN2@glSetFileP
	or	eax, -1
	jmp	SHORT $LN8@glSetFileP
$LN2@glSetFileP:

; 93   : 	if (CurrentMemoryPointer >= bufferEnd) return 1;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [ecx+12]
	cmp	eax, DWORD PTR [edx+8]
	jb	SHORT $LN1@glSetFileP
	mov	eax, 1
	jmp	SHORT $LN8@glSetFileP
$LN1@glSetFileP:
...
; 95   : }	/* glSetFilePosMem */
	...
	pop	ebp
	ret	8
?glSetFilePosMem@CFileMemory@@QAEHHH@Z ENDP		; CFileMemory::glSetFilePosMem
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\3dlib\filemem.cpp
_TEXT	SEGMENT
...
_target$ = 8						; size = 4
_total$ = 12						; size = 4
?glReadMem@CFileMemory@@QAEHPAXH@Z PROC			; CFileMemory::glReadMem
; _this$ = ecx
...
; 65   : 	ShiAssert( buffer );
; 66   : 
; 67   : 	if (total >= bytesLeft) total = bytesLeft;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _total$[ebp]
	cmp	ecx, DWORD PTR [eax+16]
	jl	SHORT $LN1@glReadMem
	mov	edx, DWORD PTR _this$[ebp]
...
; 68   : 
; 69   : 	memcpy (target, CurrentMemoryPointer, total);
...
; 74   : }	/* glReadMem */
	...
	pop	ebp
	ret	8
?glReadMem@CFileMemory@@QAEHPAXH@Z ENDP			; CFileMemory::glReadMem
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\3dlib\filemem.cpp
_TEXT	SEGMENT
tv74 = -8						; size = 4
_this$ = -4						; size = 4
?glReadCharMem@CFileMemory@@QAEIXZ PROC			; CFileMemory::glReadCharMem
; _this$ = ecx
...
; 60   : 	return *CurrentMemoryPointer++;
...
; 61   : }	/* glReadCharMem */
	...
	pop	ebp
	ret	0
?glReadCharMem@CFileMemory@@QAEIXZ ENDP			; CFileMemory::glReadCharMem
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\3dlib\filemem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?glCloseFileMem@CFileMemory@@QAEXXZ PROC		; CFileMemory::glCloseFileMem
; _this$ = ecx
...
; 48   : 	CurrentFile.closefile();

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 20					; 00000014H
	call	?closefile@CFileIO@@QAEXXZ		; CFileIO::closefile

; 49   : 	glReleaseMemory ((char *)buffer);
...
; 52   : }	/* glCloseFileMem */
	...
	pop	ebp
	ret	0
?glCloseFileMem@CFileMemory@@QAEXXZ ENDP		; CFileMemory::glCloseFileMem
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\3dlib\filemem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?glReadFileMem@CFileMemory@@QAEXXZ PROC			; CFileMemory::glReadFileMem
; _this$ = ecx
...
; 42   : 	ShiAssert( buffer );
; 43   : 	CurrentFile.readdata( buffer, bytesLeft );
	...
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 20					; 00000014H
	call	?readdata@CFileIO@@QAEHPAXH@Z		; CFileIO::readdata
...
; 44   : }
	...
	pop	ebp
	ret	0
?glReadFileMem@CFileMemory@@QAEXXZ ENDP			; CFileMemory::glReadFileMem
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\3dlib\filemem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_filename$ = 8						; size = 4
?glOpenFileMem@CFileMemory@@QAEHPBD@Z PROC		; CFileMemory::glOpenFileMem
; _this$ = ecx
...
; 14   : 	ShiAssert( buffer == NULL );
; 15   : 
; 16   : 	// Open the file and get its size
; 17   : 	if (!CurrentFile.openread( filename ))

	mov	eax, DWORD PTR _filename$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 20					; 00000014H
	call	?openread@CFileIO@@QAEHPBD@Z		; CFileIO::openread
	test	eax, eax
	jne	SHORT $LN3@glOpenFile

; 18   : 	    return -1; // JPO fail it.

	or	eax, -1
	jmp	$LN4@glOpenFile
$LN3@glOpenFile:

; 19   : 	bytesLeft = CurrentFile.getfilesize();

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 20					; 00000014H
	call	?getfilesize@CFileIO@@QAEHXZ		; CFileIO::getfilesize
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+16], eax
...
; 22   : 		return (-1);
	...
	or	eax, -1
	jmp	SHORT $LN4@glOpenFile
$LN2@glOpenFile:

; 23   : 	}
; 24   : 
; 25   : 	// Allocate memory for the whole file contents
; 26   : 	buffer = (GLubyte*)glAllocateMemory( bytesLeft );
...
; 31   : 	}
; 32   : 
; 33   : 	// Store some handy pointers into our memory buffer
; 34   : 	CurrentMemoryPointer = buffer;
...
; 38   : }	/* glOpenFileMem */
	...
	pop	ebp
	ret	4
?glOpenFileMem@CFileMemory@@QAEHPBD@Z ENDP		; CFileMemory::glOpenFileMem
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\include\filemem.h
...
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\include\filemem.h
;	COMDAT ??0CFileMemory@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0CFileMemory@@QAE@XZ PROC				; CFileMemory::CFileMemory, COMDAT
; _this$ = ecx

; 13   : 	CFileMemory()			{ buffer = NULL; bytesLeft = 0; };
	...
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 20					; 00000014H
	call	??0CFileIO@@QAE@XZ			; CFileIO::CFileIO
	mov	ecx, DWORD PTR _this$[ebp]
	...
	pop	ebp
	ret	0
??0CFileMemory@@QAE@XZ ENDP				; CFileMemory::CFileMemory
_TEXT	ENDS
; Function compile flags: /Odtp
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0CFileIO@@QAE@XZ PROC					; CFileIO::CFileIO, COMDAT
; _this$ = ecx
