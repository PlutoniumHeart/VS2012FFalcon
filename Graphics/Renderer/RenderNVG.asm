; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\Renderer\RenderNVG.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Setup@RenderNVG@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z ; RenderNVG::Setup
PUBLIC	?StartDraw@RenderNVG@@UAEXXZ			; RenderNVG::StartDraw
PUBLIC	?SetColor@RenderNVG@@UAEXK@Z			; RenderNVG::SetColor
PUBLIC	?DrawSun@RenderNVG@@MAEXXZ			; RenderNVG::DrawSun
PUBLIC	?SetTimeOfDayColor@RenderNVG@@MAEXXZ		; RenderNVG::SetTimeOfDayColor
PUBLIC	?ProcessColor@RenderNVG@@MAEXPAUTcolor@@@Z	; RenderNVG::ProcessColor
PUBLIC	?ComputeVertexColor@RenderNVG@@MAEXPAUTerrainVertex@@PAUTpost@@MMM@Z ; RenderNVG::ComputeVertexColor
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
tv346 = -20						; size = 4
tv248 = -16						; size = 4
_fog$ = -12						; size = 4
...
_x$ = 20						; size = 4
_y$ = 24						; size = 4
?ComputeVertexColor@RenderNVG@@MAEXPAUTerrainVertex@@PAUTpost@@MMM@Z PROC ; RenderNVG::ComputeVertexColor
; _this$ = ecx
...
; 53   : 
; 54   : 	// FRB - B&W
; 55   : 	if ((g_bGreyMFD) && (!bNVGmode))

	movzx	eax, BYTE PTR ?g_bGreyMFD@@3_NA		; g_bGreyMFD
	test	eax, eax
	je	SHORT $LN21@ComputeVer
	movzx	ecx, BYTE PTR ?bNVGmode@@3_NA		; bNVGmode
	test	ecx, ecx
	jne	SHORT $LN21@ComputeVer

; 56   : 		vert->r = vert->b = vert->g; 
...
; 57   : 
; 58   : 	if((distance > haze_start+haze_depth+3000)
; 59   : 	||(realWeather->weatherCondition > FAIR && (-realWeather->viewerZ) > (-realWeather->stratusZ)))
	...
	comiss	xmm0, xmm1
	jbe	SHORT $LN20@ComputeVer
$LN19@ComputeVer:

; 60   : 	{
; 61   : 		vert->RenderingStateHandle = state_far;
...
; 62   : 	}
; 63   : 	else if(distance < PERSPECTIVE_RANGE)

	movss	xmm0, DWORD PTR ?PERSPECTIVE_RANGE@RenderOTW@@2MB
	comiss	xmm0, DWORD PTR _distance$[ebp]
	jbe	SHORT $LN17@ComputeVer

; 64   : 	{
; 65   : 		vert->RenderingStateHandle = state_fore;

	mov	ecx, DWORD PTR _vert$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+263108]
	mov	DWORD PTR [ecx+56], eax
	jmp	SHORT $LN12@ComputeVer
$LN17@ComputeVer:

; 66   : 	}
; 67   : 	else if(!hazed && distance < haze_start)

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+263096], 0
	jne	SHORT $LN15@ComputeVer
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+263080]
	comiss	xmm0, DWORD PTR _distance$[ebp]
	jbe	SHORT $LN15@ComputeVer

; 68   : 	{
; 69   : 		vert->RenderingStateHandle = state_near;
...
; 70   : 	}
; 71   : 	else if(distance > haze_start+haze_depth)
	...
	movss	xmm1, DWORD PTR _distance$[ebp]
	comiss	xmm1, xmm0
	jbe	SHORT $LN13@ComputeVer

; 72   : 	{
; 73   : 		vert->RenderingStateHandle = state_far;
...
; 76   : 	{
; 77   : 		vert->RenderingStateHandle = state_mid;
...
; 78   : 	}
; 79   : 
; 80   : 	if(distance > haze_start + haze_depth)
...
; 83   : 	}
; 84   : 	else if(distance < PERSPECTIVE_RANGE)
...
; 91   : 		{
; 92   : 			fog = min(GetValleyFog(distance,post->z),.6f);
...
; 99   : 			{
; 100  : 				alpha = GetRangeOnlyFog(distance);
...
; 114  : 			{
; 115  : 				alpha = GetRangeOnlyFog(distance);
...
; 123  : }
	...
	pop	ebp
	ret	20					; 00000014H
?ComputeVertexColor@RenderNVG@@MAEXPAUTerrainVertex@@PAUTpost@@MMM@Z ENDP ; RenderNVG::ComputeVertexColor
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_color$ = 8						; size = 4
?ProcessColor@RenderNVG@@MAEXPAUTcolor@@@Z PROC		; RenderNVG::ProcessColor
; _this$ = ecx
...
; 159  : }
	...
	pop	ebp
	ret	4
?ProcessColor@RenderNVG@@MAEXPAUTcolor@@@Z ENDP		; RenderNVG::ProcessColor
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
_ground_haze$ = -8					; size = 4
_this$ = -4						; size = 4
?SetTimeOfDayColor@RenderNVG@@MAEXXZ PROC		; RenderNVG::SetTimeOfDayColor
; _this$ = ecx
...
; 127  : 	lightAmbient = NVG_LIGHT_LEVEL;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f340000
	movss	DWORD PTR [eax+262972], xmm0

; 128  : 	lightDiffuse = 0.f;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+262976], xmm0

; 129  : 	lightSpecular = 0.f;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [edx+262980], xmm0

; 130  : 	TheTimeOfDay.GetLightDirection(&lightVector);
...
; 135  : 	haze_sky_color.r	= 0.f;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+263180], xmm0

; 136  : 	haze_sky_color.g	= NVG_SKY_LEVEL;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3ec80000
	movss	DWORD PTR [edx+263184], xmm0

; 137  : 	haze_sky_color.b	= 0.f;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+263188], xmm0

; 138  : 	earth_end_color.r	= 0.f;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+263168], xmm0

; 139  : 	earth_end_color.g	= NVG_SKY_LEVEL;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3ec80000
	movss	DWORD PTR [edx+263172], xmm0

; 140  : 	earth_end_color.b	= 0.f;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+263176], xmm0

; 141  : 	haze_ground_color.r	= 0.f;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+263144], xmm0

; 142  : 	haze_ground_color.g	= NVG_SKY_LEVEL;

	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3ec80000
	movss	DWORD PTR [edx+263148], xmm0

; 143  : 	haze_ground_color.b	= 0.f;
...
; 144  : 
; 145  : 	DWORD ground_haze = (FloatToInt32(haze_ground_color.g*255.9f) << 8)+0xff000000;
	...
	mov	DWORD PTR _ground_haze$[ebp], eax

; 146  : 	context.SetState(MPR_STA_FOG_COLOR,ground_haze);

	mov	edx, DWORD PTR _ground_haze$[ebp]
	push	edx
	push	12					; 0000000cH
	mov	ecx, DWORD PTR _this$[ebp]
...
; 147  : }
	...
	pop	ebp
	ret	0
?SetTimeOfDayColor@RenderNVG@@MAEXXZ ENDP		; RenderNVG::SetTimeOfDayColor
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?DrawSun@RenderNVG@@MAEXXZ PROC				; RenderNVG::DrawSun
; _this$ = ecx
...
; 43   : 	RenderOTW::DrawSun();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?DrawSun@RenderOTW@@MAEXXZ		; RenderOTW::DrawSun
...
; 44   : }
	...
	pop	ebp
	ret	0
?DrawSun@RenderNVG@@MAEXXZ ENDP				; RenderNVG::DrawSun
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
...
?SetColor@RenderNVG@@UAEXK@Z PROC			; RenderNVG::SetColor
; _this$ = ecx
...
; 38   : 	RenderOTW::SetColor(packedRGBA);

	mov	eax, DWORD PTR _packedRGBA$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetColor@Render2D@@UAEXK@Z		; Render2D::SetColor
...
; 39   : }
	...
	pop	ebp
	ret	4
?SetColor@RenderNVG@@UAEXK@Z ENDP			; RenderNVG::SetColor
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?StartDraw@RenderNVG@@UAEXXZ PROC			; RenderNVG::StartDraw
; _this$ = ecx
...
; 29   : //	DX - YELLOW BUG FIX - RED
; 30   : 	RenderOTW::StartDraw();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?StartDraw@RenderOTW@@UAEXXZ		; RenderOTW::StartDraw

; 31   : 	Drawable2D::SetGreenMode(TRUE);

	push	1
	call	?SetGreenMode@Drawable2D@@SAXH@Z	; Drawable2D::SetGreenMode
	add	esp, 4

; 32   : 	realWeather->SetGreenMode(TRUE);

	push	1
	mov	ecx, DWORD PTR ?realWeather@@3PAVRealWeather@@A ; realWeather
	call	?SetGreenMode@RealWeather@@QAEXH@Z	; RealWeather::SetGreenMode

; 33   : 	TheColorBank.SetColorMode(ColorBankClass::UnlitGreenMode);
...
; 34   : }
	...
	pop	ebp
	ret	0
?StartDraw@RenderNVG@@UAEXXZ ENDP			; RenderNVG::StartDraw
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\rendernvg.cpp
_TEXT	SEGMENT
...
_vp$ = 12						; size = 4
?Setup@RenderNVG@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z PROC ; RenderNVG::Setup
; _this$ = ecx
...
; 24   : 	RenderOTW::Setup(imageBuffer,vp);
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Setup@RenderOTW@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z ; RenderOTW::Setup
...
; 25   : }
	...
	pop	ebp
	ret	8
?Setup@RenderNVG@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z ENDP ; RenderNVG::Setup
_TEXT	ENDS
; Function compile flags: /Odtp
