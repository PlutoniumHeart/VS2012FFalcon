; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\Graphics\Renderer\RenderIR.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Setup@RenderIR@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z ; RenderIR::Setup
PUBLIC	?StartDraw@RenderIR@@UAEXXZ			; RenderIR::StartDraw
PUBLIC	?EndDraw@RenderIR@@UAEXXZ			; RenderIR::EndDraw
PUBLIC	?ComputeVertexColor@RenderIR@@MAEXPAUTerrainVertex@@PAUTpost@@MMM@Z ; RenderIR::ComputeVertexColor
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\renderir.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_vert$ = 8						; size = 4
_post$ = 12						; size = 4
...
_x$ = 20						; size = 4
_y$ = 24						; size = 4
?ComputeVertexColor@RenderIR@@MAEXPAUTerrainVertex@@PAUTpost@@MMM@Z PROC ; RenderIR::ComputeVertexColor
; _this$ = ecx
...
; 68   : 	vert->g = TheMap.ColorTable[post->colorIndex].g*NVG_LIGHT_LEVEL; //TheMap.GreenTable[post->colorIndex].g*NVG_LIGHT_LEVEL;
...
; 74   : 
; 75   : 	vert->RenderingStateHandle = state_far;
...
; 76   : }
	...
	pop	ebp
	ret	20					; 00000014H
?ComputeVertexColor@RenderIR@@MAEXPAUTerrainVertex@@PAUTpost@@MMM@Z ENDP ; RenderIR::ComputeVertexColor
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\renderir.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?EndDraw@RenderIR@@UAEXXZ PROC				; RenderIR::EndDraw
; _this$ = ecx
...
; 53   : //	DX - YELLOW BUG FIX - RED
; 54   : 	RenderOTW::EndDraw();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?EndDraw@RenderOTW@@UAEXXZ		; RenderOTW::EndDraw

; 55   : 	Drawable2D::SetGreenMode(FALSE);
...
; 58   : 	realWeather->SetGreenMode(FALSE);
...
; 59   : 	// Disable DX engine TV Mode
; 60   : 	TheDXEngine.RestoreState();
...
; 62   : }
	...
	pop	ebp
	ret	0
?EndDraw@RenderIR@@UAEXXZ ENDP				; RenderIR::EndDraw
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\renderir.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?StartDraw@RenderIR@@UAEXXZ PROC			; RenderIR::StartDraw
; _this$ = ecx
...
; 39   : //	DX - YELLOW BUG FIX - RED
; 40   : 	RenderOTW::StartDraw();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?StartDraw@RenderOTW@@UAEXXZ		; RenderOTW::StartDraw

; 41   : 	//Drawable2D::SetGreenMode(TRUE); // RV - I-Hawk - Do not force green 
; 42   : 	TheColorBank.SetColorMode(ColorBankClass::NormalMode);
...
; 45   : 	//realWeather->SetGreenMode(TRUE); // RV - I-Hawk - Do not force green
; 46   : 	// Enable DX engine TV Mode
; 47   : 	TheDXEngine.SaveState();

	mov	ecx, OFFSET ?TheDXEngine@@3VCDXEngine@@A ; TheDXEngine
	call	?SaveState@CDXEngine@@QAEXXZ		; CDXEngine::SaveState

; 48   : 	TheDXEngine.SetState(DX_TV);
...
; 49   : }
	...
	pop	ebp
	ret	0
?StartDraw@RenderIR@@UAEXXZ ENDP			; RenderIR::StartDraw
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\graphics\renderer\renderir.cpp
_TEXT	SEGMENT
...
_vp$ = 12						; size = 4
?Setup@RenderIR@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z PROC ; RenderIR::Setup
; _this$ = ecx
...
; 24   : 	RenderTV::Setup(imageBuffer,vp);
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Setup@RenderTV@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z ; RenderTV::Setup

; 25   : 	
; 26   : 	sky_color.r			= sky_color.g			= sky_color.b			= 0.f;
...
; 27   : 	haze_sky_color.r	= haze_sky_color.g		= haze_sky_color.b		= 0.f;
...
; 28   : 	haze_ground_color.r	= haze_ground_color.g	= haze_ground_color.b	= 0.f;
...
; 29   : 	earth_end_color.r	= earth_end_color.g		= earth_end_color.b		= 0.f;
...
; 32   : 	lightAmbient = 1.f;
	...
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR [edx+262972], xmm0

; 33   : 	lightDiffuse = 0.f;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+262976], xmm0

; 34   : 	lightSpecular = 0.f;

	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+262980], xmm0
...
; 35   : }
	...
	pop	ebp
	ret	8
?Setup@RenderIR@@UAEXPAVImageBuffer@@PAVRViewPoint@@@Z ENDP ; RenderIR::Setup
_TEXT	ENDS
; Function compile flags: /Odtp
