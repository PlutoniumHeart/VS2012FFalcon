...
public:
	...
	void InvalidateState () { currentTexture1 = currentTexture2 = lastTexture1 = lastTexture2 = -1; m_colFG_Raw = 0x00ffffff; currentState = lastState = -1; };
...
protected:
	...
	/*inline*/ void AllocatePolygon(SPolygon *&curPoly, const DWORD numVertices);
