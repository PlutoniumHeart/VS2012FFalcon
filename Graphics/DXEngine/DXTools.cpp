...
{
	d->M11=s->m00;	d->M21=s->m01;	d->M31=s->m02;
	d->M12=s->m10;	d->M22=s->m11;	d->M32=s->m12;
	d->M13=s->m20;	d->M23=s->m21;	d->M33=s->m22;
}
...
bool	DXScript_None(D3DVECTOR *pos, ObjectInstance *obj, DWORD *Argument) { return true; }
...
bool DXScript_Beacon(D3DVECTOR *pos, ObjectInstance *obj, DWORD *Argument)
{
	...
	WorldVect.m30=WorldVect.m31=WorldVect.m32=0.0f; WorldVect.m33=1.0f;
