; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\ui95\ui95_dd.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?UIColorTable@@3PAY0BAA@GA			; UIColorTable
PUBLIC	?rUIColorTable@@3PAY0BAA@GA			; rUIColorTable
PUBLIC	?pmField@?$CVarTypeInfo@PAUIUnknown@@@ATL@@2QQtagVARIANT@@PAUIUnknown@@Q3@ ; ATL::CVarTypeInfo<IUnknown *>::pmField
PUBLIC	?gUIColorTable@@3PAY0BAA@GA			; gUIColorTable
PUBLIC	?is_specialized@_Num_base@std@@2_NB		; std::_Num_base::is_specialized
PUBLIC	?bUIColorTable@@3PAY0BAA@GA			; bUIColorTable
PUBLIC	?Grey_1@@3PAGA					; Grey_1
PUBLIC	?Grey_3@@3PAGA					; Grey_3
PUBLIC	?tinyness_before@_Num_base@std@@2_NB		; std::_Num_base::tinyness_before
PUBLIC	?Grey_6@@3PAGA					; Grey_6
PUBLIC	?rShift@@3PAGA					; rShift
PUBLIC	?gShift@@3PAGA					; gShift
PUBLIC	?traps@_Num_base@std@@2_NB			; std::_Num_base::traps
PUBLIC	?bShift@@3PAGA					; bShift
...
_BSS	ENDS
_BSS	SEGMENT
?UIColorTable@@3PAY0BAA@GA DW 0c900H DUP (?)		; UIColorTable
?rUIColorTable@@3PAY0BAA@GA DW 0c900H DUP (?)		; rUIColorTable
?gUIColorTable@@3PAY0BAA@GA DW 0c900H DUP (?)		; gUIColorTable
?bUIColorTable@@3PAY0BAA@GA DW 0c900H DUP (?)		; bUIColorTable
?Grey_1@@3PAGA DW 020H DUP (?)				; Grey_1
?Grey_3@@3PAGA DW 020H DUP (?)				; Grey_3
?Grey_6@@3PAGA DW 020H DUP (?)				; Grey_6
?rShift@@3PAGA DW 020H DUP (?)				; rShift
?gShift@@3PAGA DW 020H DUP (?)				; gShift
?bShift@@3PAGA DW 020H DUP (?)				; bShift
_BSS	ENDS
...
PUBLIC	?UI95_SetScreenColorInfo@@YAXKKK@Z		; UI95_SetScreenColorInfo
PUBLIC	?UI95_GetScreenColorInfo@@YAXAAKAAG0101@Z	; UI95_GetScreenColorInfo
PUBLIC	?UI95_RGB24Bit@@YAGK@Z				; UI95_RGB24Bit
PUBLIC	?UI95_RGB15Bit@@YAGG@Z				; UI95_RGB15Bit
PUBLIC	?UI95_ScreenToTga@@YAGG@Z			; UI95_ScreenToTga
PUBLIC	?UI95_ScreenToGrey@@YAGG@Z			; UI95_ScreenToGrey
PUBLIC	?UIBuildColorTable@@YAXXZ			; UIBuildColorTable
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
_color$ = -12						; size = 4
_j$ = -8						; size = 4
_i$ = -4						; size = 4
?UIBuildColorTable@@YAXXZ PROC				; UIBuildColorTable
...
; 33   : 	for(i=0;i<201;i++)
	...
	jmp	SHORT $LN11@UIBuildCol
$LN10@UIBuildCol:
	mov	eax, DWORD PTR _i$[ebp]
	add	eax, 1
	mov	DWORD PTR _i$[ebp], eax
$LN11@UIBuildCol:
	cmp	DWORD PTR _i$[ebp], 201			; 000000c9H
	jge	$LN9@UIBuildCol

; 34   : 	{
; 35   : 		color=(float)i/100;
...
; 37   : 			if((j * color) >= 0x1f)//1f = 31 = 1<<5 - 1

	cvtsi2ss xmm0, DWORD PTR _j$[ebp]
	mulss	xmm0, DWORD PTR _color$[ebp]
	comiss	xmm0, DWORD PTR __real@41f80000
	jb	SHORT $LN5@UIBuildCol

; 38   : 			{
; 39   : 				UIColorTable[i][j] =0x1f;

	mov	edx, DWORD PTR _i$[ebp]
	shl	edx, 9
	mov	eax, 31					; 0000001fH
	mov	ecx, DWORD PTR _j$[ebp]
	mov	WORD PTR ?UIColorTable@@3PAY0BAA@GA[edx+ecx*2], ax

; 40   : 				rUIColorTable[i][j]=(short)(0x1f << reds);

	movzx	ecx, WORD PTR _reds
	mov	edx, 31					; 0000001fH
	shl	edx, cl
	mov	eax, DWORD PTR _i$[ebp]
	shl	eax, 9
	mov	ecx, DWORD PTR _j$[ebp]
	mov	WORD PTR ?rUIColorTable@@3PAY0BAA@GA[eax+ecx*2], dx

; 41   : 				gUIColorTable[i][j]=(short)(0x1f << greens);

	movzx	ecx, WORD PTR _greens
	mov	edx, 31					; 0000001fH
	shl	edx, cl
	mov	eax, DWORD PTR _i$[ebp]
	shl	eax, 9
	mov	ecx, DWORD PTR _j$[ebp]
	mov	WORD PTR ?gUIColorTable@@3PAY0BAA@GA[eax+ecx*2], dx

; 42   : 				bUIColorTable[i][j]=(short)(0x1f << blues);

	movzx	ecx, WORD PTR _blues
	mov	edx, 31					; 0000001fH
	shl	edx, cl
	mov	eax, DWORD PTR _i$[ebp]
	shl	eax, 9
	mov	ecx, DWORD PTR _j$[ebp]
	mov	WORD PTR ?bUIColorTable@@3PAY0BAA@GA[eax+ecx*2], dx
...
; 45   : 			{
; 46   : 				UIColorTable[i][j] =WORD(j * color);
	...
	shl	eax, 9
	mov	ecx, DWORD PTR _j$[ebp]
	mov	WORD PTR ?UIColorTable@@3PAY0BAA@GA[eax+ecx*2], dx

; 47   : 				rUIColorTable[i][j]=static_cast<WORD>(WORD(j * color) << reds);	//! 
	...
	mov	WORD PTR ?rUIColorTable@@3PAY0BAA@GA[ecx+edx*2], ax

; 48   : 				gUIColorTable[i][j]=static_cast<WORD>(WORD(j * color) << greens);
...
; 49   : 				bUIColorTable[i][j]=static_cast<WORD>(WORD(j * color) << blues);
	...
	shl	ecx, 9
	mov	edx, DWORD PTR _j$[ebp]
	mov	WORD PTR ?bUIColorTable@@3PAY0BAA@GA[ecx+edx*2], ax
$LN4@UIBuildCol:
...
; 54   : 	{
; 55   : 		Grey_1[i]= static_cast<WORD>(FloatToInt32((float)i * 0.1f));  //! 
	...
	add	esp, 4
	mov	ecx, DWORD PTR _i$[ebp]
	mov	WORD PTR ?Grey_1@@3PAGA[ecx*2], ax

; 56   : 		Grey_3[i]= static_cast<WORD>(FloatToInt32((float)i * 0.3f));  //! 
	...
	add	esp, 4
	mov	edx, DWORD PTR _i$[ebp]
	mov	WORD PTR ?Grey_3@@3PAGA[edx*2], ax

; 57   : 		Grey_6[i]= static_cast<WORD>(FloatToInt32((float)i * 0.6f));  //! 
	...
	add	esp, 4
	mov	ecx, DWORD PTR _i$[ebp]
	mov	WORD PTR ?Grey_6@@3PAGA[ecx*2], ax

; 58   : 		rShift[i]= static_cast<short>(i << reds);

	movzx	ecx, WORD PTR _reds
	mov	edx, DWORD PTR _i$[ebp]
	shl	edx, cl
	mov	eax, DWORD PTR _i$[ebp]
	mov	WORD PTR ?rShift@@3PAGA[eax*2], dx

; 59   : 		gShift[i]= static_cast<short>(i << greens);

	movzx	ecx, WORD PTR _greens
	mov	edx, DWORD PTR _i$[ebp]
	shl	edx, cl
	mov	eax, DWORD PTR _i$[ebp]
	mov	WORD PTR ?gShift@@3PAGA[eax*2], dx

; 60   : 		bShift[i]= static_cast<short>(i << blues);

	movzx	ecx, WORD PTR _blues
	mov	edx, DWORD PTR _i$[ebp]
	shl	edx, cl
	mov	eax, DWORD PTR _i$[ebp]
	mov	WORD PTR ?bShift@@3PAGA[eax*2], dx
...
; 62   : }			
	...
	pop	ebp
	ret	0
?UIBuildColorTable@@YAXXZ ENDP				; UIBuildColorTable
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
_grey$ = -4						; size = 4
_color$ = 8						; size = 2
?UI95_ScreenToGrey@@YAGG@Z PROC				; UI95_ScreenToGrey
...
; 175  : 	long grey = Grey_3[(color  >> reds) & 0x1f] + Grey_6[(color  >> greens) & 0x1f] + Grey_1[(color  >> blues) & 0x1f];

	movzx	eax, WORD PTR _color$[ebp]
	movzx	ecx, WORD PTR _reds
	sar	eax, cl
	and	eax, 31					; 0000001fH
	movzx	edx, WORD PTR ?Grey_3@@3PAGA[eax*2]
	movzx	eax, WORD PTR _color$[ebp]
	movzx	ecx, WORD PTR _greens
	sar	eax, cl
	and	eax, 31					; 0000001fH
	movzx	ecx, WORD PTR ?Grey_6@@3PAGA[eax*2]
	add	edx, ecx
	movzx	eax, WORD PTR _color$[ebp]
	movzx	ecx, WORD PTR _blues
	sar	eax, cl
	and	eax, 31					; 0000001fH
	movzx	ecx, WORD PTR ?Grey_1@@3PAGA[eax*2]
	add	edx, ecx
	mov	DWORD PTR _grey$[ebp], edx

; 176  : 
; 177  : 	return static_cast<WORD>(rShift[grey]|gShift[grey]|bShift[grey]); //! 

	mov	edx, DWORD PTR _grey$[ebp]
	movzx	eax, WORD PTR ?rShift@@3PAGA[edx*2]
	mov	ecx, DWORD PTR _grey$[ebp]
...
; 178  : }
	...
	pop	ebp
	ret	0
?UI95_ScreenToGrey@@YAGG@Z ENDP				; UI95_ScreenToGrey
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
...
_r$ = -4						; size = 4
_color$ = 8						; size = 2
?UI95_ScreenToTga@@YAGG@Z PROC				; UI95_ScreenToTga
...
; 169  : 
; 170  : 	return static_cast<WORD>(r|g|b);//! 
...
; 171  : }
	...
	pop	ebp
	ret	0
?UI95_ScreenToTga@@YAGG@Z ENDP				; UI95_ScreenToTga
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
_rgb$ = 8						; size = 2
?UI95_RGB15Bit@@YAGG@Z PROC				; UI95_RGB15Bit
...
; 153  : 	return static_cast<WORD>(rShift[(rgb >> 10) & 0x1f]|gShift[(rgb >> 5) & 0x1f]|bShift[rgb & 0x1f]);//! 

	movzx	eax, WORD PTR _rgb$[ebp]
	sar	eax, 10					; 0000000aH
	and	eax, 31					; 0000001fH
	movzx	eax, WORD PTR ?rShift@@3PAGA[eax*2]
	movzx	ecx, WORD PTR _rgb$[ebp]
	sar	ecx, 5
...
; 154  : }
	...
	pop	ebp
	ret	0
?UI95_RGB15Bit@@YAGG@Z ENDP				; UI95_RGB15Bit
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
_rgb$ = 8						; size = 4
?UI95_RGB24Bit@@YAGK@Z PROC				; UI95_RGB24Bit
...
; 159  : 	return static_cast<WORD>(rShift[(rgb >> 3) & 0x1f] | gShift[(rgb >> 11) & 0x1f] | bShift[(rgb >> 19) & 0x1f]);//! 
...
; 160  : }
	...
	pop	ebp
	ret	0
?UI95_RGB24Bit@@YAGK@Z ENDP				; UI95_RGB24Bit
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
...
_b_mask$ = 24						; size = 4
_b_shift$ = 28						; size = 4
?UI95_GetScreenColorInfo@@YAXAAKAAG0101@Z PROC		; UI95_GetScreenColorInfo
...
; 141  : 	r_mask = redm;
	...
	mov	eax, DWORD PTR _r_mask$[ebp]
	mov	ecx, DWORD PTR _redm
	mov	DWORD PTR [eax], ecx

; 142  : 	g_mask = greenm;

	mov	edx, DWORD PTR _g_mask$[ebp]
	mov	eax, DWORD PTR _greenm
	mov	DWORD PTR [edx], eax

; 143  : 	b_mask = bluem;

	mov	ecx, DWORD PTR _b_mask$[ebp]
	mov	edx, DWORD PTR _bluem
	mov	DWORD PTR [ecx], edx

; 144  : 
; 145  : 	r_shift=reds;

	mov	eax, DWORD PTR _r_shift$[ebp]
	mov	cx, WORD PTR _reds
	mov	WORD PTR [eax], cx

; 146  : 	g_shift=greens;

	mov	edx, DWORD PTR _g_shift$[ebp]
	mov	ax, WORD PTR _greens
	mov	WORD PTR [edx], ax

; 147  : 	b_shift=blues;

	mov	ecx, DWORD PTR _b_shift$[ebp]
	mov	dx, WORD PTR _blues
	mov	WORD PTR [ecx], dx
...
; 148  : }
	...
	pop	ebp
	ret	0
?UI95_GetScreenColorInfo@@YAXAAKAAG0101@Z ENDP		; UI95_GetScreenColorInfo
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ui95_dd.cpp
_TEXT	SEGMENT
...
_g_mask$ = 12						; size = 4
_b_mask$ = 16						; size = 4
?UI95_SetScreenColorInfo@@YAXKKK@Z PROC			; UI95_SetScreenColorInfo
...
; 67   :     ShiAssert(r_mask != 0 && g_mask != 0 && b_mask != 0); // this should never happen
; 68   :     // but I saw it once (JPO)
; 69   : 
; 70   : 
; 71   : 	//XX
; 72   : 	if( r_mask == 0x00FF0000 ) 

	cmp	DWORD PTR _r_mask$[ebp], 16711680	; 00ff0000H
	jne	SHORT $LN18@UI95_SetSc

; 73   : 		r_mask = 0xf800;

	mov	DWORD PTR _r_mask$[ebp], 63488		; 0000f800H
$LN18@UI95_SetSc:

; 74   : 	if( g_mask == 0x0000FF00 ) 

	cmp	DWORD PTR _g_mask$[ebp], 65280		; 0000ff00H
	jne	SHORT $LN17@UI95_SetSc

; 75   : 		g_mask = 0x07e0;

	mov	DWORD PTR _g_mask$[ebp], 2016		; 000007e0H
$LN17@UI95_SetSc:

; 76   : 	if( b_mask == 0x000000FF ) 

	cmp	DWORD PTR _b_mask$[ebp], 255		; 000000ffH
	jne	SHORT $LN16@UI95_SetSc

; 77   : 		b_mask = 0x001f;

	mov	DWORD PTR _b_mask$[ebp], 31		; 0000001fH
$LN16@UI95_SetSc:
...
; 79   : 	redm = r_mask;
	...
	mov	eax, DWORD PTR _r_mask$[ebp]
	mov	DWORD PTR _redm, eax

; 80   : 	greenm = g_mask;

	mov	ecx, DWORD PTR _g_mask$[ebp]
	mov	DWORD PTR _greenm, ecx

; 81   : 	bluem = b_mask;

	mov	edx, DWORD PTR _b_mask$[ebp]
	mov	DWORD PTR _bluem, edx
...
; 84   : 	reds = 0;
	...
	xor	eax, eax
	mov	WORD PTR _reds, ax
$LN15@UI95_SetSc:

; 85   : 	while(r_mask &&  !(r_mask & 1) ) { // JPO cater for no reds - weird!

	cmp	DWORD PTR _r_mask$[ebp], 0
	je	SHORT $LN14@UI95_SetSc
	mov	ecx, DWORD PTR _r_mask$[ebp]
	and	ecx, 1
	jne	SHORT $LN14@UI95_SetSc

; 86   : 		r_mask >>= 1;

	mov	edx, DWORD PTR _r_mask$[ebp]
	shr	edx, 1
	mov	DWORD PTR _r_mask$[ebp], edx

; 87   : 		reds++;

	mov	ax, WORD PTR _reds
	add	ax, 1
	mov	WORD PTR _reds, ax

; 88   : 	}

	jmp	SHORT $LN15@UI95_SetSc
$LN14@UI95_SetSc:

; 89   : 	redc=0;

	xor	ecx, ecx
	mov	WORD PTR _redc, cx
$LN13@UI95_SetSc:
...
; 90   : 	while( r_mask & 1 ) {
	...
	mov	edx, DWORD PTR _r_mask$[ebp]
	and	edx, 1
	je	SHORT $LN12@UI95_SetSc

; 91   : 		r_mask >>= 1;

	mov	eax, DWORD PTR _r_mask$[ebp]
	shr	eax, 1
	mov	DWORD PTR _r_mask$[ebp], eax

; 92   : 		redc++;

	mov	cx, WORD PTR _redc
	add	cx, 1
	mov	WORD PTR _redc, cx

; 93   : 	}

	jmp	SHORT $LN13@UI95_SetSc
$LN12@UI95_SetSc:

; 94   : 	if(redc == 6)//6 meaninig bits per red color component

	movzx	edx, WORD PTR _redc
	cmp	edx, 6
	jne	SHORT $LN11@UI95_SetSc
...
; 98   : 	greens = 0;
	...
	xor	ecx, ecx
	mov	WORD PTR _greens, cx
$LN10@UI95_SetSc:

; 99   : 	while(g_mask && !(g_mask & 1) ) {

	cmp	DWORD PTR _g_mask$[ebp], 0
	je	SHORT $LN9@UI95_SetSc
	mov	edx, DWORD PTR _g_mask$[ebp]
	and	edx, 1
	jne	SHORT $LN9@UI95_SetSc

; 100  : 		g_mask >>= 1;

	mov	eax, DWORD PTR _g_mask$[ebp]
	shr	eax, 1
	mov	DWORD PTR _g_mask$[ebp], eax

; 101  : 		greens++;

	mov	cx, WORD PTR _greens
	add	cx, 1
	mov	WORD PTR _greens, cx

; 102  : 	}

	jmp	SHORT $LN10@UI95_SetSc
$LN9@UI95_SetSc:

; 103  : 	greenc=0;

	xor	edx, edx
	mov	WORD PTR _greenc, dx
$LN8@UI95_SetSc:
...
; 104  : 	while( g_mask & 1 ) {
	...
	mov	eax, DWORD PTR _g_mask$[ebp]
	and	eax, 1
	je	SHORT $LN7@UI95_SetSc

; 105  : 		g_mask >>= 1;

	mov	ecx, DWORD PTR _g_mask$[ebp]
	shr	ecx, 1
	mov	DWORD PTR _g_mask$[ebp], ecx

; 106  : 		greenc++;

	mov	dx, WORD PTR _greenc
	add	dx, 1
	mov	WORD PTR _greenc, dx

; 107  : 	}

	jmp	SHORT $LN8@UI95_SetSc
$LN7@UI95_SetSc:

; 108  : 	if(greenc == 6)

	movzx	eax, WORD PTR _greenc
	cmp	eax, 6
	jne	SHORT $LN6@UI95_SetSc
...
; 112  : 	blues = 0;
	...
	xor	edx, edx
	mov	WORD PTR _blues, dx
$LN5@UI95_SetSc:

; 113  : 	while(b_mask && !(b_mask & 1) ) {

	cmp	DWORD PTR _b_mask$[ebp], 0
	je	SHORT $LN4@UI95_SetSc
	mov	eax, DWORD PTR _b_mask$[ebp]
	and	eax, 1
	jne	SHORT $LN4@UI95_SetSc

; 114  : 		b_mask >>= 1;

	mov	ecx, DWORD PTR _b_mask$[ebp]
	shr	ecx, 1
	mov	DWORD PTR _b_mask$[ebp], ecx
...
; 116  : 	}
	...
	jmp	SHORT $LN5@UI95_SetSc
$LN4@UI95_SetSc:

; 117  : 	bluec=0;

	xor	eax, eax
	mov	WORD PTR _bluec, ax
$LN3@UI95_SetSc:
...
; 118  : 	while( b_mask & 1 ) {
	...
	mov	ecx, DWORD PTR _b_mask$[ebp]
	and	ecx, 1
	je	SHORT $LN2@UI95_SetSc

; 119  : 		b_mask >>= 1;

	mov	edx, DWORD PTR _b_mask$[ebp]
	shr	edx, 1
	mov	DWORD PTR _b_mask$[ebp], edx

; 120  : 		bluec++;

	mov	ax, WORD PTR _bluec
	add	ax, 1
	mov	WORD PTR _bluec, ax

; 121  : 	}

	jmp	SHORT $LN3@UI95_SetSc
$LN2@UI95_SetSc:

; 122  : 	if(bluec == 6)

	movzx	ecx, WORD PTR _bluec
	cmp	ecx, 6
	jne	SHORT $LN19@UI95_SetSc
...
; 124  : }
	...
	pop	ebp
	ret	0
?UI95_SetScreenColorInfo@@YAXKKK@Z ENDP			; UI95_SetScreenColorInfo
_TEXT	ENDS
; Function compile flags: /Odtp
