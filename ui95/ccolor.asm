; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\ui95\ccolor.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?gColorMgr@@3PAVC_ColorMgr@@A			; gColorMgr
...
_BSS	ENDS
_BSS	SEGMENT
?gColorMgr@@3PAVC_ColorMgr@@A DD 01H DUP (?)		; gColorMgr
_BSS	ENDS
...
PUBLIC	??0C_ColorMgr@@QAE@XZ				; C_ColorMgr::C_ColorMgr
PUBLIC	??1C_ColorMgr@@QAE@XZ				; C_ColorMgr::~C_ColorMgr
PUBLIC	?Setup@C_ColorMgr@@QAEXXZ			; C_ColorMgr::Setup
PUBLIC	?Cleanup@C_ColorMgr@@QAEXXZ			; C_ColorMgr::Cleanup
PUBLIC	?AddScheme@C_ColorMgr@@QAEXJPAUCOLORSCHEME@@@Z	; C_ColorMgr::AddScheme
PUBLIC	?GetScheme@C_ColorMgr@@QAEPAUCOLORSCHEME@@J@Z	; C_ColorMgr::GetScheme
PUBLIC	?FindScheme@C_ColorMgr@@QAEHJ@Z			; C_ColorMgr::FindScheme
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
_this$ = -8						; size = 4
_cur$ = -4						; size = 4
_ID$ = 8						; size = 4
?FindScheme@C_ColorMgr@@QAEHJ@Z PROC			; C_ColorMgr::FindScheme
; _this$ = ecx
...
; 94   : 		if(cur->ID == ID)
	...
	jne	SHORT $LN1@FindScheme

; 95   : 			return(TRUE);

	mov	eax, 1
	jmp	SHORT $LN4@FindScheme
$LN1@FindScheme:
...
; 99   : }
	...
	pop	ebp
	ret	4
?FindScheme@C_ColorMgr@@QAEHJ@Z ENDP			; C_ColorMgr::FindScheme
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_ID$ = 8						; size = 4
?GetScheme@C_ColorMgr@@QAEPAUCOLORSCHEME@@J@Z PROC	; C_ColorMgr::GetScheme
; _this$ = ecx
...
; 80   : 		if(cur->ID == ID)
	...
	mov	eax, DWORD PTR [edx]
	cmp	eax, DWORD PTR _ID$[ebp]
	jne	SHORT $LN1@GetScheme

; 81   : 			return(&cur->Color);

	mov	eax, DWORD PTR _cur$[ebp]
	add	eax, 4
	jmp	SHORT $LN4@GetScheme
$LN1@GetScheme:
...
; 83   : 	}
	...
	jmp	SHORT $LN3@GetScheme
$LN2@GetScheme:

; 84   : 	return(&Root_->Color);
...
; 85   : }
	...
	pop	ebp
	ret	4
?GetScheme@C_ColorMgr@@QAEPAUCOLORSCHEME@@J@Z ENDP	; C_ColorMgr::GetScheme
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
...
_newcolor$ = -4						; size = 4
_ID$ = 8						; size = 4
_newscheme$ = 12					; size = 4
?AddScheme@C_ColorMgr@@QAEXJPAUCOLORSCHEME@@@Z PROC	; C_ColorMgr::AddScheme
; _this$ = ecx
...
; 52   : 	COLORLIST *newcolor,*cur;
; 53   : 	if(FindScheme(ID))

	mov	eax, DWORD PTR _ID$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindScheme@C_ColorMgr@@QAEHJ@Z		; C_ColorMgr::FindScheme
	test	eax, eax
	je	SHORT $LN5@AddScheme

; 54   : 		return;

	jmp	SHORT $LN6@AddScheme
$LN5@AddScheme:

; 55   : 
; 56   : 	newcolor=new COLORLIST;
	...
	mov	DWORD PTR _newcolor$[ebp], ecx

; 57   : 	newcolor->ID=ID;

	mov	edx, DWORD PTR _newcolor$[ebp]
	mov	eax, DWORD PTR _ID$[ebp]
	mov	DWORD PTR [edx], eax

; 58   : 	memcpy(&newcolor->Color,newscheme,sizeof(COLORSCHEME));

	push	40					; 00000028H
	mov	ecx, DWORD PTR _newscheme$[ebp]
	push	ecx
	mov	edx, DWORD PTR _newcolor$[ebp]
	add	edx, 4
	push	edx
...
; 59   : 	newcolor->Next=NULL;

	mov	eax, DWORD PTR _newcolor$[ebp]
...
; 67   : 			cur=cur->Next;
	...
	mov	edx, DWORD PTR [ecx+44]
	mov	DWORD PTR _cur$[ebp], edx
	jmp	SHORT $LN2@AddScheme
$LN1@AddScheme:

; 68   : 
; 69   : 		cur->Next=newcolor;
...
; 71   : }
	...
	pop	ebp
	ret	8
?AddScheme@C_ColorMgr@@QAEXJPAUCOLORSCHEME@@@Z ENDP	; C_ColorMgr::AddScheme
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
...
_this$ = -8						; size = 4
_cur$ = -4						; size = 4
?Cleanup@C_ColorMgr@@QAEXXZ PROC			; C_ColorMgr::Cleanup
; _this$ = ecx
...
; 48   : }
	...
	pop	ebp
	ret	0
?Cleanup@C_ColorMgr@@QAEXXZ ENDP			; C_ColorMgr::Cleanup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Setup@C_ColorMgr@@QAEXXZ PROC				; C_ColorMgr::Setup
; _this$ = ecx
...
; 33   : 	AddScheme(0,&ColorScheme_0);

	push	OFFSET _ColorScheme_0
	push	0
	mov	ecx, DWORD PTR _this$[ebp]
	call	?AddScheme@C_ColorMgr@@QAEXJPAUCOLORSCHEME@@@Z ; C_ColorMgr::AddScheme
...
; 34   : }
	...
	pop	ebp
	ret	0
?Setup@C_ColorMgr@@QAEXXZ ENDP				; C_ColorMgr::Setup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1C_ColorMgr@@QAE@XZ PROC				; C_ColorMgr::~C_ColorMgr
; _this$ = ecx
...
; 29   : }
	...
	pop	ebp
	ret	0
??1C_ColorMgr@@QAE@XZ ENDP				; C_ColorMgr::~C_ColorMgr
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\ccolor.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0C_ColorMgr@@QAE@XZ PROC				; C_ColorMgr::C_ColorMgr
; _this$ = ecx
...
; 25   : }
	...
	pop	ebp
	ret	0
??0C_ColorMgr@@QAE@XZ ENDP				; C_ColorMgr::C_ColorMgr
_TEXT	ENDS
; Function compile flags: /Odtp
