; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\ui95\chash.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0C_Hash@@QAE@XZ				; C_Hash::C_Hash
PUBLIC	??1C_Hash@@QAE@XZ				; C_Hash::~C_Hash
PUBLIC	?Setup@C_Hash@@QAEXJ@Z				; C_Hash::Setup
PUBLIC	?Cleanup@C_Hash@@QAEXXZ				; C_Hash::Cleanup
PUBLIC	?Find@C_Hash@@QAEPAXJ@Z				; C_Hash::Find
PUBLIC	?FindText@C_Hash@@QAEPADJ@Z			; C_Hash::FindText
PUBLIC	?FindTextID@C_Hash@@QAEJJ@Z			; C_Hash::FindTextID
PUBLIC	?FindTextID@C_Hash@@QAEJPAD@Z			; C_Hash::FindTextID
PUBLIC	?Add@C_Hash@@QAEXJPAX@Z				; C_Hash::Add
PUBLIC	?AddText@C_Hash@@QAEJPBD@Z			; C_Hash::AddText
PUBLIC	?AddTextID@C_Hash@@QAEJJPAD@Z			; C_Hash::AddTextID
PUBLIC	?Remove@C_Hash@@QAEXJ@Z				; C_Hash::Remove
PUBLIC	?RemoveOld@C_Hash@@QAEXXZ			; C_Hash::RemoveOld
PUBLIC	?GetFirstOld@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z ; C_Hash::GetFirstOld
PUBLIC	?GetNextOld@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z ; C_Hash::GetNextOld
PUBLIC	?GetFirst@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z	; C_Hash::GetFirst
PUBLIC	?GetNext@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z	; C_Hash::GetNext
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
_this$ = -8						; size = 4
_cur$ = -4						; size = 4
_current$ = 8						; size = 4
_curidx$ = 12						; size = 4
?GetNext@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z PROC	; C_Hash::GetNext
; _this$ = ecx
...
; 503  : 	while(!cur && *curidx < (TableSize_-1))
...
; 512  : }
	...
	pop	ebp
	ret	8
?GetNext@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z ENDP	; C_Hash::GetNext
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_current$ = 8						; size = 4
_curidx$ = 12						; size = 4
?GetFirst@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z PROC	; C_Hash::GetFirst
; _this$ = ecx
...
; 473  : 
; 474  : 	ShiAssert(curidx);
; 475  : 
; 476  : 	if (!curidx)

	cmp	DWORD PTR _curidx$[ebp], 0
...
; 480  : 	while(!cur && *curidx < (TableSize_-1))
...
; 485  : 	if(*curidx < TableSize_)

	mov	eax, DWORD PTR _curidx$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [eax]
	cmp	edx, DWORD PTR [ecx+4]
	jge	SHORT $LN2@GetFirst
...
; 493  : }
	...
	pop	ebp
	ret	8
?GetFirst@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z ENDP	; C_Hash::GetFirst
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_current$ = 8						; size = 4
_curidx$ = 12						; size = 4
?GetNextOld@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z PROC	; C_Hash::GetNextOld
; _this$ = ecx
...
; 447  : 	while(!cur && *curidx < (TableSize_-1))

	cmp	DWORD PTR _cur$[ebp], 0
	jne	SHORT $LN5@GetNextOld
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	sub	edx, 1
	mov	eax, DWORD PTR _curidx$[ebp]
	cmp	DWORD PTR [eax], edx
	jge	SHORT $LN5@GetNextOld
...
; 451  : 	}
	...
	jmp	SHORT $LN7@GetNextOld
$LN5@GetNextOld:

; 452  : 	while(cur && cur->Check == Check_ && cur->Record)

	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN4@GetNextOld
	mov	eax, DWORD PTR _cur$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [eax+4]
	cmp	edx, DWORD PTR [ecx+12]
	jne	SHORT $LN4@GetNextOld
	mov	eax, DWORD PTR _cur$[ebp]
...
; 455  : 		while(!cur && *curidx < (TableSize_-1))

	cmp	DWORD PTR _cur$[ebp], 0
	jne	SHORT $LN2@GetNextOld
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	sub	ecx, 1
	mov	edx, DWORD PTR _curidx$[ebp]
	cmp	DWORD PTR [edx], ecx
	jge	SHORT $LN2@GetNextOld
...
; 459  : 		}
	...
	jmp	SHORT $LN3@GetNextOld
$LN2@GetNextOld:

; 460  : 	}

	jmp	SHORT $LN5@GetNextOld
$LN4@GetNextOld:
...
; 462  : 	if(cur)
	...
	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN1@GetNextOld

; 463  : 		return(cur->Record);

	mov	ecx, DWORD PTR _cur$[ebp]
	mov	eax, DWORD PTR [ecx+8]
	jmp	SHORT $LN9@GetNextOld
$LN1@GetNextOld:
...
; 465  : }
	...
	pop	ebp
	ret	8
?GetNextOld@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z ENDP	; C_Hash::GetNextOld
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_current$ = 8						; size = 4
_curidx$ = 12						; size = 4
?GetFirstOld@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z PROC	; C_Hash::GetFirstOld
; _this$ = ecx
...
; 422  : 	while(cur)
	...
	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN4@GetFirstOl

; 423  : 	{
; 424  : 		if(cur->Record && cur->Check != Check_)

	mov	ecx, DWORD PTR _cur$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	je	SHORT $LN3@GetFirstOl
	mov	edx, DWORD PTR _cur$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
...
; 427  : 			return(cur->Record);

	mov	ecx, DWORD PTR _cur$[ebp]
	mov	eax, DWORD PTR [ecx+8]
	jmp	SHORT $LN6@GetFirstOl
$LN3@GetFirstOl:
...
; 430  : 		while(!cur && *curidx < (TableSize_-1))

	cmp	DWORD PTR _cur$[ebp], 0
	jne	SHORT $LN1@GetFirstOl
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	sub	edx, 1
	mov	eax, DWORD PTR _curidx$[ebp]
	cmp	DWORD PTR [eax], edx
	jge	SHORT $LN1@GetFirstOl
...
; 434  : 		}
	...
	jmp	SHORT $LN2@GetFirstOl
$LN1@GetFirstOl:

; 435  : 	}

	jmp	SHORT $LN5@GetFirstOl
$LN4@GetFirstOl:
...
; 437  : }
	...
	pop	ebp
	ret	8
?GetFirstOld@C_Hash@@QAEPAXPAPAVC_HASHNODE@@PAJ@Z ENDP	; C_Hash::GetFirstOld
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_i$ = -8						; size = 4
_this$ = -4						; size = 4
?RemoveOld@C_Hash@@QAEXXZ PROC				; C_Hash::RemoveOld
; _this$ = ecx
...
; 361  : 	long i;
; 362  : 	C_HASHNODE *cur,*prev;
; 363  : 
; 364  : 	if(!TableSize_ || !Table_) return;

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN17@RemoveOld
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	jne	SHORT $LN18@RemoveOld
$LN17@RemoveOld:
	jmp	$LN19@RemoveOld
$LN18@RemoveOld:

; 365  : 
; 366  : 	for(i=0;i<TableSize_;i++)

	mov	DWORD PTR _i$[ebp], 0
	jmp	SHORT $LN16@RemoveOld
$LN15@RemoveOld:
...
; 367  : 	{
; 368  : 		while(Table_[i].Root_ && Table_[i].Root_->Check != Check_)
...
; 371  : 			Table_[i].Root_=Table_[i].Root_->Next;
...
; 372  : 			if(flags_ & C_BIT_REMOVE)

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	and	edx, 67108864				; 04000000H
	je	SHORT $LN11@RemoveOld
...
; 374  : 				if(Callback_)
	...
	je	SHORT $LN10@RemoveOld

; 375  : 					(*Callback_)(prev->Record);
...
; 376  : 				else
	...
	jmp	SHORT $LN11@RemoveOld
$LN10@RemoveOld:

; 377  : #ifdef USE_SH_POOLS
; 378  : 					MemFreePtr(prev->Record);
; 379  : #else
; 380  : 					delete prev->Record;
...
; 394  : 					if(flags_ & C_BIT_REMOVE)

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	and	edx, 67108864				; 04000000H
	je	SHORT $LN4@RemoveOld
...
; 396  : 						if(Callback_)
	...
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+16], 0
	je	SHORT $LN3@RemoveOld

; 397  : 							(*Callback_)(prev->Record);
...
; 398  : 						else
	...
	jmp	SHORT $LN4@RemoveOld
$LN3@RemoveOld:

; 399  : #ifdef USE_SH_POOLS
; 400  : 							MemFreePtr(prev->Record);
; 401  : #else
; 402  : 							delete prev->Record;
...
; 412  : }
	...
	pop	ebp
	ret	0
?RemoveOld@C_Hash@@QAEXXZ ENDP				; C_Hash::RemoveOld
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
?Remove@C_Hash@@QAEXJ@Z PROC				; C_Hash::Remove
; _this$ = ecx
...
; 304  : 	long idx;
; 305  : 	C_HASHNODE *cur,*prev;
; 306  : 
; 307  : 	if(!TableSize_ || !Table_ || (ID < 0)) return;
	...
	jge	SHORT $LN14@Remove
$LN13@Remove:
	jmp	$LN15@Remove
$LN14@Remove:

; 308  : 
; 309  : 	idx=ID % TableSize_;
...
; 310  : 
; 311  : 	if(!Table_[idx].Root_) return;
...
; 312  : 
; 313  : 	Table_[idx].Root_;
; 314  : 	if(Table_[idx].Root_->ID == ID)
...
; 317  : 		Table_[idx].Root_=Table_[idx].Root_->Next;
...
; 324  : 				MemFreePtr(prev->Record);
; 325  : #else
; 326  : 				delete prev->Record;
...
; 346  : 						MemFreePtr(prev->Record);
; 347  : #else
; 348  : 						delete prev->Record;
...
; 357  : }
	...
	pop	ebp
	ret	4
?Remove@C_Hash@@QAEXJ@Z ENDP				; C_Hash::Remove
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_TextID$ = 8						; size = 4
_string$ = 12						; size = 4
?AddTextID@C_Hash@@QAEJJPAD@Z PROC			; C_Hash::AddTextID
; _this$ = ecx
...
; 183  : 	unsigned long idx,ID,i;
; 184  : 	C_HASHNODE *cur,*newhash;
; 185  : 	_TCHAR *data;
; 186  : 
; 187  : 	if(!TableSize_ || !Table_ || !string) return(-1);

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN11@AddTextID
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	je	SHORT $LN11@AddTextID
	cmp	DWORD PTR _string$[ebp], 0
	jne	SHORT $LN12@AddTextID
$LN11@AddTextID:
	or	eax, -1
	jmp	$LN13@AddTextID
$LN12@AddTextID:
...
; 192  : 		ID += string[i];
	...
	jmp	SHORT $LN9@AddTextID
$LN8@AddTextID:

; 193  : 
; 194  : 	idx=ID % TableSize_;
...
; 197  : 	while(cur)
	...
	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN6@AddTextID

; 198  : 	{
; 199  : 		if(_tcscmp(string,(_TCHAR *)cur->Record) == 0)
...
; 202  : 	}
	...
	jmp	SHORT $LN7@AddTextID
$LN6@AddTextID:

; 203  : 
; 204  : 	i=_tcsclen(string);
...
; 205  : 	newhash=new C_HASHNODE;
	...
	mov	DWORD PTR $T2[ebp], eax
	mov	ecx, DWORD PTR $T2[ebp]
	mov	DWORD PTR _newhash$[ebp], ecx

; 206  : #ifdef USE_SH_POOLS
; 207  : 	data=(_TCHAR*)MemAllocPtr(UI_Pools[UI_GENERAL_POOL],sizeof(_TCHAR)*(i+1),FALSE);
; 208  : #else
; 209  : 	data=new _TCHAR[i+1];
...
; 219  : 	if(!Table_[idx].Root_)

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	mov	ecx, DWORD PTR _idx$[ebp]
	cmp	DWORD PTR [eax+ecx*4], 0
	jne	SHORT $LN4@AddTextID

; 220  : 	{
; 221  : 		Table_[idx].Root_=newhash;
...
; 231  : 		}
	...
	jmp	SHORT $LN2@AddTextID
$LN1@AddTextID:

; 232  : 		cur->Next=newhash;
...
; 235  : }
	...
	pop	ebp
	ret	8
?AddTextID@C_Hash@@QAEJJPAD@Z ENDP			; C_Hash::AddTextID
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_string$ = 8						; size = 4
?AddText@C_Hash@@QAEJPBD@Z PROC				; C_Hash::AddText
; _this$ = ecx
...
; 126  : 	unsigned long idx,ID,i;
; 127  : 	C_HASHNODE *cur,*newhash;
; 128  : 	_TCHAR *data;
; 129  : 
; 130  : 	if(!TableSize_ || !Table_ || !string) return(-1);
...
; 141  : 	{
; 142  : 		if(_tcscmp(string,(_TCHAR *)cur->Record) == 0)
...
; 150  : 	data=(_TCHAR*)MemAllocPtr(UI_Pools[UI_GENERAL_POOL],sizeof(_TCHAR)*(i+1),FALSE);
; 151  : #else
; 152  : 	data=new _TCHAR[i+1];
...
; 156  : 	newhash->Record=data;

	mov	edx, DWORD PTR _newhash$[ebp]
	mov	eax, DWORD PTR _data$[ebp]
	mov	DWORD PTR [edx+8], eax

; 157  : 	newhash->Check=Check_;
...
; 174  : 		}
	...
	jmp	SHORT $LN2@AddText
$LN1@AddText:

; 175  : 		cur->Next=newhash;
...
; 179  : }
	...
	pop	ebp
	ret	4
?AddText@C_Hash@@QAEJPBD@Z ENDP				; C_Hash::AddText
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_ID$ = 8						; size = 4
_rec$ = 12						; size = 4
?Add@C_Hash@@QAEXJPAX@Z PROC				; C_Hash::Add
; _this$ = ecx
...
; 94   : 	long idx;
; 95   : 	C_HASHNODE *cur,*newhash;
; 96   : 
; 97   : 	if(!TableSize_ || !Table_ || !rec || ID < 0) 
...
; 105  : 	newhash->Record=rec;

	mov	eax, DWORD PTR _newhash$[ebp]
	mov	ecx, DWORD PTR _rec$[ebp]
	mov	DWORD PTR [eax+8], ecx

; 106  : 	newhash->Check=Check_;
...
; 107  : 	newhash->Next=NULL;

	mov	edx, DWORD PTR _newhash$[ebp]
	mov	DWORD PTR [edx+12], 0

; 108  : 
; 109  : 	idx=ID % TableSize_;
...
; 122  : }
	...
	pop	ebp
	ret	8
?Add@C_Hash@@QAEXJPAX@Z ENDP				; C_Hash::Add
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_string$ = 8						; size = 4
?FindTextID@C_Hash@@QAEJPAD@Z PROC			; C_Hash::FindTextID
; _this$ = ecx
...
; 259  : 	unsigned long idx,i;
; 260  : 	unsigned long ID;
; 261  : 	C_HASHNODE *cur;
; 262  : 
; 263  : 	if(!TableSize_ || !Table_ || !string) return(-1);

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN7@FindTextID
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	je	SHORT $LN7@FindTextID
	cmp	DWORD PTR _string$[ebp], 0
	jne	SHORT $LN8@FindTextID
$LN7@FindTextID:
	or	eax, -1
	jmp	$LN9@FindTextID
$LN8@FindTextID:
...
; 268  : 		ID += string[i];
	...
	add	eax, DWORD PTR _ID$[ebp]
	mov	DWORD PTR _ID$[ebp], eax
	jmp	SHORT $LN5@FindTextID
$LN4@FindTextID:

; 269  : 
; 270  : 	idx=ID % TableSize_;
...
; 273  : 	while(cur)
	...
	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN2@FindTextID

; 274  : 	{
; 275  : 		if(_tcscmp(string,(_TCHAR *)cur->Record) == 0)
	...
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@FindTextID

; 276  : 			return(cur->ID);

	mov	eax, DWORD PTR _cur$[ebp]
	mov	eax, DWORD PTR [eax]
	jmp	SHORT $LN9@FindTextID
$LN1@FindTextID:
...
; 280  : }
	...
	pop	ebp
	ret	4
?FindTextID@C_Hash@@QAEJPAD@Z ENDP			; C_Hash::FindTextID
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_ID$ = 8						; size = 4
?FindTextID@C_Hash@@QAEJJ@Z PROC			; C_Hash::FindTextID
; _this$ = ecx
...
; 285  : 	C_HASHNODE *cur;
; 286  : 
; 287  : 	if(!TableSize_ || !Table_ || (ID < 0)) return(NULL);

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN6@FindTextID
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	je	SHORT $LN6@FindTextID
	cmp	DWORD PTR _ID$[ebp], 0
	jge	SHORT $LN7@FindTextID
$LN6@FindTextID:
	xor	eax, eax
	jmp	SHORT $LN8@FindTextID
$LN7@FindTextID:
...
; 291  : 	if(idx >= TableSize_)

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _idx$[ebp]
	cmp	edx, DWORD PTR [ecx+4]
	jl	SHORT $LN5@FindTextID
...
; 294  : 	for(i=0;i<(ID & 0x0000ffff) && cur;i++)

	mov	DWORD PTR _i$[ebp], 0
	jmp	SHORT $LN4@FindTextID
$LN3@FindTextID:
	mov	ecx, DWORD PTR _i$[ebp]
	add	ecx, 1
...
; 300  : }
	...
	pop	ebp
	ret	4
?FindTextID@C_Hash@@QAEJJ@Z ENDP			; C_Hash::FindTextID
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_ID$ = 8						; size = 4
?FindText@C_Hash@@QAEPADJ@Z PROC			; C_Hash::FindText
; _this$ = ecx
...
; 239  : 	unsigned long idx,i;
; 240  : 	C_HASHNODE *cur;
; 241  : 
; 242  : 	if(!TableSize_ || !Table_ || (ID < 0)) return(NULL);

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN6@FindText
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	je	SHORT $LN6@FindText
	cmp	DWORD PTR _ID$[ebp], 0
	jge	SHORT $LN7@FindText
$LN6@FindText:
	xor	eax, eax
	jmp	SHORT $LN8@FindText
$LN7@FindText:
...
; 246  : 	if(idx >= (unsigned long)TableSize_)//! 

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _idx$[ebp]
	cmp	edx, DWORD PTR [ecx+4]
	jb	SHORT $LN5@FindText
...
; 249  : 	for(i=0;i<(unsigned long)(ID & 0x0000ffff) && cur;i++)

	mov	DWORD PTR _i$[ebp], 0
	jmp	SHORT $LN4@FindText
$LN3@FindText:
	mov	ecx, DWORD PTR _i$[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
$LN4@FindText:
	...
	and	edx, 65535				; 0000ffffH
	cmp	DWORD PTR _i$[ebp], edx
	jae	SHORT $LN2@FindText
	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN2@FindText
...
; 252  : 	if(cur)
	...
	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN1@FindText

; 253  : 		return((_TCHAR *)cur->Record);
...
; 255  : }
	...
	pop	ebp
	ret	4
?FindText@C_Hash@@QAEPADJ@Z ENDP			; C_Hash::FindText
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_ID$ = 8						; size = 4
?Find@C_Hash@@QAEPAXJ@Z PROC				; C_Hash::Find
; _this$ = ecx
...
; 74   : 	C_HASHNODE *cur;
; 75   : 
; 76   : 	if(!TableSize_ || !Table_ || ID < 0) return(NULL);
...
; 90   : }
	...
	pop	ebp
	ret	4
?Find@C_Hash@@QAEPAXJ@Z ENDP				; C_Hash::Find
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_i$ = -8						; size = 4
_this$ = -4						; size = 4
?Cleanup@C_Hash@@QAEXXZ PROC				; C_Hash::Cleanup
; _this$ = ecx
...
; 39   : 	long i;
; 40   : 	C_HASHNODE *cur,*prev;
; 41   : 
; 42   : 	if(TableSize_ || Table_)
...
$LN8@Cleanup:
	...
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	ecx, DWORD PTR [eax+4]
	jge	SHORT $LN6@Cleanup

; 45   : 		{
; 46   : 			cur=Table_[i].Root_;
...
; 57   : 						MemFreePtr(prev->Record);
; 58   : #else
; 59   : 						delete prev->Record;
...
; 69   : }
	...
	pop	ebp
	ret	0
?Cleanup@C_Hash@@QAEXXZ ENDP				; C_Hash::Cleanup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
...
_i$ = -4						; size = 2
_Size$ = 8						; size = 4
?Setup@C_Hash@@QAEXJ@Z PROC				; C_Hash::Setup
; _this$ = ecx
...
; 25   : 
; 26   : 	//edg note: even if new is overloaded to use specific pool, when alloc'ing
; 27   : 	// and array of things, SH seems to still put into default pool(!?)
; 28   : 	#ifdef USE_SH_POOLS
; 29   : 	Table_ = (C_HASHROOT *)MemAllocPtr(UI_Pools[UI_GENERAL_POOL],sizeof(C_HASHROOT)*TableSize_,FALSE);
; 30   : 	#else
; 31   : 	Table_=new C_HASHROOT[TableSize_];
...
; 35   : }
	...
	pop	ebp
	ret	4
?Setup@C_Hash@@QAEXJ@Z ENDP				; C_Hash::Setup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1C_Hash@@QAE@XZ PROC					; C_Hash::~C_Hash
; _this$ = ecx
...
; 17   : 	if(TableSize_ || Table_)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+4], 0
	jne	SHORT $LN1@C_Hash
	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+8], 0
	je	SHORT $LN3@C_Hash
$LN1@C_Hash:
...
; 19   : }
	...
	pop	ebp
	ret	0
??1C_Hash@@QAE@XZ ENDP					; C_Hash::~C_Hash
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\chash.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0C_Hash@@QAE@XZ PROC					; C_Hash::C_Hash
; _this$ = ecx
...
; 13   : }
	...
	pop	ebp
	ret	0
??0C_Hash@@QAE@XZ ENDP					; C_Hash::C_Hash
_TEXT	ENDS
; Function compile flags: /Odtp
