; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\ui95\soundrsc.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Play@SOUND_RSC@@QAEHH@Z			; SOUND_RSC::Play
PUBLIC	?Loop@SOUND_RSC@@QAEHH@Z			; SOUND_RSC::Loop
PUBLIC	?Stream@SOUND_RSC@@QAEHH@Z			; SOUND_RSC::Stream
PUBLIC	?GetData@FLAT_RSC@@QAEPAXXZ			; FLAT_RSC::GetData
...
EXTRN	?StartMemoryStream@CSoundMgr@@QAEHJPAURIFF_FILE@@J@Z:PROC ; CSoundMgr::StartMemoryStream
EXTRN	?FillRiffInfo@CSoundMgr@@QAEJPADPAURIFF_FILE@@@Z:PROC ; CSoundMgr::FillRiffInfo
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\soundrsc.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetData@FLAT_RSC@@QAEPAXXZ PROC			; FLAT_RSC::GetData
; _this$ = ecx
...
; 10   : 	return(Owner->GetData()+Header->offset);
...
; 12   : }
	...
	pop	ebp
	ret	0
?GetData@FLAT_RSC@@QAEPAXXZ ENDP			; FLAT_RSC::GetData
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\soundrsc.cpp
_TEXT	SEGMENT
_SndFlags$ = -272					; size = 4
_this$ = -268						; size = 4
_fname$ = -264						; size = 260
__$ArrayPad$ = -4					; size = 4
_StreamID$ = 8						; size = 4
?Stream@SOUND_RSC@@QAEHH@Z PROC				; SOUND_RSC::Stream
; _this$ = ecx
...
; 64   : 	SndFlags=0;
	...
	mov	DWORD PTR _SndFlags$[ebp], 0

; 65   : 	if(Header->flags & SOUND_LOOP)
...
; 66   : 		SndFlags |= SND_STREAM_LOOP;

	mov	ecx, DWORD PTR _SndFlags$[ebp]
	or	ecx, 32768				; 00008000H
	mov	DWORD PTR _SndFlags$[ebp], ecx
$LN1@Stream:

; 67   : 
; 68   : 	strcpy(fname,Owner->ResName());
...
; 70   : 	return(gSoundDriver->StartFileStream(StreamID,fname,SndFlags,Header->offset));

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	mov	ecx, DWORD PTR [eax+44]
	push	ecx
	mov	edx, DWORD PTR _SndFlags$[ebp]
	push	edx
	lea	eax, DWORD PTR _fname$[ebp]
	push	eax
...
; 71   : }
	...
	pop	ebp
	ret	4
?Stream@SOUND_RSC@@QAEHH@Z ENDP				; SOUND_RSC::Stream
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\soundrsc.cpp
_TEXT	SEGMENT
_RiffHeader$ = -32					; size = 20
_SndFlags$ = -12					; size = 4
_snddata$ = -8						; size = 4
_this$ = -4						; size = 4
_StreamID$ = 8						; size = 4
?Loop@SOUND_RSC@@QAEHH@Z PROC				; SOUND_RSC::Loop
; _this$ = ecx
...
; 47   : 
; 48   : 	SndFlags = SND_STREAM_LOOP;

	mov	DWORD PTR _SndFlags$[ebp], 32768	; 00008000H

; 49   : 
; 50   : 	snddata=Owner->GetData() + Header->offset;
	...
	mov	DWORD PTR _snddata$[ebp], eax

; 51   : 	if(gSoundDriver->FillRiffInfo(snddata,&RiffHeader))

	lea	eax, DWORD PTR _RiffHeader$[ebp]
	push	eax
	mov	ecx, DWORD PTR _snddata$[ebp]
	push	ecx
	mov	ecx, DWORD PTR ?gSoundDriver@@3PAVCSoundMgr@@A ; gSoundDriver
	call	?FillRiffInfo@CSoundMgr@@QAEJPADPAURIFF_FILE@@@Z ; CSoundMgr::FillRiffInfo
	test	eax, eax
	je	SHORT $LN1@Loop

; 52   : 		return(gSoundDriver->StartMemoryStream(StreamID,&RiffHeader,SndFlags));
	...
	push	ecx
	mov	ecx, DWORD PTR ?gSoundDriver@@3PAVCSoundMgr@@A ; gSoundDriver
	call	?StartMemoryStream@CSoundMgr@@QAEHJPAURIFF_FILE@@J@Z ; CSoundMgr::StartMemoryStream
	jmp	SHORT $LN4@Loop
$LN1@Loop:
...
; 54   : }
	...
	pop	ebp
	ret	4
?Loop@SOUND_RSC@@QAEHH@Z ENDP				; SOUND_RSC::Loop
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\soundrsc.cpp
_TEXT	SEGMENT
...
_this$ = -4						; size = 4
_StreamID$ = 8						; size = 4
?Play@SOUND_RSC@@QAEHH@Z PROC				; SOUND_RSC::Play
; _this$ = ecx
...
; 28   : 		SndFlags |= SND_STREAM_LOOP;

	mov	edx, DWORD PTR _SndFlags$[ebp]
	or	edx, 32768				; 00008000H
	mov	DWORD PTR _SndFlags$[ebp], edx
$LN2@Play:

; 29   : 
; 30   : 	snddata=Owner->GetData() + Header->offset;
...
; 31   : 	if(gSoundDriver->FillRiffInfo(snddata,&RiffHeader))
...
; 32   : 		return(gSoundDriver->StartMemoryStream(StreamID,&RiffHeader,SndFlags));
...
; 34   : }
	...
	pop	ebp
	ret	4
?Play@SOUND_RSC@@QAEHH@Z ENDP				; SOUND_RSC::Play
_TEXT	ENDS
; Function compile flags: /Odtp
