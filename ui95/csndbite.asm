; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\ui95\csndbite.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0C_SoundBite@@QAE@XZ				; C_SoundBite::C_SoundBite
PUBLIC	??1C_SoundBite@@QAE@XZ				; C_SoundBite::~C_SoundBite
PUBLIC	?Size@C_SoundBite@@QAEJXZ			; C_SoundBite::Size
PUBLIC	?Setup@C_SoundBite@@QAEXXZ			; C_SoundBite::Setup
PUBLIC	?Cleanup@C_SoundBite@@QAEXXZ			; C_SoundBite::Cleanup
PUBLIC	?Find@C_SoundBite@@QAEPAVCATLIST@@J@Z		; C_SoundBite::Find
PUBLIC	?Add@C_SoundBite@@QAEXJJ@Z			; C_SoundBite::Add
PUBLIC	?Pick@C_SoundBite@@QAEJJ@Z			; C_SoundBite::Pick
PUBLIC	?PickAlways@C_SoundBite@@QAEJJ@Z		; C_SoundBite::PickAlways
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
_this$ = -16						; size = 4
_num$ = -12						; size = 4
_cur$ = -8						; size = 4
_snds$ = -4						; size = 4
_CatID$ = 8						; size = 4
?PickAlways@C_SoundBite@@QAEJJ@Z PROC			; C_SoundBite::PickAlways
; _this$ = ecx
...
; 148  : 	cur=Find(CatID);
	...
	mov	eax, DWORD PTR _CatID$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Find@C_SoundBite@@QAEPAVCATLIST@@J@Z	; C_SoundBite::Find
	mov	DWORD PTR _cur$[ebp], eax

; 149  : 	if(cur)

	cmp	DWORD PTR _cur$[ebp], 0
	je	SHORT $LN4@PickAlways
...
; 151  : 		snds=cur->Root;
	...
	mov	DWORD PTR _snds$[ebp], edx

; 152  : 		num=rand() % cur->Count;
...
; 154  : 		snds=cur->Root;
	...
	mov	DWORD PTR _snds$[ebp], eax
$LN3@PickAlways:

; 155  : 		while(snds && num > 0)

	cmp	DWORD PTR _snds$[ebp], 0
	je	SHORT $LN2@PickAlways
	cmp	DWORD PTR _num$[ebp], 0
	jle	SHORT $LN2@PickAlways
...
; 158  : 			snds=snds->Next;
	...
	mov	edx, DWORD PTR _snds$[ebp]
	mov	eax, DWORD PTR [edx+12]
	mov	DWORD PTR _snds$[ebp], eax

; 159  : 		}

	jmp	SHORT $LN3@PickAlways
$LN2@PickAlways:
...
; 162  : 			snds->Used++;
	...
	mov	ecx, DWORD PTR _snds$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	add	edx, 1
	mov	eax, DWORD PTR _snds$[ebp]
	mov	DWORD PTR [eax+8], edx

; 163  : 			return(snds->SoundID);

	mov	ecx, DWORD PTR _snds$[ebp]
	mov	eax, DWORD PTR [ecx+4]
	jmp	SHORT $LN5@PickAlways
$LN4@PickAlways:
...
; 167  : }
	...
	pop	ebp
	ret	4
?PickAlways@C_SoundBite@@QAEJJ@Z ENDP			; C_SoundBite::PickAlways
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
...
_snds$ = -4						; size = 4
_CatID$ = 8						; size = 4
?Pick@C_SoundBite@@QAEJJ@Z PROC				; C_SoundBite::Pick
; _this$ = ecx
...
; 140  : }
	...
	pop	ebp
	ret	4
?Pick@C_SoundBite@@QAEJJ@Z ENDP				; C_SoundBite::Pick
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
...
_CatID$ = 8						; size = 4
_SoundID$ = 12						; size = 4
?Add@C_SoundBite@@QAEXJJ@Z PROC				; C_SoundBite::Add
; _this$ = ecx
...
; 68   : 	CATLIST *cur;
; 69   : 	SOUNDCAT *sndlist,*newitem;
; 70   : 
; 71   : 	newitem=new SOUNDCAT;
...
; 80   : 		sndlist=cur->Root;
	...
	mov	DWORD PTR _sndlist$[ebp], ecx
$LN7@Add:

; 81   : 		while(sndlist->Next)

	mov	edx, DWORD PTR _sndlist$[ebp]
	cmp	DWORD PTR [edx+12], 0
	je	SHORT $LN6@Add

; 82   : 			sndlist=sndlist->Next;

	mov	eax, DWORD PTR _sndlist$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	mov	DWORD PTR _sndlist$[ebp], ecx
	jmp	SHORT $LN7@Add
$LN6@Add:

; 83   : 		newitem->ID=sndlist->ID+1;
...
; 112  : }
	...
	pop	ebp
	ret	8
?Add@C_SoundBite@@QAEXJJ@Z ENDP				; C_SoundBite::Add
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
...
_cur$ = -4						; size = 4
_CatID$ = 8						; size = 4
?Find@C_SoundBite@@QAEPAVCATLIST@@J@Z PROC		; C_SoundBite::Find
; _this$ = ecx
...
; 58   : 	{
; 59   : 		if(cur->CatID == CatID)

	mov	edx, DWORD PTR _cur$[ebp]
	mov	eax, DWORD PTR [edx]
	cmp	eax, DWORD PTR _CatID$[ebp]
	jne	SHORT $LN1@Find
...
; 64   : }
	...
	pop	ebp
	ret	4
?Find@C_SoundBite@@QAEPAVCATLIST@@J@Z ENDP		; C_SoundBite::Find
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
...
_cursnd$ = -8						; size = 4
_cur$ = -4						; size = 4
?Cleanup@C_SoundBite@@QAEXXZ PROC			; C_SoundBite::Cleanup
; _this$ = ecx
...
; 40   : 		cursnd=last->Root;
	...
	mov	eax, DWORD PTR [edx+8]
	mov	DWORD PTR _cursnd$[ebp], eax
$LN2@Cleanup:

; 41   : 		while(cursnd)

	cmp	DWORD PTR _cursnd$[ebp], 0
	je	SHORT $LN1@Cleanup

; 42   : 		{
; 43   : 			lastsnd=cursnd;

	mov	ecx, DWORD PTR _cursnd$[ebp]
	mov	DWORD PTR _lastsnd$[ebp], ecx

; 44   : 			cursnd=cursnd->Next;

	mov	edx, DWORD PTR _cursnd$[ebp]
	mov	eax, DWORD PTR [edx+12]
	mov	DWORD PTR _cursnd$[ebp], eax

; 45   : 			delete lastsnd;

	mov	ecx, DWORD PTR _lastsnd$[ebp]
...
; 50   : }
	...
	pop	ebp
	ret	0
?Cleanup@C_SoundBite@@QAEXXZ ENDP			; C_SoundBite::Cleanup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Setup@C_SoundBite@@QAEXXZ PROC				; C_SoundBite::Setup
; _this$ = ecx
...
; 27   : }
	...
	pop	ebp
	ret	0
?Setup@C_SoundBite@@QAEXXZ ENDP				; C_SoundBite::Setup
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Size@C_SoundBite@@QAEJXZ PROC				; C_SoundBite::Size
; _this$ = ecx
...
; 22   : }
	...
	pop	ebp
	ret	0
?Size@C_SoundBite@@QAEJXZ ENDP				; C_SoundBite::Size
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1C_SoundBite@@QAE@XZ PROC				; C_SoundBite::~C_SoundBite
; _this$ = ecx
...
; 17   : }
	...
	pop	ebp
	ret	0
??1C_SoundBite@@QAE@XZ ENDP				; C_SoundBite::~C_SoundBite
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\ui95\csndbite.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0C_SoundBite@@QAE@XZ PROC				; C_SoundBite::C_SoundBite
; _this$ = ecx
...
; 10   : }
	...
	pop	ebp
	ret	0
??0C_SoundBite@@QAE@XZ ENDP				; C_SoundBite::C_SoundBite
_TEXT	ENDS
; Function compile flags: /Odtp
