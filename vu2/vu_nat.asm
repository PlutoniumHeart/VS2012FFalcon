; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.51106.1 
	...
	TITLE	C:\Users\Zhitao Li\Documents\Visual Studio 2012\Projects\Freefalcon\vu2\Src\vu_nat.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	?Decode@VU_ADDRESS@@QAEXPAPAEPAJ@Z		; VU_ADDRESS::Decode
PUBLIC	?Encode@VU_ADDRESS@@QAEHPAPAE@Z			; VU_ADDRESS::Encode
PUBLIC	?IsPrivate@VU_ADDRESS@@QBE_NXZ			; VU_ADDRESS::IsPrivate
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\vu2\src\vu_nat.cpp
_TEXT	SEGMENT
_this$ = -8						; size = 4
tv68 = -1						; size = 1
?IsPrivate@VU_ADDRESS@@QBE_NXZ PROC			; VU_ADDRESS::IsPrivate
; _this$ = ecx

; 9    : bool VU_ADDRESS::IsPrivate() const{
...
; 10   : 	return (ComAPIPrivateIP(this->ip)) ? true : false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	call	_ComAPIPrivateIP
	add	esp, 4
	test	eax, eax
	je	SHORT $LN3@IsPrivate
	mov	BYTE PTR tv68[ebp], 1
	jmp	SHORT $LN4@IsPrivate
$LN3@IsPrivate:
...
; 11   : }
	...
	pop	ebp
	ret	0
?IsPrivate@VU_ADDRESS@@QBE_NXZ ENDP			; VU_ADDRESS::IsPrivate
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\vu2\src\vu_nat.cpp
_TEXT	SEGMENT
...
_this$ = -4						; size = 4
_stream$ = 8						; size = 4
?Encode@VU_ADDRESS@@QAEHPAPAE@Z PROC			; VU_ADDRESS::Encode
; _this$ = ecx

; 19   : int VU_ADDRESS::Encode(VU_BYTE **stream){
...
; 20   : 	VU_BYTE *init = *stream;

	mov	eax, DWORD PTR _stream$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _init$[ebp], ecx

; 21   : 	memcpy(*stream, &recvPort, sizeof(unsigned short));
...
; 22   : 	*stream += sizeof(unsigned short);
...
; 23   : 	memcpy(*stream, &reliableRecvPort, sizeof(unsigned short));
...
; 24   : 	*stream += sizeof(unsigned short);
...
; 25   : 	memcpy(*stream, &ip, sizeof(unsigned long));
...
; 26   : 	*stream += sizeof(unsigned long);
...
; 27   : 	// how much we wrote
; 28   : 	return *stream - init;

	mov	edx, DWORD PTR _stream$[ebp]
	mov	eax, DWORD PTR [edx]
	sub	eax, DWORD PTR _init$[ebp]
...
; 29   : }
	...
	pop	ebp
	ret	4
?Encode@VU_ADDRESS@@QAEHPAPAE@Z ENDP			; VU_ADDRESS::Encode
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\zhitao li\documents\visual studio 2012\projects\freefalcon\vu2\src\vu_nat.cpp
_TEXT	SEGMENT
...
_stream$ = 8						; size = 4
_rem$ = 12						; size = 4
?Decode@VU_ADDRESS@@QAEXPAPAEPAJ@Z PROC			; VU_ADDRESS::Decode
; _this$ = ecx

; 13   : void VU_ADDRESS::Decode(VU_BYTE **stream, long *rem){
...
; 14   : 	memcpychk(&recvPort, stream, sizeof(unsigned short), rem);
...
; 15   : 	memcpychk(&reliableRecvPort, stream, sizeof(unsigned short), rem);
...
; 16   : 	memcpychk(&ip, stream, sizeof(unsigned long), rem);
...
; 17   : }
	...
	pop	ebp
	ret	8
?Decode@VU_ADDRESS@@QAEXPAPAEPAJ@Z ENDP			; VU_ADDRESS::Decode
_TEXT	ENDS
END
